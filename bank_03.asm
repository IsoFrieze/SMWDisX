...
Football:             JSL GenericSprGfxRt2
                      ...
                      BNE +
                      JSL CODE_01AB6F
CODE_03802D:          JSL UpdateSpritePos
...
CODE_03807E:          CMP.B #$20
                      BCC +
                      LDA.B #$20
                    + STA.B SpriteXSpeed,X
Return038086:         RTS

BigBooBoss:           JSL CODE_038398
                      JSL CODE_038239
...
CODE_0380D5:          LDA.W SpriteMisc1540,X
                      BNE Return0380F9
                      LDA.B #$08
                      STA.W SpriteMisc1540,X
...
CODE_038106:          LDA.W SpriteMisc1540,X
                      BNE +
...
CODE_038119:          STZ.W SpriteMisc1602,X
                      JSR CODE_0381E4
...
CODE_03818B:          LDA.W SpriteMisc1540,X
                      BNE CODE_0381AE
                      INC.B SpriteTableC2,X
                      LDA.B #$08
                      STA.W SpriteMisc1540,X
...
CODE_0381BC:          LDA.W SpriteMisc1540,X
                      BNE +
                      LDA.B #$08
                      STA.W SpriteMisc1540,X
...
CODE_0381D3:          LDA.B #$02                                ; \ Sprite status = Killed
...
CODE_0381E4:          LDY.B #$0B
CODE_0381E6:          LDA.W SpriteStatus,Y
                      CMP.B #$09
                      BEQ CODE_0381F5
                      CMP.B #$0A
                      BEQ CODE_0381F5
...
CODE_0383A0:          LDA.B SpriteNumber,X
                      CMP.B #$37
                      BNE CODE_0383C2
                      LDA.B #$00
...
CODE_0383C2:          JSR GetDrawInfoBnk3
...
GreyFallingPlat:      JSR CODE_038492
                      LDA.B SpriteLock
                      BNE Return038489
                      JSR SubOffscreen0Bnk3
                      LDA.B SpriteYSpeed,X
                      ...
                      STA.B SpriteYSpeed,X
                    + JSL UpdateYPosNoGvtyW
CODE_038476:          JSL InvisBlkMainRt
                      BCC Return038489
                      LDA.B SpriteYSpeed,X
                      BNE Return038489
                      LDA.B #$03
...
CODE_038492:          JSR GetDrawInfoBnk3
                      PHX
                      LDX.B #$03
                    - LDA.B _0
                      CLC
...
Blurp:                JSL GenericSprGfxRt2
                    ...
                    + STA.W OAMTileNo+$100,Y
                      ...
                      CMP.B #$08
                      BEQ +
CODE_0384EC:          LDA.W OAMTileAttr+$100,Y
                      ORA.B #$80
                      STA.W OAMTileAttr+$100,Y
                      RTS
...
CODE_0385A3:          JSR GetDrawInfoBnk3
                      LDA.B EffFrame
                      AND.B #$04
                      STA.B _3
                      LDA.W SpriteMisc157C,X
...
FlyingTurnBlocks:     JSR CODE_0386A8
                      LDA.B SpriteLock
                      BNE Return038675
                    ...
                    + LDA.W SpriteMisc157C,X
                      ...
                      STA.B SpriteYSpeed,X
CODE_038629:          LDA.B SpriteYSpeed,X
                      PHA
                    ...
                    + JSL UpdateYPosNoGvtyW
                      ...
                      STA.W SpriteMisc1602,X
                      LDY.B #$09
CODE_038660:          CPY.W CurSpriteProcess
                      BEQ CODE_03866C
...
CODE_0386A8:          JSR GetDrawInfoBnk3
                      LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
                      LDA.B EffFrame
                      LSR A
                      AND.B #$04
...
GrayLavaPlatform:     JSR CODE_03873A
                      LDA.B SpriteLock
                      BNE Return038733
                      JSR SubOffscreen0Bnk3
                      LDA.W SpriteMisc1540,X
...
CODE_03873A:          JSR GetDrawInfoBnk3
                      PHX
                      LDX.B #$02
                    - LDA.B _0
                      STA.W OAMTileXPos+$100,Y
...
MegaMole:             JSR MegaMoleGfxRt                         ; Graphics routine
                      LDA.W SpriteStatus,X                      ; \
...
MegaMoleInAir:        PLA
                    ...
                    + LDA.W SpriteMisc1540,X
                      ...
                      STZ.B SpriteYSpeed,X                      ; Sprite Y Speed = 0
MegaMoleOnGround:     LDY.W SpriteMisc15AC,X                    ; \
                    ...
                    + LDA.W SpriteMisc157C,X                    ; \ Flip the temp direction status
                      EOR.B #$01                                ; |
                      STA.W SpriteMisc157C,X                    ; /
CODE_0387CD:          CPY.B #$00                                ; \ If time until flip == 0...
                      BNE +                                     ; |
...
MegaMoleContact:      LDA.W SpriteMisc154C,X                    ; \ If riding Mega Mole...
...
MegaMoleGfxRt:        JSR GetDrawInfoBnk3
...
CODE_0388E4:          LDA.W SpriteOffscreenX,X
                      BNE +
                      JSR SubHorzPosBnk3
                      LDA.B _F
                      CLC
...
SlidingKoopa:         LDA.B #$00
                      ...
                      INC A
                    + STA.W SpriteMisc157C,X
CODE_038964:          JSL GenericSprGfxRt2
                      LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
                      LDA.W SpriteMisc1558,X
                      CMP.B #$01
                      BNE +
                    ...
                    + STA.B _0
                      ...
                      BPL CODE_0389CC
                      LDY.B #$D0
CODE_0389CC:          STY.B SpriteYSpeed,X
                      LDA.B TrueFrame
                      AND.B #$01
                      BNE Return0389FE
                      LDA.W SpriteSlope,X
...
CODE_0389FF:          LDA.B SpriteXSpeed,X
                      BEQ Return038A20
                      LDA.B TrueFrame
                      AND.B #$03
                      BNE Return038A20
                      ...
                      BNE Return038A20
                      LDY.B #$03
CODE_038A18:          LDA.W SmokeSpriteNumber,Y
                      BEQ CODE_038A21
                      DEY
                      BPL CODE_038A18
Return038A20:         RTS

CODE_038A21:          LDA.B #$03
...
BowserStatue:         JSR BowserStatueGfx
                      LDA.B SpriteLock
                      BNE +
                      JSR SubOffscreen0Bnk3
                      LDA.B SpriteTableC2,X
...
CODE_038A54:          JSR CODE_038ACB
CODE_038A57:          JSL InvisBlkMainRt
                      JSL UpdateSpritePos
                      LDA.W SpriteBlockedDirs,X                 ; \ Branch if not on ground
                      AND.B #$04                                ; |
                      BEQ +                                     ; /
...
CODE_038A69:          ASL.W SpriteTweakerD,X
...
BowserStatueGfx:      JSR GetDrawInfoBnk3
                      LDA.W SpriteMisc1602,X
                      STA.B _4
                      EOR.B #$01
                      DEC A
...
CarrotTopLift:        JSR CarrotTopLiftGfx
                      LDA.B SpriteLock
                      BNE -
                      JSR SubOffscreen0Bnk3
                      LDA.W SpriteMisc1540,X
...
CODE_038CE4:          LDA.B PlayerXPosNext
                      CLC
                      ADC.B #$04
                      STA.B _0
...
CarrotTopLiftGfx:     JSR GetDrawInfoBnk3
                      PHX
...
TimedLift:            JSR TimedPlatformGfx
                      LDA.B SpriteLock
                      BNE Return038DEF
                      JSR SubOffscreen0Bnk3
                      LDA.B TrueFrame
...
CODE_038DF0:          JSL UpdateSpritePos
                      LDA.W SpriteXMovement
                      STA.W SpriteMisc1528,X
                      JSL InvisBlkMainRt
                      RTS
...
TimedPlatformGfx:     JSR GetDrawInfoBnk3
                      LDA.W SpriteMisc1570,X
                      PHX
                      PHA
                      LSR A
...
GreyCastleBlock:      JSR CODE_038EB4
                      LDA.B SpriteLock
                      BNE Return038EA7
                      LDA.W SpriteMisc1540,X
                      BNE +
...
CODE_038EB4:          JSR GetDrawInfoBnk3
                      PHX
                      LDX.B #$03
                    - LDA.B _0
                      CLC
...
StatueFireball:       JSR StatueFireballGfx
                      LDA.B SpriteLock
                      BNE +
                      JSR SubOffscreen0Bnk3
                      JSL MarioSprInteract
...
StatueFireballGfx:    JSR GetDrawInfoBnk3
                      LDA.W SpriteMisc157C,X
                      ASL A
                      STA.B _2
                      LDA.B EffFrame
...
ReflectingFireball:   JSR CODE_038FF2
                      BRA CODE_038FA4
...
BooStream:            LDA.B #$00
                    ...
                    + STA.W SpriteMisc157C,X
                      ...
                      STA.W OAMTileNo+$100,Y
                      PLX
CODE_038FA4:          LDA.W SpriteStatus,X
                      CMP.B #$08
                      BNE Return038FF1
                      LDA.B SpriteLock
                      BNE Return038FF1
...
CODE_038FF2:          JSL GenericSprGfxRt2
                      LDA.B EffFrame
                      LSR A
                      LSR A
                      LDA.B #$04
...
CODE_039020:          LDY.B #$0B
CODE_039022:          LDA.W MinExtSpriteNumber,Y
                      BEQ CODE_039037
                      DEY
                      BPL CODE_039022
...
CODE_0390F3:          LDA.W SpriteMisc157C,X
                      ASL A
...
FishinBooGfx:         JSR GetDrawInfoBnk3
                      LDA.W SpriteMisc1602,X
                      STA.B _4
                      LDA.W SpriteMisc157C,X
                      STA.B _2
...
FallingSpike:         JSL GenericSprGfxRt2
                      LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
                      LDA.B #$E0
                      STA.W OAMTileNo+$100,Y
                      LDA.W OAMTileYPos+$100,Y
...
CODE_03924C:          STZ.B SpriteYSpeed,X                      ; Sprite Y Speed = 0
                      JSR SubHorzPosBnk3
                      LDA.B _F
                      CLC
                      ADC.B #$40
...
CODE_039262:          LDA.W SpriteMisc1540,X
                      BNE CODE_03926C
                      JSL MarioSprInteract
                      RTS

CODE_03926C:          STZ.B SpriteYSpeed,X                      ; Sprite Y Speed = 0
                      RTS
...
CreateEatBlock:       JSL GenericSprGfxRt2
                      LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
                      LDA.W OAMTileYPos+$100,Y
                      DEC A
                      STA.W OAMTileYPos+$100,Y
...
CODE_0392C0:          LDA.B SpriteLock
                      ...
                      BMI CODE_0392F8
                      BNE CODE_03931F
CODE_0392F8:          LDY.W PlayerTurnLvl
...
CODE_039441:          LDA.W SpriteMisc1540,X
                      BEQ CODE_03944A
                      LDA.B #$20
                      BRA CODE_039475

CODE_03944A:          LDA.B #$30
                      BRA SetTimerNextState

CODE_03944E:          LDA.W SpriteMisc1540,X
                      BNE Return039457
                      LDA.B #$18
                      BRA SetTimerNextState
...
CODE_039458:          LDA.W SpriteMisc1540,X
                      BEQ +
                      LDA.B #$F0
                      JSR CODE_039475
                      RTS
                    ...
                    + LDA.B #$30
SetTimerNextState:    STA.W SpriteMisc1540,X
                      INC.B SpriteTableC2,X                     ; Goto next state
                      RTS

CODE_03946B:          LDA.W SpriteMisc1540,X                    ; \ If stall timer us up,
...
CODE_039475:          LDY.W SpriteMisc151C,X
                      BEQ +
                      EOR.B #$FF
                      INC A
                    + STA.B SpriteYSpeed,X
...
CODE_039488:          JSL MarioSprInteract
                      BCC Return0394B0
                      JSR SubHorzPosBnk3
                      LDA.B _F
                      CLC
...
WoodSpikeGfx:         JSR GetDrawInfoBnk3
...
RexMainRt:            JSR RexGfxRt                              ; Draw Rex gfx
...
RexAlive:             JSR SubOffscreen0Bnk3                     ; Only process Rex while on screen
...
RexInAir:             LDA.W SpriteMisc1FE2,X                    ; \ If time to show half-smushed Rex > 0...
...
RexWins:              LDA.W IFrameTimer                         ; \ If mario is invincible...
...
RexGfxRt:             LDA.W SpriteMisc1558,X                    ; \ If time to show Rex remains > 0...
                      BEQ +                                     ; |
...
CODE_03972F:          INC.W SpriteMisc1570,X
                      LDA.W SpriteMisc1570,X
                      NOP
                      LSR A
                      AND.B #$01
...
CODE_039756:          INC.B SpriteTableC2,X
                      LDA.B #$30
                      STA.W SpriteMisc1540,X
                      RTS

CODE_03975E:          STZ.W SpriteMisc1602,X
                      LDA.W SpriteMisc1540,X
                      BEQ CODE_039776
                      AND.B #$03
                      BNE Return039775
...
CODE_039776:          STZ.B SpriteTableC2,X
                      LDA.B #$30
                      STA.W SpriteMisc1540,X
                      RTS
...
FishboneGfx:          JSL GenericSprGfxRt2
                      LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
                      LDA.W SpriteMisc1558,X
                      CMP.B #$01
                      LDA.B #$A6
...
ReznorNoLevelEnd:     LDA.W SpriteMisc151C+7                    ; \
                      CLC                                       ; |
                    ...
                    - STA.W ExtSpriteNumber,Y                   ; |
                      DEY                                       ; |
                      BPL -                                     ; /
CODE_039910:          LDA.W SpriteStatus,X
                      CMP.B #$08
                      BEQ +
                      JMP DrawReznor
...
DrawReznor:           STZ.W SpriteMisc1602,X                    ; Set normal image
                      LDA.W SpriteMisc157C,X
                      PHA
                    ...
                    + LDA.B #$02                                ; \ Set turning image
                      STA.W SpriteMisc1602,X                    ; /
ReznorNoTurning:      LDA.W SpriteMisc1558,X                    ; \ Shoot fire if "time to show firing image" == 20
                      BEQ ReznorNoFiring                        ; |
                    ...
                    + LDA.B #$01                                ; \ Set firing image
                      STA.W SpriteMisc1602,X                    ; /
ReznorNoFiring:       JSR ReznorGfxRt                           ; Draw Reznor
                      PLA
                      STA.W SpriteMisc157C,X
...
CODE_039AFA:          LDA.W ExtSpriteNumber,Y                   ; |
                      BEQ FoundRznrFireSlot                     ; |
                      DEY                                       ; |
                      BPL CODE_039AFA                           ; |
                      RTS                                       ; / Return if no free slots

FoundRznrFireSlot:    LDA.B #!SFX_MAGIC                         ; \
                      STA.W SPCIO0                              ; / Play sound effect
...
ReznorGfxRt:          LDA.W SpriteMisc151C,X                    ; \ if the reznor is dead, only draw the platform
                      BNE DrawReznorPlats                       ; /
...
RznrGfxLoopStart:     PHX
                    ...
                    + STA.W OAMTileAttr+$100,Y                  ; /
                      ...
                      CMP.B #$02
                      BEQ +
DrawReznorPlats:      JSR ReznorPlatGfxRt
                    + RTS


ReznorPlatDispY:      db $00,$03,$04,$05,$05,$04,$03,$00

ReznorPlatGfxRt:      LDA.W SpriteOAMIndex,X
                      CLC
                      ADC.B #$10
                      STA.W SpriteOAMIndex,X
                      JSR GetDrawInfoBnk3
...
InvisBlk_DinosMain:   LDA.B SpriteNumber,X                      ; \ Branch if sprite isn't "Invisible solid block"
                      CMP.B #$6D                                ; |
                      BNE +                                     ; /
...
CODE_039C74:          LDA.B SpriteYSpeed,X
                      BMI CODE_039C89
                      STZ.B SpriteTableC2,X
                      LDA.W SpriteBlockedDirs,X                 ; \ Branch if not touching object
                      AND.B #$03                                ; |
                      ...
                      EOR.B #$01
                      STA.W SpriteMisc157C,X
CODE_039C89:          STZ.W SpriteMisc1602,X
                      LDA.W SpriteBlockedDirs,X
                      AND.B #$03
                      TAY
                      LDA.B SpriteXPosLow,X
...
CODE_039CA8:          LDA.W SpriteBlockedDirs,X                 ; \ Branch if not on ground
                      AND.B #$04                                ; |
                      BEQ CODE_039C89                           ; /
                      LDA.W SpriteMisc1540,X
                      BNE +
...
CODE_039D41:          STZ.B SpriteXSpeed,X                      ; Sprite X Speed = 0
                      LDA.W SpriteMisc1540,X
                      BNE +
                      STZ.B SpriteTableC2,X
                      LDA.B #$40
...
DinoFlameClipping:    LDA.W SpriteMisc1602,X
                      SEC
                      SBC.B #$02
                      TAY
                      LDA.W SpriteMisc157C,X
...
DinoSetGfxFrame:      INC.W SpriteMisc1570,X
                      LDA.W SpriteMisc1570,X
                      AND.B #$08
                      LSR A
                      LSR A
...
CODE_039EA9:          LDA.W SpriteMisc151C,X
                      STA.B _3
                      LDA.W SpriteMisc1602,X
                      STA.B _4
                      PHX
...
CODE_039EFD:          LDA.W DinoFlameTiles,X
                    + STA.W OAMTileNo+$100,Y
                      LDA.B #$00
                      LDX.B _2
                      BNE +
...
CODE_039F57:          LDA.W SpriteOffscreenX,X
                      ORA.W SpriteMisc1540,X
                      BNE +
                      JSR SubHorzPosBnk3
                      LDA.B _F
...
CODE_039F8B:          LDA.B SpriteYSpeed,X
                      CMP.B #$10
                      BMI +
                      LDA.B #$50
                      STA.W SpriteMisc1540,X
...
CODE_039FA4:          LDA.W SpriteMisc1540,X
                      BNE +
                      INC.B SpriteTableC2,X
                      LDA.B #$0A
                      STA.W SpriteMisc1540,X
...
CODE_039FC0:          JSR SubHorzPosBnk3
                      TYA
                    + STA.W SpriteMisc157C,X
Return039FC7:         RTS

CODE_039FC8:          LDA.W SpriteMisc1540,X
                      BEQ +
                      LDA.B #$20
                      STA.B SpriteYSpeed,X
                      JSL UpdateYPosNoGvtyW
...
CODE_039FEF:          STZ.W SpriteMisc1602,X
                      LDA.W SpriteMisc1540,X
                      BEQ CODE_03A002
                      DEC A
                      BNE CODE_03A038
                      ...
                      STA.W SPCIO0                              ; /
                      JSR CODE_03A045
CODE_03A002:          JSL UpdateXPosNoGvtyW
                      JSL UpdateYPosNoGvtyW
                      LDA.B TrueFrame
                      AND.B #$00
                      BNE +
                    ...
                    + LDA.B SpriteYSpeed,X
                      ...
                      LDA.B #$40
                      STA.W SpriteMisc1540,X
CODE_03A038:          LDA.B SpriteYSpeed,X
                      CLC
                      ADC.B #$06
                      CMP.B #$0C
                      BCS +
...
CODE_03A045:          LDA.B SpriteYPosLow,X
                      PHA
                      SEC
                      SBC.B #$0C
                      STA.B SpriteYPosLow,X
...
CODE_03A062:          JSR GetDrawInfoBnk3
                      LDA.B SpriteTableC2,X
                      BEQ CODE_03A038
                      CMP.B #$04
                      BEQ +
...
CODE_03A0F1:          JSL InitSpriteTables
...
CODE_03A3E2:          JSR GetDrawInfoBnk3
                      LDA.W SpriteMisc1564,X
                      DEC A
                      LSR A
                      STA.B _3
...
CODE_03A441:          LDA.W SpriteMisc154C,X
                      BNE CODE_03A482
                      LDA.W SpriteMisc1540,X
                      BNE CODE_03A465
                      LDA.B #$0E
...
CODE_03A465:          STZ.B SpriteYSpeed,X                      ; Sprite Y Speed = 0
                      STZ.B SpriteXSpeed,X                      ; Sprite X Speed = 0
                      CMP.B #$01
                      BEQ CODE_03A47C
                      CMP.B #$40
...
CODE_03A47C:          LDA.B #con($24,$24,$24,$15,$15)
                      STA.W SpriteMisc154C,X
                      RTS
...
CODE_03A6C0:          LDA.B #$04
                      STA.W SpriteMisc151C,X
                      STZ.B SpriteXSpeed,X                      ; Sprite X Speed = 0
                      RTS

KillMostSprites:      LDY.B #$09
CODE_03A6CA:          LDA.W SpriteStatus,Y
                      BEQ +
                      LDA.W SpriteNumber,Y
                      CMP.B #$A9
                      BEQ +
...
CODE_03A6F8:          LDA.W SpriteMisc1540,X
                      BEQ CODE_03A731
                      CMP.B #$01
                      BNE +
...
CODE_03A731:          LDY.W SpriteMisc1528,X
                      CPY.B #$02
                      BCS +
                      LDA.B TrueFrame
                      AND.W DATA_03A723,Y
...
CODE_03A7AD:          LDA.B #$60
                    ...
                    + CMP.B #$60
                      ...
                      BNE Return03A840
                      LDY.B #$07
CODE_03A7EB:          LDA.W SpriteStatus,Y
                      BEQ CODE_03A7F6
                      DEY
                      CPY.B #$01
                      BNE CODE_03A7EB
...
CODE_03A7F6:          LDA.B #!SFX_FIRESPIT                      ; \ Play sound effect
                      STA.W SPCIO3                              ; /
                      LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,Y                      ; /
                      LDA.B #$33
...
BowserSound:          db !SFX_BOWSERFIRE1
                      db !SFX_BOWSERFIRE2
                      db !SFX_BOWSERFIRE3
                      db !SFX_BOWSERFIRE4
                      db !SFX_BOWSERFIRE5
...
BowserSoundMusic:     db !BGM_BOWSERPHASE2
                      db !BGM_BOWSERPHASE3

CODE_03A84B:          STZ.B SpriteYSpeed,X                      ; Sprite Y Speed = 0
                      LDA.W SpriteMisc1540,X
                      BNE CODE_03A86E
                      LDA.B SpriteXSpeed,X
                      BEQ +
...
CODE_03A8D6:          LDY.B #$07
CODE_03A8D8:          LDA.W SpriteStatus,Y
                      BEQ CODE_03A8E3
                      DEY
                      CPY.B #$01
                      BNE CODE_03A8D8
...
CODE_03A8E3:          LDA.B #!SFX_MAGIC                         ; \ Play sound effect
                      STA.W SPCIO0                              ; /
                      LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,Y                      ; /
                      LDA.B #$74
...
CODE_03AA6E:          LDA.B SpriteXPosLow,X
                      CLC
                      ADC.B #$04
                      SEC
                      SBC.B Layer1XPos
...
CODE_03ABEB:          CMP.B #con($40,$40,$40,$30,$30)
                      BCC Return03AC02
...
PrincessPeach:        LDA.B SpriteXPosLow,X
                      SEC
                      SBC.B Layer1XPos
                      STA.B _0
                      LDA.B SpriteYPosLow,X
...
CODE_03AD37:          LDA.B #$06
                    ...
                    + LDA.B TrueFrame
                      ...
                      BNE Return03AD73
                      LDY.B #$0B
CODE_03AD6B:          LDA.W MinExtSpriteNumber,Y
                      BEQ CODE_03AD74
                      DEY
                      BPL CODE_03AD6B
Return03AD73:         RTS

CODE_03AD74:          LDA.B #$05
                      STA.W MinExtSpriteNumber,Y
                      JSL GetRand
                      STZ.B _0
                      AND.B #$1F
...
CODE_03ADB3:          LDA.W SpriteMisc1540,X
                      BNE +
                      INC.B SpriteTableC2,X
                      JSR CODE_03ADCC
                      BCC +
...
CODE_03ADCC:          JSL GetSpriteClippingA
                      JSL GetMarioClipping
                      JSL CheckForContact
                      RTS
...
ADDR_03ADF9:          BCC CODE_03AE14
                      TYA
                      EOR.B #$01
                      TAY
CODE_03ADFF:          LDA.W DATA_03ADD9,Y
                      STA.B SpriteXSpeed,X
                      EOR.B #$FF
                      INC A
                      STA.B PlayerXSpeed
...
CODE_03AE14:          JSR SubHorzPosBnk3
                      TYA
                      STA.W SpriteMisc157C,X
                      STA.B PlayerDirection
                      INC.B SpriteTableC2,X
...
CODE_03AE25:          LDA.W SpriteMisc1540,X
                      BNE +
                      INC.B SpriteTableC2,X
                      LDA.B #$A0
                      STA.W SpriteMisc1540,X
...
CODE_03AE32:          LDA.W SpriteMisc1540,X
                      BNE +
                      INC.B SpriteTableC2,X
                      STZ.W Empty188A
...
DATA_03AE5B:          db $08,$08,$00,$10,$08,$08,$00,$08        ;!
...
DATA_03AE5B:          db $05,$05,$05,$05,$05,$05,$10,$05        ;!
...
CODE_03AEE8:          LDA.W SpriteMisc1540,X
                      BEQ -
                      LSR A
                      STA.B _0
                      STZ.B _1
...
CODE_03AF59:          JSR GetDrawInfoBnk3
                      LDA.W SpriteMisc157C,X
                      STA.B _4
                      LDA.B EffFrame
                      LSR A
...
CODE_03B019:          STZ.B _2
                      JSR CODE_03B020
                      INC.B _2
CODE_03B020:          LDY.B #$01
CODE_03B022:          LDA.W SpriteStatus,Y
                      BEQ CODE_03B02B
                      DEY
                      BPL CODE_03B022
                      RTS

CODE_03B02B:          LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,Y                      ; /
                      LDA.B #$A2
                      STA.W SpriteNumber,Y
                      LDA.B SpriteYPosLow,X
...
CODE_03B0BD:          INC.W SpriteTweakerB,X
                    ...
                    + INC.W SpriteTweakerB,X
                      JSL MarioSprInteract
                      BCC Return03B0DB
CODE_03B0D2:          JSL HurtMario
CODE_03B0D6:          LDA.B #$20
                      STA.W SpriteMisc154C,X
Return03B0DB:         RTS

CODE_03B0DC:          LDY.B #$01
CODE_03B0DE:          PHY
...
BowserBowlingBall:    JSR BowserBallGfx
                      LDA.B SpriteLock
                      BNE Return03B1D4
                      JSR SubOffscreen0Bnk3
                      JSL MarioSprInteract
...
CODE_03B186:          LDA.B #$40
                    ...
                    + JSR CODE_03B7F8
                      ...
                      STA.B SpriteXSpeed,X
CODE_03B1C5:          LDA.B SpriteXSpeed,X
                      BEQ Return03B1D4
                      BMI +
                      DEC.W SpriteMisc1570,X
                      DEC.W SpriteMisc1570,X
...
CODE_03B369:          LDY.B #$04
                    + TYA
                      ...
                      STA.W SpriteOBJAttribute,X
CODE_03B37F:          JSR GetDrawInfoBnk3
                      LDA.W SpriteOBJAttribute,X
                      STA.B _4
                      TYA
                      CLC
...
MechaKoopaKeyGfx:     LDA.W SpriteOAMIndex,X
                      CLC
                      ADC.B #$10
                      STA.W SpriteOAMIndex,X
                      JSR GetDrawInfoBnk3
...
CODE_03B43C:          JSR BowserItemBoxGfx
                      JSR BowserSceneGfx
                      RTS
...
BowserItemBoxGfx:     LDA.W FinalCutscene
                      BEQ +
                      STZ.W PlayerItembox
                    + LDA.W PlayerItembox
                      BEQ Return03B48B
...
BowserRoofPosY:       db $C0,$C0,$C0,$C0,$C0,$C0,$E0,$E0        ;!
...
BowserSceneGfx:       PHX
                      ...
                      LDY.B #$90
                      DEX
CODE_03B4BF:          LDA.B #con($C0,$C0,$C0,$C0,$D0)
                      SEC
                      SBC.B Layer1YPos
                      STA.W OAMTileYPos+$100,Y
                      LDA.B _1
                      ...
                      BNE CODE_03B532
                      LDY.B #$14
CODE_03B4FA:          %LorW_X(LDA,BowserRoofPosX)
                      SEC
                      SBC.B Layer1XPos
                      STA.W OAMTileXPos,Y
...
CODE_03B532:          LDY.B #$50
CODE_03B534:          %LorW_X(LDA,BowserRoofPosX)
                      SEC
                      SBC.B Layer1XPos
                      STA.W OAMTileXPos+$100,Y
                      %LorW_X(LDA,BowserRoofPosY)
...
GetDrawInfoBnk3:      STZ.W SpriteOffscreenVert,X               ; Reset sprite offscreen flag, vertical
                    ...
                    + LDA.W SpriteYPosHigh,X                    ; \
                      ...
                      INY                                       ; /
CODE_03B79A:          LDA.B SpriteYPosLow,X                     ; \
...
CODE_03B7CF:          PLA                                       ; \ Return from *main gfx routine* subroutine...
...
CODE_03B7F8:          LDA.B SpriteYSpeed,X
                      PHA
                      STZ.B SpriteYSpeed,X                      ; Sprite Y Speed = 0
                      PLA
                      LSR A
...
SubOffscreen0Bnk3:    STZ.B _3                                  ; /
                    ...
                    + LDA.B _0
                      BPL Return03B8C2
OffScrEraseSprBnk3:   LDA.W SpriteStatus,X                      ; \ If sprite status < 8, permanently erase sprite
                      CMP.B #$08                                ; |
                      BCC +                                     ; /
...
VerticalLevelBnk3:    LDA.W SpriteTweakerD,X                    ; \ If "process offscreen" flag is set, return
                      AND.B #$04                                ; |
                      BNE Return03B8C2                          ; /
...
IsSprOffScreenBnk3:   LDA.W SpriteOffscreenX,X                  ; \ If sprite is on screen, A = 0
                      ORA.W SpriteOffscreenVert,X               ; |
                      RTS                                       ; /


MagiKoopaPals:        %incpal("col/misc/magikoopa.pal")

BooBossPals:          %incpal("col/misc/the_big_boo.pal")

                      %insert_empty($5FE,$5FE,$5FE,$5FE,$5FE)

GenTileFromSpr2:      STA.B Map16TileGenerate                   ; $9C = tile to generate
...
CODE_03C02F:          LDY.W SpriteMisc160E,X
                      LDA.B #$00
                      STA.W SpriteStatus,Y
                    ...
                    + CMP.B #$74
                      ...
                      CMP.B #$78
                      BCS CODE_03C09B
ADDR_03C05C:          STZ.W YoshiSwallowTimer
...
CODE_03C09B:          INC.W SpriteMisc1570,X
                      LDA.W SpriteMisc1570,X
                      CMP.B #$05
                      BNE CODE_03C0A7
                      BRA ADDR_03C05C

CODE_03C0A7:          JSL CODE_05B34A
                      LDA.B #$01
                      JSL GivePoints
                      RTS
...
CODE_03C11E:          LDA.B SpriteLock                          ; \ If sprites locked...
...
LightSwitch:          LDA.B SpriteLock
                      ...
                      PHA
                      LDY.B #$09
CODE_03C211:          LDA.W SpriteStatus,Y
                      CMP.B #$08
                      BNE +
                      LDA.W SpriteNumber,Y
                      CMP.B #$C6
                    ...
                    + DEY
                      BPL CODE_03C211
                      PLA
CODE_03C22B:          LDA.W SpriteMisc1558,X
                      LSR A
                      TAY
                      LDA.B Layer1YPos
                      PHA
...
ChainsawGfx:          JSR GetDrawInfoBnk3
                      PHX
                      LDA.B SpriteNumber,X
                      SEC
                      SBC.B #$65
...
TriggerInivis1Up:     PHX                                       ; \ Find free sprite slot (#$0B-#$00)
                      LDX.B #$0B                                ; |
CODE_03C2DC:          LDA.W SpriteStatus,X                      ; |
                      BEQ Generate1Up                           ; |
                      DEX                                       ; |
                      BPL CODE_03C2DC                           ; |
                      PLX                                       ; |
...
InvisMushroom:        JSR GetDrawInfoBnk3
...
Ninji:                JSL GenericSprGfxRt2                      ; Draw sprite uing the routine for sprites <= 53
...
CODE_03C3DA:          LDA.B SpriteNumber,X
                      CMP.B #$31
                      BEQ -
                      JSR GetDrawInfoBnk3
                      LDA.W SpriteMisc15AC,X
...
CODE_03C44E:          LDA.W SpriteOffscreenX,X
                      ORA.W SpriteOffscreenVert,X
                      BNE Return03C460
                      LDY.B #$07                                ; \ Find a free extended sprite slot
CODE_03C458:          LDA.W ExtSpriteNumber,Y                   ; |
                      BEQ CODE_03C461                           ; |
                      DEY                                       ; |
                      BPL CODE_03C458                           ; |
Return03C460:         RTL                                       ; / Return if no free slots

CODE_03C461:          LDA.B #$06                                ; \ Extended sprite = Bone
                      STA.W ExtSpriteNumber,Y                   ; /
                      LDA.B SpriteYPosLow,X
                      SEC
                      SBC.B #$10
...
CODE_03C4A5:          LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
                      LDA.B #$78
                      STA.W OAMTileXPos+$100,Y
                      LDA.B #$28
                      STA.W OAMTileYPos+$100,Y
...
DarkRoomWithLight:    LDA.W SpriteMisc1534,X
                      BNE CODE_03C500
                      LDY.B #$09
CODE_03C4E3:          CPY.W CurSpriteProcess
                      BEQ +
                      LDA.W SpriteStatus,Y
                      CMP.B #$08
                      BNE +
...
CODE_03C5F0:          SBC.B #$CF
                    ...
                    + LDA.B _F
                      BNE CODE_03C60F
CODE_03C607:          LDA.B #$01
                      STA.W WindowTable,X
                      DEC A
                      BRA +

CODE_03C60F:          LDA.W LightWinOpenCalc
                      STA.W WindowTable,X
...
FireworkSfx1:         db !SFX_FIREWORKFIRE1
                      db $00
...
FireworkSfx3:         db !SFX_FIREWORKBANG1
                      db $00
...
CODE_03C796:          LDA.W SpriteMisc1564,X
                      BEQ CODE_03C7A7
                      DEC A
                      BNE +
                      INC.W CutsceneID
...
CODE_03C7A7:          LDA.W SpriteMisc1564+9
                      AND.B #$03
                      TAY
                      LDA.W DATA_03C78A,Y
                      STA.W BackgroundColor
                      ...
                      BEQ CODE_03C810
                      LDY.B #$01
CODE_03C7C7:          LDA.W SpriteStatus,Y
                      BEQ CODE_03C7D0
                      DEY
                      BPL CODE_03C7C7
                      RTS

CODE_03C7D0:          LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,Y                      ; /
                      LDA.B #$7A
                      STA.W SpriteNumber,Y
                      LDA.B #$00
...
CODE_03C810:          LDA.B #$70
                      STA.W SpriteMisc1564,X
                      RTS

Firework:             LDA.B SpriteTableC2,X
                      JSL ExecutePtr
...
CODE_03C828:          LDY.W SpriteMisc1534,X
...
CODE_03C845:          LDA.W SpriteMisc1564,X
                      CMP.B #$01
                      BNE +
                      LDY.W SpriteMisc1534,X
...
CODE_03C88D:          LDA.W SpriteMisc15AC,X
                      DEC A
                      BNE +
                      LDY.W SpriteMisc1534,X
...
CODE_03C8B1:          LDY.W SpriteMisc1534,X
                      LDA.W SpriteMisc1570,X
                      CLC
                      ...
                      STA.W SpriteMisc151C,X
                      BCS +
CODE_03C8D4:          LDA.B #$01
                      STA.W SpriteMisc151C,X
                      BRA +

ADDR_03C8DB:          LDA.B #$FF
                      STA.W SpriteMisc1570,X
CODE_03C8E0:          INC.B SpriteTableC2,X
                      STZ.B SpriteYSpeed,X                      ; Sprite Y Speed = 0
                    + LDA.W SpriteMisc151C,X
                      AND.B #$FF
                      TAY
...
CODE_03CBB3:          JSL FindFreeSprSlot                       ; \ Return if no free slots
                      BMI +                                     ; /
...
CODE_03CC8A:          LDA.W SpriteMisc1540,X
                      BNE Return03CCDF
                      LDA.W SpriteMisc1570,X
                      BNE +
                      JSL GetRand
...
CODE_03CCE2:          LDY.B #$01
                      JSR CODE_03CCE8
                      DEY
CODE_03CCE8:          LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,Y                      ; /
                      LDA.B #$29
                      STA.W SpriteNumber,Y
                      PHX
...
CODE_03CDC7:          JSR CODE_03CEA7
                      LDA.W SpriteMisc1540,X
                      BNE +
CODE_03CDCF:          LDA.B #$24
                      STA.W SpriteMisc1540,X
                      LDA.B #$03
                      STA.W SpriteMisc151C,X
                      RTS
...
CODE_03CDEF:          LDA.W SpriteMisc1540,X
                      BNE CODE_03CE05
                      LDA.W SpriteMisc1570,X
                      BEQ +
                      STZ.W SpriteStatus,X
                    ...
                    + STZ.W SpriteMisc151C,X
                      LDA.B #$30
                      STA.W SpriteMisc1540,X
CODE_03CE05:          LDA.B #$10
                      STA.B SpriteYSpeed,X
                      JSL UpdateYPosNoGvtyW
                      RTS

CODE_03CE0E:          LDA.W SpriteMisc1540,X
                      BNE CODE_03CE2A
                      INC.W SpriteMisc1534,X
                      LDA.W SpriteMisc1534,X
                      CMP.B #$03
...
CODE_03CE2A:          LDY.W SpriteMisc1570,X
                      BNE CODE_03CE42
CODE_03CE2F:          CMP.B #$24
                      BNE +
                      LDY.B #!SFX_CORRECT
...
CODE_03CE5A:          JSL UpdateYPosNoGvtyW
                      LDA.B SpriteYSpeed,X
                      CMP.B #$40
                      BPL +
                      CLC
...
CODE_03CE89:          LDA.W SpriteMisc1540,X
                      BNE +
                      STZ.W SpriteStatus,X
                      INC.W CutsceneID
                      LDA.B #$FF
...
CODE_03D484:          JSR GetDrawInfoBnk3
                      LDA.W SpriteMisc1602,X
                      ASL A
                      ASL A
                      ADC.W SpriteMisc1602,X
...
CODE_03D4DF:          PHX
                   ...
                   if ver_is_japanese(!_VER)                    ;\========================= J ===================
DATA_03D524:          db $28,$30,$88,$0E,$30,$30,$89,$0E        ;!
...
DATA_03D524:          db $18,$20,$A1,$0E,$20,$20,$88,$0E        ;!
...
CODE_03D766:          JSR CODE_03D76C
                      JSR CODE_03D759
CODE_03D76C:          REP #$20                                  ; A->16
...
CODE_03D77F:          LDA.B TouchBlockXPos
                      LSR A
                      LSR A
                      LSR A
                      STA.B _1
...
DATA_03D7EC:          db $00,$00,$00,$00,$00,$00,$00,$00
                      db $00,$00,$00,$00,$00,$00,$00,$00
                      db $00,$00,$00,$00,$00,$00,$00,$00
                      db $00,$00,$00,$00,$00,$00,$00,$00
                      db $00,$00,$00,$00,$00,$00,$00,$00
...
CODE_03D991:          STZ.W HW_VMAINC
                      LDY.B #$00
CODE_03D996:          STY.B _2
                      LDA.B #$00
CODE_03D99A:          STA.B _3
                      LDA.B _0
                      STA.W HW_VMADD
                      LDA.B _1
                      STA.W HW_VMADD+1
...
KoopaPalPtrLo:        db StandardColors+$6C
                      db StandardColors+$54
                      db StandardColors+$48
                      db SpriteColors+$60
                      db SpriteColors+$54

KoopaPalPtrHi:        db StandardColors+$6C>>8
...
CODE_03DDE5:          LDX.B #$00
                      TXY
                      LDA.B #$08
                      STA.B _5
CODE_03DDEC:          JSR CODE_03DE39
                      PHY
                      TYA
                      LSR A
                      CLC
...
CODE_03DE8E:          STZ.W HW_VMAINC
                      REP #$20                                  ; A->16
                      LDA.W #$0A1C
                      STA.B _0
                      LDX.B #$00
CODE_03DE9A:          REP #$20                                  ; A->16
                      LDA.B _0
                      CLC
                      ADC.W #$0080
                      STA.B _0
...
CODE_03DEDF:          PHB
                    ...
                    + TXA
                      ...
                      LDY.W #$0007
                      SEC
CODE_03DF44:          STY.B _0
                      BCS CODE_03DF55
CODE_03DF48:          LDA.W Mode7TileIndex
                      AND.W #$007F
                      ASL A
                      ASL A
                      ASL A
...
CODE_03DF55:          STX.B _2
                    ...
                    + TAY
                      ...
                      LDA.B _0
                      STA.B _4
CODE_03DF69:          LDA.W DATA_03D9DE,Y
                      INY
...
CODE_03DFF0:          LDA.B EffFrame
                      ...
                      LDA.B #!SFX_THUNDER
                      STA.W SPCIO3                              ; / Play sound effect
CODE_03E01B:          DEC.W LightningTimer
                      BPL +
...
CODE_03E031:          STA.W DynPaletteTable+2,Y
                      SEP #$20                                  ; A->8
CODE_03E036:          LDX.W BowserPalette
                      LDA.L DATA_03DFC4,X
                      TAX
                      LDA.B #$0E
                      STA.B _0
...
MusicBank3:           dw MusicBank3_End-MusicBank3-4
                      dw MusicData
...
MusicB3S09L00:        dw MusicB3S01P00
                      dw $0000
                      dw $0000
                      dw $0000
                      dw $0000
...
MusicB3S0BL0F:        dw MusicB3S01P01
                      dw MusicB3S01P02
                      dw MusicB3S01P03
                      dw MusicB3S01P04
                      dw MusicB3S01P05
...
MusicB3S09L02:        dw MusicB3S01P09
                      dw MusicB3S01P0A
                      dw MusicB3S01P0B
                      dw $0000
                      dw $0000
...
MusicB3S09L04:        dw MusicB3S01P13
                      dw MusicB3S01P0A
                      dw MusicB3S01P0B
                      dw MusicB3S01P14
                      dw $0000
...
MusicB3S09L03:        dw MusicB3S01P0E
                      dw MusicB3S01P0F
                      dw MusicB3S01P10
                      dw $0000
                      dw $0000
...
MusicB3S09L05:        dw MusicB3S01P16
                      dw MusicB3S01P17
                      dw MusicB3S01P18
                      dw MusicB3S01P19
                      dw $0000
...
MusicB3S09L06:        dw MusicB3S01P1D
                      dw MusicB3S01P1E
                      dw MusicB3S01P1F
                      dw MusicB3S01P20
                      dw $0000
...
MusicB3S09L07:        dw MusicB3S01P24
                      dw MusicB3S01P25
                      dw MusicB3S01P26
                      dw MusicB3S01P27
                      dw $0000
...
MusicB3S09L08:        dw MusicB3S01P2A
                      dw MusicB3S01P0A
                      dw MusicB3S01P0B
                      dw MusicB3S01P14
                      dw MusicB3S01P2B
...
MusicB3S09L09:        dw MusicB3S01P2D
                      dw MusicB3S01P2E
                      dw MusicB3S01P2F
                      dw MusicB3S01P30
                      dw MusicB3S01P31
...
MusicB3S09L0A:        dw MusicB3S01P35
                      dw MusicB3S01P36
                      dw MusicB3S01P37
                      dw MusicB3S01P38
                      dw MusicB3S01P39
...
MusicB3S0BL10:        dw MusicB3S01P2A
                      dw MusicB3S01P3D
                      dw MusicB3S01P0B
                      dw MusicB3S01P14
                      dw MusicB3S01P2B
...
MusicB3S0BL11:        dw MusicB3S01P2D
                      dw MusicB3S01P3E
                      dw MusicB3S01P3F
                      dw MusicB3S01P30
                      dw MusicB3S01P31
...
MusicB3S0BL12:        dw MusicB3S01P40
                      dw MusicB3S01P41
                      dw MusicB3S01P42
                      dw MusicB3S01P43
                      dw MusicB3S01P44
...
MusicB3S0BL13:        dw MusicB3S01P48
                      dw MusicB3S01P49
                      dw MusicB3S01P0B
                      dw MusicB3S01P14
                      dw MusicB3S01P4A
...
MusicB3S0BL14:        dw MusicB3S01P4C
                      dw MusicB3S01P4D
                      dw MusicB3S01P3F
                      dw MusicB3S01P30
                      dw MusicB3S01P4E
...
MusicB3S0BL16:        dw MusicB3S01P50
                      dw MusicB3S01P41
                      dw MusicB3S01P42
                      dw MusicB3S01P43
                      dw MusicB3S01P44
...
MusicB3S09L11:        dw MusicB3S01P51
                      dw MusicB3S01P52
                      dw MusicB3S01P53
                      dw MusicB3S01P54
                      dw MusicB3S01P55
...
MusicB3S02:           dw MusicB3S0AL00
                      dw $0000

MusicB3S0AL00:        dw MusicB3S02P00
                      dw MusicB3S02P01
                      dw MusicB3S02P02
                      dw MusicB3S02P03
                      dw MusicB3S02P04
...
MusicB3S0BL00:        dw MusicB3S03P00
                      dw MusicB3S03P01
                      dw MusicB3S03P02
                      dw MusicB3S03P03
                      dw MusicB3S03P04
...
MusicB3S0BL01:        dw MusicB3S03P08
                      dw MusicB3S03P09
                      dw MusicB3S03P0A
                      dw MusicB3S03P0B
                      dw MusicB3S03P0C
...
MusicB3S0CL00:        dw MusicB3S03P10
                      dw MusicB3S03P11
                      dw MusicB3S03P12
                      dw MusicB3S03P13
                      dw MusicB3S03P14
...
MusicB3S0BL04:        dw MusicB3S03P10
                      dw MusicB3S03P11
                      dw MusicB3S03P12
                      dw MusicB3S03P13
                      dw MusicB3S03P14
...
MusicB3S0CL01:        dw MusicB3S03P17
                      dw MusicB3S03P18
                      dw MusicB3S03P19
                      dw MusicB3S03P1A
                      dw MusicB3S03P1B
...
MusicB3S0CL02:        dw MusicB3S03P1E
                      dw MusicB3S03P1F
                      dw MusicB3S03P20
                      dw MusicB3S03P21
                      dw MusicB3S03P22
...
MusicB3S0CL03:        dw MusicB3S03P24
                      dw MusicB3S03P25
                      dw MusicB3S03P26
                      dw MusicB3S03P27
                      dw MusicB3S03P28
...
MusicB3S0CL04:        dw MusicB3S03P2A
                      dw MusicB3S03P2B
                      dw MusicB3S03P2C
                      dw MusicB3S03P2D
                      dw MusicB3S03P2E
...
MusicB3S0BL08:        dw MusicB3S03P24
                      dw MusicB3S03P25
                      dw MusicB3S03P26
                      dw MusicB3S03P27
                      dw MusicB3S03P28
...
MusicB3S0CL05:        dw MusicB3S03P31
                      dw MusicB3S03P32
                      dw MusicB3S03P33
                      dw MusicB3S03P34
                      dw MusicB3S03P35
...
MusicB3S0BL0A:        dw MusicB3S03P10
                      dw MusicB3S03P11
                      dw MusicB3S03P12
                      dw MusicB3S03P13
                      dw MusicB3S03P14
...
MusicB3S0BL0C:        dw MusicB3S03P10
                      dw MusicB3S03P11
                      dw MusicB3S03P12
                      dw MusicB3S03P13
                      dw MusicB3S03P14
...
MusicB3S0BL0B:        dw MusicB3S03P17
                      dw MusicB3S03P18
                      dw MusicB3S03P19
                      dw MusicB3S03P1A
                      dw MusicB3S03P1B
...
MusicB3S0BL0D:        dw MusicB3S03P3B
                      dw MusicB3S03P3C
                      dw MusicB3S03P3D
                      dw MusicB3S03P3E
                      dw MusicB3S03P3F
...
MusicB3S0BL0E:        dw MusicB3S03P42
                      dw $0000
                      dw $0000
                      dw $0000
                      dw $0000
...
MusicB3S0BL15:        dw MusicB3S03P43
                      dw $0000
                      dw $0000
                      dw $0000
                      dw $0000
...
MusicB3S0BL17:        dw MusicB3S03P44
                      dw MusicB3S03P45
                      dw MusicB3S03P46
                      dw MusicB3S03P47
                      dw MusicB3S03P48
...
MusicB3S03P42:        db $DA,$04,$E2,$16,$E3,$90,$1B,$00

MusicB3S03P43:        db $E4,$01,$00

MusicB3S03P10:        db $DA,$12,$E2,$1E,$DB,$0A,$DE,$14
...
MusicB3S03P39:        db $DA,$12,$DB,$0F,$DE,$14,$14,$20
                      db $48,$6D,$B7,$18,$B9,$48,$B7,$0C
                      db $B4,$B5,$30,$B7,$0C,$C6,$B9,$B7
                      db $B9,$48,$B7,$18,$B4

MusicB3S03P15:        db $DA,$00,$DB,$05,$DE,$14,$19,$27
...
MusicB3S03P1D:        db $30,$6B,$B4,$0C,$C7,$B7,$0C,$2C
                      db $B9,$BC,$06,$7B,$BB,$BC,$0C,$69
                      db $BB,$18,$C6,$0C,$C7,$B3,$0C,$2C
                      db $B7,$BB,$06,$7B,$B9,$BB,$0C,$69
                      db $B9,$18,$C6,$0C,$C7,$B2,$0C,$2C
...
MusicB3S03P13:        db $DA,$12,$DB,$08,$DE,$14,$1F,$25
...
MusicB3S03P14:        db $DA,$12,$DB,$0C,$DE,$14,$1B,$26
...
MusicB3S03P11:        db $DA,$04,$DB,$08,$DE,$14,$19,$28
...
MusicB3S03P12:        db $DA,$08,$DB,$0C,$DE,$14,$19,$28
...
MusicB3S03P16:        db $DA,$05,$DB,$14,$DE,$00,$00,$00
                      db $E9,$F3,$17,$08,$0C,$4B,$D1,$0C
                      db $4C,$D2,$0C,$49,$D1,$0C,$4B,$D2
                      db $00

MusicB3S03P17:        db $0C,$6E,$B9,$0C,$2D,$BB,$BC,$30
...
MusicB3S03P3A:        db $30,$6D,$B0,$0C,$C6,$AF,$C6,$AD
                      db $AB,$AC,$AD,$B4,$30,$C6,$24,$B4
                      db $18,$B0,$0C,$AF,$B0,$B1,$30,$B2
                      db $06,$C7,$AB,$AD,$AF,$B0,$B2,$B4
                      db $B5

MusicB3S03P1C:        db $06,$7B,$B4,$B5,$0C,$69,$B4,$18
...
MusicB3S03P1A:        db $0C,$6E,$B5,$0C,$2D,$B5,$B9,$30
...
MusicB3S03P1B:        db $0C,$6E,$B0,$0C,$2D,$B0,$B5,$30
...
MusicB3S03P23:        db $06,$7B,$B4,$B5,$0C,$69,$B4,$18
                      db $C6,$0C,$C7,$06,$4B,$AF,$B0,$B2
                      db $B4,$B5,$B6,$06,$7B,$B7,$B9,$0C
                      db $69,$B7,$18,$C6,$0C,$C7,$06,$4B
                      db $B2,$B4,$B5,$B7,$B9,$BB,$30,$BC
...
MusicB3S03P21:        db $0C,$6E,$B5,$0C,$2D,$B5,$B9,$30
                      db $6E,$B6,$0C,$2D,$B6,$0C,$6E,$B4
...
MusicB3S03P22:        db $0C,$6E,$B0,$0C,$2D,$B0,$B5,$30
                      db $6E,$B0,$0C,$2D,$B0,$0C,$6E,$B0
...
MusicB3S03P1F:        db $0C,$C7,$98,$C7,$98,$C7,$98,$C7
                      db $98,$C7,$9C,$C7,$9C,$C7,$99,$C7
                      db $99,$C7,$95,$C7,$95,$C7,$97,$C7
                      db $97,$C7,$9C,$C7,$9C,$C7,$9C,$C7
                      db $9C

MusicB3S03P20:        db $0C,$91,$9D,$98,$9D,$92,$9E,$98
                      db $9E,$93,$9F,$9A,$9F,$95,$A1,$9C
                      db $A1,$8E,$9A,$95,$9A,$93,$9F,$9A
                      db $9F,$98,$9F,$93,$9F,$98,$98,$97
                      db $96

MusicB3S03P3B:        db $0C,$6E,$B9,$0C,$2D,$BB,$BC,$30
                      db $6E,$B9,$0C,$2D,$B8,$0C,$6E,$B7
                      db $0C,$2D,$B8,$B9,$30,$6E,$C0,$0C
                      db $C7,$00

MusicB3S03P41:        db $30,$6D,$B0,$0C,$C6,$AF,$C6,$AD
                      db $AB,$AC,$AD,$B4,$30,$C6

MusicB3S03P3E:        db $0C,$6E,$B5,$0C,$2D,$B5,$B9,$30
                      db $6E,$B6,$0C,$2D,$B6,$0C,$6E,$B4
                      db $0C,$2D,$B4,$B4,$30,$6E,$BD,$0C
                      db $C7

MusicB3S03P3F:        db $0C,$6E,$B0,$0C,$2D,$B0,$B5,$30
                      db $6E,$B0,$0C,$2D,$B0,$0C,$6E,$B0
                      db $0C,$2D,$B0,$B0,$30,$6E,$B7,$0C
                      db $C7

MusicB3S03P40:        db $06,$7B,$B4,$B5,$0C,$69,$B4,$18
                      db $C6,$0C,$C7,$06,$4B,$AF,$B0,$B2
                      db $B4,$B5,$B6,$06,$7B,$B7,$B9,$0C
                      db $69,$B7,$18,$C6,$0C,$C7,$06,$4B
                      db $B2,$B4,$B5,$B7,$B9,$BB

MusicB3S03P3C:        db $0C,$C7,$98,$C7,$98,$C7,$98,$C7
                      db $98,$C7,$9C,$C7,$9C,$C7,$99,$C7
                      db $99

MusicB3S03P3D:        db $0C,$91,$9D,$98,$9D,$92,$9E,$98
                      db $9E,$93,$9F,$9A,$9F,$95,$A1,$9C
                      db $A1

MusicB3S03P24:        db $DA,$12,$18,$6D,$AD,$0C,$B4,$C7
...
MusicB3S03P30:        db $DB,$0F,$DE,$14,$14,$20,$DA,$12
...
MusicB3S03P27:        db $DA,$12,$18,$6D,$A8,$0C,$AB,$C7
...
MusicB3S03P2D:        db $18,$6D,$A3,$0C,$A9,$C7,$C7,$0C
...
MusicB3S03P2E:        db $30,$69,$AB,$0C,$C6,$A9,$AB,$AF
                      db $48,$B2,$0C,$B0,$B2,$48,$B0,$18
                      db $B2,$60,$B4

MusicB3S03P2F:        db $30,$69,$A3,$0C,$C6,$A3,$A6,$A9
                      db $48,$AB,$0C,$A9,$AB,$48,$A8,$18
                      db $AB,$60,$AC

MusicB3S03P2B:        db $0C,$C7,$97,$C7,$97,$C7,$97,$C7
                      db $97,$C7,$97,$C7,$97,$C7,$97,$C7
                      db $97,$C7,$9C,$C7,$9C,$C7,$9C,$C7
                      db $9C,$C7,$97,$C7,$97,$C7,$97,$C7
                      db $97

MusicB3S03P2C:        db $0C,$93,$9D,$8E,$9D,$93,$9D,$8E
                      db $9D,$93,$9D,$8E,$9D,$93,$9D,$95
                      db $97,$98,$9F,$93,$9F,$98,$9F,$93
                      db $9F,$90,$A0,$97,$A0,$90,$A0,$92
                      db $94

MusicB3S03P31:        db $18,$6D,$AB,$0C,$B2,$C7,$C7,$0C
                      db $2D,$B2,$0C,$6E,$B1,$0C,$2D,$B2
...
MusicB3S03P37:        db $18,$6D,$B7,$0C,$BE,$C7,$C7,$0C
...
MusicB3S03P34:        db $18,$6D,$A3,$0C,$A9,$C7,$C7,$0C
                      db $2D,$A9,$0C,$6E,$A8,$0C,$2D,$A9
...
MusicB3S03P35:        db $30,$69,$AB,$0C,$C6,$A9,$AB,$AF
                      db $48,$B2,$0C,$B0,$B2,$30,$B0,$B2
                      db $30,$B4,$B3

MusicB3S03P36:        db $30,$69,$A3,$0C,$C6,$A3,$A6,$A9
                      db $48,$AB,$0C,$A9,$AB,$30,$A8,$AB
                      db $30,$AB,$AF

MusicB3S03P32:        db $0C,$C7,$97,$C7,$97,$C7,$97,$C7
                      db $97,$C7,$97,$C7,$97,$C7,$97,$C7
                      db $97,$C7,$9C,$C7,$9C,$C7,$9C,$C7
                      db $9C,$DA,$01,$18,$AF,$C7,$A7,$C6

MusicB3S03P33:        db $0C,$93,$9D,$8E,$9D,$93,$9D,$8E
                      db $9D,$93,$9D,$8E,$9D,$93,$9D,$95
                      db $97,$98,$9F,$93,$9F,$98,$9F,$93
                      db $9F,$18,$8C,$C7,$93,$C6

MusicB3S03P38:        db $DA,$05,$DB,$14,$DE,$00,$00,$00
                      db $E9,$F3,$17,$06,$18,$4C,$D1,$C7
                      db $30,$6D,$D2

MusicB3S03P44:        db $DA,$04,$DB,$0A,$DE,$22,$19,$38
                      db $60,$5E,$BC,$C6,$DA,$01,$60,$C6
                      db $C6,$C6,$00

MusicB3S03P45:        db $DA,$04,$DB,$08,$DE,$20,$18,$36
                      db $60,$5D,$B4,$C6,$DA,$01,$60,$C6
                      db $C6,$C6

MusicB3S03P4A:        db $DA,$04,$DB,$0C,$DE,$21,$1A,$37
                      db $60,$5D,$AB,$C6,$DA,$01,$60,$C6
                      db $C6,$C6

MusicB3S03P47:        db $DA,$04,$DB,$0A,$DE,$22,$18,$36
                      db $60,$5D,$A4,$C6,$DA,$01,$60,$C6
                      db $C6,$C6

MusicB3S03P49:        db $DA,$04,$DB,$0F,$10,$5D,$B0,$C7
                      db $B0,$AE,$C7,$AE,$AD,$C7,$AD,$AC
                      db $C7,$AC,$30,$AB,$24,$A7,$6C,$A6
                      db $60,$C6

MusicB3S03P4B:        db $DA,$04,$DB,$0F,$10,$5D,$AB,$C7
                      db $AB,$A8,$C7,$A8,$A9,$C7,$A9,$A9
                      db $C7,$A9,$30,$A6,$24,$A3,$6C,$A2
                      db $60,$C6

MusicB3S03P48:        db $DA,$04,$DB,$0F,$10,$5D,$A8,$C7
                      db $A8,$A4,$C7,$A4,$A4,$C7,$A4,$A4
                      db $C7,$A4,$30,$A3,$24,$9D,$6C,$9C
                      db $60,$C6

MusicB3S03P46:        db $DA,$08,$DB,$0A,$DE,$22,$19,$38
                      db $10,$5D,$8C,$8C,$8C,$90,$90,$90
                      db $91,$91,$91,$92,$92,$92,$30,$93
                      db $24,$93,$6C,$8C,$60,$C6

MusicB3S02P00:        db $DA,$01,$E2,$12,$DB,$0A,$DE,$14
...
MusicB3S02P03:        db $DA,$02,$DB,$0A,$18,$79,$A7,$0C
                      db $A8,$AB,$AD,$30,$AB,$0C,$AD,$AF
                      db $C6,$AF,$30,$AD,$0C,$A7,$A8,$AB
                      db $AD,$30,$AB,$0C,$AC,$AD,$C6,$AD
                      db $60,$AB,$C6

MusicB3S02P01:        db $DA,$01,$DB,$0C,$DE,$14,$19,$28
...
MusicB3S03P07:        db $DA,$04,$DB,$14,$08,$C7,$18,$6C
...
MusicB3S01P13:        db $DA,$06,$DB,$0A,$DE,$22,$19,$38

MusicB3S01P2A:        db $08,$5D,$A8,$C7,$AB,$AD,$C7,$24
                      db $AB,$0C,$C7,$08,$AD,$AF,$C7,$B0
                      db $AF,$AE,$24,$AD,$0C,$C7,$08,$A7
                      db $A8,$C7,$AB,$AD,$C7,$24,$AB,$0C
                      db $C7,$08,$AC,$AD,$C7,$AE,$AD,$AC
...
MusicB3S01P14:        db $DA,$12,$DB,$05,$DE,$22,$19,$28
                      db $60,$6B,$B4,$30,$B3,$08,$C6,$C6
                      db $B3,$BB,$C6,$B9,$48,$B7,$18,$B2
                      db $60,$B1

MusicB3S01P15:        db $DA,$06,$DB,$08,$DE,$14,$1F,$30
...
MusicB3S01P2C:        db $08,$6D,$A4,$C7,$A4,$A8,$C7,$24
                      db $A4,$0C,$C7,$08,$A8,$AB,$C7,$AB
                      db $A7,$A7,$24,$A7,$0C,$C7,$08,$A3
                      db $A2,$C7,$A6,$A6,$C7,$24,$A6,$0C
                      db $C7,$08,$A6,$A8,$C7,$AB,$A8,$A8
...
MusicB3S01P2B:        db $DA,$06,$DB,$0C,$DE,$14,$1F,$30
...
MusicB3S01P0A:        db $DA,$0D,$DB,$0F,$01,$C7,$18,$4E
                      db $C7,$9F,$C7,$9F,$C7,$9F,$C7,$9F
                      db $C7,$9F,$C7,$9F,$C7,$9F,$C7,$9F

MusicB3S01P0C:        db $DA,$0D,$DB,$0F,$18,$4E,$C7,$9C
                      db $C7,$9C,$C7,$9B,$C7,$9B,$C7,$9A
                      db $C7,$9A,$C7,$99,$C7,$99

MusicB3S01P0B:        db $DA,$08,$DB,$0A,$DE,$14,$1F,$30
...
MusicB3S01P0D:        db $DA,$00,$DB,$14,$18,$6B,$D1,$08
                      db $D2,$C7,$D1,$18,$D1,$08,$D2,$C7
...
MusicB3S01P12:        db $18,$D1,$08,$D2,$C7,$D1,$18,$D1
...
MusicB3S01P1C:        db $18,$D1,$08,$D2,$C7,$D1,$18,$D1
                      db $08,$D2,$C7,$D1,$18,$D1,$08,$D2
                      db $C7,$D1,$D1,$C7,$D1,$D2,$D1,$D1
                      db $18,$D2,$08,$C6,$C7,$D2,$18,$C6
...
MusicB3S01P1E:        db $01,$C7,$18,$C7,$9F,$C7,$9F,$C7
                      db $9F,$C7,$9F,$C7,$9E,$C7,$9E,$C7
                      db $9E,$C7,$9E

MusicB3S01P22:        db $18,$C7,$99,$C7,$99,$C7,$99,$C7
                      db $99,$C7,$98,$C7,$98,$C7,$98,$C7
                      db $98

MusicB3S01P1F:        db $18,$95,$08,$C7,$C7,$95,$18,$90
...
MusicB3S01P23:        db $18,$D1,$08,$D2,$C7,$D1,$18,$D1
                      db $08,$D2,$C7,$D1,$18,$D1,$08,$D2
                      db $C7,$D1,$D1,$C7,$D1,$D2,$D1,$D1
...
MusicB3S01P25:        db $01,$C7,$18,$C7,$9D,$C7,$9D,$C7
                      db $9D,$C7,$9D,$C7,$9C,$10,$9C,$9D
                      db $9E,$18,$9F,$C7,$9B,$C6

MusicB3S01P29:        db $18,$C7,$97,$C7,$97,$C7,$97,$C7
                      db $97,$C7,$9F,$10,$9F,$A0,$A1,$18
                      db $A3,$C7,$A3,$C6

MusicB3S01P26:        db $18,$93,$08,$C7,$C7,$93,$18,$8E
...
MusicB3S01P32:        db $08,$A9,$C7,$A9,$AD,$C7,$24,$AA
                      db $0C,$C7,$08,$A9,$A8,$C7,$A8,$A8
                      db $C7,$24,$AB,$0C,$C7,$08,$C7

MusicB3S01P2D:        db $08,$AD,$C7,$AF,$B0,$C7,$24,$AD
                      db $0C,$C7,$08,$AC,$AB,$C7,$AC,$AD
                      db $C7,$24,$B4,$0C,$C7,$08,$C7,$00

MusicB3S01P31:        db $DA,$04,$DB,$0C,$DE,$22,$18,$14
                      db $08,$5C,$A4,$C7,$A4,$A9,$C7,$24
                      db $A4,$0C,$C7,$08,$A4,$A4,$C7,$A4
                      db $A4,$C7,$24,$A5,$0C,$C7,$08,$C7

MusicB3S01P30:        db $48,$B0,$08,$AD,$C6,$B0,$60,$B4

MusicB3S01P2E:        db $01,$C7,$18,$C7,$9D,$C7,$9E,$C7
                      db $9F,$C7,$9F,$18,$9E,$08,$C7,$C7
                      db $9D,$18,$C6,$08,$C7,$C7,$AB

MusicB3S01P33:        db $18,$C7,$98,$C7,$98,$C7,$9A,$C7
                      db $99,$18,$A1,$08,$C7,$C7,$A3,$18
                      db $C6,$08,$C7,$C7,$A4

MusicB3S01P2F:        db $18,$91,$08,$C7,$C7,$91,$18,$92
                      db $08,$C7,$C7,$92,$18,$93,$08,$C7
                      db $C7,$93,$18,$95,$08,$95,$90,$8F
                      db $18,$8E,$08,$C6,$C7,$93,$18,$C6
                      db $08,$C7,$C7,$98

MusicB3S01P34:        db $18,$D1,$08,$D2,$C7,$D1,$18,$D1
                      db $08,$D2,$C7,$D1,$18,$D1,$08,$D2
                      db $C7,$D1,$D1,$C7,$D1,$D2,$D1,$D1
                      db $18,$D2,$08,$C6,$C7,$D2,$18,$C6
                      db $08,$C7,$C7,$D2

MusicB3S01P35:        db $DA,$04,$DB,$0A,$DE,$22,$19,$38
                      db $18,$4D,$B4,$08,$C7,$C7,$B4,$18
                      db $B4,$08,$C7,$C7,$B7,$18,$B7,$08
                      db $C7,$C7,$B7,$18,$B7,$C7,$00

MusicB3S01P36:        db $DA,$04,$DB,$08,$DE,$20,$18,$36
                      db $18,$4D,$A4,$08,$C7,$C7,$A4,$18
                      db $A4,$08,$C7,$C7,$A7,$18,$A7,$08
                      db $C7,$C7,$A7,$18,$A7,$C7

MusicB3S01P3B:        db $DA,$04,$DB,$0C,$DE,$21,$1A,$37
                      db $18,$4D,$AD,$08,$C7,$C7,$AD,$18
                      db $AD,$08,$C7,$C7,$AF,$18,$AF,$08
                      db $C7,$C7,$AF,$18,$AF,$C7

MusicB3S01P38:        db $DA,$04,$DB,$0A,$DE,$22,$18,$36
                      db $18,$4D,$A9,$08,$C7,$C7,$A9,$18
                      db $A9,$08,$C7,$C7,$AB,$18,$AB,$08
                      db $C7,$C7,$AB,$18,$AB,$C7

MusicB3S01P3A:        db $DA,$04,$DB,$0F,$08,$4D,$C7,$C7
                      db $9A,$18,$9A,$08,$C7,$C7,$9A,$18
                      db $9A,$08,$C7,$C7,$9F,$18,$9F,$08
                      db $C7,$C7,$C7,$18,$7D,$9F

MusicB3S01P39:        db $DA,$04,$DB,$0F,$08,$4C,$C7,$C7
                      db $8E,$18,$8E,$08,$C7,$C7,$8E,$18
                      db $8E,$08,$C7,$C7,$93,$18,$93,$08
                      db $C7,$C7,$C7,$18,$7E,$93

MusicB3S01P37:        db $DA,$08,$DB,$0A,$DE,$22,$19,$38
                      db $08,$5F,$C7,$C7,$8E,$18,$8E,$08
                      db $C7,$C7,$8E,$18,$8E,$08,$C7,$C7
                      db $93,$18,$93,$08,$C7,$C7,$C7,$18
                      db $7F,$93

MusicB3S01P3C:        db $DA,$00,$DB,$0A,$08,$6C,$C7,$C7
                      db $D0,$18,$D0,$08,$C7,$C7,$D0,$18
                      db $D0,$08,$C7,$C7,$D0,$18,$D0,$C7
                      db $08,$D0,$DB,$14,$08,$D1,$D1

MusicB3S01P3D:        db $DA,$06,$DB,$0A,$DE,$22,$19,$38
...
MusicB3S01P3E:        db $08,$B9,$C7,$BB,$BC,$C7,$24,$B9
                      db $0C,$C7,$08,$B8,$B7,$C7,$B8,$B9
                      db $C7,$24,$C0,$0C,$C7,$08,$C7,$00

MusicB3S01P3F:        db $18,$91,$08,$C7,$C7,$91,$18,$92
                      db $08,$C7,$C7,$92,$18,$93,$08,$C7
                      db $C7,$93,$18,$95,$08,$C7,$C7,$95

MusicB3S01P50:        db $DA,$04,$DB,$0A,$DE,$22,$19,$38
                      db $18,$5D,$C0,$08,$C7,$C7,$C0,$E3
                      db $78,$18,$18,$C0,$08,$C7,$C7,$C3
                      db $18,$C3,$08,$C7,$C7,$C3,$18,$C3
                      db $C3,$00

MusicB3S01P40:        db $DA,$04,$DB,$0A,$DE,$22,$19,$38
                      db $18,$5D,$C0,$08,$C7,$C7,$C0,$18
                      db $C0,$08,$C7,$C7,$C3,$18,$C3,$08
                      db $C7,$C7,$C3,$18,$C3,$C3,$00

MusicB3S01P41:        db $DA,$04,$DB,$08,$DE,$20,$18,$36
                      db $18,$5D,$A4,$08,$C7,$C7,$A4,$18
                      db $A4,$08,$C7,$C7,$A7,$18,$A7,$08
                      db $C7,$C7,$A7,$18,$A7,$A7

MusicB3S01P46:        db $DA,$04,$DB,$0C,$DE,$21,$1A,$37
                      db $18,$5D,$B9,$08,$C7,$C7,$B9,$18
                      db $B9,$08,$C7,$C7,$BB,$18,$BB,$08
                      db $C7,$C7,$BB,$18,$BB,$BB

MusicB3S01P43:        db $DA,$04,$DB,$0A,$DE,$22,$18,$36
                      db $18,$5D,$A9,$08,$C7,$C7,$A9,$18
                      db $A9,$08,$C7,$C7,$AB,$18,$AB,$08
                      db $C7,$C7,$AB,$18,$AB,$AB

MusicB3S01P45:        db $DA,$04,$DB,$0F,$08,$5D,$C7,$C7
                      db $9A,$18,$9A,$08,$C7,$C7,$9A,$18
                      db $9A,$08,$C7,$C7,$9F,$18,$9F,$08
                      db $C7,$C7,$9F,$08,$7D,$C7,$C7,$9F

MusicB3S01P44:        db $DA,$04,$DB,$0F,$08,$5C,$C7,$C7
                      db $8E,$18,$8E,$08,$C7,$C7,$8E,$18
                      db $8E,$08,$C7,$C7,$93,$18,$93,$08
                      db $C7,$C7,$93,$08,$7E,$C7,$C7,$93

MusicB3S01P42:        db $DA,$08,$DB,$0A,$DE,$22,$19,$38
                      db $08,$5F,$C7,$C7,$8E,$18,$8E,$08
                      db $C7,$C7,$8E,$18,$8E,$08,$C7,$C7
                      db $93,$18,$93,$08,$C7,$C7,$C7,$08
                      db $7F,$C7,$C7,$93

MusicB3S01P47:        db $DA,$00,$DB,$0A,$08,$6C,$C7,$C7
                      db $D0,$18,$D0,$08,$C7,$C7,$D0,$18
                      db $D0,$08,$C7,$C7,$D0,$18,$D0,$C7
                      db $08,$D0,$DB,$14,$08,$D1,$D1

MusicB3S01P49:        db $DA,$04,$DE,$14,$19,$30,$DB,$0A
...
MusicB3S01P48:        db $DE,$16,$18,$30,$DB,$0A,$08,$4E
...
MusicB3S01P4B:        db $DE,$15,$19,$31,$DB,$08,$08,$4E
...
MusicB3S01P4A:        db $DA,$06,$DB,$0C,$DE,$14,$1A,$30
...
MusicBank3_End:       dw $0000,SPCEngine

                      db $E8,$00,$00,$00,$00
                      db $00,$00,$00,$00,$00,$00,$00,$00
                      db $00,$00,$00,$00,$00

                      padbyte $FF : pad $048000