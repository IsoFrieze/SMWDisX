...
TilesetMAP16Loc:      dw Map16Tileset0                          ; Addresses to tileset-specific MAP16 data
                      dw Map16Tileset1
                      dw Map16Tileset2
                      dw Map16Tileset3
                      dw Map16Tileset4
...
EDATA_05809E:         db $20,$00,$5F,$FE,$FA,$18,$30,$00        ;!
                      db $5F,$FE,$FA,$18,$FF                    ;!
																;!
CODE_05809E:          PHP                                       ;!
                      SEP #$20                                  ;! A->8
...
CODE_0581FB:          SEP #$30                                  ; AXY->8
                      ...
                      TYX                                       ; /
CODE_058237:          SEP #$20                                  ; A->8
                      LDA.B [_D],Y
                      STA.B _C
CODE_05823D:          ASL.B _C
                      BCC +
                      REP #$20                                  ; A->16
                      LDA.B _2
                      STA.W Map16Pointers,X
...
CODE_058281:          LDA.B #$FF
                    ...
                    - LDA.B _0
                      ...
                      DEX
                      BPL -
CODE_0582C5:          SEP #$30                                  ; AXY->8
                      RTS

CODE_0582C8:          STA.L Map16TilesLow,X
...
CODE_05833A:          STA.L Map16TilesHigh,X
...
LoadLevel:            PHP
                      ...
                      JSR CODE_0581FB
LoadAgain:            LDA.W LevelModeSetting                    ; Get current level mode
                      CMP.B #$09                                ; \
                      BEQ LoadLevelDone                         ; |
...
LoadLevelDone:        STZ.W LayerProcessing
                      PLP
                      RTS
...
LevelMusicTable:      db !BGM_OVERWORLD                         ; A level can choose between 8 tracks. ; This table contains the tracks to choose from.
                      db !BGM_UNDERGROUND
                      db !BGM_ATHLETIC
                      db !BGM_CASTLE
                      db !BGM_GHOSTHOUSE
...
CODE_0585D8:          LDA.B LvlLoadObjNo
                      BNE CODE_0585E2
                      LDA.B LvlLoadObjSize
                      CMP.B #$02
                      BCC +
CODE_0585E2:          LDA.B _A
                      AND.B #$0F
                      STA.B _0
                      LDA.B _B
                      AND.B #$0F
...
LevLoadExtObj:        SEP #$30                                  ; AXY->8
                      JSL CODE_0DA100
                      RTS

LevLoadNrmObj:        SEP #$30                                  ; AXY->8
                      JSL CODE_0DA40F
                      RTS
...
CODE_058713:          REP #$20                                  ; A->16
                      ...
                      CMP.B Layer1PrevTileUp,X
                      BEQ +
CODE_058724:          STA.B Layer1PrevTileUp,X
                      TXA
                      EOR.W #$0002
                      TAX
                      LDA.W #$FFFF
...
CODE_058753:          REP #$20                                  ; A->16
                      ...
                      CMP.B Layer2PrevTileUp,X
                      BEQ CODE_058774
CODE_058764:          STA.B Layer2PrevTileUp,X
                      TXA
                      EOR.W #$0002
                      TAX
                      LDA.W #$FFFF
...
DATA_05A5A7:          dw SwitchMessage-MessageBoxes
...
IntroMessage:         db $16,$44,$4B,$42,$4E,$4C,$44,$1A        ;!
...
SwitchMessage:        db $1C,$1F,$12,$16,$08,$13,$02,$07        ;!!
...
YoshiGoneMessage:     db $07,$44,$4B,$4B,$4E,$1A,$1F            ;!
                      ...
                      db $E3                                    ;!
RescueYoshiMessage:   db $07,$4E,$4E,$51,$40,$58,$1A            ;!
                      ...
                      db $9B,$9F                                ;!
FillYellowMessage:    db $08,$53,$1F,$48,$52,$1F                ;!
                      ...
                      db $9B                                    ;!
ItemBoxMessage:       db $1C,$0F,$0E,$08,$0D,$13,$1F            ;!
                      ...
                      db $4D,$9B,$9F                            ;!
HoldItemMessage:      db $1C,$0F,$0E,$08,$0D                    ;!
...
DragonCoinMessage:    db $1C,$0F,$0E,$08,$0D,$13,$1F,$0E        ;!
...
JumpHighMessage:      db $16,$47,$44,$4D,$1F,$58,$4E,$54        ;!
                      ...
                      db $53,$44,$51,$9B                        ;!
StartSelectMessage:   db $08,$45,$1F,$1F                        ;!
...
IggyKoopaMessage:     db $1C,$0F,$0E,$08,$0D,$13,$1F,$0E        ;!
                      db $05,$1F,$00,$03,$15,$08,$02,$04        ;!
                      ...
                      db $4B,$9B                                ;!
CapeMarioMessage:     db $14,$52,$44,$1F,$1F,$0C                ;!
                      ...
                      db $02,$4E,$4D,$53,$51,$4E,$4B,$1F        ;!
                      db $0F,$40,$43,$9B                        ;!
SecretExitMessage:    db $13,$47,$44,$1F                        ;!
...
GhostHouseMessage:    db $13                                    ;!
                      ...
                      db $9F                                    ;!
ScreenScrollMessage:  db $18,$4E,$54,$1F,$42,$40,$4D            ;!
...
ClearMessageStripe:   db $50,$C7,$41,$E2,$FC,$38,$FF            ;!
                   endif                                        ;/===============================================
...
CODE_05B132:          LDA.W OverworldOverride
...
CODE_05B15B:          LDA.B #$8E
                      STA.W OWPlayerYPos
SubSideExit:          STZ.W OverworldOverride
                      LDA.B #$00
...
CODE_05B16E:          LDA.B byetudlrHold
                      AND.B #$F0
                      BEQ CODE_05B18E
                      EOR.B byetudlrFrame
                      AND.B #$F0
...
CODE_05B18E:          JMP CODE_05B299

CODE_05B191:          CMP.W DATA_05B106,X
                      BNE CODE_05B1A0
                      TXA
                      BEQ +
                      JSR CODE_05B31B
                      LDA.B #$09
                      STA.B StripeImage
CODE_05B1A0:          JMP CODE_05B250

                    + LDX.B #$16
CODE_05B1A5:          LDY.B #$01
                      LDA.W DATA_05A590,X
                      BPL +
                      INY
                      AND.B #$7F
...
CODE_05B1B9:          DEX
                      BNE CODE_05B1A5
CODE_05B1BC:          LDY.W MessageBoxTrigger
                      CPY.B #$03
                      BNE +
                      LDX.B #$18
                    + CPX.B #$04
...
CODE_05B208:          LDA.B #$1F                                ;!
                    ...
                    + STA.L DynamicStripeImage+4,X              ;!
                      ...
                      STZ.B Layer3YPos
                      STZ.B Layer3YPos+1
CODE_05B250:          LDX.W MessageBoxExpand
                      LDA.W MessageBoxTimer
                      CLC
                      ADC.W DATA_05B10A,X
                      ...
                      LDX.B #$00
                      LDY.B #$50
CODE_05B26D:          CPX.W MessageBoxTimer
                      BCC +
                      LDA.W #$00FF
...
DATA_05B2DB:          db $50,$57,$58,$57,$50,$5F,$58,$5F        ;!
...
PlayerSelectStripe:   db $51,$F5,$00,$01,$FC,$38,$52,$08        ;!
                      ...
                      db $73,$31,$FF                            ;!
                   elseif ver_is_arcade(!_VER)                  ;<========================= SS ==================
DATA_05B6FE:          db $52,$05,$40,$2E,$FC,$38,$52,$28        ;!
                      ...
                      db $7C,$30,$FF                            ;!
																;!
DATA_05B7C9:          db $52,$05,$40,$2E,$FC,$38,$52,$28        ;!
                      db $40,$1C,$FC,$38,$52,$45,$40,$2E        ;!
                      db $FC,$38,$52,$68,$40,$1C,$FC,$38        ;!
                      db $52,$85,$40,$2E,$FC,$38,$52,$C5        ;!
                      ...
                      db $FF                                    ;!
																;!
PlayerSelectStripe:   db $52,$05,$40,$2F,$FC,$38,$52,$45        ;!
...
DATA_05B7C9:          db $51,$E5,$40,$2E,$FC                    ;!
                      ...
                      db $31,$71,$31,$FF                        ;!
																;!
PlayerSelectStripe:   db $51,$E5,$40,$2F,$FC,$38,$52,$25        ;!
...
ContinueSaveStripe:   db $51,$C6,$00,$21,$2D,$39,$7A,$38        ;!
                      ...
                      db $80,$38,$73,$39,$FF                    ;!
																;!
ContinueEndStripe:    db $51,$CD,$00,$0F,$2D,$39,$7A,$38        ;!
                      db $79,$38,$2F,$39,$82,$38,$79,$38        ;!
...
AnimatedTileData:     dw AnimatedTiles+$1800                    ; ? Block frame 1
                      ...
                      dw AnimatedTiles+$2400                    ; Water frame 3
                      dw AnimatedTiles+$2600                    ; Water frame 4
DATA_05BA39:          dw AnimatedTiles+$1180                    ; Coin frame 1
...
CODE_05BB67:          PHY                                       ;\ Start loop, backup X and Y.
                      PHX                                       ;/
                      SEP #$20                                  ; A->8
                      TYA                                       ; A = GFX_TILE_IDX
...
CODE_05BB81:          LDY.W ObjectTileset                       ; Load the current object tileset.
...
CODE_05BC72:          JSR CODE_05BC4A
                      RTL

CODE_05BC76:          STZ.W ScrollLayerIndex
                      LDA.W SpriteLock
                      BNE Return05BC49
...
CODE_05BCE9:          LDA.W Layer1ScrollCmd
                      JSL ExecutePtr
...
CODE_05BD0E:          LDA.W Layer2ScrollCmd
                      BEQ Return05BD35
                      JSL ExecutePtr
...
CODE_05BD36:          STZ.W HorizLayer1Setting
...
CODE_05BD4C:          LDX.W ScrollLayerIndex
                      REP #$20                                  ; A->16
                    ...
                    + LDX.W ScrollLayerIndex
                      ...
                      STZ.W Layer1ScrollYPosUpd,X
CODE_05BDC9:          STZ.W Layer1ScrollXSpeed,X
                      STZ.W Layer1ScrollYSpeed,X
CODE_05BDCF:          SEP #$20                                  ; A->8
                      TXA
                      LSR A
                      LSR A
                      AND.B #$FF
...
ADDR_05BDDD:          LDA.W Layer1ScrollBits
                      ASL A
                      TAY
                      REP #$20                                  ; A->16
                      LDA.W DATA_05CA08,Y
...
ADDR_05BE3A:          LDA.W Layer1ScrollBits
                      ASL A
                      TAY
                      REP #$20                                  ; A->16
                      LDA.W DATA_05CA16,Y
...
CODE_05BEA6:          STZ.W HorizLayer1Setting
                      LDA.W Layer1ScrollBits
                      ASL A
                      TAY
                      REP #$20                                  ; A->16
...
CODE_05BF0A:          STZ.W VertLayer2Setting
                      LDA.W Layer1ScrollBits
                      ASL A
                      TAY
                      REP #$20                                  ; A->16
...
CODE_05BF6A:          LDY.W Layer1ScrollBits
                      LDA.W DATA_05C94F,Y
                      STA.W Layer1ScrollBits
                      LDA.W DATA_05C952,Y
...
ADDR_05BF97:          STZ.W HorizLayer1Setting
                      REP #$20                                  ; A->16
                      STZ.B Layer1XPos
                      STZ.W NextLayer1XPos
                      STZ.B Layer2XPos
...
ADDR_05BFBA:          STZ.W HorizLayer1Setting
                      REP #$20                                  ; A->16
                      STZ.B Layer2XPos
                      STZ.W NextLayer2XPos
                      LDA.W #$03C0
                      ...
                      LDA.W #$0005
CODE_05BFD2:          STZ.W Layer1ScrollTimer
CODE_05BFD5:          STZ.W Layer1ScrollType
                      STA.W Layer1ScrollCmd
...
CODE_05C005:          STZ.W HorizLayer1Setting
                      LDA.W Layer1ScrollBits
                      ASL A
                      TAY
                      REP #$20                                  ; A->16
...
CODE_05C01A:          REP #$20                                  ; A->16
                      LDA.W #$0D00
                      JSR CODE_05BFD2
CODE_05C022:          STZ.W HorizLayer2Setting
                      REP #$20                                  ; A->16
                      STZ.W Layer2ScrollXSpeed
                      STZ.W Layer2ScrollYSpeed
                      STZ.W Layer2ScrollXPosUpd
...
CODE_05C036:          LDY.W Layer1ScrollBits
                      LDA.W DATA_05C808,Y
...
CODE_05C04D:          LDA.W ScrollLayerIndex
                      LSR A
                      LSR A
                      TAX
...
CODE_05C134:          ASL.B _C
                    ...
                    + ROL.B _E
                      ...
                      STA.B _A
                      LDX.B #$02
CODE_05C15D:          LDA.B _8
                      BMI CODE_05C165
                      LDA.B _A
                      BRA +

CODE_05C165:          LDA.B _E
                    + BIT.B _0,X
                      BPL +
                      EOR.W #$FFFF
                      INC A
...
ADDR_05C1EB:          STA.B _2
                    ...
                    + LDX.W ScrollLayerIndex
                      ...
                      STA.W Layer1ScrollXPosUpd,X
ADDR_05C24D:          LDA.W ScrollLayerIndex
                      AND.W #$00FF
                      LSR A
                      LSR A
                      TAY
...
ADDR_05C280:          JMP ADDR_05C31D

ADDR_05C283:          REP #$20                                  ; A->16
                      LDY.W ScrollLayerIndex
                      LDA.W Layer1ScrollXPosUpd,Y
                      SEC
                    ...
                    + CLC
                      ADC.W NextLayer1YPos,X
                      STA.W NextLayer1YPos,X
ADDR_05C2E5:          LDX.W Layer1ScrollBits
                      LDA.W ScrollLayerIndex
                      AND.W #$00FF
                      BEQ +
                    ...
                    + LDA.W Layer1ScrollYSpeed,X
                      ...
                      ADC.W DATA_05CB9B,Y
                      STA.W Layer1ScrollYSpeed,X
ADDR_05C31D:          LDA.W ScrollLayerIndex
                      AND.W #$00FF
                      CLC
                      ADC.W #$0002
                      TAX
CODE_05C328:          JSR CODE_05C4F9
CODE_05C32B:          SEP #$20                                  ; A->8
                      RTS

ADDR_05C32E:          REP #$20                                  ; A->16
                      LDY.W ScrollLayerIndex
...
ADDR_05C39F:          LDA.W ScrollLayerIndex
                      AND.W #$00FF
                      LSR A
                      LSR A
                      TAX
                    ...
                    + LDA.W Layer1ScrollXSpeed,X
                      ...
                      ADC.W DATA_05CBA3,Y
                      STA.W Layer1ScrollXSpeed,X
ADDR_05C3FD:          LDX.W ScrollLayerIndex
                      JSR CODE_05C4F9
                      SEP #$20                                  ; A->8
                      RTS
...
CODE_05C40C:          LDA.W Layer3TideSetting
                      BEQ +
                      JMP CODE_05C494
                    ...
                    + REP #$20                                  ; A->16
                      ...
                      CPY.B #$03
                      BNE CODE_05C428
CODE_05C421:          LDA.B Layer1XPos
                      LSR A
                      STA.B Layer3XPos
                      BRA CODE_05C491

CODE_05C428:          LDY.W SpriteLock
                      BNE CODE_05C48D
...
CODE_05C45B:          LDA.W Layer3ScrollXPosUpd
                      AND.W #$00FF
                      CLC
                    ...
                    + STA.B _0
                      ...
                      ADC.B _0
                      STA.B Layer3XPos
CODE_05C48D:          LDA.B Layer1YPos
                      STA.B Layer3YPos
CODE_05C491:          SEP #$20                                  ; A->8
                      RTS
...
CODE_05C494:          DEC A
                      ...
                      BNE CODE_05C4EC
CODE_05C4AF:          CMP.W DATA_05C408,Y
                      BEQ +
                      CLC
                      ADC.W DATA_05C406,Y
...
CODE_05C4F9:          LDA.W Layer1ScrollXPosUpd,X
                      AND.W #$00FF
                      CLC
...
CODE_05C538:          STA.B _2
                    ...
                    + LDX.W ScrollLayerIndex
                      ...
                      STA.W Layer1ScrollYPosUpd,X
CODE_05C585:          LDA.W ScrollLayerIndex
                      AND.W #$00FF
                      LSR A
                      LSR A
                      TAX
                    ...
                    + LDA.W Layer1ScrollXSpeed,X
                      ...
                      ADC.W DATA_05CBC3,Y
                      STA.W Layer1ScrollXSpeed,X
CODE_05C5B8:          JMP CODE_05C328

CODE_05C5BB:          REP #$30                                  ; AXY->16
                      LDY.W ScrollLayerIndex
                      REP #$30                                  ; AXY->16
                      LDA.W Layer1ScrollXPosUpd,Y
                      TAX
...
CODE_05C5D4:          STA.B _2
                    ...
                    + LDX.W ScrollLayerIndex
                      ...
                      ADC.W Layer1ScrollXPosUpd,X
                      STA.W Layer1ScrollXPosUpd,X
CODE_05C621:          LDA.W ScrollLayerIndex
                      AND.W #$00FF
                      LSR A
                      LSR A
                      TAX
...
ADDR_05C6CD:          LDY.B #$16                                ; \ Unreachable
                      STY.W HW_TM
                      LDA.W Layer2ScrollYSpeed
                      CMP.W #$FF80
                      BEQ +
...
CODE_05C770:          LDA.W Layer2ScrollYSpeed
                      CMP.W DATA_05C71F,X
                      BEQ +
                      CLC
                      ADC.W DATA_05C723,X
                    ...
                    + LDX.B #$06
                      JSR CODE_05C4F9
CODE_05C784:          JMP CODE_05C32B

CODE_05C787:          LDA.B #$02
                      STA.B Layer1ScrollDir
...
CODE_05C7BC:          LDA.W BGFastScrollActive
                      BEQ CODE_05C7ED
CODE_05C7C1:          LDA.B #$02
                      STA.B Layer2ScrollDir
                      REP #$20                                  ; A->16
                    ...
                    + CLC
                      ...
                      STA.W NextLayer2XPos
CODE_05C7ED:          JMP CODE_05C32B


DATA_05C7F0:          dw $0000,$02F0,$08B0,$0000
                      dw $0000,$0370

DATA_05C7FC:          dw $00D0,$0350,$0A30,$0008
                      dw $0040,$0380
...
DATA_05C810:          dw $0000,$00B0

DATA_05C814:          dw $FF80,$00C0

                   if ver_is_ntsc(!_VER)                        ;\==================== J, U, & SS ===============
DATA_05C818:          dw $FFFF,$0001                            ;!
                   else                                         ;<===================== E0 & E1 =================
DATA_05C818:          dw $FFFE,$0002                            ;!
                   endif                                        ;/===============================================

CODE_05C81C:          REP #$20                                  ; A->16
                      STZ.B _0
                      ...
                      BCC CODE_05C830
                      LDY.B #$02
CODE_05C830:          LDA.W NextLayer2XPos
                      CMP.W DATA_05C7F0,X
                      BCC +
                      CMP.W DATA_05C7FC,X
                      BCS +
                    ...
                    + INX
                      ...
                      CLC
                      ADC.W DATA_05C818,Y
CODE_05C875:          STA.W Layer2ScrollYSpeed
                      LDX.B #$06
                      JSR CODE_05C4F9
CODE_05C87D:          SEP #$20                                  ; A->8
                      RTS
...
DATA_05C934:          db $66,$33,$01,$66,$00,$00,$66,$00        ;!
...
CODE_05C955:          LDX.W Layer1ScrollBits
                      LDY.W Layer2ScrollBits
CODE_05C95B:          REP #$20                                  ; A->16
CODE_05C95D:          LDA.W NextLayer2XPos
                      CMP.W DATA_05C880,X
                      BCC +
                      CMP.W DATA_05C8A4,X
                      BCS +
...
DATA_05CBF5:          db $90                                    ;!
DATA_05CBF6:          db $72,$60,$42,$22,$02,$40,$22,$20        ;!
                      db $10                                    ;!
                   endif                                        ;/===============================================
...
CODE_05CC07:          LDA.W OverworldProcess
                      JSL ExecutePtr
...
CODE_05CC77:          CPY.W InGameTimerTens
                      BNE +
...
CODE_05CCC8:          LDY.W #$0002
                    ...
                    - LDA.W InGameTimerHundreds,Y
                      ...
                      LDA.L DynStripeImgSize
                      TAX
CODE_05CCE4:          LDA.L DynamicStripeImage+$32,X
                      AND.B #$0F
                      BNE CODE_05CCF9
                      LDA.B #$FC
                      STA.L DynamicStripeImage+$32,X
...
CODE_05CCF9:          SEP #$10                                  ; XY->8
                      ...
                      JSR CODE_05CDFD
                      LDX.B #$00
CODE_05CD10:          LDA.L DynamicStripeImage+$40,X
                      AND.W #$000F
                      BNE CODE_05CD26
                      LDA.W #$38FC
...
CODE_05CD76:          LDA.W BonusStarsGained
                      BEQ CODE_05CDD5
                    ...
                    + LDA.B #$22
                      ...
                      INC A
                      STA.L DynStripeImgSize
CODE_05CDD5:          DEC.W DrumrollTimer
                      BPL Return05CDE8
                      LDA.W BonusStarsGained
                      STA.W DisplayBonusStars
                      INC.W OverworldProcess
...
CODE_05CDFD:          LDA.L DynStripeImgSize,X
                      AND.W #$FF00
...
CODE_05CF05:          LDX.W BonusStarsGained
                      BEQ CODE_05CF36
                      SEP #$20                                  ; A->8
                      LDA.B TrueFrame
                      AND.B #$03
                      ...
                      STA.W BonusStarsGained
                    + REP #$20                                  ; A->16
CODE_05CF36:          LDA.W ScoreIncrement
                      BNE +
                    ...
                    - LDA.W DATA_05CEA3,Y
                      ...
                      LDA.L DynStripeImgSize
                      TAX
CODE_05CF8A:          LDA.L DynamicStripeImage+4,X
                      AND.W #$000F
                      BNE CODE_05CFA0
                      LDA.W #$38FC
                      STA.L DynamicStripeImage+4,X
...
PtrsLong05D766:       dl GhostHouseEntrance
                      dl CastleEntrance1
                      dl NoYoshiEntrance1
                      dl NoYoshiEntrance2
                      dl NoYoshiEntrance3
...
CODE_05DA24:          LDX.B #$04
                      LDY.B #$04
                      LDA.B [Layer1DataPtr],Y
                      AND.B #$0F
CODE_05DA2C:          CMP.L DATA_05D760,X
                      BEQ CODE_05DA38
                      DEX
                      BPL CODE_05DA2C
                    - JMP CODE_05DAD7

CODE_05DA38:          LDA.W SublevelCount
                      BNE -
...
CODE_05DA5E:          LDX.B #$05
                    ...
                    + LDA.L DATA_05D760,X
                      STA.W ObjectTileset
CODE_05DAD7:          LDA.W SublevelCount
                      BEQ +
...
ChocIsld2Layer1:      dw CI2Sub8Level0CD
...
ChocIsld2Sprites:     dw CI2Sub8Sprites0CD
...
CODE_05DB3E:          LDX.B #$00
                      LDA.W DragonCoinsShown
                      CMP.B #$04
                      BEQ CODE_05DB49
                      LDX.B #$02
CODE_05DB49:          REP #$20                                  ; A->16
...
CODE_05DB82:          LDX.B #$0C
                      ...
                      CMP.B #$05
                      BMI CODE_05DBA6
CODE_05DB9B:          LDX.B #$0E
                      LDA.W InGameTimerTens
                      CMP.B #$05
                      BMI CODE_05DBA6
                      LDX.B #$10
CODE_05DBA6:          JMP CODE_05DB49


DATA_05DBA9:          db $00,$C8,$00

CODE_05DBAC:          LDY.B #$00
                      LDA.W YoshiHeavenFlag
                      BEQ +
                      LDY.B #$01
                    + LDX.B PlayerXPosNext+1
...
CODE_05DC3A:          LDX.B #$00
CODE_05DC3C:          CMP.B #$0A
                      BCC Return05DC45
                      SBC.B #$0A
                      INX
                      BRA CODE_05DC3C
...
Layer2Ptrs:           dw DATA_0CE674 : db $FF
...
Ptrs05EC00:           dw BonusGameSprites
                      dw VS2Sprites001
                      dw VS3Sprites002
                      dw TSASprites003
                      dw DGHSprites004
