...
IsTouchingObjSide:    LDA.W SpriteBlockedDirs,X                 ; \ Set A to lower two bits of
                      AND.B #$03                                ; / current sprite's Position Status
                      RTS

IsOnGround:           LDA.W SpriteBlockedDirs,X                 ; \ Set A to bit 2 of
                      AND.B #$04                                ; / current sprite's Position Status
                      RTS

IsTouchingCeiling:    LDA.W SpriteBlockedDirs,X                 ; \ Set A to bit 3 of
                      AND.B #$08                                ; / current sprite's Position Status
                      RTS

UpdateYPosNoGvtyW:    PHB
                      PHK
                      PLB
...
CODE_01804E:          LDA.W SpriteBlockedDirs,X                 ; \ Branch if in air
                      BEQ Return018072                          ; /
                      LDA.B TrueFrame
                      AND.B #$03
                      ...
                      LDA.B #$0A
                      STA.B _1
CODE_018063:          JSR IsSprOffScreen
                      BNE Return018072
                      LDY.B #$03
CODE_01806A:          LDA.W SmokeSpriteNumber,Y
                      BEQ CODE_018073
                      DEY
                      BPL CODE_01806A
Return018072:         RTS

CODE_018073:          LDA.B #$03
...
IsSprOffScreen:       LDA.W SpriteOffscreenX,X                  ; \ A = Current sprite is offscreen
                      ORA.W SpriteOffscreenVert,X               ; /
                      RTS

CODE_0180D2:          PHX                                       ; In all sprite routines, X = current sprite
                      TXA
...
HandleSprite:         LDA.W SpriteStatus,X                      ; Call a routine based on the sprite's status
...
HandleGoalPowerup:    JSR CallSpriteMain
...
HandleSprLvlEnd:      JSL LvlEndSprCoins
                      RTS
...
InitGreyLavaPlat:     INC.B SpriteYPosLow,X
                      INC.B SpriteYPosLow,X
Return018313:         RTS

InitBowserStatue:     INC.W SpriteMisc157C,X
...
InitYoshiEgg:         LDA.B SpriteXPosLow,X
                      LSR A
                      LSR A
                      LSR A
                      LSR A
...
InitWoodSpike:        LDA.B SpriteYPosLow,X
                      SEC
                      SBC.B #$40
...
InitWoodSpike2:       JMP InitMontyMole

InitBowserScene:      JSL CODE_03A0F1
                      RTS
...
InitExplodingBlk:     LDA.B SpriteXPosLow,X
                      LSR A
                      LSR A
                      LSR A
                      LSR A
...
InitScalePlats:       LDA.B SpriteYPosLow,X
                      STA.W SpriteMisc1534,X
                      LDA.W SpriteXPosHigh,X
...
InitYoshi:            DEC.W SpriteMisc160E,X
...
InitUrchinWallFllw:   INC.B SpriteYPosLow,X
                      BNE InitFuzzBall_Spark
                      INC.W SpriteXPosHigh,X
InitFuzzBall_Spark:   JSR InitUrchin
CODE_01840E:          LDA.W SpriteMisc151C,X
                      EOR.B #$10
                      STA.W SpriteMisc151C,X
                      LSR A
                      LSR A
...
InitUrchin:           LDA.B SpriteXPosLow,X
CODE_01841D:          LDY.B #$00
                      AND.B #$10
                      STA.W SpriteMisc151C,X
                      BNE +
                      INY
                    + LDA.W DATA_0183EF,Y
                      ...
                      LDA.W DATA_0183F0,Y
                      STA.B SpriteYSpeed,X
InitRipVanFish:       INC.W SpriteInLiquid,X
                      RTS
...
InitChangingItem:     INC.B SpriteTableC2,X
Return01843D:         RTS

InitPeaBouncer:       LDA.B SpriteXPosLow,X
                      SEC
                      SBC.B #$08
...
InitPSwitch:          LDA.B SpriteXPosLow,X                     ; \ $151C,x = Blue/Silver,
...
ADDR_018468:          JMP OffScrEraseSprite

InitLakitu:           LDY.B #$09
CODE_01846D:          CPY.W CurSpriteProcess
                      BEQ CODE_018484
...
InitMontyMole:        LDA.B SpriteXPosLow,X
                      AND.B #$10
                      STA.W SpriteMisc151C,X
                      RTS
...
InitBulletBill:       JSR SubHorizPos
                      TYA
                      STA.B SpriteTableC2,X
                      LDA.B #$10
                      STA.W SpriteMisc1540,X
...
InitPitchinChuck:     LDA.B SpriteXPosLow,X
                      AND.B #$30
                      LSR A
                      LSR A
                      LSR A
...
InitSuperKoopaFthr:   JSR FaceMario
                      LDA.B SpriteXPosLow,X
                      AND.B #$10
                      BEQ +
...
InitBubbleSpr:        JSR InitExplodingBlk
                      STY.B SpriteTableC2,X
                      DEC.W SpriteMisc1534,X
                      BRA FaceMario

InitGrnBounceKoopa:   LDA.B SpriteYPosLow,X
                      AND.B #$10
                      STA.W SpriteMisc160E,X
InitStandardSprite:   JSL GetRand
                      STA.W SpriteMisc1570,X
FaceMario:            JSR SubHorizPos
                      TYA
                      STA.W SpriteMisc157C,X
Return018583:         RTS

InitBowsersFire:      LDA.B #!SFX_FIRESPIT
                      STA.W SPCIO3                              ; / Play sound effect
                      BRA FaceMario

InitPowerUp:          INC.B SpriteTableC2,X
                      RTS

InitFishbone:         JSL GetRand
                      AND.B #$1F
                      STA.W SpriteMisc1540,X
                      JMP FaceMario

InitDownPiranha:      ASL.W SpriteOBJAttribute,X
                      SEC
                      ...
                      SBC.B #$00
                      STA.W SpriteXPosHigh,X
InitPiranha:          LDA.B SpriteXPosLow,X                     ; \ Center sprite between two tiles
                      CLC                                       ; |
                      ADC.B #$08                                ; |
                      STA.B SpriteXPosLow,X                     ; /
                      ...
                      CMP.B #$FF
                      BNE Return0185C2
                      DEC.W SpriteXPosHigh,X
Return0185C2:         RTS

CallSpriteMain:       STZ.W SpriteXMovement                     ; CallSpriteMain
                      LDA.B SpriteNumber,X
                      JSL ExecutePtr
...
InvisSolid_Dinos:     JSL InvisBlk_DinosMain
                      RTS

GoalSphere:           JSR SubSprGfx2Entry1
...
InitReznor:           JSL ReznorInit
                      RTS

Bank3SprHandler:      JSL Bnk3CallSprMain
                      RTS

BanzaiBnCGrayPlat:    JSL Banzai_Rotating
                      RTS

BubbleWithSprite:     JSL BubbleSpriteMain
                      RTS

HammerBrother:        JSL HammerBrotherMain
                      RTS

FlyingPlatform:       JSL FlyingPlatformMain
                      RTS

InitHammerBrother:    JSL Return02DA59                          ; Do nothing at all (Might as well be NOPs)
                      RTS

VolcanoLotus:         JSL VolcanoLotusMain
                      RTS

SumoBrother:          JSL SumoBrotherMain
                      RTS

SumosLightning:       JSL SumosLightningMain
                      RTS

JumpingPiranha:       JSL JumpingPiranhaMain
                      RTS

GasBubble:            JSL GasBubbleMain
                      RTS

                      JSL SumoBrotherMain                       ; Unused call to main Sumo Brother routine
                      RTS

DirectionalCoins:     JSL DirectionCoinsMain
                      RTS

ExplodingBlock:       JSL ExplodingBlkMain
                      RTS

ScalePlatforms:       JSL ScalePlatformMain
                      RTS

InitFloatingSkull:    JSL FloatingSkullInit
                      RTS

FloatingSkulls:       JSL FloatingSkullMain
                      RTS

GhostHouseExit:       JSL GhostExitMain
                      RTS

WarpBlocks:           JSL WarpBlocksMain
                      RTS

Pokey:                JSL PokeyMain
                      RTS

RedSuperKoopa:        JSL SuperKoopaMain
                      RTS

YellowSuperKoopa:     JSL SuperKoopaMain
                      RTS

FeatherSuperKoopa:    JSL SuperKoopaMain
                      RTS

PipeLakitu:           JSL PipeLakituMain
                      RTS

DigginChuck:          JSL ChucksMain
                      RTS

SwimJumpFish:         JSL SwimJumpFishMain
                      RTS

DigginChucksRock:     JSL ChucksRockMain
                      RTS

GrowingPipe:          JSL GrowingPipeMain
                      RTS

YoshisHouseBirds:     JSL BirdsMain
                      RTS

YoshisHouseSmoke:     JSL SmokeMain
                      RTS

SideExit:             JSL SideExitMain
                      RTS

InitWiggler:          JSL WigglerInit
                      RTS

Wiggler:              JSL WigglerMain
                      RTS

CoinCloud:            JSL CoinCloudMain
                      RTS

TorpedoTed:           JSL TorpedoTedMain
                      RTS
...
InitMovingLedge:      DEC.B SpriteYPosLow,X
                      RTS

MovingLedge:          JSL MovingLedgeMain
                      RTS
...
JumpLoopStart:        LDA.W SpriteStatus,Y                      ; |
...
HandleJumpOver:       LDA.W SpriteXPosLow,Y
                      SEC
                      SBC.B #$1A
                      STA.B _0
...
ShellessKoopas:       LDA.B SpriteLock                          ; \ If sprites aren't locked,
                      BEQ CODE_018952                           ; / branch to $8952
CODE_018908:          LDA.W SpriteMisc163E,X                    ;COME BACK HERE ON NOT STATIONARY BRANCH
                      CMP.B #$80
                      BCC +
                      LDA.B SpriteLock                          ; \ If sprites are locked,
                      BNE +                                     ; / branch to $891F
CODE_018913:          JSR SetAnimationFrame
...
CODE_018952:          LDA.W SpriteMisc163E,X                    ;CODE RUNA T START?
...
CODE_0189B4:          LDA.W SpriteMisc1528,X
                      BEQ CODE_018A15
                    ...
                    + SEC
                      ...
                      STA.B SpriteXSpeed,X
                      JSR CODE_01804E
CODE_0189E6:          STZ.W SpriteMisc1570,X
                      JSR CODE_018B43
                      LDA.B #$E6
...
CODE_0189FD:          JSR IsOnGround                            ;KOOPA CODE
                      BEQ CODE_018A0F
                      LDA.B #$FF
...
CODE_018A0F:          STZ.W SpriteMisc1528,X
                      JMP CODE_018913

CODE_018A15:          LDA.W SpriteMisc1534,X
                      BEQ CODE_018A88
                      LDY.W SpriteMisc160E,X
                      LDA.W SpriteStatus,Y
                      CMP.B #$0A
...
CODE_018A29:          STA.W SpriteMisc1528,Y
                      JSR IsTouchingObjSide
                      BEQ +
                      LDA.B #$00
                      STA.W SpriteXSpeed,Y
                    ...
                    + SEC
                      ...
                      STA.B SpriteXSpeed,X
                      JSR CODE_01804E
CODE_018A62:          STZ.W SpriteMisc1570,X
                      JSR CODE_018B43
                      RTS

CODE_018A69:          LDA.B #$00
                      STA.B SpriteXSpeed,X
                      STA.W SpriteXSpeed,Y
                      STZ.W SpriteMisc1534,X
                      LDA.B #$09                                ; \ Sprite status = Carryable
                      ...
                      STA.W SpriteMisc1540,X
                    + PLX
CODE_018A88:          LDA.B SpriteTableC2,X
                      BEQ CODE_018A9B
...
CODE_018A9B:          LDA.W SpriteMisc1558,X
                      CMP.B #$01
                      BNE Spr0to13Main
...
Bobomb:               LDA.W SpriteMisc1534,X                    ; \ Branch if exploding
                      BNE -                                     ; /
...
Spr0to13Start:        LDA.B SpriteLock                          ; \ If sprites locked...
                      BEQ Spr0to13Main                          ; |
CODE_018B00:          JSR MarioSprInteractRt                    ; | ...interact with Mario
CODE_018B03:          JSR SubSprSprInteract                     ; | ...interact with sprites
                      JSR Spr0to13Gfx                           ; | ...draw sprite
                      RTS                                       ; / Return

Spr0to13Main:         JSR IsOnGround                            ; \ If sprite on ground...
                      BEQ CODE_018B2E                           ; |
                      LDY.B SpriteNumber,X                      ; |
                    ...
                    + LDA.W Spr0to13SpeedX,Y                    ; |
                      ...
                      ADC.W SpriteSlope,X                       ; |
                    + STA.B SpriteXSpeed,X                      ; /
CODE_018B2E:          LDY.W SpriteMisc157C,X                    ; \ If touching an object in the direction
...
CODE_018B43:          JSR SubOffscreen0Bnk1
...
CODE_018B90:          STZ.W SpriteMisc1570,X                    ; /
                    + LDA.W Spr0to13Prop,Y                      ; \ If stay on ledges is set...
                      ...
                      LDA.B #$01                                ; |
                      STA.W SpriteMisc151C,X                    ; /
CODE_018BB0:          LDA.W SpriteMisc1528,X
                      BEQ CODE_018BBA
                      JSR CODE_018931
                      BRA +

CODE_018BBA:          JSR MarioSprInteractRt                    ; Interact with Mario
                    + JSR SubSprSprInteract                     ; Interact with other sprites
                      JSR FlipIfTouchingObj                     ; Change direction if touching an object
Spr0to13Gfx:          LDA.W SpriteMisc157C,X                    ; \ Store sprite direction
                      PHA                                       ; /
                    ...
                    + EOR.W SpriteMisc157C,X                    ; |
                      STA.W SpriteMisc157C,X                    ; /
CODE_018BDE:          LDY.B SpriteNumber,X                      ; \ Branch if sprite is 2 tiles high
...
CODE_018BEC:          LDA.W SpriteMisc1602,X                    ; \ Nothing?
                      LSR A                                     ; /
...
SpinyEgg:             LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE CODE_018C44                           ; /
                    ...
                    + JSR FlipIfTouchingObj
                      JSR SubSprSpr_MarioSpr
CODE_018C44:          JSR SubOffscreen0Bnk1
                      LDA.B #$02
                      JSR SubSprGfx0Entry0
                      RTS

GreenParaKoopa:       LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE CODE_018CB7                           ; /
                      LDY.W SpriteMisc157C,X
                      LDA.W Spr0to13SpeedX,Y
                      EOR.W SpriteSlope,X
...
CODE_018C8C:          JSR SubUpdateSprPos
                      DEC.B SpriteYSpeed,X
                    + JSR SubSprSpr_MarioSpr
                    ...
                    + JSR IsOnGround
                      ...
                      LDA.B #$B0
                    + STA.B SpriteYSpeed,X
CODE_018CAE:          JSR FlipIfTouchingObj
                      JSR SetAnimationFrame
                      JSR SubOffscreen0Bnk1
CODE_018CB7:          JMP Spr0to13Gfx
...
RedHorzParaKoopa:     JSR SubOffscreen1Bnk1
                      BRA +

RedVertParaKoopa:     JSR SubOffscreen0Bnk1
                    + LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE CODE_018D2A                           ; /
                      LDA.W SpriteMisc157C,X
                      PHA
...
CODE_018CEA:          LDY.B #$FC
                    ...
                    + STY.B SpriteYSpeed,X
                      JSR SubSprYPosNoGrvty
                      JSR SubSprXPosNoGrvty
CODE_018CFD:          LDA.W SpriteMisc1540,X
                      BNE +
                      ...
                      STA.W SpriteMisc1540,X
                    + JSR SubSprSpr_MarioSpr
CODE_018D2A:          JSR CODE_018CB7
                      RTS

WingedGoomba:         JSR SubOffscreen0Bnk1
                      LDA.B SpriteLock
                      BEQ +
                      JSR CODE_018DAC
                      RTS
                    ...
                    + LDA.W SpriteMisc1540,X
                      ...
                      LDY.B #$D0
                    + STY.B SpriteYSpeed,X
CODE_018DA5:          JSR FlipIfTouchingObj
                      JSR SubSprSpr_MarioSpr
                      RTS

CODE_018DAC:          JSR GoombaWingGfxRt
...
GoombaWingGfxRt:      JSR GetDrawInfoBnk1
                      LDA.W SpriteMisc1570,X
                      LSR A
                      LSR A
                      AND.B #$02
...
SetAnimationFrame:    INC.W SpriteMisc1570,X
...
ClassicPiranhas:      LDA.W SpriteMisc1594,X                    ; \ Don't draw the sprite if in pipe and Mario naerby
                      BNE CODE_018E9A                           ; /
                    ...
                    + JSR SubSprGfx1                            ; Draw the sprite
                      ...
                      STA.B SpriteProperties                    ; /
CODE_018E9A:          JSR SubOffscreen0Bnk1
                      LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE Return018EC7                          ; /
                      JSR SetAnimationFrame
...
ChangePiranhaState:   LDA.B SpriteTableC2,X                     ; \ $00 = Sprite state (00 - 03)
                      AND.B #$03                                ; |
                      STA.B _0                                  ; /
                      ...
                      BCC +                                     ; |
CODE_018EE1:          STZ.W SpriteMisc1594,X                    ; /
...
CODE_018EEF:          LDY.B #$07                                ; \ Find a free extended sprite slot
CODE_018EF1:          LDA.W ExtSpriteNumber,Y
                      BEQ CODE_018F07
                      DEY
                      BPL CODE_018EF1
...
CODE_018F07:          LDA.W SpriteOffscreenX,X
                      BNE -
                      RTS

HoppingFlame:         LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE CODE_018F49                           ; /
...
CODE_018F38:          JSL GetRand
                      AND.B #$1F
                      ORA.B #$20
                      STA.W SpriteMisc1540,X
CODE_018F43:          JSR FlipIfTouchingObj
                      JSR MarioSprInteractRt
CODE_018F49:          JSR SubOffscreen0Bnk1
                      JSR SubSprGfx2Entry1
                      RTS

CODE_018F50:          JSL GetRand
                      AND.B #$0F
                      ORA.B #$D0
                      STA.B SpriteYSpeed,X
                      LDA.W RandomNumber
...
Lakitu:               LDY.B #$00
                    ...
                    + LDA.W SpriteMisc151C,X
                      ...
                      JSL CODE_02E672
SubSprSpr_MarioSpr:   JSR SubSprSprInteract
...
SubUpdateSprPos:      JSR SubSprYPosNoGrvty
                      LDY.B #$00
...
FlipIfTouchingObj:    LDA.W SpriteMisc157C,X                    ; \ If touching an object in the direction
...
FlipSpriteDir:        LDA.W SpriteMisc15AC,X                    ; \ Return if turning timer is set
                      BNE +                                     ; /
                      LDA.B #$08                                ; \ Set turning timer
                      STA.W SpriteMisc15AC,X                    ; /
CODE_0190A2:          LDA.B SpriteXSpeed,X                      ; \ Invert speed
                      EOR.B #$FF                                ; |
                      INC A                                     ; |
                      STA.B SpriteXSpeed,X                      ; /
...
CODE_019140:          STZ.W SpriteBlockOffset
                    ...
                    + CLC
                      ...
                      STA.W SpriteYPosHigh,X
CODE_0191BE:          LDA.W SpriteTweakerF,X                    ; \ Branch if "Don't get stuck in walls" is not set
                      BPL +                                     ; /
...
CODE_019211:          LDA.W SpriteBuoyancy
                      BEQ CODE_01925B
                      LDA.B LevelIsWater
                      BNE CODE_019258
                      LDY.B #$3C
                      ...
                      BCC CODE_01925B
                      BCS CODE_01923A
CODE_019233:          LDA.W Map16TileNumber
                      CMP.B #$06
                      BCS CODE_01925B
CODE_01923A:          TAY
                      LDA.W SpriteInLiquid,X
                      ...
                      AND.B #$02                                ; | is set
                      BNE +                                     ; /
CODE_019252:          JSR CODE_019330
                    + PLA
                      ORA.B #$80
CODE_019258:          STA.W SpriteInLiquid,X
CODE_01925B:          LDA.W SpriteTweakerE,X
                      BMI Return019210
...
CODE_019310:          CMP.B #$59
                      ...
                      CPY.B #$03
                      BNE CODE_01933B
CODE_019323:          LDA.B SpriteNumber,X                      ; \ Branch if sprite == Yoshi
                      CMP.B #$35                                ; |
                      BEQ CODE_019330                           ; /
                      LDA.W SpriteTweakerD,X                    ; \ Branch if "Process interaction every frame"
                      AND.B #$02                                ; | is set
                      BNE CODE_01933B                           ; /
CODE_019330:          LDA.B #$05                                ; \ Sprite status = #$05 ???
                      STA.W SpriteStatus,X                      ; /
                      LDA.B #$40
                      STA.W SpriteMisc1558,X
                      RTS

CODE_01933B:          CMP.B #$11
                      BCC CODE_0193B0
                      CMP.B #$6E
                      BCC CODE_0193B8
                      CMP.B #$D8
...
CODE_01935D:          LDA.B [_5],Y
                      ...
                      CMP.B #$FC
                      BNE CODE_019384
CODE_019375:          EOR.B SpriteXSpeed,X
                      BPL +
                      LDA.B SpriteXSpeed,X
                      BEQ +
                      JSR FlipSpriteDir
                    + JSL CODE_03C1CA
CODE_019384:          BRA CODE_0193B8

CODE_019386:          LDA.B _C
                      AND.B #$0F
                      CMP.B #$05
                      BCS Return0193AF
...
CODE_0193B0:          LDA.B _C
                      AND.B #$0F
                      CMP.B #$05
                      BCS Return019424
CODE_0193B8:          LDA.W SpriteTweakerE,X
                      AND.B #$04
                      BNE CODE_019414
                      LDA.W SpriteStatus,X                      ; \ Return if sprite status == Killed
                      CMP.B #$02                                ; |
...
ADDR_0193EF:          TYA
                      ...
                      ADC.W DATA_0192C7,Y
                      STA.W SpriteYPosHigh,X
CODE_019405:          LDA.W SpriteOnYoshiTongue,X
                      BNE CODE_019414
                      LDA.B SpriteYPosLow,X
                      AND.B #$F0
                      CLC
...
CODE_019435:          LDY.B _F
                      LDA.W SpriteBlockedDirs,X
                      ORA.W DATA_019134,Y
                      STA.W SpriteBlockedDirs,X
                      RTS

CODE_019441:          STY.B _F                                  ; Can be 00-03
                      ...
                      ADC.B _F                                  ; |
                      TAY                                       ; /
CODE_01944D:          LDA.W TileGenerateTrackA
                      INC A
                      AND.B ScreenMode
                      BEQ CODE_0194BF
                      LDA.B SpriteYPosLow,X
...
CODE_0194B4:          LDY.B _F
                      LDA.B #$00
                      STA.W Map16TileNumber
                      STA.W SpriteBlockOffset
                      RTS

CODE_0194BF:          LDA.B SpriteYPosLow,X
                      CLC
                      ADC.W SpriteObjClippingY,Y
                      STA.B _C
                      AND.B #$F0
...
HandleSprStunned:     LDA.B SpriteNumber,X                      ; \ Branch if not Yoshi shell
                      CMP.B #$2C                                ; /
                      BNE CODE_019554
                      LDA.B SpriteTableC2,X
                      BEQ CODE_01956A
...
CODE_019554:          CMP.B #$2F                                ; \ If Spring Board...
...
SetNormalStatus2:     LDA.B #$08                                ; |
                      STA.W SpriteStatus,X                      ; |
                      JMP CODE_01A187                           ; /

CODE_01956A:          LDA.B SpriteLock                          ; \ If sprites locked,
                      BEQ +                                     ; | jump to $0195F5
                      JMP CODE_0195F5                           ; /
                    ...
                    + JSR CODE_019624
                      ...
                      BNE +                                     ; |
ADDR_019589:          JMP SetNormalStatus2                      ; /
                    ...
                    + CMP.B #$2C                                ; \ Branch if not Yoshi Egg
                      ...
                      STA.B SpriteYSpeed,X                      ; /
                      JSL CODE_01F74C
CODE_019598:          JSR IsTouchingCeiling
                      BEQ +
                    ...
                    + LDA.B SpriteXSpeed,X
                      ...
                      PLP
                      ROR.B SpriteXSpeed,X
CODE_0195F2:          JSR SubSprSpr_MarioSpr
CODE_0195F5:          JSR CODE_01A187
                      JSR SubOffscreen0Bnk1
                      RTS
...
CODE_019624:          LDA.B SpriteNumber,X                      ; \ Branch away if sprite isn't a Bob-omb
                      CMP.B #$0D                                ; |
                      BNE CODE_01965C                           ; /
...
CODE_01965C:          LDA.W SpriteMisc1540,X
                      ORA.W SpriteMisc1558,X
                      STA.B SpriteTableC2,X
                      LDA.W SpriteMisc1558,X
                      BEQ CODE_01969C
...
CODE_01969C:          LDA.W SpriteMisc1540,X                    ; \ Return if stun timer == 0
                      BEQ -                                     ; /
...
UnstunSprite:         LDA.B SpriteNumber,X                      ; \ Branch if Buzzy Beetle
                      CMP.B #$11                                ; |
                      BEQ SetNormalStatus                       ; /
...
SetNormalStatus:      LDA.B #$08                                ; \ Sprite Status = Normal
                      STA.W SpriteStatus,X                      ; /
                      ASL.W SpriteOBJAttribute,X                ; \ Clear vertical flip bit
                      LSR.W SpriteOBJAttribute,X                ; /
                      RTS

IncrmntStunTimer:     LDA.B TrueFrame                           ; \ Increment timer every other frame
                      AND.B #$01                                ; |
                      BNE +                                     ; |
                      INC.W SpriteMisc1540,X                    ; |
                    + RTS                                       ; /

GeneralResetSpr:      JSL FindFreeSprSlot                       ; \ Return if no free sprite slot found
                      BMI Return0196CA                          ; /
                      LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,Y                      ; /
...
CODE_01976D:          LDA.W SpriteStatus,Y                      ; |
...
CODE_0197D5:          LDA.B SpriteXSpeed,X
                      PHP
                      BPL +
                      JSR InvertAccum
                    + LSR A
...
CODE_019806:          LDA.B #$06
                      LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
                      BNE CODE_01980F
                      LDA.B #$08
CODE_01980F:          STA.W SpriteMisc1602,X
                      LDA.W SpriteOAMIndex,X
                      PHA
                      BEQ +
                      CLC
...
HandleSprKicked:      LDA.W SpriteMisc187B,X
                      BEQ +
                      JMP CODE_0198A9
...
CODE_019969:          JSR IsOnGround
                      BEQ CODE_019984
                      JSR SetSomeYSpeed__
                      LDA.B #$10                                ; \ Set downward speed
                      STA.B SpriteYSpeed,X                      ; /
CODE_019975:          LDA.W SprMap16TouchHorizLow
                      CMP.B #$B5
                      BEQ CODE_019980
                      CMP.B #$B4
                      BNE CODE_019984
CODE_019980:          LDA.B #$B8
                      STA.B SpriteYSpeed,X
CODE_019984:          JSR IsTouchingObjSide
                      BEQ CODE_01998C
                      JSR CODE_01999E
CODE_01998C:          JSR SubSprSpr_MarioSpr
CODE_01998F:          JSR SubOffscreen0Bnk1
...
BreakThrowBlock:      STZ.W SpriteStatus,X                      ; Free up sprite slot
                      LDY.B #$FF                                ; Is this for the shatter routine??
CODE_0199E1:          JSR IsSprOffScreen                        ; \ Return if off screen
                      BNE +                                     ; /
...
CODE_019A2A:          LDA.B SpriteTableC2,X
                      STA.W SpriteMisc1558,X
                      LDA.B EffFrame
                      LSR A
                      LSR A
...
HandleSprSpinJump:    LDA.W SpriteMisc1540,X                    ; \ Erase sprite if time up
...
SpinJumpEraseSpr:     JSR OffScrEraseSprite                     ; Permanently kill the sprite
                      RTS

CODE_019A7B:          LDA.W SpriteMisc1558,X
                      BEQ SpinJumpEraseSpr
                      LDA.B #$04
                      STA.B SpriteYSpeed,X
...
CODE_019A94:          DEC.B SpriteXSpeed,X
                      JSR IsTouchingObjSide
                      BEQ CODE_019A9D
                      STZ.B SpriteXSpeed,X                      ; Sprite X Speed = 0
CODE_019A9D:          LDA.B #$01
                      STA.W SpriteBehindScene,X
HandleSprKilled:      LDA.B SpriteNumber,X                      ; \ If Wiggler, call main sprite routine
                      CMP.B #$86                                ; |
                      BNE +                                     ; |
                      JMP CallSpriteMain                        ; /
                    ...
                    + LDA.W SpriteTweakerA,X                    ; \ If "disappears in puff of smoke" is set...
                      AND.B #$80                                ; |
                      BEQ +                                     ; |
CODE_019ACB:          LDA.B #$04                                ; | ...Sprite status = Spin Jump Killed...
                      STA.W SpriteStatus,X                      ; |
...
HandleSprSmushed:     LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE CODE_019AFE                           ; /
                    ...
                    + JSR SubUpdateSprPos
                      ...
                      JSR SetSomeYSpeed__
                      STZ.B SpriteXSpeed,X                      ; Sprite X Speed = 0
CODE_019AFE:          LDA.B SpriteNumber,X                      ; \ If Dino Torch...
                      CMP.B #$6F                                ; |
                      BNE +                                     ; |
...
HandleSpriteDeath:    LDA.W SpriteTweakerD,X                    ; \ If the main routine handles the death state...
                      AND.B #$01                                ; |
                      BEQ +                                     ; |
                    ...
                    + STZ.W SpriteMisc1602,X
                      ...
                      STA.W SpriteBehindScene,X                 ; /
CODE_019B3D:          LDA.B #$01
                      STA.W SpriteMisc1602,X
                      BRA +

CODE_019B44:          LDA.W SpriteOBJAttribute,X                ; \ Set to flip tiles vertically
                      ORA.B #$80                                ; |
                      STA.W SpriteOBJAttribute,X                ; /
...
CODE_019B5F:          LDA.B #$06
                      STA.W SpriteMisc1602,X
CODE_019B64:          LDA.B #$00
                      CPY.B #$1C
                      BEQ +
                      LDA.B #$80
                    + STA.B _0
...
SubSprGfx1:           LDA.W SpriteOBJAttribute,X
                      BPL +
                      JSR SubSprGfx1Hlpr1
                      RTS
...
SubSprGfx1Hlpr1:      JSR GetDrawInfoBnk1
                      LDA.W SpriteMisc157C,X
                      STA.B _2
                      TYA
                      CLC
...
KoopaWingGfxRt:       LDY.B #$00                                ; \ If not on ground, $02 = animation frame (00 or 01)
                      ...
                      AND.B #$01                                ; |
                      TAY                                       ; |
CODE_019E35:          STY.B _2                                  ; /
CODE_019E37:          LDA.W SpriteOffscreenVert,X               ; \ Return if offscreen vertically
                      BNE Return019E94                          ; /
                      LDA.B SpriteXPosLow,X                     ; \ $00 = X position low
                      STA.B _0                                  ; /
                      LDA.W SpriteYPosHigh,X                    ; \ $04 = X position high
                      STA.B _4                                  ; /
...
CODE_019E95:          LDA.B SpriteYPosLow,X
                      PHA
                      CLC
                      ADC.B #$02
                      STA.B SpriteYPosLow,X
...
SubSprGfx2Entry0:     STA.B _4
                      BRA +

SubSprGfx2Entry1:     STZ.B _4
                    + JSR GetDrawInfoBnk1
                      LDA.W SpriteMisc157C,X
                      STA.B _2
                      LDY.B SpriteNumber,X
...
ShellSpeedX:          db $D2,$2E,$CC,$34                        ;!
                   else                                         ;<==================== E0 & E1 ==================
ShellSpeedX:          db $C9,$37,$C2,$3E                        ;!
                   endif                                        ;/===============================================

DATA_019F6F:          db $00,$10

HandleSprCarried:     JSR CODE_019F9B
                      ...
                      BEQ +                                     ; /
CODE_019F83:          STZ.W SpriteOAMIndex,X
                    + LDA.B SpriteProperties
                      PHA
...
CODE_019F9B:          LDA.B SpriteNumber,X                      ; \ Branch if not Balloon
                      CMP.B #$7D                                ; |
                      BNE CODE_019FE0                           ; /
                      LDA.B TrueFrame
                      AND.B #$03
...
CODE_019FBE:          LDA.B PlayerAnimation                     ; \ Branch if no Mario animation sequence in progress
                      CMP.B #$01                                ; |
                      BCC +                                     ; /
CODE_019FC4:          STZ.W PBalloonInflating
                      JMP OffScrEraseSprite
...
CODE_01A041:          LDA.B byetudlrHold
                      AND.B #$03
                      BNE CODE_01A079
CODE_01A047:          LDY.B PlayerDirection
                      LDA.B PlayerXPosNow
                      CLC
                      ADC.W DATA_019F67,Y
                      STA.B SpriteXPosLow,X
...
CODE_01A079:          JSL CODE_01AB6F
                    ...
                    + LDA.W ShellSpeedX,Y
                      ...
                      ADC.W ShellSpeedX,Y
                      STA.B SpriteXSpeed,X
CODE_01A0A6:          LDA.B #$10
                      STA.W SpriteMisc154C,X
                      LDA.B #$0C
                      STA.W KickingTimer
                      RTS

CODE_01A0B1:          LDY.B #$00
                    ...
                    + LDA.W YoshiInPipeSetting
                      ...
                      CMP.B #$02
                      BEQ CODE_01A0D4
CODE_01A0CD:          LDA.W PlayerTurningPose
                      ORA.B PlayerIsClimbing
                      BEQ +
CODE_01A0D4:          LDY.B #$05
                    + PHY
                      LDY.B #$00
...
StunMechaKoopa:       LDA.B Layer1XPos
                      PHA
                      LDA.W SpriteMisc1540,X
                      CMP.B #$30
                      BCS +
                    ...
                    + JSL CODE_03B307
                      PLA
                      STA.B Layer1XPos
CODE_01A169:          LDA.W SpriteStatus,X                      ; \ If sprite status == Carried,
                      CMP.B #$0B                                ; |
                      BNE +                                     ; |
...
StunFish:             JSR SetAnimationFrame
                      LDA.W SpriteOBJAttribute,X
                      ORA.B #$80
                      STA.W SpriteOBJAttribute,X
                      JSR SubSprGfx2Entry1
...
CODE_01A187:          LDA.W SpriteTweakerD,X                    ; \ Branch if sprite changes into a shell
                      AND.B #$08                                ; |
                      BEQ CODE_01A1D0                           ; /
                      LDA.B SpriteNumber,X
                      CMP.B #$A2
...
CODE_01A1D0:          JSR CODE_019806
Return01A1D3:         RTS

StunThrowBlock:       LDA.W SpriteMisc1540,X
                      CMP.B #$40
                      BCS CODE_01A1DE
                      LSR A
                      BCS StunYoshiEgg
CODE_01A1DE:          LDA.W SpriteOBJAttribute,X
                      INC A
                      INC A
                      AND.B #$0F
                      STA.W SpriteOBJAttribute,X
StunYoshiEgg:         JSR SubSprGfx2Entry1
                      RTS

StunBomb:             JSR SubSprGfx2Entry1
                      LDA.B #$CA
                      BRA CODE_01A222

StunKey:              JSR CODE_01A169
                      JSR SubSprGfx2Entry1
                      LDA.B #$EC
                      BRA CODE_01A222

StunPow:              LDY.W SpriteMisc163E,X
                      BEQ CODE_01A218
                      CPY.B #$01
                      BNE +
                      JMP CODE_019ACB
...
CODE_01A218:          LDA.B #$01
                      STA.W SpriteMisc157C,X
                      JSR SubSprGfx2Entry1
                      LDA.B #$42
CODE_01A222:          LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
                      STA.W OAMTileNo+$100,Y
                      RTS

StunSpringBoard:      JMP CODE_01E6F0

StunBabyYoshi:        LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE CODE_01A27B                           ; /
                      LDA.B SpriteXPosLow,X
                      CLC
                      ADC.B #$08
                    ...
                    + TYA
                      STA.W SpriteMisc1602,X
CODE_01A27B:          JMP CODE_01A34F

CODE_01A27E:          STZ.W SpriteOAMIndex,X
                      CMP.B #$20
                      BEQ +
                      JMP CODE_01A30A
                    ...
                    + CMP.B #$74
                      ...
                      CMP.B #$78
                      BCS CODE_01A2F4
CODE_01A2B5:          STZ.W YoshiSwallowTimer
...
CODE_01A2F4:          INC.W SpriteMisc1570,X
                      LDA.W SpriteMisc1570,X
                      CMP.B #$05
                      BNE CODE_01A300
                      BRA CODE_01A2B5

CODE_01A300:          JSL CODE_05B34A
                      LDA.B #$01
                      JSL GivePoints
CODE_01A30A:          LDA.W SpriteMisc163E,X
                      LSR A
                      LSR A
                      LSR A
                      TAY
...
GetDrawInfoBnk1:      STZ.W SpriteOffscreenVert,X
                    ...
                    + LDA.W SpriteYPosHigh,X
                      ...
                      BEQ CODE_01A3A6                           ; /
                      INY
CODE_01A3A6:          LDA.B SpriteYPosLow,X
                      CLC
                      ADC.W DATA_01A361,Y
                      PHP
                      CMP.B Layer1YPos
...
CODE_01A3DF:          LDA.W SpriteOffscreenVert,X
                      BEQ Return01A40A
                      PHX
                      LSR A
                      BCC +
...
SubSprSprInteract:    TXA
                      ...
                      BCC Return01A40A                          ; /
                      DEX
CODE_01A417:          LDA.W SpriteStatus,X                      ; \ Jump to $01A4B0 if
...
CODE_01A4BA:          LDA.W SpriteStatus,Y                      ; \ Branch if sprite 2 status == Normal
                      CMP.B #$08                                ; |
                      BEQ CODE_01A4CE                           ; /
...
CODE_01A4CE:          LDA.W SpriteStatus,X                      ; \ Branch if sprite status == Normal
                      CMP.B #$08                                ; |
                      BEQ CODE_01A53D                           ; /
...
CODE_01A4E2:          LDA.W SpriteBlockedDirs,Y                 ; \ Branch if on ground
                      AND.B #$04                                ; |
                      BNE CODE_01A4F2                           ; /
...
CODE_01A4F2:          LDA.W SpriteStatus,X                      ; \ Branch if sprite status == Normal
                      CMP.B #$08                                ; |
                      BEQ CODE_01A540                           ; /
                      CMP.B #$09                                ; \ Branch if sprite status == Carryable
                      BEQ CODE_01A555                           ; /
...
CODE_01A506:          LDA.W SpriteStatus,X                      ; \ Branch if sprite status == Normal
                      CMP.B #$08                                ; |
                      BEQ CODE_01A52E                           ; /
                      CMP.B #$09                                ; \ Branch if sprite status == Carryable
                      BEQ CODE_01A531                           ; /
...
CODE_01A51A:          LDA.W SpriteStatus,X                      ; \ Branch if sprite status == Normal
                      CMP.B #$08                                ; |
                      BEQ CODE_01A534                           ; /
                      CMP.B #$09                                ; \ Branch if sprite status == Carryable
                      BEQ CODE_01A534                           ; /
...
CODE_01A52E:          JMP CODE_01A625

CODE_01A531:          JMP CODE_01A642

CODE_01A534:          JMP CODE_01A685

CODE_01A537:          JMP CODE_01A5C4

ADDR_01A53A:          JMP CODE_01A5C4

CODE_01A53D:          JMP CODE_01A56D

CODE_01A540:          JSR CODE_01A6D9
                      PHX
                      PHY
                      TYA
                      TXY
                      ...
                      BNE Return01A5C3
CODE_01A555:          LDA.W SpriteStatus,X
                      CMP.B #$09
                      BNE CODE_01A56D
                      JSR IsOnGround
                      BNE CODE_01A56D
...
CODE_01A56D:          LDA.B SpriteXPosLow,X
                      SEC
                      SBC.W SpriteXPosLow,Y
                      LDA.W SpriteYPosHigh,X
                      SBC.W SpriteYPosHigh,Y
                      ROL A
                      AND.B #$01
                      STA.B _0
...
CODE_01A5C4:          LDA.W SpriteNumber,Y
                      SEC
                      SBC.B #$83
                      CMP.B #$02
                      BCS +
...
CODE_01A625:          LDA.B SpriteNumber,X
                      SEC
                      SBC.B #$83
                      CMP.B #$02
                      BCS +
...
CODE_01A685:          LDA.B SpriteNumber,X                      ; \ Branch if Flying Question Block
                      CMP.B #$83                                ; |
                      BEQ ADDR_01A69A                           ; |
                      CMP.B #$84                                ; |
                      BEQ ADDR_01A69A                           ; /
...
ADDR_01A6B8:          JSR CODE_01A5D3
CODE_01A6BB:          JSL CODE_01AB6F
                      LDA.B #$04
                      JSL GivePoints
                      LDA.B SpriteXSpeed,X
                      ASL A
...
PlayKickSfx:          LDA.B #!SFX_KICK                          ; \ Play sound effect
                      STA.W SPCIO0                              ; /
Return01A72D:         RTS
                    ...
                    + LDA.W SpriteMisc1540,Y                    ; \ Return if timer is set
                      ...
                      LDA.B #$20                                ; \ $1564,y = #$20
                      STA.W SpriteMisc1564,Y                    ; /
CODE_01A755:          LDA.B #$20                                ; \ C2,x and 1558,x = #$20
...
CODE_01A77C:          LDA.B SpriteNumber,X
                      CMP.B #$02
                      BNE CODE_01A7C2
                    ...
                    + PLA
                      PLA
CODE_01A7C2:          LDX.W SpriteInterIndex
                      LDY.W CurSpriteProcess                    ; Y = Sprite index
                      RTS
...
MarioSprInteractRt:   LDA.W SpriteTweakerD,X                    ; \ Branch if "Process interaction every frame" is set
                      AND.B #$20                                ; |
                      BNE ProcessInteract                       ; /
...
ProcessInteract:      JSR SubHorizPos
                      ...
                      CMP.B #$C0
                      BCS -                                     ; No contact, return
CODE_01A80F:          LDA.B PlayerAnimation                     ; \ If animation sequence activated...
                      CMP.B #$01                                ; |
                      BCS -                                     ; / ...no contact, return
...
CODE_01A87E:          STZ.W StarKillCounter
                      LDA.W SpriteMisc154C,X
                      BNE CODE_01A895
                      LDA.B #$08
                      STA.W SpriteMisc154C,X
...
CODE_01A895:          CLC
                    ...
                    + LDA.B #$14
                      ...
                      BEQ CODE_01A8E6
CODE_01A8C0:          JSR IsOnGround
                      BEQ CODE_01A8C9
                      LDA.B PlayerInAir
                      BEQ CODE_01A8E6
CODE_01A8C9:          LDA.W SpriteTweakerA,X                    ; \ Branch if can be jumped on
                      AND.B #$10                                ; |
                      BNE CODE_01A91C                           ; /
                      LDA.W SpinJumpFlag
                      ORA.W PlayerRidingYoshi
                      BEQ CODE_01A8E6
CODE_01A8D8:          LDA.B #!SFX_SPLAT
                      STA.W SPCIO0                              ; / Play sound effect
                      JSL BoostMarioSpeed
                      JSL DisplayContactGfx
                      RTS

CODE_01A8E6:          LDA.W PlayerSlopePose
                      BEQ +
...
CODE_01A91C:          LDA.W SpinJumpFlag
                      ORA.W PlayerRidingYoshi
                      BEQ CODE_01A947
CODE_01A924:          JSL DisplayContactGfx
                      LDA.B #$F8
                      STA.B PlayerYSpeed
                      LDA.W PlayerRidingYoshi
                      BEQ +
...
CODE_01A998:          LDA.W SpriteToSpawn,Y
CODE_01A99B:          STA.B SpriteNumber,X
                      LDA.W SpriteOBJAttribute,X
                      AND.B #$0E
                      STA.B _F
                      JSL LoadSpriteTables
...
CODE_01A9BE:          LDA.B SpriteNumber,X
                      SEC
                      SBC.B #$04
                      CMP.B #$0D
                      BCS CODE_01A9CC
                      LDA.W FlightPhase
                      BNE CODE_01A9D3
CODE_01A9CC:          LDA.W SpriteTweakerA,X                    ; \ Branch if doesn't die when jumped on
                      AND.B #$20                                ; |
                      BEQ +                                     ; /
CODE_01A9D3:          LDA.B #$03                                ; \ Sprite status = Smushed
                      STA.W SpriteStatus,X                      ; /
                      LDA.B #$20
                      STA.W SpriteMisc1540,X
                    ...
                    + LDA.W SpriteTweakerB,X                    ; \ Branch if Tweaker bit...
                      ...
                      STZ.B SpriteXSpeed,X                      ; \ Sprite Speed = 0
                      STZ.B SpriteYSpeed,X                      ; /
CODE_01A9F2:          LDA.B SpriteNumber,X                      ; \ Return if NOT Lakitu
                      CMP.B #$1E                                ; |
                      BNE +                                     ; /
...
CODE_01AA01:          LDY.W SpriteStatus,X
                      STZ.W SpriteMisc1626,X
                      CPY.B #$08
                      BEQ SetStunnedTimer
CODE_01AA0B:          LDA.B SpriteTableC2,X
                      BNE SetStunnedTimer
                      STZ.W SpriteMisc1540,X
                      BRA SetAsStunned
...
SetStunnedTimer:      LDA.B #$02                                ; \
                      ...
                      CPY.B #$0D                                ; |
                      BNE +                                     ; |
CODE_01AA28:          LDA.B #$FF                                ; |
                    + STA.W SpriteMisc1540,X                    ; /
SetAsStunned:         LDA.B #$09                                ; \ Status = stunned
                      STA.W SpriteStatus,X                      ; /
                      RTS

BoostMarioSpeed:      LDA.B PlayerIsClimbing                    ; \ Return if climbing
                      BNE Return01AA41                          ; /
                      LDA.B #$D0
                      BIT.B byetudlrHold
                      BPL +
...
CODE_01AA42:          LDA.W SpinJumpFlag
                      ORA.W PlayerRidingYoshi
                      BEQ +
                      LDA.B PlayerYSpeed
                      BMI +
...
CODE_01AA94:          JSR CODE_01AB46
CODE_01AA97:          JSR PlayKickSfx
                      LDA.W SpriteMisc1540,X
                      STA.B SpriteTableC2,X
                      LDA.B #$0A                                ; \ Sprite status = Kicked
                      STA.W SpriteStatus,X                      ; /
...
CODE_01AAB2:          LDA.W SpriteMisc163E,X
                      BNE Return01AB2C
CODE_01AAB7:          STZ.W SpriteMisc154C,X
                      LDA.B SpriteYPosLow,X
                      SEC
                      SBC.B PlayerYPosNow
                      CLC
...
CODE_01AB31:          STZ.B PlayerXSpeed
                      JSR SubHorizPos
                      TYA
                      ASL A
                      TAY
...
CODE_01AB6F:          JSR PlayKickSfx
CODE_01AB72:          JSR IsSprOffScreen
                      BNE Return01AB98
                      PHY
                      LDY.B #$03
CODE_01AB7A:          LDA.W SmokeSpriteNumber,Y
                      BEQ CODE_01AB83
                      DEY
                      BPL CODE_01AB7A
                      INY
CODE_01AB83:          LDA.B #$02
                      STA.W SmokeSpriteNumber,Y
                      LDA.B SpriteXPosLow,X
                      STA.W SmokeSpriteXPos,Y
                      LDA.B SpriteYPosLow,X
...
DisplayContactGfx:    JSR IsSprOffScreen
                      BNE Return01ABCB
                      PHY
                      LDY.B #$03
CODE_01ABA1:          LDA.W SmokeSpriteNumber,Y
                      BEQ CODE_01ABAA
                      DEY
                      BPL CODE_01ABA1
                      INY
CODE_01ABAA:          LDA.B #$02
                      STA.W SmokeSpriteNumber,Y
                      LDA.B PlayerXPosNext
                      STA.W SmokeSpriteXPos,Y
                      LDA.W PlayerRidingYoshi
...
SubSprYPosNoGrvty:    LDA.B SpriteYSpeed,X                      ; Load current sprite's Y speed
                    ...
                    + PLP
                      ...
                      PLP
                      ADC.B #$00
CODE_01AC09:          STA.W SpriteXMovement
                      RTS
...
SubOffscreen0Bnk1:    STZ.B _3                                  ; /
                    ...
                    + LDA.B _0
                      BPL Return01ACA4
OffScrEraseSprite:    LDA.B SpriteNumber,X                      ; \ If MagiKoopa...
                      CMP.B #$1F                                ; |
...
VerticalLevel:        LDA.W SpriteTweakerD,X                    ; \ If "process offscreen" flag is set, return
                      AND.B #$04                                ; |
                      BNE Return01ACA4                          ; /
...
CODE_01AD23:          INC.W RNGCalc+1
CODE_01AD26:          LDA.W RNGCalc+1
                      EOR.W RNGCalc
...
InitFlying_Block:     LDA.B SpriteXPosLow,X
                      LSR A
                      LSR A
                      LSR A
                      LSR A
...
Flying_Block:         LDA.W SpriteMisc163E,X
                      BEQ +
...
CODE_01ADE8:          LDA.B #$F4
                      STA.B SpriteXSpeed,X
                    + JSR SubSprXPosNoGrvty
                      LDA.W SpriteXMovement
                      STA.W SpriteMisc1528,X
                      INC.W SpriteMisc1570,X
CODE_01ADF8:          JSR SubSprSprInteract
                      JSR CODE_01B457
                      JSR SubOffscreen0Bnk1
                      LDA.W SpriteMisc1558,X
                      CMP.B #$08
...
PalaceSwitch:         JSL CODE_02CD2D
                      RTS

InitThwomp:           LDA.B SpriteYPosLow,X
                      STA.W SpriteMisc151C,X
                      LDA.B SpriteXPosLow,X
                      CLC
                      ADC.B #$08
...
CODE_01AEC3:          LDA.W SpriteOffscreenVert,X
                      BNE CODE_01AEEE
                      LDA.W SpriteOffscreenX,X
                      BNE Return01AEF9
                      JSR SubHorizPos
...
CODE_01AEFA:          JSR SubSprYPosNoGrvty
                      LDA.B SpriteYSpeed,X
                      CMP.B #$3E
                      BCS +
                      ADC.B #$04
...
CODE_01AF24:          LDA.W SpriteMisc1540,X
                      BNE Return01AF3F
                      STZ.W SpriteMisc1528,X
                      LDA.B SpriteYPosLow,X
...
CODE_01AF64:          LDA.B _0
                      ...
                      LDA.B #$CA
                    + PLX
CODE_01AF8F:          STA.W OAMTileNo+$100,Y
                      INY
                      INY
                      INY
                      INY
...
CODE_01AFFC:          LDA.B #!SFX_BONK
                      STA.W SPCIO0                              ; / Play sound effect
                      LDA.B #$40
                      STA.W SpriteMisc1540,X
CODE_01B006:          LDA.B #$01
                      JMP SubSprGfx0Entry0

InitVerticalFish:     JSR FaceMario
                      INC.W SpriteMisc151C,X
Return01B011:         RTS
...
Fish:                 LDA.W SpriteStatus,X
                      CMP.B #$08
                      BNE CODE_01B03E
                      LDA.B SpriteLock
                      BEQ +
CODE_01B03E:          JMP CODE_01B10A
                    ...
                    + JSL GetRand
                      ...
                      BNE CODE_01B09C
                      JSR UpdateDirection
CODE_01B09C:          LDA.W SpriteMisc1602,X
                      CLC
                      ADC.B #$02
                      STA.W SpriteMisc1602,X
                      BRA CODE_01B0EA

CODE_01B0A7:          JSR CODE_019140
                      JSR UpdateDirection
                      ASL.W SpriteOBJAttribute,X
                      LSR.W SpriteOBJAttribute,X
                      LDA.W SpriteBlockedDirs,X
...
CODE_01B0C3:          LDA.B #$80
                    ...
                    + LDA.W DATA_01B01D,Y
                      ...
                      BNE CODE_01B0EA
                      JSR SubSprYPosNoGrvty
CODE_01B0EA:          JSR SubSprSprInteract
                      JSR MarioSprInteractRt
                      BCC CODE_01B10A
                      LDA.W SpriteInLiquid,X
                      BEQ CODE_01B107
...
CODE_01B107:          JSR CODE_01B12A
CODE_01B10A:          LDA.W SpriteMisc1602,X
                      LSR A
                      EOR.B #$01
                      STA.B _0
                      LDA.W SpriteOBJAttribute,X
...
CODE_01B14E:          LDA.B TrueFrame
                      AND.B #$03
CODE_01B152:          ORA.W SpriteOffscreenVert,X
                      ORA.B SpriteLock
                      BNE Return01B191
                      JSL GetRand
                      AND.B #$0F
...
JumpingFish:          LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE CODE_01B209                           ; /
                      LDA.W SpriteInLiquid,X
                      STA.W SpriteMisc151C,X
                      JSR SubUpdateSprPos
...
CODE_01B1DE:          DEC.B SpriteYSpeed,X
                      LDA.B TrueFrame
                      AND.B #$03
                      BNE +
                      DEC.B SpriteYSpeed,X
...
CODE_01B1EA:          INC.W SpriteMisc1570,X
                      INC.W SpriteMisc1570,X
                      CMP.W SpriteMisc151C,X
                      BEQ CODE_01B206
                      LDA.B #$10
                      ...
                      LDA.B #$D0
                      STA.B SpriteYSpeed,X
CODE_01B206:          JSR SetAnimationFrame
CODE_01B209:          JSR SubSprSpr_MarioSpr
                      JSR UpdateDirection
                      JMP CODE_01B10A
...
InitFloatSpkBall:     JSR FaceMario
                      LDY.W SpriteMisc157C,X
                      LDA.B SpriteXPosLow,X
                      AND.B #$10
                      BEQ +
...
InitFallingPlat:      INC.W SpriteMisc1602,X
InitOrangePlat:       LDA.W SpriteBuoyancy
...
InitChckbrdPlat:      INC.W SpriteMisc1602,X
                      RTS

CODE_01B262:          LDA.B #$01                                ; \ Sprite status = Initialization
                      STA.W SpriteStatus,X                      ; /
Return01B267:         RTS
...
Platforms:            JSR CODE_01B2D1
                      ...
                      LDA.B #$08
                    + STA.W SpriteMisc1540,X
CODE_01B2A5:          LDA.B SpriteNumber,X
                      CMP.B #$57
                      BCS CODE_01B2B0
                      JSR SubSprXPosNoGrvty
                      BRA +

CODE_01B2B0:          JSR SubSprYPosNoGrvty
...
CODE_01B2D1:          LDA.B SpriteNumber,X
                      SEC
                      SBC.B #$55
                      TAY
                      LDA.W DATA_01B2C3,Y
...
CODE_01B2DF:          JSR GetDrawInfoBnk1
                      LDA.W SpriteMisc1602,X
                      STA.B _1
                      LDA.B SpriteYPosLow,X
                      SEC
...
CODE_01B395:          JSR GetDrawInfoBnk1
                      PHY
                      LDY.B #$00
                      LDA.B SpriteNumber,X
                      CMP.B #$5E
                    ...
                    + PHA
                      ...
                      SBC.B Layer1XPos
                      PLX
CODE_01B3F6:          STA.W OAMTileXPos+$100,Y
                      CLC
                      ADC.B #$08
                      PHA
...
CODE_01B43A:          LDA.B #$CB
                      STA.W OAMTileNo+$110,Y
                      LDA.B #$E4
                      STA.W OAMTileNo+$10C,Y
CODE_01B444:          LDA.B #$08
                      LDY.B _0
                      BNE +
                      LDA.B #$04
                    + JMP CODE_01B37E
...
CODE_01B457:          JSR ProcessInteract
                      BCC CODE_01B4B2
                      LDA.B SpriteYPosLow,X
                      SEC
                      SBC.B Layer1YPos
...
CODE_01B4B4:          LDA.W SpriteTweakerF,X                    ; \ Branch if "Make Platform Passable" is set
                      LSR A                                     ; |
                      BCS CODE_01B4B2                           ; /
                      LDA.B #$00
...
OrangePlatform:       LDA.B SpriteTableC2,X
                      BEQ Platforms2
                      JSR CODE_01B2D1
                      LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE +                                     ; /
...
FloatingSpikeBall:    LDA.W SpriteStatus,X
                      CMP.B #$08
                      BEQ Platforms2
                      JMP CODE_01B666

Platforms2:           LDA.B SpriteLock
                      BEQ +
                      JMP CODE_01B64E
...
CODE_01B5A1:          SEC
                      SBC.B #$02
                      STA.B SpriteYSpeed,X
CODE_01B5A6:          LDA.B PlayerYSpeed
                      PHA
                      LDA.B SpriteNumber,X
                      CMP.B #$A4
                      BNE CODE_01B5B5
...
CODE_01B5B5:          JSR CODE_01B457
                    ...
                    + STY.B _0
                      ...
                      ADC.B #$02
                      STA.B SpriteYSpeed,X
CODE_01B5DA:          INC.W TileGenerateTrackA
                      LDA.B _0
                      CMP.B #$20
                      BCC CODE_01B5E7
                      LSR A
                      LSR A
                      STA.B SpriteYSpeed,X
CODE_01B5E7:          LDA.W TileGenerateTrackA
                      CMP.W SpriteMisc151C,X
                      STA.W SpriteMisc151C,X
                      BEQ CODE_01B610
                      LDA.W TileGenerateTrackA
...
CODE_01B610:          LDA.B #$01
                    ...
                    + SEC
                      SBC.B #$01
                      STA.B SpriteYSpeed,X
CODE_01B624:          LDY.W TileGenerateTrackA
                      BEQ +
                      LDY.B #$05
                      LDA.B Powerup
                      BNE +
                    ...
                    + STY.B _0
                      ...
                      PLA
                      STA.B SpriteYPosLow,X
CODE_01B64E:          JSR SubOffscreen0Bnk1
                      LDA.B SpriteNumber,X
                      CMP.B #$A4
                      BEQ CODE_01B666
                      JMP CODE_01B2D1
...
CODE_01B666:          JSR GetDrawInfoBnk1
                      PHX
                      LDX.B #$03
                    - LDA.B _0
                      CLC
...
TurnBlockBridge:      JSR SubOffscreen0Bnk1
                      JSR CODE_01B710
                      JSR CODE_01B852
                      JSR CODE_01B6B2
                      RTS

CODE_01B6B2:          LDA.B SpriteTableC2,X
                      AND.B #$01
                      TAY
                      LDA.W SpriteMisc151C,X
...
CODE_01B6D1:          LDA.W BlkBridgeTiming,Y
                      STA.W SpriteMisc1540,X
                      INC.B SpriteTableC2,X
                      RTS

HorzTurnBlkBridge:    JSR SubOffscreen0Bnk1
                      JSR CODE_01B710
                      JSR CODE_01B852
                      JSR CODE_01B6E7
                      RTS

CODE_01B6E7:          LDY.B SpriteTableC2,X
                      LDA.W SpriteMisc151C,X
                      CMP.W BlkBridgeLength,Y
                      BEQ CODE_01B703
                      LDA.W SpriteMisc1540,X
...
CODE_01B703:          LDA.W BlkBridgeTiming,Y
                      STA.W SpriteMisc1540,X
                      LDA.B SpriteTableC2,X
                      EOR.B #$01
                      STA.B SpriteTableC2,X
...
CODE_01B710:          JSR GetDrawInfoBnk1
                      STZ.B _0
                      STZ.B _1
                      STZ.B _2
                      STZ.B _3
...
CODE_01B7F0:          STA.W OAMTileSize+$40,X
                    + LDX.B #$00
...
CODE_01B852:          LDA.W SpriteWayOffscreenX,X
                      BNE Return01B8B1
...
InitHorzNetKoopa:     JSR SubHorizPos
                      LDA.W HorzNetKoopaSpeed,Y
                      STA.B SpriteXSpeed,X
                      BRA +

InitVertNetKoopa:     INC.B SpriteTableC2,X
                      INC.B SpriteXSpeed,X
                      LDA.B #$F8
                      STA.B SpriteYSpeed,X
                    + LDA.B SpriteXPosLow,X
...
ClimbingKoopa:        LDA.W SpriteMisc1540,X
                      BEQ CODE_01B9FB
                      CMP.B #$30
                      BCC CODE_01B9A0
                      CMP.B #$40
                      ...
                      JSR FlipSpriteDir
                      JSR CODE_01BA7F
CODE_01B9A0:          JMP CODE_01BA37

CODE_01B9A3:          LDY.B SpriteYPosLow,X
                      PHY
                      LDY.W SpriteXPosHigh,X
                      PHY
                      LDY.B #$00
                      CMP.B #$38
                      BCC +
...
CODE_01B9FB:          LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE CODE_01BA53                           ; /
                      JSR CODE_019140
                      LDY.B SpriteTableC2,X
                      LDA.W SpriteBlockedDirs,X
                      AND.W DATA_01B97D,Y
                      BEQ CODE_01BA14
CODE_01BA0C:          JSR FlipSpriteDir
                      JSR CODE_01BA7F
                      BRA CODE_01BA37

CODE_01BA14:          LDA.W SprMap16TouchVertLow
                      LDY.B SpriteYSpeed,X
                      BEQ CODE_01BA27
                      BPL CODE_01BA1F
                      BMI CODE_01BA2A
CODE_01BA1F:          CMP.B #$07
                      BCC CODE_01BA0C
                      CMP.B #$1D
                      BCS CODE_01BA0C
CODE_01BA27:          LDA.W SprMap16TouchHorizLow
CODE_01BA2A:          CMP.B #$07
                      BCC CODE_01BA32
                      CMP.B #$1D
                      BCC CODE_01BA37
CODE_01BA32:          LDA.B #$50
                      STA.W SpriteMisc1540,X
CODE_01BA37:          LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE CODE_01BA53                           ; /
                      INC.W SpriteMisc1570,X
                      JSR UpdateDirection
                      LDA.B SpriteTableC2,X
...
CODE_01BA4A:          JSR SubSprYPosNoGrvty
                    + JSR MarioSprInteractRt
                      JSR SubOffscreen0Bnk1
CODE_01BA53:          LDA.W SpriteMisc157C,X
                      PHA
                      LDA.W SpriteMisc1570,X
                      AND.B #$08
                      LSR A
...
CODE_01BA7F:          LDA.B SpriteYSpeed,X
                      EOR.B #$FF
                      INC A
                      STA.B SpriteYSpeed,X
                      RTS

InitClimbingDoor:     LDA.B SpriteXPosLow,X
                      CLC
                      ADC.B #$08
                      STA.B SpriteXPosLow,X
                      LDA.B SpriteYPosLow,X
...
ClimbingDoor:         JSR SubOffscreen0Bnk1
                      LDA.W SpriteMisc154C,X
                      CMP.B #$01
                      BNE +
                    ...
                    - %LorW_X(LDA,DATA_01BAB7)
                      ...
                      LDY.B _3
                      LDX.B #$08
CODE_01BBD0:          LDA.B SpriteProperties
                      ORA.B #$09
                      CPX.B #$06
                      BCS +
                      ORA.B #$40
...
CODE_01BC1D:          LDA.B PlayerXPosNext                      ; \ $00 = Mario X Low
                      STA.B _0                                  ; /
...
MagikoopasMagic:      LDA.B SpriteLock
                      BEQ +
                      JMP CODE_01BCBD
                    ...
                    + STY.B SpriteNumber,X
                      ...
                      STA.W SpriteXPosHigh,X                    ; \ Sprite Y position = block Y position
                      ...
                      JSL GenerateTile
CODE_01BCB9:          JSR CODE_01BD98
                      RTS

CODE_01BCBD:          JSR SubSprSpr_MarioSpr
                      LDA.B TrueFrame
                      LSR A
                      LSR A
                      AND.B #$03
...
MagiKoopasMagicGfx:   JSR GetDrawInfoBnk1
                      LDA.B EffFrame
                      LSR A
                      AND.B #$0F
                      STA.B _3
...
CODE_01BD98:          LDY.B #$03
CODE_01BD9A:          LDA.W SmokeSpriteNumber,Y
                      BEQ CODE_01BDA3
                      DEY
                      BPL CODE_01BD9A
                      RTS

CODE_01BDA3:          LDA.B #$01
                      STA.W SmokeSpriteNumber,Y
                      LDA.B SpriteXPosLow,X
                      STA.W SmokeSpriteXPos,Y
                      LDA.B SpriteYPosLow,X
...
CODE_01BDBA:          CPY.W CurSpriteProcess
                      BEQ +
                      LDA.W SpriteStatus,Y
                      BEQ +
                      LDA.W SpriteNumber,Y
...
CODE_01BDF2:          LDA.W SpriteWillAppear
                      BEQ +
                      STZ.W SpriteStatus,X
                      RTS
...
CODE_01BE6E:          STZ.W SpriteOnYoshiTongue,X
                      JSR SubSprSpr_MarioSpr
                      JSR SubHorizPos
                      TYA
                      STA.W SpriteMisc157C,X
...
CODE_01BF16:          JSR CODE_01BFE3
                      JSR SubSprGfx1
                      RTS

CODE_01BF1D:          LDY.B #$09
CODE_01BF1F:          LDA.W SpriteStatus,Y
                      BEQ CODE_01BF28
                      DEY
                      BPL CODE_01BF1F
                      RTS

CODE_01BF28:          LDA.B #!SFX_MAGIC                         ; \ Play sound effect
                      STA.W SPCIO0                              ; /
                      LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,Y                      ; /
...
CODE_01BF6A:          STA.B _1                                  ;FILLS OUT RAM TO USE FOR SPEED?
                      PHX
                      PHY
                      JSR CODE_01AD42
                      STY.B _2
...
CODE_01BFE3:          LDA.W SpriteMisc1540,X
                      BNE Return01C000
                      LDA.B #$02
                      STA.W SpriteMisc1540,X
...
CODE_01C004:          LDA.W SpriteMisc1540,X
                      BNE CODE_01C05E
                      LDA.B #$04
                      STA.W SpriteMisc1540,X
                      INC.W SpriteMisc1570,X
...
CODE_01C028:          LDA.W SpriteMisc1570,X
                      DEC A
                      ASL A
                      ASL A
                      ASL A
...
CODE_01C05E:          LDX.W CurSpriteProcess                    ; X = Sprite index
                      RTS
...
InitGoalTape:         LDA.B SpriteXPosLow,X
                      SEC
                      SBC.B #$08
                      STA.B SpriteTableC2,X
                      LDA.W SpriteYPosHigh,X
                      ...
                      LDA.B SpriteYPosLow,X
                      STA.W SpriteMisc1528,X
                      LDA.W SpriteXPosHigh,X                    ; \ Save extra bits into $187B,x
                      STA.W SpriteMisc187B,X                    ; /
...
CODE_01C125:          STZ.W SpriteTweakerE,X
                    + JSL TriggerGoalTape
Return01C12C:         RTS

CODE_01C12D:          LDA.W SpriteMisc160E,X
                      BNE +
                      JSR GetDrawInfoBnk1
                      LDA.B _0
                      SEC
...
GrowingVine:          LDA.B SpriteProperties
                      PHA
                      LDA.W SpriteMisc1540,X
                      CMP.B #$20
                      BCC +
                    ...
                    + STA.W OAMTileNo+$100,Y
                      ...
                      LDA.W SpriteXPosHigh,X
                      BPL CODE_01C1CB
CODE_01C1C8:          JMP OffScrEraseSprite

CODE_01C1CB:          LDA.B SpriteYPosLow,X
                      AND.B #$0F
                      CMP.B #$00
                      BNE Return01C1ED
...
BalloonKeyFlyObjs:    LDA.W SpriteStatus,X
                      CMP.B #$0C
                      BEQ CODE_01C255
                      LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE CODE_01C255                           ; /
                    ...
                    + LDA.B #$0C
                      ...
                      JSR SubOffscreen0Bnk1
                      INC.W SpriteMisc1570,X
CODE_01C255:          LDA.B SpriteNumber,X
                      CMP.B #$7D
                      BNE CODE_01C262
                      LDA.B #$01
                      STA.W SpriteMisc157C,X
...
CODE_01C262:          LDA.B SpriteTableC2,X
                      CMP.B #$02
                      BNE CODE_01C27C
                      LDA.B TrueFrame
                      AND.B #$03
                    ...
                    + LDA.B EffFrame
                      ...
                      EOR.W SpriteOBJAttribute,X
                      STA.W SpriteOBJAttribute,X
CODE_01C27C:          JSR CODE_019E95
CODE_01C27F:          LDA.B SpriteTableC2,X
                      BEQ +
                      JSR GetDrawInfoBnk1
                      RTS
...
CODE_01C2A6:          CMP.B #$7F
                      BNE CODE_01C2AF
                      JSR GiveMario1Up
                      BRA ADDR_01C30F

CODE_01C2AF:          CMP.B #$80
                      BNE CODE_01C2CE
                      LDA.B PlayerYSpeed
                      BMI Return01C2D2
                      LDA.B #$09                                ; \ Sprite status = Carryable
...
CODE_01C2CE:          CMP.B #$7D
                      BEQ +
Return01C2D2:         RTS

                    + LDY.B #$0B
CODE_01C2D5:          LDA.W SpriteStatus,Y
                      CMP.B #$0B
                      BNE +
                      LDA.W SpriteNumber,Y
                      CMP.B #$7D
...
ADDR_01C30F:          STZ.W SpriteStatus,X
                      RTS
...
FireFlower:           LDA.B EffFrame                            ; \ Flip flower every 8 frames
                      AND.B #$08                                ; |
                      LSR A                                     ; |
                      LSR A                                     ; |
                      LSR A                                     ; | ($157C,x = 0 or 1)
                      STA.W SpriteMisc157C,X                    ; /
PowerUpRt:            LDA.W SpriteMisc160E,X
                      BEQ +
                      JSR SubSprGfx2Entry1
                      LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
...
CODE_01C38F:          LDA.W SpriteMisc1540,X
                      BEQ CODE_01C3AE
                      JSR CODE_019140
                      LDA.W SpriteMisc1528,X
                      BNE +
                    ...
                    + LDA.B SpriteLock                          ; \ Branch if sprites locked
                      ...
                      STA.B SpriteYSpeed,X
                      JSR SubSprYPosNoGrvty
CODE_01C3AB:          JMP CODE_01C48D

CODE_01C3AE:          LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE CODE_01C3AB                           ; /
                      LDA.W SpriteStatus,X
                      CMP.B #$0C
                      BEQ CODE_01C3AB
...
CODE_01C3F3:          LDA.W IRQNMICommand
                      CMP.B #$C1
                      BEQ CODE_01C42C
                      BIT.W IRQNMICommand
                      BVC CODE_01C42C
...
CODE_01C42C:          JSR SubUpdateSprPos
                    + LDA.B TrueFrame
                      AND.B #$03
                      BEQ CODE_01C437
                      DEC.B SpriteYSpeed,X
CODE_01C437:          JSR SubOffscreen0Bnk1
                      JSR IsTouchingCeiling
                      BEQ +
                      LDA.B #$00
                      STA.B SpriteYSpeed,X
...
CODE_01C44A:          LDA.B SpriteNumber,X
                      CMP.B #$21                                ; sprite coin
                      BNE CODE_01C46C
                      JSR CODE_018DBB
                      LDA.B SpriteYSpeed,X
...
CODE_01C46C:          JSR SetSomeYSpeed__
                      LDA.W SpriteMisc151C,X
                      BNE CODE_01C47A
                      LDA.B SpriteNumber,X
                      CMP.B #$76                                ; star
                      BNE CODE_01C47E
CODE_01C47A:          LDA.B #$C8
                      STA.B SpriteYSpeed,X
CODE_01C47E:          LDA.W SpriteMisc1558,X
                      ORA.B SpriteTableC2,X
                      BNE CODE_01C48D
                      JSR IsTouchingObjSide
                      BEQ CODE_01C48D
                      JSR FlipSpriteDir
CODE_01C48D:          LDA.W SpriteMisc1540,X
                      CMP.B #$36
                      BCS CODE_01C4A8
                      LDA.B SpriteTableC2,X
                      BEQ CODE_01C49C
...
CODE_01C4AC:          JSR CODE_01A80F
                      BCC -
                      LDA.W SpriteMisc151C,X
                      BEQ CODE_01C4BA
                      LDA.B SpriteTableC2,X
                      BNE Return01C4FA
CODE_01C4BA:          LDA.W SpriteMisc154C,X
                      BNE Return01C4FA
CODE_01C4BF:          LDA.W SpriteMisc1540,X
                      CMP.B #$18
                      BCS Return01C4FA
                      STZ.W SpriteStatus,X
                      LDA.B SpriteNumber,X
...
CODE_01C4E0:          LDA.W SilverCoinsCollected
                      INC.W SilverCoinsCollected
                      CMP.B #$0A
                      BCC +
                      LDA.B #$0A
                    + JSL GivePoints
CODE_01C4F0:          LDY.B #$03
CODE_01C4F2:          LDA.W SmokeSpriteNumber,Y
                      BEQ CODE_01C4FB
                      DEY
                      BPL CODE_01C4F2
Return01C4FA:         RTS

CODE_01C4FB:          LDA.B #$05
                      STA.W SmokeSpriteNumber,Y
                      LDA.B SpriteXPosLow,X
                      STA.W SmokeSpriteXPos,Y
                      LDA.B SpriteYPosLow,X
...
CODE_01C580:          LDA.B #$FF                                ; \ Set star timer
...
CODE_01C5AE:          LDA.B PlayerYPosScrRel+1
                      ...
                      LDY.B #$03
CODE_01C5BF:          LDA.W SmokeSpriteNumber,Y
                      BEQ CODE_01C5D4
                      DEY
                      BPL CODE_01C5BF
...
CODE_01C61A:          JSR GetDrawInfoBnk1
                      STZ.B _A
...
CoinSprGfx:           JSR CoinSprGfxSub
                      RTL

CoinSprGfxSub:        JSR GetDrawInfoBnk1
                      LDA.B _0
                      STA.W OAMTileXPos+$100,Y
                      LDA.B _1
                      STA.W OAMTileYPos+$100,Y
...
Feather:              LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE CODE_01C744                           ; /
                      LDA.B SpriteTableC2,X
                      BEQ CODE_01C701
                      JSR CODE_019140
...
CODE_01C701:          LDA.W SpriteStatus,X
                      CMP.B #$0C
                      BEQ CODE_01C744
                      LDA.W SpriteMisc154C,X
                      BEQ +
                    ...
                    + LDA.W DATA_01C6EA,Y
                      ...
                      JSR SubSprXPosNoGrvty
                      JSR SubSprYPosNoGrvty
CODE_01C741:          JSR UpdateDirection
CODE_01C744:          JSR CODE_01C4AC
                      JMP CODE_01C61A
...
BrownChainedPlat:     JSR SubOffscreen2Bnk1
                      LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE CODE_01C795                           ; /
                      LDA.B TrueFrame
                      AND.B #$03
...
CODE_01C795:          LDA.W SpriteMisc151C,X
                      PHA
                      LDA.W SpriteMisc1528,X
                      PHA
                      LDA.B #$00
...
CODE_01C9DA:          LDA.W SpriteMisc160E,X
                      BEQ +
...
CODE_01C9EC:          LDA.W BrSwingPlatXPos+1
                      XBA
                      LDA.W BrSwingPlatXPos
                      REP #$20                                  ; A->16
                      SEC
...
CODE_01CA9C:          LDA.W BrSwingPlatXPos
                      SEC
                      SBC.B #$18
                      STA.B _4
...
CODE_01CB20:          LDA.B Mode7Angle+1
...
CODE_01CCEC:          EOR.B #$FF
                      INC A
                      RTS

CODE_01CCF0:          LDA.W SpriteMisc1504,X
                      ASL A
                      ASL A
                      ASL A
                      ASL A
...
PipeKoopaKids:        JSL CODE_03CC09
                      RTS

InitKoopaKid:         LDA.B SpriteYPosLow,X
                      LSR A
                      LSR A
                      LSR A
                      LSR A
...
CODE_01CDA7:          JSR GetDrawInfoBnk1
                      RTS

WallKoopaKids:        STZ.W PlayerIsFrozen
                      LDA.W SpriteMisc1602,X
                      CMP.B #$1B
                      BCS CODE_01CDD5
                      LDA.W SpriteMisc15AC,X
                    ...
                    + STA.B _0
                      ...
                      CLC
                      ADC.B _0
CODE_01CDD5:          STA.W Mode7TileIndex
                      JSL CODE_03DEDF
                      JSR CODE_01CDA7
                      LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE Return01CE3D                          ; /
...
CODE_01CE1E:          LDA.W SpriteMisc187B,X
                      CMP.B #$01
                      BNE +
...
CODE_01CE3E:          STZ.B PlayerXSpeed
                      JSR SubSprYPosNoGrvty
                      LDA.B SpriteYSpeed,X
                      CMP.B #$40
                      BPL +
...
CODE_01CE5F:          LDA.B SpriteTableC2,X
                      JSL ExecutePtr
...
CODE_01CE6B:          LDA.W SpriteMisc1528,X
                      JSL ExecutePtr
...
CODE_01CEA5:          INC.W SpriteMisc1528,X
CODE_01CEA8:          LDA.B #$FF
                      STA.W SpriteMisc1540,X
                      RTS
...
CODE_01CEB6:          LDA.W SpriteMisc1540,X
                      BNE +
                      JSR SubHorizPos
                      TYA
                      CMP.W SpriteYPosHigh,X
                      BNE +
                      INC.W SpriteMisc1528,X
                      LDA.W DATA_01CEB4,Y
                      STA.W SpriteMisc160E,X
...
CODE_01CEFD:          LDA.W SpriteMisc1540,X
                      BEQ CODE_01CF1C
                      DEC A
                      BNE +
...
CODE_01CF1C:          JSR CODE_01D0C0
                    ...
                    + JSR SubSprXPosNoGrvty
                      ...
                      CMP.B #$70
                      BCS CODE_01CF44
CODE_01CF42:          INC.B SpriteYSpeed,X
CODE_01CF44:          LDA.W SpriteMisc1558,X
                      BNE CODE_01CF4F
                      LDA.B Mode7Angle
                      ORA.B Mode7Angle+1
                      BEQ CODE_01CF67
CODE_01CF4F:          LDA.B SpriteXSpeed,X
                      ASL A
                      LDA.B #$04
                      LDY.B #$00
                      BCC +
...
CODE_01CF7D:          JSR SubSprYPosNoGrvty
                      INC.B SpriteYSpeed,X
                      JSR CODE_01D0C0
                      LDA.W SpriteMisc1540,X
                      BEQ CODE_01CFB7
...
CODE_01CFC6:          INC.W SpriteMisc1626,X
                      LDA.W SpriteMisc1626,X
                      CMP.B #$03
                      BCC +
CODE_01CFD0:          LDA.B #!SFX_BOSSDEAD                      ; \ Play sound effect
                      STA.W SPCIO0                              ; /
                      LDA.B #$04
                      STA.W SpriteMisc151C,X
                      LDA.B #$13
...
CODE_01CFE0:          LDY.W SpriteMisc1540,X
                      BEQ CODE_01CFFC
                      LDA.B SpriteYPosLow,X
                      SEC
                      SBC.B #$01
...
CODE_01D043:          LDA.W SpriteMisc1540,X
                      BNE +
                      INC.W CutsceneID
                      DEC.W EndLevelTimer
                      LDA.B #!BGM_BOSSCLEAR
...
CODE_01D059:          LDA.B #!SFX_FIRESPIT                      ; \ Play sound effect
                      STA.W SPCIO3                              ; /
                      LDY.B #$04
CODE_01D060:          LDA.W SpriteStatus,Y
                      BEQ CODE_01D069
                      DEY
                      BPL CODE_01D060
                      RTS

CODE_01D069:          LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,Y                      ; /
                      LDA.B #$34
                      STA.W SpriteNumber,Y
                      LDA.B SpriteXPosLow,X
...
CODE_01D0C0:          LDA.B SpriteYSpeed,X
                      BMI +
                      LDA.W SpriteXPosHigh,X
                      BNE +
                      LDA.B Mode7YScale
...
CODE_01D116:          LDA.W SpriteMisc1528,X
                      JSL ExecutePtr
...
CODE_01D1AE:          CMP.W SpriteMisc160E,X
                      BCS CODE_01D215
                      BRA CODE_01D1D8

CODE_01D1B5:          LDA.W SpriteMisc157C,X
                      BNE +
                      INY
                      INY
                      INY
...
ADDR_01D1D3:          CMP.W DATA_01D13E,Y
                      BCS CODE_01D215
CODE_01D1D8:          LDA.W SpriteMisc1626,X
                      CMP.B #$02
                      BCC +
                      LDA.B #$02
                    + ASL A
...
CODE_01D215:          LDY.W SpriteMisc157C,X
                      LDA.W SpriteMisc1594,X
                      CLC
                      ADC.W DATA_01D23D,Y
                      AND.B #$03
                      STA.W SpriteMisc1594,X
CODE_01D224:          LDY.W SpriteMisc157C,X
                      LDA.B Mode7Angle
                      CLC
                      ADC.W DATA_01D239,Y
                      STA.B Mode7Angle
...
CODE_01D23F:          LDA.W SpriteMisc1540,X
                      BEQ CODE_01D25E
                      CMP.B #$01
                      BNE Return01D2A7
                      STZ.W SpriteMisc1528,X
...
CODE_01D2A8:          LDA.W SpriteMisc151C,X
                      CMP.B #$03
                      BCS Return01D318
                      LDA.W SpriteMisc187B,X
                      CMP.B #$03
                      ...
                      CMP.B #$03
                      BCS Return01D318
CODE_01D2BD:          JSL GetMarioClipping
                      JSR CODE_01D40B
                      JSL CheckForContact
                      BCC Return01D318
                      LDA.W SpriteMisc1FE2,X
                      ...
                      CMP.B #$06
                      BCS ADDR_01D31E
CODE_01D2E3:          LDA.B PlayerYPosNext
                      CLC
                      ADC.B #$08
                      CMP.B SpriteYPosLow,X
                      BCS ADDR_01D31E
...
CODE_01D319:          JSL HurtMario
Return01D31D:         RTS

ADDR_01D31E:          LDA.B #!SFX_BONK                          ; \ Play sound effect
                      STA.W SPCIO0                              ; /
                      LDA.B PlayerYSpeed
                      BPL +
                      LDA.B #$10
...
CODE_01D334:          LDA.B #!SFX_BONK                          ; \ Play sound effect
                      STA.W SPCIO0                              ; /
                      LDA.B PlayerYSpeed
                      BPL +
                      LDA.B #$20
...
CODE_01D351:          LDA.B SpriteXPosLow,X
                      PHA
                      SEC
                      SBC.B #$08
                      STA.B SpriteXPosLow,X
...
CODE_01D3B1:          LDA.W SpriteMisc151C,X
                      CMP.B #$03
                      BCS Return01D40A
                      LDY.B #$0A
CODE_01D3BA:          STY.W SpriteInterIndex
...
CODE_01D40B:          LDA.B SpriteXPosLow,X
                      SEC
                      SBC.B #$08
                      STA.B _4
                      LDA.W SpriteYPosHigh,X
...
BossFireball:         LDA.B SpriteLock
                    ...
                    + JSR SubSprXPosNoGrvty
                      ...
                      BCC CODE_01D487
                      STZ.W SpriteStatus,X
CODE_01D487:          JSR GetDrawInfoBnk1
                      LDA.W SpriteMisc1602,X
                      ASL A
                      STA.B _3
                      LDA.W SpriteMisc157C,X
...
ParachuteSprites:     LDA.W SpriteStatus,X
                      CMP.B #$08
                      BEQ +
                      JMP CODE_01D671
...
CODE_01D558:          JSR SubOffscreen0Bnk1
                      JMP CODE_01D5B3
...
CODE_01D5B3:          STZ.W TileGenerateTrackA
                      LDY.B #$F0
                      LDA.W SpriteMisc1540,X
                      BEQ +
                      LSR A
                    ...
                    + LDY.W SpriteMisc1602,X
                      ...
                      LDA.B #$80
                      STA.W SpriteMisc1540,X
CODE_01D671:          LDA.B SpriteNumber,X
                      SEC
                      SBC.B #$3F
                      TAY
                      LDA.W DATA_01D5AE,Y
...
InitLinePlat:         LDA.B SpriteXPosLow,X
                      AND.B #$10
                      EOR.B #$10
                      STA.W SpriteMisc1602,X
                      BEQ +
...
InitLineGuidedSpr:    INC.W SpriteMisc187B,X
                      LDA.B SpriteXPosLow,X
                      AND.B #$10
                      BNE CODE_01D707
                      LDA.B SpriteXPosLow,X
...
CODE_01D707:          INC.W SpriteMisc157C,X
                      LDA.B SpriteXPosLow,X
                      CLC
                      ADC.B #$0F
                      STA.B SpriteXPosLow,X
...
LineGrinder:          LDA.B TrueFrame
                      ...
                      STA.W SPCIO1                              ; /
LineFuzzy_Plats:      JMP CODE_01D9A7

CODE_01D74D:          JSR SubOffscreen1Bnk1
                      LDA.W SpriteMisc1540,X
                      BNE CODE_01D75C
                      LDA.B SpriteLock
                      ORA.W SpriteMisc1626,X
                      BNE Return01D6EC
CODE_01D75C:          LDA.B SpriteTableC2,X
                      JSL ExecutePtr
...
CODE_01D768:          LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE Return01D791                          ; /
                      LDA.W SpriteMisc157C,X
                      BNE CODE_01D792
                      LDY.W SpriteMisc1534,X
...
CODE_01D792:          LDY.W SpriteMisc1570,X
                      DEY
                      JSR CODE_01D7B0
                      DEC.W SpriteMisc1570,X
                      BEQ CODE_01D7AD
                      ...
                      DEC.W SpriteMisc1570,X
                      BNE +
CODE_01D7AD:          STZ.B SpriteTableC2,X
                    + RTS

CODE_01D7B0:          PHB                                       ; Sprites calling this routine must be modified
...
CODE_01D7F1:          JMP CODE_01D89F

CODE_01D7F4:          LDY.B #$03
CODE_01D7F6:          STY.W SpriteInterIndex
                      LDA.B SpriteXPosLow,X
                      CLC
                      ADC.W DATA_01D7E1,Y
                      STA.B _2
                      ...
                      CMP.B _5
                      BEQ CODE_01D861
CODE_01D83A:          JSR CODE_01D94D                           ;WIERD ROUTINE INVOLVING POSITIONS.  ALL VARIABLES SET ABOVE...
                      BNE CODE_01D7F1
                      ...
                      BEQ CODE_01D861
                      BNE CODE_01D856
CODE_01D851:          LDA.W OnOffSwitch
                      BNE CODE_01D861
CODE_01D856:          LDA.W Map16TileNumber
                      CMP.B #$76
                      BCC CODE_01D861
                      CMP.B #$9A
                      BCC CODE_01D895
CODE_01D861:          LDY.W SpriteInterIndex
                      DEY
                      BPL CODE_01D7F6
                      LDA.B SpriteTableC2,X
...
CODE_01D895:          PHA
                      ...
                      CMP.B #$96
                      BCC CODE_01D8A4
CODE_01D89F:          LDY.W SpriteMisc160E,X
                      BRA +

CODE_01D8A4:          LDA.B SpriteYPosLow,X
                      STA.B _8
                      LDA.W SpriteXPosHigh,X
                      STA.B _9
                      LDA.B SpriteXPosLow,X
...
CODE_01D8FF:          LDA.B SpriteXPosLow,X
                    + AND.B #$0F
                      CMP.B #$0A
                      BCC +
                      LDA.B SpriteTableC2,X
...
CODE_01D9A7:          LDA.B SpriteNumber,X                      ;LINE GUIDE PLATFORM FUZZY
...
CODE_01D9BA:          CMP.B #$67
                      BNE CODE_01D9C6
                      JSR CODE_01DC0B
CODE_01D9C1:          JSR MarioSprInteractRt
                      BRA +

CODE_01D9C6:          JSR MarioSprInteractRt
                      JSL CODE_03C263
                    + JMP CODE_01D74D

CODE_01D9D0:          JMP CODE_01DAA2

CODE_01D9D3:          JSR CODE_01DC54
                      LDA.B SpriteXPosLow,X
                      PHA
                      LDA.B SpriteYPosLow,X
                      PHA
                      ...
                      JSR CODE_01A80F
                      BCS CODE_01DA0A
CODE_01D9FE:          LDA.W SpriteMisc163E,X
                      BEQ Return01DA09
                      STZ.W SpriteMisc163E,X
                      STZ.W PlayerClimbingRope
Return01DA09:         RTS

CODE_01DA0A:          LDA.W SpriteStatus,X
                      BEQ CODE_01DA37
                      LDA.W CarryingFlag                        ; \ Branch if carrying an enemy...
...
CODE_01DA2F:          BIT.B byetudlrFrame
                      BPL +
                      LDA.B #$B0
                      STA.B PlayerYSpeed
CODE_01DA37:          STZ.W PlayerClimbingRope
                      LDA.B #$10
                      STA.W SpriteMisc154C,X
                    + LDY.B #$00
                      LDA.W TileGenerateTrackA
...
CODE_01DA7F:          LDA.B #$01
                    + JSR CODE_01DA90
CODE_01DA84:          LDA.W SpriteMisc1626,X
                      BEQ Return01DA8F
                      STZ.W SpriteMisc1626,X
                      STZ.W SpriteMisc1540,X
Return01DA8F:         RTS

CODE_01DA90:          LDY.B #$00
                      CMP.B #$00
                      BPL +
                      DEY
                    + CLC
...
CODE_01DAA2:          LDY.B #$18                                ;LINE GUIDED PLATFORM CODE
                      LDA.W SpriteMisc1602,X
                      BEQ +
...
CODE_01DB44:          LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE +                                     ; /
                      JSR SubUpdateSprPos
                      LDA.W SpriteMisc1540,X
                      BNE +
...
CODE_01DBA2:          JSR GetDrawInfoBnk1
                      PHX
                      LDX.B #$03
                    - LDA.B _0
                      CLC
                      ...
                      DEX
                      BPL -
CODE_01DBD0:          LDA.B #$03
                      BRA +

CODE_01DBD4:          JSR SubSprGfx2Entry1
                      LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
                      LDA.W OAMTileXPos+$100,Y
                      SEC
                      SBC.B #$08
                      ...
                      LDA.B #$00
                    + PLX
CODE_01DC04:          LDY.B #$02
                      JMP FinishOAMWriteRt


DATA_01DC09:          db $05,$45

CODE_01DC0B:          JSR GetDrawInfoBnk1
                      PHX
                      LDX.B #$03
                    - LDA.B _0
                      CLC
...
CODE_01DC54:          JSR GetDrawInfoBnk1
                      LDA.B _0
                      SEC
                      SBC.B #$08
                      STA.B _0
...
InitBonusGame:        LDA.W DisableBonusSprite
                      BEQ +
                      STZ.W SpriteStatus,X
                      RTS

                    + LDX.B #$09
CODE_01DDB7:          LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,X                      ; /
                      LDA.B #$82
                      STA.W SpriteNumber,X
...
BonusGame:            STZ.W SpriteOffscreenX,X
                      CPX.B #$01
                      BNE +
                      JSR CODE_01E26A
                    + JSR CODE_01DF19
...
Return01DE40:         RTS
                    ...
                    + CLC
                      ...
                      LDA.B #$10
                      STA.W SpriteMisc1540,X
CODE_01DE8C:          LDY.W SpriteMisc157C,X
                      BMI Return01DEAF
                      LDA.B SpriteXPosLow,X
                      CMP.W DATA_01DE19,Y
                      BNE CODE_01DE9F
                      ...
                      CMP.W DATA_01DE1D,Y
                      BEQ +
CODE_01DE9F:          LDA.W DATA_01DE11,Y
                      STA.B SpriteXSpeed,X
                      LDA.W DATA_01DE15,Y
                      STA.B SpriteYSpeed,X
                      JSR SubSprXPosNoGrvty
...
Return01DEAF:         RTS
                    ...
                    + LDY.B #$09
CODE_01DEB2:          LDA.W SpriteTableC2,Y
                      BEQ CODE_01DED7
                      LDA.W SpriteYPosLow,Y
                      CLC
                      ADC.B #$04
...
CODE_01DED7:          LDA.W SpriteMisc157C,X
                      INC A
                      AND.B #$03
                      TAY
                      STA.W SpriteMisc157C,X
...
CODE_01DF19:          LDA.W SpriteMisc1540,X
                      LSR A
                      TAY
                      LDA.W DATA_01DF10,Y
                      STA.B _0
...
CODE_01DFD9:          LDA.B #$07
                      STA.B _0
CODE_01DFDD:          LDX.B #$02
CODE_01DFDF:          STX.B _1
                      LDA.B _0
                      ASL A
                      ADC.B _0
                      CLC
                      ...
                      STA.B _3
                      LDY.B #$09
CODE_01DFFA:          LDA.W SpriteYPosLow,Y
                      CMP.B _2
                      BNE CODE_01E008
                      LDA.W SpriteXPosLow,Y
                      CMP.B _3
...
CODE_01E008:          DEY
                      CPY.B #$01
                      BNE CODE_01DFFA
CODE_01E00D:          LDA.W SpriteMisc1570,Y
                      STA.B _4,X
                      STY.B _7,X
                      DEX
                      BPL CODE_01DFDF
...
InitFireball:         LDA.B SpriteYPosLow,X
                      STA.W SpriteMisc1528,X
                      LDA.W SpriteXPosHigh,X
                      STA.W SpriteMisc151C,X
                    - LDA.B SpriteYPosLow,X
...
Fireballs:            STZ.W SpriteOnYoshiTongue,X
                      LDA.W SpriteMisc1540,X
                      BEQ CODE_01E0A7
                      STA.W SpriteOnYoshiTongue,X
                      DEC A
...
CODE_01E0A7:          LDA.B SpriteLock
                    ...
                    + STA.W SpriteOBJAttribute,X
                      ...
                      ADC.B #$60
                      STA.W SpriteMisc1540,X
CODE_01E0E2:          LDA.B SpriteYPosLow,X
                      SEC
                      SBC.W SpriteMisc1528,X
                      STA.B _0
                      LDA.W SpriteXPosHigh,X
...
CODE_01E106:          JSR SubSprYPosNoGrvty
                      LDA.B EffFrame
                      AND.B #$07
                      ORA.B SpriteTableC2,X
                      BNE +
...
CODE_01E125:          CLC
                      ADC.B #$02
                      STA.B SpriteYSpeed,X
CODE_01E12A:          JSR SubOffscreen0Bnk1
CODE_01E12D:          LDA.B SpriteTableC2,X
                      BEQ CODE_01E198
                      LDY.B SpriteLock
                      BNE CODE_01E164
...
CODE_01E151:          TXA
                    ...
                    + STY.B SpriteXSpeed,X
                      JSR SubSprXPosNoGrvty
CODE_01E164:          LDA.B SpriteYPosLow,X
                      CMP.B #$F0
                      BCC +
                      STZ.W SpriteStatus,X
                    + JSR SubSprGfx2Entry1
...
InitKeyHole:          LDA.B SpriteXPosLow,X
                      CLC
                      ADC.B #$08
                      STA.B SpriteXPosLow,X
                      LDA.W SpriteYPosHigh,X
...
Keyhole:              LDY.B #$0B
CODE_01E1CA:          LDA.W SpriteStatus,Y
                      CMP.B #$08
                      BCC CODE_01E1D8
                      LDA.W SpriteNumber,Y
                      CMP.B #$80
...
CODE_01E1D8:          DEY
                      BPL CODE_01E1CA
CODE_01E1DB:          LDA.W PlayerRidingYoshi
                      BEQ CODE_01E1E5
                      LDA.W YoshiHasKey
                      BNE CODE_01E1ED
CODE_01E1E5:          TYA
...
CODE_01E1ED:          JSL GetMarioClipping
                      BRA CODE_01E201

CODE_01E1F3:          LDA.W SpriteStatus,Y
                      CMP.B #$0B
                      BNE CODE_01E23A
                      PHX
                      TYX
                      JSL GetSpriteClippingB
                      PLX
CODE_01E201:          JSL GetSpriteClippingA
                      JSL CheckForContact
                      BCC CODE_01E23A
                      LDA.W SpriteMisc154C,X
                      BNE CODE_01E23A
                      ...
                      LDA.B #$30
                      STA.W SpriteMisc154C,X
CODE_01E23A:          JSR GetDrawInfoBnk1
                      LDA.B _0
                      STA.W OAMTileXPos+$100,Y
                      STA.W OAMTileXPos+$104,Y
                      LDA.B _1
...
CODE_01E281:          LDY.B #$07
CODE_01E283:          LDA.W ClusterSpriteNumber,Y
                      BEQ CODE_01E28C
                      DEY
                      BPL CODE_01E283
                      RTS

CODE_01E28C:          LDA.B #$01
...
MontyMole:            JSR SubOffscreen0Bnk1
                      LDA.B SpriteTableC2,X
                      JSL ExecutePtr
...
CODE_01E2E0:          JSR SubHorizPos
                      ...
                      LDA.B #$20
                    + STA.W SpriteMisc1540,X
CODE_01E305:          JSR GetDrawInfoBnk1
                      RTS

CODE_01E309:          LDA.W SpriteMisc1540,X
                      ORA.W SpriteOnYoshiTongue,X
                      BNE CODE_01E343
                      INC.B SpriteTableC2,X
                      LDA.B #$B0
                    ...
                    + JSR FaceMario
                      ...
                      STA.B Map16TileGenerate                   ; /
                      JSL GenerateTile
CODE_01E343:          LDA.B SpriteNumber,X
                      CMP.B #$4D
                      BNE +
                      LDA.B EffFrame
                      LSR A
...
CODE_01E3E9:          LDA.B #$01
                      STA.W SpriteMisc1602,X
                      RTS

CODE_01E3EF:          LDA.B SpriteProperties
                      PHA
                      LDA.W SpriteMisc1540,X
                      BEQ +
                      LDA.B #$10
...
DryBonesAndBeetle:    LDA.W SpriteStatus,X
                      CMP.B #$08
                      BEQ +
                      ASL.W SpriteOBJAttribute,X
                      SEC
...
CODE_01E4C0:          LDA.B SpriteLock
                    ...
                    + STA.B SpriteXSpeed,X
                      ...
                      AND.B #$03                                ; |
                      BEQ +                                     ; /
CODE_01E4ED:          STZ.B SpriteXSpeed,X
                    + JSR IsTouchingCeiling
                      BEQ +
                      STZ.B SpriteYSpeed,X                      ; Sprite Y Speed = 0
                    + JSR SubOffscreen0Bnk1
...
CODE_01E51E:          CMP.B #$30
                      ...
                      CMP.B #$31
                      BNE CODE_01E542
CODE_01E52D:          LDA.W SpriteMisc1540,X
                      BEQ CODE_01E542
                      CMP.B #$01
                      BNE +
                      JSL CODE_03C44E
...
CODE_01E557:          LDA.W SpriteMisc1570,X
                      AND.B #$7F
                      BNE +
                      JSR FaceMario
                    + BRA +

CODE_01E563:          STZ.W SpriteMisc1570,X
                      LDA.B SpriteNumber,X
                      CMP.B #$32
                      BNE +
                      LDA.B SpriteTableC2,X
...
CODE_01E598:          CMP.B #$30
                      ...
                      CMP.B #$31
                      BNE CODE_01E5B6
CODE_01E5A7:          LDA.W SpriteMisc1570,X
                      CLC
                      ADC.B #$40
                      AND.B #$7F
                      BNE CODE_01E5B6
                      LDA.B #$3F
                      STA.W SpriteMisc1540,X
CODE_01E5B6:          JSR CODE_01E5C4
                      JSR SubSprSprInteract
                      JSR FlipIfTouchingObj
CODE_01E5BF:          JSL CODE_03C390
                      RTS

CODE_01E5C4:          JSR MarioSprInteractRt
                      BCC Return01E610
                      LDA.B PlayerYPosNow
                      CLC
                      ADC.B #$14
                      ...
                      LDA.B PlayerYSpeed
                      BMI CODE_01E604
CODE_01E5DB:          LDA.B SpriteNumber,X
                      CMP.B #$31
                      BNE CODE_01E5EB
                      LDA.W SpriteMisc1540,X
                      SEC
...
CODE_01E69A:          LDA.B byetudlrHold
                      BPL +
CODE_01E69E:          LDA.B #$0B
                      STA.B PlayerInAir
                      LDY.B #$80
                    ...
                    + STY.B PlayerYSpeed
                      LDA.B #!SFX_SPRING                        ; \ Play sound effect
                      STA.W SPCIO3                              ; /
CODE_01E6AE:          BRA CODE_01E6F0

CODE_01E6B0:          JSR ProcessInteract
                      BCC CODE_01E6F0
...
CODE_01E6CE:          BIT.B byetudlrHold
                      BVC +
                      LDA.W CarryingFlag                        ; \ Branch if carrying an enemy...
                      ORA.W PlayerRidingYoshi                   ; | ...or if on Yoshi
                      BNE +                                     ; /
...
CODE_01E6E7:          LDA.B PlayerYSpeed
                      BMI CODE_01E6F0
                      LDA.B #$11
                      STA.W SpriteMisc1540,X
CODE_01E6F0:          LDY.W SpriteMisc1602,X
                      LDA.W DATA_01E6FD,Y
                      TAY
                      LDA.B #$02
...
SmushedGfxRt:         JSR GetDrawInfoBnk1
                      JSR IsSprOffScreen
                      BNE Return01E75A
...
PSwitch:              LDA.W SpriteMisc1564,X
                      CMP.B #$01
                      BNE +
...
LakituCloud:          LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BEQ +                                     ; /
CODE_01E7A8:          JMP LakituCloudGfx
...
CODE_01E7DB:          LDY.B #$09
CODE_01E7DD:          LDA.W SpriteStatus,Y
                      CMP.B #$08
                      BNE +
                      LDA.W SpriteNumber,Y
                      CMP.B #$1E
                    ...
                    + CLC
                      ...
                      LDA.B PlayerXSpeed
                      STA.B SpriteXSpeed,X
CODE_01E83D:          JMP LakituCloudGfx

CODE_01E840:          JSR LakituCloudGfx
                      PHB
                      LDA.B #$02
                      PHA
                      PLB
...
CODE_01E898:          PHY
                      ...
                      LDA.B #$10
                      STA.W SpriteMisc154C,X
LakituCloudGfx:       JSR GetDrawInfoBnk1
                      LDA.W SpriteOffscreenVert,X
                      BNE Return01E897
                      LDA.B #$F8
                      STA.B _C
...
CODE_01E98D:          LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE Return01E984                          ; /
                      JSR SubHorizPos
                      TYA
                      LDY.W SpriteMisc160E,X
...
CODE_01E9BD:          LDA.B TrueFrame
                    ...
                    + LDA.W SpriteMisc1534,X
                      ...
                      BNE CODE_01E9E6
                      INC.W SpriteMisc1534,X
CODE_01E9E6:          LDA.B SpriteXSpeed,X
                      PHA
...
CODE_01EA21:          JSL FindFreeSprSlot                       ; \ Return if no free slots
                      BMI Return01EA6F                          ; /
                      LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,Y                      ; /
...
CODE_01EA70:          LDX.W YoshiIsLoose
                      BEQ +
                      STZ.W ScrShakePlayerYOffset
                      STZ.W YoshiHasKey
...
CODE_01EA8F:          LDA.W YoshiGrowingTimer
                      ORA.W CutsceneID
                      BEQ +
                      JMP CODE_01EB48
...
CODE_01EAA7:          LDY.B #$00
                      LDA.B PlayerXSpeed                        ; \ Branch if Mario X speed == 0
                      BEQ CODE_01EADF                           ; /
                      BPL CODE_01EAB2                           ; \ If Mario X speed is positive,
                      EOR.B #$FF                                ; | invert it
                      INC A                                     ; /
CODE_01EAB2:          LSR A                                     ; \ Y = Upper 4 bits of X speed
                      LSR A                                     ; |
                      LSR A                                     ; |
                      LSR A                                     ; |
                      TAY                                       ; /
...
CODE_01EADF:          STZ.W SpriteMisc1570,X
                    + LDA.B PlayerInAir
                      BEQ +
                      LDY.B #$02
                      LDA.B PlayerYSpeed
...
CODE_01EB0C:          LDA.W YoshiDuckTimer
                      BEQ CODE_01EB16
                      DEC.W YoshiDuckTimer
                      BRA CODE_01EB1C

CODE_01EB16:          LDA.B byetudlrHold
                      AND.B #$04
                      BEQ CODE_01EB21
CODE_01EB1C:          LDY.B #$04
                      INC.W PlayerDuckingOnYoshi
CODE_01EB21:          LDA.B SpriteTableC2,X
                      CMP.B #$01
                      BEQ CODE_01EB2E
                      LDA.W SpriteMisc151C,X
                      BNE CODE_01EB2E
                      LDY.B #$04
CODE_01EB2E:          LDA.W PlayerRidingYoshi
                      BEQ +
                      LDA.W YoshiInPipeSetting
                      CMP.B #$01
                      BNE +
                    ...
                    + TYA
                      STA.W SpriteMisc1602,X
CODE_01EB48:          LDA.B SpriteTableC2,X
                      CMP.B #$01
                      BNE CODE_01EB97
                      LDY.W SpriteMisc157C,X
                      LDA.B PlayerXPosNext
...
CODE_01EB97:          LDA.B SpriteProperties
                      PHA
                      LDA.W PlayerRidingYoshi
                      BEQ CODE_01EBAD
                      LDA.W YoshiInPipeSetting
...
CODE_01EC04:          LDA.W PlayerRidingYoshi
                      BEQ CODE_01EC0E
                      LDA.W YoshiInPipeSetting
                      BNE CODE_01EC61
CODE_01EC0E:          LDA.W EggLaidTimer
                      BNE CODE_01EC61
...
CODE_01EC4C:          LDA.B SpriteLock
                      BEQ CODE_01EC61
CODE_01EC50:          LDY.W PlayerRidingYoshi
                      BEQ +
                      LDY.B #$06
...
CODE_01EC61:          LDA.B PlayerInAir
                      BNE CODE_01EC6A
                      LDA.W EggLaidTimer
                      BNE +
CODE_01EC6A:          JMP CODE_01ECE1
...
CODE_01EC78:          INC.W PlayerIsFrozen
                      JSR CODE_01EC50
                      STY.B SpriteLock
                      CMP.B #$02
                      BNE Return01EC8A
...
CODE_01ECE1:          LDA.B SpriteTableC2,X
                      CMP.B #$01
                      BNE +
                      JMP CODE_01ED70
                    ...
                    + LDA.B #$04
                      ...
                      ORA.W PlayerRidingYoshi                   ; | ...or if on Yoshi
                      BNE CODE_01ED70                           ; /
                      LDA.B PlayerYSpeed                        ; \ Branch if upward speed
                      BMI CODE_01ED70                           ; /
                      LDY.B #$01
                      JSR CODE_01EDCE
                      STZ.B PlayerXSpeed                        ; \ Mario's speed = 0
                      STZ.B PlayerYSpeed                        ; /
                      LDA.B #$0C
                      ...
                      STA.W SpriteMisc163E,X
                      INC.W SpriteStompCounter
CODE_01ED70:          LDA.B SpriteTableC2,X
                      CMP.B #$01
                      BNE Return01EDCB
                      JSR CODE_01F622
                      LDA.B byetudlrHold
...
CODE_01EDCC:          LDY.B #$00
CODE_01EDCE:          LDA.B SpriteYPosLow,X
                      SEC
                      SBC.W DATA_01EDE2,Y
                      STA.B PlayerYPosNext
                      STA.B PlayerYPosNow
...
HandleOffYoshi:       LDA.W SpriteMisc1602,X
                      PHA
                      LDY.W SpriteMisc15AC,X
                      CPY.B #$08
                      BNE +
...
CODE_01EF00:          LDA.B EffFrame
                    ...
                    + AND.B #$01
                      ...
                      STY.W SPCIO3                              ; /
CODE_01EF13:          JSL CODE_02BB23
Return01EF17:         RTS

CODE_01EF18:          LDY.W SpriteMisc1602,X
...
CODE_01EFDB:          LDA.W SpriteMisc1594,X
                      CMP.B #$03
                      BEQ CODE_01EFEE
                      LDA.W SpriteMisc151C,X
                      BEQ +
                      ...
                      CMP.B #$24
                      BEQ +
CODE_01EFEE:          LDA.B #$2A
                      STA.W OAMTileNo+$100,Y
                    + LDA.W YoshiStartEatTimer
                      BEQ CODE_01EFFD
CODE_01EFF8:          LDA.B #$0C
CODE_01EFFA:          STA.W OAMTileNo+$100,Y
CODE_01EFFD:          LDA.W SpriteMisc1564,X
                      ...
                      AND.B #$18
                      BNE CODE_01F038
CODE_01F00F:          LDA.W SpriteMisc1564,X
                      CMP.B #$00
                      BEQ Return01EFDA
                      LDY.B #$00
                      CMP.B #$0F
...
CODE_01F0A2:          LDA.B SpriteTableC2,X
                      CMP.B #$01
                      BNE +
                      JSL CODE_02D0D4
...
CODE_01F0D3:          LDA.B #!SFX_GULP                          ; \ Play sound effect
                      STA.W SPCIO0                              ; /
                      JSL CODE_05B34A
...
CODE_01F116:          INC.W PinkBerriesEaten
                      LDA.W PinkBerriesEaten
                      CMP.B #$02
                      BNE Return01F12D
                      STZ.W PinkBerriesEaten
                      LDA.B #$6A
CODE_01F125:          STA.W YoshiEggSpriteHatch
                      LDY.B #$20
                      STY.W EggLaidTimer
Return01F12D:         RTS

CODE_01F12E:          LDA.W SpriteMisc1558,X
                      BNE +
...
CODE_01F14B:          LDA.W YoshiHeavenFlag
                      BEQ +
...
CODE_01F1DF:          LDA.B SpriteTableC2,X
                      CMP.B #$01
                      BNE Return01F1DE
                      BIT.B byetudlrFrame
                      BVC Return01F1DE
...
CODE_01F2DF:          LDA.B #!SFX_SPIT                          ; \ Play sound effect
                      STA.W SPCIO0                              ; /
...
CODE_01F309:          LDA.B #$12
                      STA.W YoshiTongueTimer
                      LDA.B #!SFX_YOSHITONGUE                   ; \ Play sound effect
                      STA.W SPCIO3                              ; /
                      RTS

CODE_01F314:          LDA.W SpriteMisc151C,X
                      CLC
                      ADC.B #$03
                      STA.W SpriteMisc151C,X
                      CMP.B #$20
                      BCS +
CODE_01F321:          JSR CODE_01F3FE
                      JSR CODE_01F4B2
                      RTS
...
CODE_01F332:          LDA.W SpriteMisc1558,X
                      BNE CODE_01F321
                      LDA.W SpriteMisc151C,X
                      SEC
                      SBC.B #$04
...
CODE_01F344:          STZ.W SpriteMisc151C,X
                      STZ.W SpriteMisc1594,X
                      LDY.W SpriteMisc160E,X
                      BMI CODE_01F370
                      LDA.W SpriteTweakerE,Y
                      ...
                      STA.W SpriteNumber,Y
                      PLX
CODE_01F370:          JMP CODE_01F3FA

CODE_01F373:          LDA.B #$00
                      STA.W SpriteStatus,Y
                      LDA.B #$1B
                      STA.W SpriteMisc1564,X
                      LDA.B #$FF
...
CODE_01F3F7:          JSR CODE_01F0D3
CODE_01F3FA:          JMP CODE_01F321

Return01F3FD:         RTS

CODE_01F3FE:          LDA.W SpriteOffscreenX,X                  ; \ Branch if sprite off screen...
                      ORA.W SpriteOffscreenVert,X               ; |
...
CODE_01F43C:          BCC Return01F3FD
CODE_01F43E:          LDA.W SpriteMisc151C,X
                      STA.W HW_WRDIV+1
                      STZ.W HW_WRDIV
                      LDA.B #$04
                      STA.W HW_WRDIV+2
...
CODE_01F47C:          BCS Return01F4B1
CODE_01F47E:          LDA.B _1
                      STA.W OAMTileYPos,Y
                      LDA.B _6
                      CMP.B #$01
                      LDA.B #$76
...
CODE_01F4B2:          LDA.W SpriteMisc160E,X
                      BMI CODE_01F524
                      LDY.B #$00
                      LDA.B _D
                      BMI CODE_01F4C3
...
CODE_01F4C3:          LDA.W SpriteMisc151C,X
                      EOR.B #$FF
                      INC A
                      CLC
                      ADC.B _D
...
CODE_01F531:          LDA.W SpriteMisc151C,X
                      EOR.B #$FF
                      INC A
                      CLC
                      ADC.B _D
...
CODE_01F568:          STY.W SpriteInterIndex
...
TryEatSprite:         PHX
                    ...
                    + LDA.W SpriteNumber,Y                      ; \ Branch if sprite being eaten not Pokey
                      ...
                      PLX
CODE_01F5FB:          TYA                                       ; \ $160E,x = Index of sprite being eaten
                      STA.W SpriteMisc160E,X                    ; /
                      LDA.B #$02
                      STA.W SpriteMisc1594,X
                      LDA.B #$0A
...
CODE_01F622:          LDA.W SpriteMisc163E,X
                      ORA.B SpriteLock
                      BNE Return01F667
                      LDY.B #$0B
CODE_01F62B:          STY.W SpriteInterIndex
                      TYA
                      EOR.B TrueFrame
                      AND.B #$01
                      BNE +
...
CODE_01F69E:          LDA.W SpriteInLiquid,Y
                      BEQ -
CODE_01F6A3:          LDA.W SpriteNumber,Y
                      CMP.B #$BF
                      BNE CODE_01F6B4
                      LDA.B PlayerYPosNext
                      SEC
                      ...
                      CMP.B #$E8
                      BMI Return01F6DC
CODE_01F6B4:          LDA.W SpriteNumber,Y
                      CMP.B #$7E
                      BNE CODE_01F6DD
                      LDA.W SpriteTableC2,Y
                      BEQ Return01F6DC
...
CODE_01F6DD:          CMP.B #$4E
                      BEQ CODE_01F6E5
                      CMP.B #$4D
                      BNE CODE_01F6EC
CODE_01F6E5:          LDA.W SpriteTableC2,Y
                      CMP.B #$02
                      BCC Return01F6DC
CODE_01F6EC:          LDA.B _5
                      CLC
                      ADC.B #$0D
                      CMP.B _1
                      BMI Return01F74B
                      ...
                      CMP.B _0
                      BNE Return01F74B
CODE_01F70E:          LDA.W InvinsibilityTimer                  ; \ Branch if Mario has star
                      BNE Return01F74B                          ; /
                      LDA.B #$10
                      STA.W SpriteMisc163E,X
                      LDA.B #!SFX_YOSHIDRUMOFF                  ; \ Play sound effect
...
CODE_01F74C:          LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,X                      ; /
CODE_01F751:          LDA.B #$20
                      STA.W SpriteMisc1540,X
...
YoshiEgg:             LDA.W SpriteMisc187B,X
                      BEQ CODE_01F799
                      JSR IsSprOffScreen
                      BNE CODE_01F78D
                      JSR SubHorizPos
                      ...
                      LDA.B #$78
                    + STA.W SpriteMisc151C,X
CODE_01F78D:          JSR SubSprGfx2Entry1
                      LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
                      LDA.B #$00
                      STA.W OAMTileNo+$100,Y
                      RTS

CODE_01F799:          LDA.W SpriteMisc1540,X
                      BEQ +
                      LSR A
                      LSR A
                      LSR A
...
CODE_01F7C8:          JSR IsSprOffScreen
                      BNE Return01F82C
                      LDA.B SpriteXPosLow,X
                      STA.B _0
                      LDA.B SpriteYPosLow,X
                      ...
                      LDY.B #$03
                      LDX.B #$0B
CODE_01F7DF:          LDA.W MinExtSpriteNumber,X
                      BEQ CODE_01F7F4
CODE_01F7E4:          DEX
                      BPL CODE_01F7DF
...
CODE_01F83D:          LDA.W SpriteMisc151C,X
                      STA.B SpriteNumber,X
                      CMP.B #$35
                      BEQ CODE_01F86C
                      CMP.B #$2D
...
CODE_01F86C:          JSL InitSpriteTables
                      JMP CODE_01A2B5


                      db $08,$F8

UnusedInit:           JSR FaceMario
                      STA.W SpriteMisc1534,X
Return01F87B:         RTS

InitEerie:            JSR SubHorizPos
                      LDA.W EerieSpeedX,Y
                      STA.B SpriteXSpeed,X
InitBigBoo:           JSL GetRand
                      STA.W SpriteMisc1570,X
                      RTS
...
CODE_01F8C0:          JSR SubOffscreen0Bnk1
                    + JSR MarioSprInteractRt
                      JSR SetAnimationFrame
CODE_01F8C9:          JSR UpdateDirection
                      JMP SubSprGfx2Entry1
...
BigBoo:               JSR SubOffscreen1Bnk1
                      LDA.B #$20
                      BRA +

Boo_BooBlock:         JSR SubOffscreen0Bnk1
                      LDA.B #$10
                    + STA.W TileGenerateTrackB
                      LDA.W SpriteStatus,X
                      CMP.B #$08
...
CODE_01F8EF:          JMP CODE_01F9CE
                    ...
                    + JSR SubHorizPos
                      ...
                      CMP.B #$14
                      BCC CODE_01F92F
CODE_01F90C:          STZ.B SpriteTableC2,X
                      CPY.B PlayerDirection
                      BNE CODE_01F914
                      INC.B SpriteTableC2,X
CODE_01F914:          LDA.B _F
                      CLC
                      ADC.B #$0A
                      CMP.B #$14
                      BCC CODE_01F92F
...
CODE_01F92F:          STZ.W SpriteMisc1602,X
                      LDA.B SpriteTableC2,X
                      BEQ CODE_01F989
                      LDA.B #$03
                      STA.W SpriteMisc1602,X
                    ...
                    + LDA.B SpriteXSpeed,X
                      ...
                      INC A
                    + DEC A
CODE_01F962:          STA.B SpriteXSpeed,X
                      LDA.B SpriteYSpeed,X
                      BEQ CODE_01F96D
                      BPL +
                      INC A
                      INC A
                    + DEC A
CODE_01F96D:          STA.B SpriteYSpeed,X
CODE_01F96F:          BRA CODE_01F9C8

CODE_01F971:          CMP.B #$10
                      BNE +
                      PHA
                      LDA.W SpriteMisc157C,X
                      EOR.B #$01
                    ...
                    + LSR A
                      ...
                      LDA.W DATA_01F8D1,Y
                      STA.W SpriteMisc1602,X
CODE_01F989:          STZ.W SpriteMisc1570,X
                      LDA.B TrueFrame
                      AND.B #$07
                      BNE CODE_01F9C8
                      JSR SubHorizPos
                    ...
                    + LDA.B PlayerYPosNow
                      ...
                      ADC.W DATA_01EBB4,Y
                      STA.B SpriteYSpeed,X
CODE_01F9C8:          JSR SubSprXPosNoGrvty
                      JSR SubSprYPosNoGrvty
CODE_01F9CE:          LDA.B SpriteNumber,X
                      CMP.B #$AF
                      BNE CODE_01FA3D
                      LDA.B SpriteXSpeed,X
                      BPL +
...
CODE_01FA09:          LDA.W SpriteStatus,X
                      CMP.B #$08
                      BNE +
                      PHY
                      JSR MarioSprInteractRt
...
CODE_01FA3D:          LDA.W SpriteStatus,X
                      CMP.B #$08
                      BNE +
                      JSR MarioSprInteractRt
                    + JSL CODE_038398
...
IggysBall:            JSR SubSprGfx2Entry1
                      LDY.W SpriteMisc157C,X
                      LDA.W DATA_01FA4C,Y
                      STA.B _0
                      LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
...
KoopaKid:             LDA.B SpriteTableC2,X
...
PlatformKoopaKids:    LDA.B SpriteLock
                      ORA.W SpriteMisc154C,X
                      BNE +
                      JSR SubHorizPos
                      STY.B _0
...
CODE_01FB36:          JSL LoadTweakerBytes
                      LDA.B SpriteLock
                      BEQ +
                      JMP CODE_01FC08
...
CODE_01FBC5:          LDA.B #$01
                      BRA CODE_01FBEE

CODE_01FBC9:          LDY.B _1
                      LDA.B SpriteXPosLow,X
                      CMP.B #$78
                      BCS CODE_01FBD5
                      LDA.B #$01
...
CODE_01FBD5:          LDA.B #$FF
                      BRA CODE_01FBEE

CODE_01FBD9:          LDA.B Mode7Angle+1
                      BNE CODE_01FBE7
                      LDY.B _0
                      LDA.W DATA_01FADD,Y
                      EOR.B #$FF
...
CODE_01FBE7:          LDY.B _1
                      LDA.W DATA_01FADD,Y
                    + ASL A
                      ASL A
CODE_01FBEE:          STA.B SpriteXSpeed,X
                      INC.W SpriteMisc1570,X
                      LDA.B SpriteXSpeed,X
                      BEQ +
                      INC.W SpriteMisc1570,X
                    + LDA.W SpriteMisc1570,X
                      ...
                      LDA.W DATA_01FAE5,Y
                      STA.W SpriteMisc1602,X
CODE_01FC08:          JSR CODE_01FD50
                      JSR CODE_01FC62
CODE_01FC0E:          LDA.W SpriteMisc154C,X
                      BNE CODE_01FC4E
                      LDA.W SpriteMisc157C,X
                      PHA
                      LDY.W SpriteMisc15AC,X
                    ...
                    + LDA.B #$06
                      STA.W SpriteMisc1602,X
CODE_01FC2A:          LDA.W SpriteMisc1564,X
                      BEQ +
                      PHA
                      LSR A
                      LSR A
...
CODE_01FC62:          LDA.B PlayerAnimation
                      CMP.B #$01
                      BCS -
                      LDA.W SpriteMisc160E,X
                      BNE -
...
CODE_01FD05:          JSL HurtMario
Return01FD09:         RTS

CODE_01FD0A:          LDY.B #$0A
CODE_01FD0C:          STY.W SpriteInterIndex
                      LDA.W ExtSpriteNumber,Y
                      CMP.B #$05
                      BNE +
                      LDA.W ExtSpriteXPosLow,Y
...
CODE_01FDA9:          LDA.W SpriteStatus,Y                      ; |
                      BEQ GenerateBall                          ; |
                      DEY                                       ; |
                      BPL CODE_01FDA9                           ; /
                      RTS

GenerateBall:         LDA.B #!SFX_SPIT                          ; \ Play sound effect
                      STA.W SPCIO0                              ; /
                      LDA.B #$08                                ; \ Sprite status = normal
                      STA.W SpriteStatus,Y                      ; /
...
CODE_01FEBC:          LDY.B SpriteTableC2,X
                      LDA.W DATA_01FEB7,Y
                      STA.B _D
                      STY.B _5
                      LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
