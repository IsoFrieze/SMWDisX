...
SPC700Engine:         dw SoundEffects-SPC700Engine-4
                      dw SPCEngine
...
APU_Loop:             MOV.W Y,HW_COUNTER0                       ; main loop
...
APU_058D:             MOV.B A,SPCOutBuffer+2                    ; if writing 0 to APU2 then
...
CopyToSNES:           MOV A,X                                   ; SEND 04+X TO APUX; get APUX to 00+X with "debounce"?;
                      MOV Y,A
...
HandleVCmd:           CMP A,#$D0                                ; handle a note vcmd;
                      BCS +                                     ; percussion note;
                      CMP A,#$C6
...
APU_05E3:             AND A,#$7F
                    ...
                    + MOV.W A,ARam_0320+1+X
                      ...
                      CALL APU_0F5D
APU_062B:             MOV.W A,ARam_02B0+1+X
                      MOV Y,A
                      MOV.W A,ARam_02B0+X
                      MOVW.B ARam_10,YA

APU_0634:             MOV Y,#$00                                ; set DSP pitch from $10/11;
                      MOV.B A,ARam_11
                      SETC
                      SBC A,#$34
                      BCS APU_0646
...
WriteDSPRegCond:      PUSH A                                    ; write A to DSP reg Y if vbit clear in $1D;
...
APU_06AE:             CMP.B SPCInEdge,#$12
                      ...
                      BEQ APU_06C8
APU_06C2:             MOV.B A,SPCInEdge
                      BMI APU_069E
                      BNE APU_06D2
APU_06C8:             MOV.W A,ARam_0382
                      BNE APU_071A
                      MOV.B A,SPCOutBuffer
                      BNE APU_074D
APU_06D1:             RET

APU_06D2:             MOV.B SPCOutBuffer,A
                      MOV.W A,ARam_0388
                      BEQ APU_06F7
                      MOV A,#$00
                      MOV.W ARam_0388,A
                    ...
                    + MOV A,#$16
                      ...
                      CALL APU_0EEB                             ; set echo vol L/R to #$16;
                      MOV A,#$00
APU_06F2:             MOV Y,#$6C
                      CALL WriteDSPReg                          ; enable echo write;
APU_06F7:             MOV A,#$02
                      MOV.W ARam_0382,A
                      CMP.B SPCOutBuffer,#$11
                      BNE +
...
APU_071A:             DEC.W ARam_0382                           ; 0382 nonzero
                      BNE APU_06D1                              ; ret;
APU_071F:             MOV.B A,SPCOutBuffer
                      ASL A
                      MOV Y,A
                      ...
                      BRA APU_0754
APU_072F:             CMP.B SPCOutBuffer,#$11
                      BNE +
                      MOV A,#$60
                      MOV.W ARam_0388,A
                      MOV Y,#$6C
...
APU_074D:             DEC.W ARam_0380
                      BNE APU_07A6
APU_0752:             INCW.B SFX1DF9PhrasePtr
APU_0754:             MOV X,#$00
...
APU_0786:             CMP A,#$DA
                      ...
                      MOV A,#$10
                      CALL APU_0D32
APU_07A0:             MOV.W A,ARam_0381
                      MOV.W ARam_0380,A
APU_07A6:             CLR7.B ARam_13
                      MOV X,#$08
...
APU_0816:             CMP.B SPCOutBuffer+3,#$24
                      BEQ +
...
APU_084B:             DBNZ.B ARam_0C+1,-
                      ...
                      BRA APU_087D
APU_085E:             MOV.B SPCOutBuffer+3,#$00
...
APU_0876:             DEC.W ARam_0384
                      BNE APU_08D3
APU_087B:             INCW.B SFX1DFCPhrasePtr
APU_087D:             MOV X,#$00
                      ...
                      MOV.B A,ARam_10
                      MOV Y,#$61
                      CALL WriteDSPReg                          ; set voice 6 vol R from $10;
                      MOV A,X
                      BRA APU_08AF
                    + MOV Y,#$61
                      CALL WriteDSPReg                          ; set voice 6 vol R;
                      INCW.B SFX1DFCPhrasePtr
                      MOV.B A,(SFX1DFCPhrasePtr+X)
APU_08AF:             CMP A,#$DA
                      BEQ APU_0920
                    ...
                    + MOV X,#$0C                                ; other $80+;
                      ...
                      MOV A,#$40
                      CALL APU_0D32
APU_08CD:             MOV.W A,ARam_0385
                      MOV.W ARam_0384,A
APU_08D3:             CLR7.B ARam_13
                      MOV X,#$0C
...
APU_097D:             MOV.B A,SPCOutBuffer+2                    ; $01 = 02
                      CMP A,#$06
                      BEQ +
                      AND A,#$FC
                      BNE APU_0A03
                    + MOV.W A,ARam_0386
                      ...
                      MOV A,#$01
                      BNE +
APU_0995:             MOV A,#$00                                ; $01 = 03;
                    + MOV.W ARam_0386,A
APU_099A:             BRA APU_0A03

APU_099C:             MOV A,#$60                                ; $01 = FF (reset?);
                      MOV Y,#$6C
...
PitchSlideDelta:      MOV A,#$B0                                ; add pitch slide delta and set DSP pitch;
...
APU_0A03:             MOV.B A,SPCOutBuffer+1
                      CMP A,#$01
                      BEQ APU_0A51
                      CMP A,#$04
                      BEQ +                                     ; (jmp $0b08);
...
APU_0A0E:             JMP APU_0ACE
                    + JMP APU_0B08

APU_0A14:             MOV.B SPCOutBuffer+1,A                    ; $01 = 01
                      MOV A,#$04
                      MOV.W ARam_0383,A
                      MOV A,#$80
                      MOV Y,#$5C
...
APU_0ACE:             MOV.B SPCOutBuffer+1,A                    ; $01 = 04 && $05 != 01
                      MOV A,#$04
                      MOV.W ARam_0383,A
                      MOV A,#$80
                      MOV Y,#$5C
...
APU_0AE8:             DEC.W ARam_0383
                      BNE -
                      MOV.B ARam_1C,#$18
                      BRA +
APU_0AF2:             CMP.B ARam_1C,#$0C
                      BNE APU_0B33
                    + MOV A,#$07
                      CALL APU_0AB3
                      MOV A,#$A4
...
APU_0BC0:             MOV.B A,SPCOutBuffer+2
                      BEQ APU_0BDE
                      CMP A,#$06
                      BEQ ++
                      AND A,#$FC
...
APU_0BDE:             MOV.B A,SPCInEdge+2
                      BMI APU_0BAE
                      BEQ APU_0BE7
                      JMP APU_0B40                              ; play song in A?;

APU_0BE7:             MOV.B A,ARam_0C
                      BNE APU_0BFE
                      MOV.B A,SPCOutBuffer+2
                      BNE APU_0C46
                    - RET

APU_0BF0:             MOV Y,#$00                                ; read next word at $40 into YA;
                      MOV.B A,(BlockPtr)+Y
                      INCW.B BlockPtr
                      PUSH A
                      MOV.B A,(BlockPtr)+Y
...
APU_0BFE:             DBNZ.B ARam_0C,-
APU_0C01:             CALL APU_0BF0                             ; read next word at $40;
...
APU_0C1C:             INCW.B BlockPtr
                      INCW.B BlockPtr                           ; skip goto address
                      BRA APU_0C01                              ; continue;

APU_0C22:             MOV Y,#$0F                                ; high byte not zero:;
...
APU_0C9F:             CMP A,#$DA
                    ...
                    + MOV.W NoteLength+X,A                      ; set note dur counter from dur * dur%
                      BRA APU_0CC9
APU_0CC6:             CALL APU_10A1                             ; do voice readahead;
APU_0CC9:             INC X
                      INC X
...
APU_0CE1:             MOVW.B MasterTempo,YA
APU_0CE3:             MOV.B A,ARam_60
                      BEQ APU_0D03
                      DBNZ.B ARam_60,+
                      MOV A,#$00
...
APU_0CFE:             MOVW.B EchoVolRight,YA
                      CALL APU_0EEB
APU_0D03:             MOV.B A,VolFadeTimer
                      BEQ APU_0D17
                      DBNZ.B VolFadeTimer,+
...
APU_0D40:             ASL A                                     ; dispatch vcmd in A;
                      MOV X,A
                      MOV A,#$00
                      JMP (VCmdPtrs-$B4+X)                      ; $DA minimum? (F90);

VCmd_DA:              CALL NextVCmd46                           ; vcmd DA: set instrument;

APU_0D4A:             INC A                                     ; set instrument to A;
APU_0D4B:             MOV.B VoInstrument+1+X,A
                      DEC A
                      MOV Y,#$05
                      MOV.B ARam_14,#$46
                      MOV.B ARam_15,#$5F

APU_0D56:             MUL YA                                    ; set sample A in bank at $14/15 width Y;
                      ADDW.B YA,ARam_14
                      MOVW.B ARam_14,YA
                      MOV.B A,CurrentChannel
                      AND.B A,ChannelsMuted
...
VCmd_DB:              CALL NextVCmd46                           ; vcmd DB: set pan;
                      AND A,#$1F
...
VCmd_DC:              CALL NextVCmd46                           ; vcmd DC: pan fade;
...
VCmd_DE:              CALL NextVCmd46                           ; vcmd DE: vibrato on;
                      MOV.W ARam_0340+X,A
                      MOV A,#$00
...
VCmd_DF:              MOV.B X,CurrentChannel2                   ; vcmd DF: vibrato off
                      MOV.B VoVibrato+1+X,A
                      RET

VCmd_EA:              CALL NextVCmd46                           ; vcmd EA: vibrato fade;
                      MOV.W ARam_0340+1+X,A
                      PUSH A
...
VCmd_E0:              CALL NextVCmd46                           ; vcmd E0: set master volume;
                      MOV.B MasterVolume,A
                      MOV.B ARam_56,#$00
                      MOV.B ARam_5C,#$FF                        ; all vol chgd
                      RET

VCmd_E1:              CALL NextVCmd46                           ; vcmd E1: master vol fade;
...
VCmd_E2:              CALL NextVCmd46                           ; vcmd E2: tempo;
APU_0E14:             ADC.W A,ARam_0387                         ; set tempo
                      MOV.B MasterTempo+1,A
                      MOV.B MasterTempo,#$00
                      RET

VCmd_E3:              CALL NextVCmd46                           ; vcmd E3: tempo fade;
...
VCmd_E4:              CALL NextVCmd46                           ; vcmd E4: transpose (global);
                      MOV.B MasterTranspose,A
                      RET

VCmd_E5:              CALL NextVCmd46                           ; vcmd E5: tremolo on;
                      MOV.W ARam_0370+X,A
                      CALL NextVCmd
                      MOV.W ARam_0360+2+X,A
                      CALL NextVCmd

VCmd_E6:              MOV.B X,CurrentChannel2                   ; vcmd E6: tremolo off
                      MOV.B ARam_B0+1+X,A
                      RET

VCmd_EB:              MOV A,#$01                                ; vcmd EB: pitch envelope (release);
                      BRA +
VCmd_EC:              MOV A,#$00                                ; vcmd EC: pitch envelope (attack);
                    + MOV.B X,CurrentChannel2
                      MOV.W ARam_0320+X,A
                      CALL NextVCmd46
...
VCmd_E7:              CALL NextVCmd46                           ; vcmd E7: set voice volume base;
...
VCmd_E8:              CALL NextVCmd46                           ; vcmd E8: voice volume base fade;
                      MOV.B VoPanFade+X,A
                      PUSH A
                      CALL NextVCmd
                      MOV.W ARam_0260+X,A
...
VCmd_EE:              CALL NextVCmd46                           ; vcmd EE: tuning;
                      MOV.W ARam_02D0+1+X,A
                      RET

VCmd_E9:              CALL NextVCmd46                           ; vcmd E9: call subroutine;
                      PUSH A
                      CALL NextVCmd
                      PUSH A
                      CALL NextVCmd
...
VCmd_EF:              CALL NextVCmd46                           ; vcmd EF: set echo vbits/volume;
...
APU_0EEB:             MOV.B A,EchoVolLeft+1                     ; set echo vol's from shadows
                      MOV Y,#$2C
...
VCmd_F2:              CALL NextVCmd46                           ; vcmd F2: echo volume fade;
                      MOV.B ARam_60,A
                      CALL NextVCmd
                      MOV.B ARam_69,A
                      MOV.B X,ARam_60
...
VCmd_F0:              MOV.B X,CurrentChannel2                   ; vcmd F0: disable echo
...
APU_0F22:             MOV Y,A
                      ...
                      CALL APU_0EEB                             ; set echo vol DSP regs from shadows;
                      MOV.B ARam_2E,A                           ; zero 2E
                      OR A,#$20
                      MOV Y,#$6C
                      JMP WriteDSPReg                           ; disable echo write, noise freq 0;

VCmd_F1:              CALL NextVCmd46                           ; vcmd F1: set echo delay, feedback, filter;
                      MOV Y,#$7D
...
APU_0F5D:             AND A,#$7F                                ; calculate portamento delta;
...
APU_0F76:             BCS APU_0F85                              ; signed 16 bit division;
                      EOR A,#$FF
                      INC A
                      CALL APU_0F85
                      MOVW.B ARam_14,YA
...
VCmdPtrs:             dw VCmd_DA                                ; DA - SET INSTRUMENT ; dispatch table for 0d44 (vcmds)
...
VCmdLens:             db $02,$02,$03,$04,$04,$01,$02,$03        ; vcmd op lens?
                      db $02,$03,$02,$04,$01,$02,$03,$04
                      db $02,$04,$04,$01,$02,$04,$01,$04
                      db $04

APU_0FDB:             MOV.B A,VoPanFade+X
                      BEQ +
...
APU_1011:             INC.B ARam_B0+X
APU_1013:             MOV.W A,ARam_0210+1+X                     ; volume from note
                      CALL APU_124D                             ; set voice vol from master/base/note;
APU_1019:             MOV.B A,VoPanFade+1+X
                      BNE APU_1024
                      MOV.B A,CurrentChannel
                      AND.B A,ARam_5C
                      BNE APU_102D
...
APU_1024:             MOV A,#$80                                ; do: pan fade and set volume;
                      MOV Y,#$02
                      DEC.B VoPanFade+1+X
                      CALL APU_1075
APU_102D:             MOV.W A,ARam_0280+1+X
                      MOV Y,A
                      MOV.W A,ARam_0280+X
                      MOVW.B ARam_10,YA                         ; set $10/1 from voice pan

APU_1036:             MOV A,X                                   ; set voice volume DSP regs with pan value from $10/1;
                      XCN A
                      LSR A
                      MOV.B ARam_12,A                           ; $12 = voice X volume DSP reg
APU_103B:             MOV.B Y,ARam_11
...
APU_1075:             MOVW.B ARam_14,YA                         ; add fade delta to value (set final value at end)
                      BNE APU_1088
                      CLRC
                      ADC A,#$20
                      MOVW.B PitchValue,YA
...
APU_1088:             CLRC
                      ...
                      MOV.B A,(ARam_14)+Y
                      ADC.B A,(PitchValue)+Y
APU_109A:             MOV.B (ARam_14)+Y,A
                      DEC Y
                      POP A
                      MOV.B (ARam_14)+Y,A
                      RET

APU_10A1:             SETP                                      ; do: voice readahead;
                      DEC.B SPCInEdge+X
                      CLRP
                      BEQ +
                      MOV A,#$02
...
APU_10D8:             CLR7.B ARam_13
                    ...
                    + CALL APU_1260
                      ...
                      CALL APU_0F5D
APU_1111:             MOV.B A,VoPitchSlide+1+X
                      BEQ +
                    ...
                    + MOV.B A,ChannelsMuted
                      ...
                      BNE APU_112A
APU_111F:             SET7.B ARam_13
                      MOV A,#$B0
                      MOV Y,#$02
                      DEC.B VoPitchSlide+X
                      CALL APU_1075
APU_112A:             MOV.W A,ARam_02B0+1+X
                      MOV Y,A
                      MOV.W A,ARam_02B0+X
                      ...
                      BEQ APU_1144
                      INC.B VoVibrato+X
APU_1140:             BBS7.B ARam_13,APU_1195
                      RET
APU_1144:             MOV.W A,ARam_0340+1+X
                      BEQ APU_1166
                      CMP.W A,ARam_0110+X
                      BNE +
                    ...
                    + CLRC
                      ...
                      INC.B ARam_10+X
                      CLRP
APU_1166:             MOV.W A,ARam_0330+X
                      CLRC
                      ADC.W A,ARam_0330+1+X
                      MOV.W ARam_0330+X,A
APU_1170:             MOV.B ARam_12,A
                      ASL A
                      ASL A
                      BCC +
                      EOR A,#$FF
...
APU_1185:             AND A,#$0F
                      MUL YA
APU_1188:             BBC7.B ARam_12,+
                      MOVW.B ARam_12,YA
                      MOVW.B YA,ARam_0E
                      SUBW.B YA,ARam_12
                    + ADDW.B YA,ARam_10
                      MOVW.B ARam_10,YA
APU_1195:             JMP APU_0634

APU_1198:             CLR7.B ARam_13                            ; per-voice fades/dsps?
                      MOV.B A,ARam_B0+1+X
                      BEQ +
                      MOV.W A,ARam_0370+X
                      CBNE.B ARam_B0+X,+
...
APU_11C3:             CALL APU_1036                             ; set voice DSP regs, pan from $10/11;
APU_11C6:             CLR7.B ARam_13
                      MOV.W A,ARam_02B0+1+X
                      MOV Y,A
                      MOV.W A,ARam_02B0+X
...
APU_11FF:             SET7.B ARam_13
APU_1201:             MOVW.B PitchValue,YA
                      MOV.B ARam_12,Y
                      BBC7.B ARam_12,+
                      MOVW.B YA,ARam_0E
...
NextVCmd46:           MOV.B X,CurrentChannel2                   ; get next vcmd stream byte for voice $46 Channel2
NextVCmd:             MOV.B A,(VoPhrasePtr+X)                   ; get next vcmd stream byte into A/Y
APU_1260:             INC.B VoPhrasePtr+X
                      BNE +
                      INC.B VoPhrasePtr+1+X
                    + MOV Y,A
                      RET

NoteDurs:             db $33,$66,$80,$99,$B3,$CC,$E6,$FF        ; for 0C89 - note dur%'s

VelocityValues:       db $08,$12,$1B,$24,$2C,$35,$3E,$47        ; per-note velocity values
                      db $51,$5A,$62,$6B,$7D,$8F,$A1,$B3

PanTable:             db $00,$01,$03,$07,$0D,$15,$1E,$29        ; pan table (max pan full L = $14.00)
                      db $34,$42,$51,$5E,$67,$6E,$73,$77
                      db $7A,$7C,$7D,$7E,$7F

DefaultDSPVals:       db $7F,$7F,$00,$00,$2F,$60,$00,$00        ; default values (1295) for DSP regs (12A1)
                      db $00,$80,$60,$02

DefaultDSPRegs:       db $0C,$1C,$2C,$3C,$6C,$0D,$2D,$3D        ; mvol L/R max, echo vol L/R zero, FLG = echo off/noise 400HZ
                      db $4D,$5D,$6D,$7D                        ; echo feedback = $60, echo/pitchmod/noise vbits off
                                                                ; source dir = $8000, echo ram = $6000, echo delay = 32ms
EchoFilters:          db $FF,$08,$17,$24,$24,$17,$08,$FF        ; echo filters 0 and 1
                      db $7F,$00,$00,$00,$00,$00,$00,$00

GetPitch:             MOV Y,#$00                                ; get pitch from note number in A (with octave correction) to YA;to YA
                      ASL A
                      MOV X,#$18
                      DIV YA,X
                      MOV X,A
...
PitchTable:           dw $10BE                                  ; pitch table
                      dw $11BD
                      dw $12CB
                      dw $13E9
                      dw $1518
...
StandardTransfer:     MOV A,#$AA                                ; do: standardish SPU transfer;
                      MOV.W HW_SNESIO0,A
                      MOV A,#$BB
                      MOV.W HW_SNESIO1,A
                    - MOV.W A,HW_SNESIO0
...
APU_1305:             MOV.W Y,HW_SNESIO0
                      BNE APU_1305
APU_130A:             CMP.W Y,HW_SNESIO0
                      BNE APU_131E
                      MOV.W A,HW_SNESIO1
                      MOV.W HW_SNESIO0,Y
                      MOV.B (ARam_14)+Y,A
                      ...
                      INC.B ARam_15
                      BRA APU_130A
APU_131E:             BPL APU_130A
                      CMP.W Y,HW_SNESIO0
                      BPL APU_130A
APU_1325:             MOV.W A,HW_SNESIO2
                      MOV.W Y,HW_SNESIO3
                      MOVW.B ARam_14,YA
                      MOV.W Y,HW_SNESIO0
                      MOV.W A,HW_SNESIO1
...
SoundEffects:         dw MusicBank1-SoundEffects-4
                      dw SoundEffectTable

                      base SoundEffectTable

SFXDSPSettings:       db $70,$70 : dw $1000
                      db $06,$DF,$E0,$B8,$02
                      db $70,$70 : dw $1000
                      db $00,$FE,$0A,$B8,$03
                      db $70,$70 : dw $1000
...
SFX_1DF9_2A:          incbin "sfx/SFX_1DF9_2A.bin"
SFX_1DFC_2D:          incbin "sfx/SFX_1DFC_2D.bin"
SFX_1DFC_2E:          incbin "sfx/SFX_1DFC_2E.bin"
SFX_1DFC_2F:          incbin "sfx/SFX_1DFC_2F.bin"
SFX_1DFC_30:          incbin "sfx/SFX_1DFC_30.bin"
SFX_1DFC_31:          incbin "sfx/SFX_1DFC_31.bin"
SFX_1DFC_32:          incbin "sfx/SFX_1DFC_32.bin"
SFX_1DFC_33:          incbin "sfx/SFX_1DFC_33.bin"
SFX_1DFC_34:          incbin "sfx/SFX_1DFC_34.bin"
SFX_1DF9_29:          incbin "sfx/SFX_1DF9_29.bin"
SFX_1DF9_28:          incbin "sfx/SFX_1DF9_28.bin"
SFX_1DFC_2C:          incbin "sfx/SFX_1DFC_2C.bin"
SFX_1DFC_2B:          incbin "sfx/SFX_1DFC_2B.bin"
SFX_1DF9_27:          incbin "sfx/SFX_1DF9_27.bin"
                      db $AA,$AA,$18,$6C,$AA,$60,$5D,$A9

MusicB1S05P00:        db $F0,$DA,$04,$E2,$19,$DB,$0A,$0C
                      db $3B,$B0,$B0,$B0,$A6,$18,$B0,$0C
                      db $A6,$AF,$C6,$AF,$AF,$A4,$AF,$AD
                      db $AE,$AF,$00

MusicB1S05P04:        db $DA,$04,$DB,$00,$0C,$3B,$AD,$AD
                      db $AD,$C7,$18,$AD,$0C,$C7,$AB,$C6
                      db $AB,$AB,$C7,$AB,$C7,$C7,$C7

MusicB1S05P02:        db $DA,$04,$DB,$00,$0C,$3B,$A9,$A9
                      db $A9,$C7,$18,$A9,$0C,$C7,$A8,$C6
                      db $A8,$A8,$C7,$A8,$C7,$C7,$C7

MusicB1S05P01:        db $DA,$08,$DB,$0A,$24,$3E,$8E,$0C
                      db $95,$24,$9A,$0C,$95,$24,$8C,$0C
                      db $93,$98,$98,$93,$C6

MusicB1S05P05:        db $DA,$0C,$DB,$00,$0C,$6F,$A6,$C6
                      db $AD,$C6,$C6,$AD,$A3,$A3,$A6,$C6
                      db $AD,$C6,$C6,$AD,$A3,$A3

MusicB1S05P03:        db $DA,$0A,$DB,$14,$0C,$6B,$C7,$C6
                      db $D2,$C6,$C6,$C6,$0C,$69,$D1,$D1
                      db $0C,$6B,$C7,$C6,$D2,$C6,$C6,$C6
                      db $0C,$69,$D1,$D1

MusicB1S05P06:        db $0C,$B0,$B0,$B0,$A6,$18,$B0,$0C
                      db $A6,$AF,$C6,$AF,$AF,$AF,$AF,$C7
                      db $C7,$C7,$00

MusicB1S05P0A:        db $0C,$AD,$AD,$AD,$C7,$18,$AD,$0C
                      db $C7,$AB,$C6,$AB,$AB,$AB,$AB,$C7
                      db $C7,$C7

MusicB1S05P08:        db $0C,$A9,$A9,$A9,$C7,$18,$A9,$0C
                      db $C7,$A8,$C6,$A8,$A8,$A8,$A8,$C7
                      db $C7,$C7

MusicB1S05P07:        db $24,$8E,$0C,$95,$24,$9A,$0C,$95
                      db $8C,$8C,$8C,$8C,$8C,$C6,$C6,$93

MusicB1S05P0B:        db $0C,$A6,$C6,$AD,$C6,$C6,$AD,$A3
                      db $A3,$A6,$C6,$AD,$AD,$AD,$C6,$B0
                      db $C6

MusicB1S05P09:        db $0C,$C7,$C6,$D2,$C6,$C6,$C6,$0C
                      db $69,$D1,$D1,$0C,$6B,$C7,$D1,$0C
                      db $69,$D1,$0C,$6B,$D1,$30,$6C,$D1

MusicB1S07P00:        db $F0,$DA,$04,$E2,$18,$DB,$05,$DE
                      db $00,$00,$00,$60,$49,$C6,$48,$C6
                      db $0C,$C7,$AC,$00

MusicB1S07P02:        db $DA,$04,$DB,$0A,$DE,$00,$00,$00
                      db $60,$49,$C6,$48,$C6,$0C,$C7,$A7

MusicB1S07P04:        db $DA,$04,$DB,$0F,$DE,$00,$00,$00
                      db $60,$49,$C6,$48,$C6,$0C,$C7,$A1

MusicB1S07P06:        db $60,$AB,$48,$C6,$0C,$C7,$AB,$00

MusicB1S07P07:        db $60,$A6,$48,$C6,$0C,$C7,$A6

MusicB1S07P08:        db $60,$A0,$48,$C6,$0C,$C7,$A0

MusicB1S07P09:        db $60,$AC,$48,$C6,$0C,$C7,$AC,$00

MusicB1S07P0A:        db $60,$A7,$48,$C6,$0C,$C7,$A7

MusicB1S07P0B:        db $60,$A1,$48,$C6,$0C,$C7,$A1

MusicB1S07P01:        db $DA,$0E,$E7,$FF,$DB,$0A,$06,$6F
...
MusicB1S07P05:        db $DA,$05,$DB,$14,$DE,$00,$00,$00
...
MusicB1S07P03:        db $DA,$05,$E7,$FF,$DB,$0A,$DE,$00
                      db $00,$00,$18,$4F,$D0,$D8,$0C,$C7
                      db $D0,$18,$D8,$D0,$D8,$0C,$C7,$D0
                      db $18,$D8

MusicB1S03P00:        db $F0,$DA,$03,$E2,$1C,$DB,$0A,$12
...
MusicB1S03P01:        db $DA,$03,$DB,$0A,$12,$5D,$A4,$06
...
MusicB1S03P04:        db $DA,$03,$E2,$1C,$DB,$0A,$12,$5D
                      db $A8,$06,$A8,$0C,$A8,$9F,$18,$A1
                      db $9F,$DA,$01,$0C,$A8,$A7,$A6,$A5
                      db $30,$A4,$00

MusicB1S03P05:        db $DA,$03,$DB,$0A,$12,$5D,$A4,$06
                      db $A4,$0C,$A4,$9C,$18,$9D,$9C,$DA
                      db $01,$0C,$A2,$A1,$A0,$9F,$30,$9E

MusicB1S03P06:        db $DA,$04,$DB,$0A,$24,$6D,$8C,$0C
                      db $93,$18,$98,$93,$0C,$8C,$8B,$8A
                      db $89,$30,$88

MusicB1S03P07:        db $DA,$04,$DB,$14,$06,$6B,$D1,$06
                      db $69,$D1,$D1,$D1,$0C,$D1,$D1,$18
                      db $D1,$D1,$48,$C7,$D4

MusicB1S02P06:        db $DA,$08,$E2,$1C,$DB,$0A,$18,$4F
                      db $8C,$98,$89,$95,$8E,$9A,$87,$93
                      db $8C,$98,$89,$95,$60,$C7,$00

MusicB1S02P05:        db $DA,$03,$DB,$0A,$08,$6F,$C7,$C7
...
MusicB1S02P07:        db $DA,$03,$DB,$00,$08,$6F,$C7,$C7
                      db $C7,$AB,$C7,$AB,$18,$C7,$A8,$08
                      db $C7,$C7,$C7,$AD,$C7,$AD,$18,$C7
                      db $AB,$08,$C7,$C7,$C7,$AB,$C7,$AB
                      db $18,$C7,$A8,$60,$C7

MusicB1S02P08:        db $DA,$03,$DB,$14,$08,$6F,$C7,$C7
...
MusicB1S02P01:        db $DA,$08,$DB,$0A,$18,$4F,$8C,$98
                      db $89,$95,$8E,$9A,$87,$93,$8C,$98
                      db $89,$95,$0C,$8E,$C7,$18,$C7,$30
                      db $8D,$00

MusicB1S02P00:        db $F0,$DA,$03,$E2,$1C,$DB,$0A,$08
...
MusicB1S04P0E:        db $DA,$05,$DB,$0A,$DE,$00,$00,$00
                      db $30,$4F,$D0,$02,$C7,$16,$D8,$0C
                      db $C6,$D0,$0C,$C7,$D0,$C7,$D0,$01
                      db $C7,$17,$D8,$0C,$C6,$D0,$30,$D0
...
MusicB1S01P00:        db $F0,$DA,$03,$E2,$3C,$E0,$E6,$DB
...
MusicB1S01P01:        db $DA,$00,$DB,$0A,$E7,$FA,$DE,$23
                      db $13,$40,$18,$4E,$BE,$BE,$BE,$B2
                      db $BE,$BE,$BE,$B2,$E1,$0C,$96,$0C
                      db $BF,$E1,$54,$FA,$54,$C6,$E0,$E6
                      db $18,$BE,$C7,$C7

MusicB1S01P02:        db $DA,$01,$DB,$0A,$E7,$FA,$DE,$23
                      db $12,$40,$18,$4E,$A6,$A6,$A6,$9A
                      db $A6,$A6,$A6,$9A,$60,$AD,$18,$AA
                      db $C7,$C7

MusicB1S01P03:        db $DA,$00,$DB,$0A,$E7,$FA,$DE,$23
                      db $11,$40,$60,$4E,$C7,$C7,$60,$9D
                      db $18,$9A,$C7,$C7

MusicB1S01P04:        db $DA,$02,$E0,$C8,$DB,$00,$18,$4B
...
MusicB1S01P05:        db $DA,$00,$DB,$0A,$E7,$DC,$DE,$23
...
MusicB1S01P0A:        db $DA,$00,$DB,$0A,$18,$4C,$B2,$BB
...
MusicB1S01P1A:        db $DA,$01,$DB,$0A,$18,$6E,$C7,$48
                      db $9F,$18,$9F,$30,$9F,$C7,$60,$9F
                      db $9A

MusicB1S01P19:        db $DA,$01,$DB,$0A,$18,$6E,$C7,$48
                      db $98,$18,$98,$30,$98,$C7,$60,$97
                      db $93

MusicB1S01P1B:        db $DA,$00,$E0,$DC,$DB,$0A,$DE,$23
                      db $12,$40,$18,$6E,$B3,$B4,$B4,$B4
...
MusicB1S01P1C:        db $DA,$02,$DB,$05,$18,$6E,$C7,$06
...
MusicBank1_End:       dw $0000,SPCEngine

MusicBank2:           dw MusicBank2_End-MusicBank2-4
                      dw MusicData
...
MusicB2S0B:           dw MusicB2S0CL00
                      dw MusicB2S0BL01
                      dw $0000

MusicB2S0BL01:        dw MusicB2S0BP02
                      dw MusicB2S0BP03
                      dw MusicB2S0BP04
                      dw MusicB2S0BP05
                      dw MusicB2S0BP06
...
MusicB2S05L00:        dw MusicB2S05P00
                      dw MusicB2S05P01
                      dw MusicB2S05P02
                      dw MusicB2S05P03
                      dw $0000
...
MusicB2S05L01:        dw MusicB2S05P07
                      dw $0000
                      dw $0000
                      dw MusicB2S05P08
                      dw $0000
...
MusicB2S05L04:        dw MusicB2S05P07
                      dw MusicB2S05P14
                      dw MusicB2S05P15
                      dw MusicB2S05P08
                      dw $0000
...
MusicB2S05L07:        dw MusicB2S05P07
                      dw MusicB2S05P20
                      dw MusicB2S05P21
                      dw MusicB2S05P08
                      dw $0000
...
MusicB2S05L08:        dw MusicB2S05P07
                      dw MusicB2S05P22
                      dw MusicB2S05P23
                      dw MusicB2S05P08
                      dw $0000
...
MusicB2S05L02:        dw MusicB2S05P07
                      dw MusicB2S05P0C
                      dw MusicB2S05P0D
                      dw MusicB2S05P08
                      dw $0000
...
MusicB2S05Lu00:       dw MusicB2S05P07
                      dw $0000
                      dw $0000
                      dw MusicB2S05P1E
                      dw $0000
...
MusicB2S05L06:        dw MusicB2S05P07
                      dw MusicB2S05P1C
                      dw MusicB2S05P1D
                      dw MusicB2S05P1E
                      dw $0000
...
MusicB2S05Lu01:       dw MusicB2S05P0E
                      dw $0000
                      dw $0000
                      dw MusicB2S05P08
                      dw $0000
...
MusicB2S05L03:        dw MusicB2S05P0E
                      dw MusicB2S05P0F
                      dw MusicB2S05P10
                      dw MusicB2S05P08
                      dw $0000
...
MusicB2S05Lu02:       dw MusicB2S05P16
                      dw $0000
                      dw $0000
                      dw MusicB2S05P19
                      dw $0000
...
MusicB2S05L05:        dw MusicB2S05P16
                      dw MusicB2S05P17
                      dw MusicB2S05P18
                      dw MusicB2S05P19
                      dw $0000
...
MusicB2S08L00:        dw MusicB2S08P00
                      dw MusicB2S08P01
                      dw MusicB2S08P02
                      dw MusicB2S08P03
                      dw MusicB2S08P04
...
MusicB2S08L01:        dw MusicB2S08P08
                      dw MusicB2S08P09
                      dw $0000
                      dw $0000
                      dw $0000
...
MusicB2S08L02:        dw MusicB2S08P08
                      dw MusicB2S08P09
                      dw MusicB2S08P0B
                      dw MusicB2S08P0C
                      dw $0000
...
MusicB2S08L03:        dw MusicB2S08P0D
                      dw MusicB2S08P0E
                      dw MusicB2S08P0F
                      dw MusicB2S08P10
                      dw MusicB2S08P11
...
MusicB2S08L04:        dw MusicB2S08P14
                      dw MusicB2S08P15
                      dw $0000
                      dw $0000
                      dw $0000
...
MusicB2S08L05:        dw MusicB2S08P14
                      dw MusicB2S08P15
                      dw MusicB2S08P17
                      dw $0000
                      dw $0000
...
MusicB2S08L07:        dw MusicB2S08P14
                      dw MusicB2S08P15
                      dw MusicB2S08P17
                      dw $0000
                      dw $0000
...
MusicB2S08L06:        dw MusicB2S08P14
                      dw MusicB2S08P15
                      dw MusicB2S08P19
                      dw MusicB2S08P1A
                      dw $0000
...
MusicB2S08L08:        dw MusicB2S08P1C
                      dw MusicB2S08P1D
                      dw MusicB2S08P1E
                      dw MusicB2S08P1F
                      dw $0000
...
MusicB2S08L09:        dw MusicB2S08P23
                      dw MusicB2S08P24
                      dw MusicB2S08P25
                      dw MusicB2S08P26
                      dw $0000
...
MusicB2S0EL00:        dw MusicB2S0EP00
                      dw $0000
                      dw $0000
                      dw $0000
                      dw $0000
...
MusicB2S0EL02:        dw MusicB2S0EP04
                      dw $0000
                      dw $0000
                      dw $0000
                      dw $0000
...
MusicB2S0EL03:        dw MusicB2S0EP05
                      dw $0000
                      dw $0000
                      dw $0000
                      dw $0000
...
MusicB2S0EL01:        dw MusicB2S0EP01
                      dw MusicB2S0EP02
                      dw MusicB2S0EP03
                      dw $0000
                      dw $0000
...
MusicB2S0A:           dw MusicB2S0AL00
                      dw MusicB2S0AL01
                      dw MusicB2S0AL02
                      dw $0000

MusicB2S0AL00:        dw MusicB2S0AP00
                      dw MusicB2S0AP01
                      dw MusicB2S0AP02
                      dw MusicB2S0AP03
                      dw MusicB2S0AP04
...
MusicB2S0AL01:        dw MusicB2S0AP07
                      dw MusicB2S0AP08
                      dw MusicB2S0AP09
                      dw MusicB2S17P07
                      dw $0000
...
MusicB2S16:           dw MusicB2S18L00
                      dw $0000

MusicB2S18L00:        dw MusicB2S18P00
                      dw MusicB2S18P01
                      dw MusicB2S18P02
                      dw MusicB2S18P03
                      dw $0000
...
MusicB2S19:           dw MusicB2S1BL00
                      dw MusicB2S1BL01
                      dw MusicB2S1BL02
                      dw $0000

MusicB2S1BL00:        dw MusicB2S1BP00
                      dw MusicB2S1BP01
                      dw MusicB2S1BP02
                      dw MusicB2S1BP03
                      dw $0000
...
MusicB2S1BL01:        dw MusicB2S1BP04
                      dw MusicB2S1BP05
                      dw MusicB2S1BP06
                      dw MusicB2S1BP07
                      dw $0000
...
MusicB2S1A:           dw MusicB2S1CL00
                      dw MusicB2S1CL01
                      dw $0000

MusicB2S1CL00:        dw MusicB2S1CP00
                      dw MusicB2S1CP01
                      dw MusicB2S1CP02
                      dw $0000
                      dw $0000
...
MusicB2S1CL01:        dw MusicB2S1CP03
                      dw MusicB2S1CP04
                      dw MusicB2S1CP05
                      dw MusicB2S1CP06
                      dw MusicB2S1CP07
...
MusicB2S1CP00:        db $DA,$12,$E2,$14,$DE,$14,$14,$20
                      db $DB,$0A,$0C,$6D,$AA,$0C,$3D,$AD
                      db $0C,$6D,$A8,$0C,$3D,$AD,$0C,$6D
                      db $A6,$0C,$3D,$AD,$18,$6D,$B2,$60
                      db $B9,$C6,$00

MusicB2S1CP01:        db $DA,$12,$DB,$0A,$06,$C7,$0C,$6B
...
MusicB2S1CP02:        db $DA,$12,$DE,$14,$14,$20,$DB,$0A
                      db $18,$5D,$9A,$99,$98,$97,$60,$96
                      db $C6

MusicB2S1CP03:        db $DA,$12,$E2,$23,$DE,$14,$14,$20
...
MusicB2S1CP08:        db $DA,$12,$DE,$14,$14,$20,$DB,$0A
...
MusicB2S1BP01:        db $DA,$11,$DB,$0A,$03,$C7,$0C,$7F
...
MusicB2S1BP02:        db $DA,$11,$DB,$05,$06,$C7,$0C,$7F
...
MusicB2S1BP03:        db $DA,$11,$DB,$0A,$06,$7E,$D0,$06
...
MusicB2S1BP04:        db $DA,$11,$E2,$19,$E0,$FF,$E1,$60
...
MusicB2S1BP05:        db $DA,$11,$DB,$00,$06,$C7,$18,$7F
...
MusicB2S1BP06:        db $DA,$11,$DB,$0F,$0C,$C7,$18,$7F
...
MusicB2S1BP07:        db $DA,$11,$DB,$05,$12,$C7,$18,$7F
                      db $91,$DD,$00,$0C,$9A,$DD,$00,$0C
                      db $90,$18,$7F,$95,$DD,$00,$0C,$9D
                      db $DD,$00,$0C,$93,$18,$7F,$98,$DD
                      db $00,$0C,$9F,$DD,$00,$0C,$97,$18
...
MusicB2S17P00:        db $DA,$11,$E2,$19,$E0,$C8,$E1,$60
...
MusicB2S17P01:        db $DA,$11,$DB,$00,$DC,$30,$0A,$06
...
MusicB2S17P02:        db $DA,$11,$DB,$0F,$DC,$30,$0A,$0C
...
MusicB2S17P03:        db $DA,$11,$DB,$05,$DC,$30,$0A,$12
                      db $C7,$18,$7E,$9F,$DD,$00,$0C,$A6
                      db $DD,$00,$0C,$9D,$18,$7D,$A3,$DD
                      db $00,$0C,$A9,$DD,$00,$0C,$A1,$18
                      db $7C,$A6,$DD,$00,$0C,$AB,$DD,$00
...
MusicB2S17P04:        db $DA,$11,$E0,$64,$E1,$60,$FF,$DB
...
MusicB2S17P05:        db $DB,$0A,$DC,$60,$00,$06,$C7,$18
                      db $7B,$B2,$DD,$00,$0C,$B9,$DD,$00
...
MusicB2S17P06:        db $DB,$0A,$DC,$60,$0F,$0C,$C7,$18
...
MusicB2S17P07:        db $DB,$0A,$DC,$60,$05,$12,$C7,$18
                      db $7B,$A9,$DD,$00,$0C,$AD,$DD,$00
                      db $0C,$9C,$18,$7B,$A6,$DD,$00,$0C
                      db $AB,$DD,$00,$0C,$A4,$18,$7C,$A3
                      db $DD,$00,$0C,$A9,$DD,$00,$0C,$A1
...
MusicB2S18P00:        db $DA,$11,$E2,$19,$E0,$FF,$E1,$60
...
MusicB2S18P01:        db $DA,$11,$DB,$00,$DC,$60,$0A,$06
...
MusicB2S18P02:        db $DA,$11,$DB,$0F,$DC,$60,$0A,$0C
...
MusicB2S18P03:        db $DA,$11,$DB,$05,$DC,$60,$0A,$12
                      db $C7,$18,$7F,$9F,$DD,$00,$0C,$A6
                      db $DD,$00,$0C,$9D,$18,$7E,$9C,$DD
                      db $00,$0C,$A3,$DD,$00,$0C,$9A,$18
                      db $7D,$98,$DD,$00,$0C,$A1,$DD,$00
...
MusicB2S19P00:        db $DA,$04,$E2,$28,$DB,$0A,$48,$7E
                      db $A3,$C6,$DD,$0C,$60,$97,$E2,$41
                      db $00

MusicB2S1AP00:        db $DA,$04,$E2,$32,$DB,$0A,$48,$7E
                      db $A3,$C6,$DD,$0C,$60,$97,$E2,$46
                      db $00

MusicB2S19P01:        db $DA,$04,$DB,$14,$48,$7E,$A8,$C6
                      db $DD,$0C,$60,$97

MusicB2S19P02:        db $DA,$04,$DB,$0F,$48,$7E,$AD,$C6
                      db $DD,$0C,$60,$97

MusicB2S19P03:        db $DA,$04,$DB,$05,$48,$7E,$B2,$C6
                      db $DD,$0C,$60,$97

MusicB2S19P04:        db $DA,$04,$DB,$00,$48,$7E,$B7,$C6
                      db $DD,$0C,$60,$97

MusicB2S19P05:        db $DA,$04,$DB,$0A,$48,$7E,$BB,$C6
                      db $DD,$0C,$60,$97

MusicB2S04P00:        db $DA,$04,$E2,$0D,$E3,$FF,$1E,$DB
                      db $14,$18,$7D,$84,$8A,$89,$88,$82
                      db $83,$18,$7E,$84,$8A,$89,$88,$82
                      db $83,$18,$7F,$84,$8A,$89,$88,$C7
                      db $C7,$00

MusicB2S04P01:        db $DA,$04,$DB,$0A,$18,$7D,$90,$96
                      db $95,$94,$8E,$8F,$18,$7E,$90,$96
                      db $95,$94,$8E,$8F,$18,$7F,$90,$96
                      db $95,$94,$C7,$C7

MusicB2S04P02:        db $DA,$04,$DB,$00,$18,$7D,$8B,$91
                      db $90,$8F,$89,$8A,$18,$7E,$8B,$91
                      db $90,$8F,$89,$8A,$18,$7F,$8B,$91
                      db $90,$8F,$C7,$C7

MusicB2S04P03:        db $DA,$04,$DB,$0F,$60,$7D,$C7,$30
                      db $C7,$18,$7E,$97,$9D,$9C,$9B,$95
                      db $96,$18,$7F,$97,$9D,$9C,$9B,$C7
                      db $C7

MusicB2S04P04:        db $DA,$04,$DB,$0A,$60,$C7,$C7,$C7
                      db $18,$7F,$9C,$A2,$A1,$A0,$C7,$C7

MusicB2S04P05:        db $DA,$04,$DB,$0A,$06,$C7,$18,$79
                      db $90,$96,$95,$94,$8E,$8F,$18,$7B
                      db $97,$9D,$9C,$9B,$95,$96,$18,$7C
                      db $9C,$A2,$A1,$12,$A0,$18,$C7,$C7

MusicB2S04P06:        db $DA,$04,$DB,$0A,$18,$7D,$D0,$D0
                      db $D0,$D0,$D0,$D0,$18,$7E,$D0,$D0
                      db $D0,$D0,$D0,$D0,$0C,$7F,$D0,$D0
                      db $D0,$D0,$D0,$D0,$D0,$D0,$C7,$C7
                      db $C7,$C7

MusicB2S04P07:        db $DA,$04,$E2,$14,$E3,$FF,$28,$DB
                      db $14,$48,$7E,$84,$DB,$08,$48,$A2
                      db $DB,$0A,$48,$A3,$C6,$DD,$0C,$60
                      db $97,$E2,$3C,$00

MusicB2S04P08:        db $DA,$04,$DB,$12,$0C,$7E,$C7,$48
                      db $89,$DB,$06,$3C,$A7,$DB,$14,$48
                      db $A8,$C6,$DD,$0C,$60,$97

MusicB2S04P09:        db $DA,$04,$DB,$10,$18,$7E,$C7,$48
                      db $8E,$DB,$04,$30,$AC,$DB,$0F,$48
                      db $AD,$C6,$DD,$0C,$60,$97

MusicB2S04P0A:        db $DA,$04,$DB,$0E,$24,$7E,$C7,$48
                      db $93,$DB,$02,$24,$B1,$DB,$05,$48
                      db $B2,$C6,$DD,$0C,$60,$97

MusicB2S04P0B:        db $DA,$04,$DB,$0C,$30,$7E,$C7,$48
                      db $98,$DB,$00,$18,$B6,$DB,$00,$48
                      db $B7,$C6,$DD,$0C,$60,$97

MusicB2S04P0C:        db $DA,$04,$DB,$0A,$3C,$7E,$C7,$48
                      db $9D,$DB,$00,$0C,$BA,$DB,$0A,$48
                      db $BB,$C6,$DD,$0C,$60,$97

MusicB2S04P15:        db $E7,$F0,$DA,$11,$DE,$48,$07,$30
                      db $DB,$0A,$08,$7E,$97,$9A,$9D,$48
                      db $A3,$54,$A2,$6C,$9C,$60,$C6,$00

MusicB2S04P16:        db $E7,$F0,$DA,$11,$DE,$48,$07,$30
                      db $DB,$0C,$08,$7C,$C6,$C6,$97,$9A
                      db $9D,$48,$A3,$54,$A2,$6C,$9C,$60
                      db $C6

MusicB2S04P18:        db $08,$C6,$C6

MusicB2S04P17:        db $08,$97,$9A,$9D,$48,$A3,$54,$A2
                      db $6C,$A6,$60,$C6,$00

MusicB2S04P10:        db $DA,$0F,$DB,$0F,$60,$7D,$C6,$54
                      db $9E,$6C,$A1,$C6

MusicB2S04P13:        db $DA,$0F,$DB,$0F,$60,$7D,$C6,$54
                      db $A1,$6C,$A7,$C6

MusicB2S04P0E:        db $DA,$11,$DB,$0F,$60,$7D,$97,$96
                      db $95,$94

MusicB2S04P12:        db $DA,$11,$DB,$05,$60,$7D,$90,$8F
                      db $8E,$8D

MusicB2S04P0D:        db $DA,$0E,$DB,$0A,$0C,$7F,$90,$C6
                      db $90,$C6,$90,$C6,$90,$C6,$0C,$90
                      db $90,$90,$8E,$C6,$8E,$8E,$8F,$18
                      db $90,$90,$90,$90,$0C,$90,$90,$90
                      db $8E,$C6,$8E,$8E,$8F,$00

MusicB2S04P0F:        db $DA,$01,$DB,$0A,$E9,$9D,$24,$04
                      db $18,$7E,$D0,$C6,$0C,$D0,$D0,$18
                      db $C6,$0C,$D0,$C6,$C6,$D0,$C6,$D0
                      db $C6,$C6,$00

MusicB2S04P11:        db $DA,$01,$DB,$0A,$E9,$B8,$24,$10
                      db $18,$7E,$C6,$D8,$00

MusicB2S04P14:        db $18,$7E,$C6,$D8,$C6,$D8,$C6,$D8
                      db $C6,$D8,$C6,$D8,$C6,$D8,$0C,$C6
                      db $D8,$D8,$D8,$D8,$D8,$D8,$D8,$00

MusicB2S04P1E:        db $08,$C6,$C6

MusicB2S04P1B:        db $60,$A9,$54,$A8,$6C,$A0,$48,$C6
                      db $18,$A9,$00

MusicB2S04P1A:        db $DB,$0A,$0C,$3D,$97,$9D,$97,$C6
...
MusicB2S04P1F:        db $DB,$05,$01,$3C,$C7,$0C,$9D,$97
...
MusicB2S04P19:        db $0C,$88,$C6,$88,$C6,$88,$C6,$88
                      db $C6,$88,$C6,$88,$88,$C6,$88,$88
                      db $88,$0C,$88,$C6,$88,$C6,$88,$C6
                      db $88,$C6,$88,$C6,$88,$88,$C6,$88
                      db $88,$88,$00

MusicB2S04P1C:        db $DA,$01,$DB,$0A,$E9,$89,$25,$04
                      db $18,$7E,$D0,$C6,$0C,$D0,$D0,$18
                      db $C6,$0C,$C6,$D0,$D0,$C6,$D0,$D0
                      db $C6,$D0,$00

MusicB2S04P1D:        db $DA,$01,$DB,$0A,$E9,$A4,$25,$04
                      db $18,$7E,$C6,$D8,$C6,$D8,$0C,$7E
                      db $D8,$C6,$C6,$D8,$C6,$C6,$D8,$C6
                      db $00

MusicB2S04P23:        db $08,$C6,$C6

MusicB2S04P22:        db $60,$A8,$54,$A7,$6C,$9F,$48,$C6
                      db $30,$A8

MusicB2S04P21:        db $0C,$96,$9C,$96,$C6,$96,$9C,$96
...
MusicB2S04P24:        db $01,$C7,$0C,$9C,$96,$9C,$C6,$9C
...
MusicB2S04P20:        db $0C,$87,$C6,$87,$C6,$87,$C6,$87
                      db $C6,$87,$C6,$87,$87,$C6,$87,$87
                      db $87,$0C,$87,$C6,$87,$C6,$87,$C6
                      db $87,$C6,$87,$C6,$87,$87,$C6,$87
                      db $87,$87,$00

MusicB2S04P26:        db $08,$C6,$C6

MusicB2S04P25:        db $E8,$FF,$28,$60,$C6,$18,$C6,$DD
                      db $00,$30,$BB,$48,$C6,$60,$C6,$C6
                      db $00

MusicB2S15P00:        db $DA,$01,$E2,$2D,$DE,$14,$14,$20
                      db $DB,$05,$30,$5D,$B4,$B2,$B0,$60
                      db $AF,$C6,$30,$C6,$00

MusicB2S15P01:        db $DA,$01,$DE,$14,$14,$20,$DB,$0F
                      db $30,$5D,$B0,$AF,$AD,$60,$AB,$C6
                      db $C6

MusicB2S15P02:        db $DA,$01,$DE,$14,$14,$20,$DB,$0A
                      db $0C,$5D,$B7,$B9,$B7,$B9,$B7,$B9
                      db $B7,$B9,$B7,$B9,$B7,$B9,$06,$B7
                      db $B9,$B7,$B9,$B7,$B9,$B7,$B9,$60
                      db $B7,$60,$59,$C3

MusicB2S15P03:        db $DA,$00,$DE,$14,$14,$20,$DB,$0A
                      db $0C,$59,$B7,$B9,$B7,$B9,$B7,$B9
                      db $B7,$B9,$B7,$B9,$B7,$B9,$06,$B7
                      db $B9,$B7,$B9,$B7,$B9,$B7,$B9,$60
                      db $B7,$C6,$C6

MusicB2S13P00:        db $DA,$01,$E2,$32,$DE,$14,$14,$20
...
MusicB2S13P04:        db $DA,$00,$DE,$14,$13,$20,$DB,$0A
...
MusicB2S13P01:        db $DA,$01,$DE,$14,$15,$20,$DB,$0F
...
MusicB2S13P07:        db $DA,$01,$DB,$0F,$DE,$14,$14,$20
                      db $E7,$AA,$E8,$C0,$F0,$18,$3E,$C7
...
MusicB2S13P06:        db $DA,$01,$DB,$05,$E9,$67,$28,$04
                      db $E7,$DC,$E8,$60,$64,$06,$7E,$D7
                      db $D7,$D7,$D7,$D7,$D7,$D7,$D7,$D7
                      db $D7,$D7,$D7,$D7,$D7,$D7,$D7,$E7
                      db $AA,$48,$C7,$18,$5E,$D6,$00

MusicB2S13P08:        db $60,$A9,$C6,$18,$7C,$AB,$B2,$B7
                      db $B9,$30,$BA,$BB,$60,$C6,$00

MusicB2S13P0F:        db $DA,$01,$DE,$14,$15,$20,$60,$7C
                      db $A4,$C6,$18,$A3,$A9,$AF,$B0,$30
                      db $B1,$B2,$60,$C6

MusicB2S13P09:        db $30,$5B,$C6,$B9,$30,$B5,$B2,$60
                      db $B0,$AF,$C6

MusicB2S13P0C:        db $DA,$00,$DB,$0A,$DE,$14,$14,$20
                      db $18,$5D,$C7,$0C,$A6,$A5,$18,$A6
                      db $A9,$AD,$A9,$AD,$B5,$60,$B4,$B2
                      db $C6

MusicB2S13P0B:        db $60,$8E,$C6,$60,$93,$C6,$C6

MusicB2S13P0D:        db $DA,$01,$DB,$0A,$60,$6D,$A1,$C6
                      db $60,$A3,$DA,$10,$06,$6D,$AB,$AF
                      db $B2,$B5,$B7,$BB,$BE,$C1,$30,$C3
                      db $60,$C6

MusicB2S13P0A:        db $60,$9A,$C6,$60,$9F,$C6,$C6

MusicB2S13P0E:        db $DA,$01,$DB,$05,$E7,$C8,$E8,$30
...
MusicB2S12P00:        db $F0,$DA,$04,$E2,$40,$DB,$05,$30
                      db $5C,$AB,$AB,$AA,$AA,$18,$A9,$A6
                      db $AD,$60,$AB,$18,$C7,$00

MusicB2S12P04:        db $DA,$00,$DB,$0A,$30,$5C,$B7,$B7
                      db $B6,$B6,$18,$B5,$B2,$B9,$60,$B7
                      db $18,$C7

MusicB2S12P02:        db $DA,$04,$DB,$0A,$30,$5C,$A8,$A8
                      db $A7,$A7,$18,$A6,$A2,$A9,$60,$A8
                      db $18,$C7

MusicB2S12P03:        db $DA,$04,$DB,$0F,$30,$5C,$A4,$A4
                      db $A4,$A4,$18,$A2,$9F,$A6,$60,$A4
                      db $18,$C7

MusicB2S12P01:        db $DA,$0E,$DB,$0A,$30,$5D,$95,$95
                      db $94,$94,$18,$93,$C7,$93,$8C,$C6
                      db $8C,$8C,$8C

MusicB2S12P06:        db $DA,$07,$DB,$0A,$18,$5B,$91,$A4
                      db $A4,$91,$A4,$A4,$91,$A4,$8E,$A1
                      db $A1,$8E,$A1,$A1,$8E,$A1,$91,$A4
                      db $A4,$91,$A4,$A4,$91,$A4,$8E,$A1
                      db $A1,$8E,$A1,$C6,$C6,$C6

MusicB2S12P05:        db $DA,$07,$DB,$05,$18,$5B,$C7,$A9
                      db $A9,$C7,$A9,$A9,$C7,$A9,$C7,$A6
                      db $A6,$C7,$A6,$A6,$C7,$A6,$C7,$A9
                      db $A9,$C7,$A9,$A9,$C7,$A9,$C7,$A6
                      db $A6,$C7,$A6,$C6,$C6,$C6,$00

MusicB2S12P07:        db $DA,$0C,$DB,$0F,$DB,$0A,$E7,$FF
...
MusicB2S12P08:        db $DE,$00,$00,$00,$DA,$01,$DB,$0A
                      db $EC,$00,$06,$08,$30,$5D,$B9,$24
                      db $B5,$0C,$B0,$18,$B5,$B5,$24,$B5
                      db $0C,$B0,$18,$B5,$B5,$B5,$BC,$30
                      db $B9,$24,$B7,$0C,$B0,$00

MusicB2S12P0B:        db $DE,$00,$00,$00,$DA,$02,$DB,$05
                      db $30,$59,$B9,$24,$B5,$0C,$B0,$18
                      db $B5,$B5,$24,$B5,$0C,$B0,$18,$B5
                      db $B5,$B5,$BC,$30,$B9,$24,$B7,$0C
                      db $B0

MusicB2S12P09:        db $DA,$07,$DB,$0A,$18,$59,$91,$A4
                      db $91,$A4,$91,$A4,$91,$A4,$91,$A4
                      db $91,$A4,$91,$C7,$8C,$C6

MusicB2S12P0A:        db $DA,$07,$DB,$05,$18,$59,$C7,$A1
                      db $C7,$A1,$C7,$A1,$C7,$A1,$C7,$A1
                      db $C7,$A1,$A1,$C7,$9F,$C6

MusicB2S12P0C:        db $DA,$07,$DB,$0F,$18,$59,$C7,$A9
                      db $C7,$A9,$C7,$A9,$C7,$A9,$C7,$A9
                      db $C7,$A9,$A4,$C7,$A8,$C6

MusicB2S12P0D:        db $30,$B9,$24,$B5,$0C,$B0,$18,$B5
                      db $B5,$24,$B5,$0C,$B0,$18,$B5,$BC
                      db $B9,$B7,$30,$B5,$DA,$0F,$18,$A1
                      db $C6,$00

MusicB2S12P10:        db $30,$B9,$24,$B5,$0C,$B0,$18,$B5
                      db $B5,$24,$B5,$0C,$B0,$18,$B5,$BC
                      db $B9,$B7,$30,$B5,$DA,$0F,$18,$AD
                      db $C6

MusicB2S12P0E:        db $18,$91,$A4,$91,$A4,$91,$A4,$91
                      db $A4,$91,$A4,$98,$A8,$91,$C7,$91
                      db $C7

MusicB2S12P0F:        db $18,$C7,$A1,$C7,$A1,$C7,$A1,$C7
                      db $A1,$C7,$A1,$C7,$A4,$A1,$C7,$A1
                      db $C7

MusicB2S12P11:        db $18,$C7,$A9,$C7,$A9,$C7,$A9,$C7
                      db $A9,$C7,$A9,$C7,$AB,$A4,$C7,$A4
                      db $C7

MusicB2S12P12:        db $DA,$01,$30,$B9,$18,$B5,$B0,$30
                      db $B9,$B5,$0C,$B8,$B5,$18,$B0,$30
                      db $B8,$60,$B7,$00

MusicB2S12P13:        db $18,$96,$A6,$96,$A6,$95,$A4,$95
                      db $A4,$94,$A4,$94,$A4,$93,$A6,$8C
                      db $A4,$00

MusicB2S12P14:        db $18,$C7,$A2,$C7,$A2,$C7,$A1,$C7
                      db $A1,$C7,$A0,$C7,$A0,$C7,$A2,$C7
                      db $A2

MusicB2S12P15:        db $18,$C7,$A9,$C7,$A9,$C7,$A9,$C7
                      db $A9,$C7,$A9,$C7,$A9,$C7,$A9,$C7
                      db $A8

MusicB2S12P16:        db $30,$B9,$18,$B5,$B0,$30,$B9,$B5
                      db $0C,$B8,$B5,$18,$B0,$60,$BC,$30
                      db $C7,$00

MusicB2S14P00:        db $DA,$01,$DB,$0A,$E2,$40,$EC,$00
                      db $06,$08,$30,$5D,$BE,$BE,$BE,$BE
                      db $18,$BC,$BC,$B9,$B7,$30,$B5,$DA
                      db $0F,$18,$A1,$C6,$00

MusicB2S14P05:        db $DA,$01,$DB,$0A,$EC,$00,$06,$08
                      db $30,$5D,$BA,$BA,$BB,$BB,$18,$B9
                      db $B9,$B5,$B4,$30,$B0,$DA,$0F,$18
                      db $95,$C6,$00

MusicB2S14P04:        db $DA,$02,$DB,$05,$30,$59,$BE,$BE
                      db $BE,$BE,$18,$BC,$BC,$B9,$B7,$30
                      db $B5,$DA,$0F,$18,$A1,$C6,$00

MusicB2S14P01:        db $DA,$07,$DB,$0A,$18,$59,$96,$A6
                      db $96,$A6,$97,$A6,$97,$A6,$98,$A8
                      db $98,$A8,$91,$C7,$91,$C7

MusicB2S14P02:        db $DA,$07,$DB,$05,$18,$59,$C7,$A2
                      db $C7,$A2,$C7,$A3,$C7,$A3,$C7,$A4
                      db $C7,$A4,$A1,$C7,$A1,$C7

MusicB2S14P06:        db $DA,$07,$DB,$0F,$18,$59,$C7,$A9
                      db $C7,$A9,$C7,$A9,$C7,$A9,$C7,$AB
                      db $C7,$AB,$A4,$C7,$A4,$C7

MusicB2S14P03:        db $DA,$0C,$DB,$0F,$DB,$0A,$E7,$FF
                      db $24,$6F,$B5,$0C,$B0,$18,$B2,$24
                      db $B5,$0C,$B0,$18,$B2,$0C,$B5,$B9
                      db $B0,$B2,$24,$B5,$0C,$B0,$18,$B2
                      db $B5,$B5,$C6,$B5,$C6

MusicB2S0BP02:        db $F0,$DA,$04,$E2,$2D,$DE,$23,$13
...
MusicB2S0BP03:        db $DA,$04,$DE,$23,$14,$30,$DB,$0A
...
MusicB2S0BP04:        db $DA,$04,$DE,$23,$13,$30,$DB,$0A
...
MusicB2S0BP05:        db $DA,$04,$DE,$23,$14,$30,$DB,$0A
...
MusicB2S0BP08:        db $DA,$02,$DB,$14,$60,$6B,$C7,$C7
...
MusicB2S0BP09:        db $DA,$02,$DB,$14,$04,$69,$C7,$60
...
MusicB2S0BP07:        db $DA,$04,$DE,$23,$11,$30,$DB,$0A
                      db $60,$7E,$8C,$C6,$18,$C6,$0C,$8C
                      db $8C,$18,$8C,$8C,$10,$8C,$8D,$8E
                      db $60,$8F,$10,$8F,$8F,$8F,$60,$91
                      db $30,$C6

MusicB2S0BP06:        db $DA,$04,$DB,$0A,$60,$7E,$D5,$C6
...
MusicB2S08P00:        db $F0,$DA,$01,$E2,$28,$E3,$8C,$46
                      db $E0,$FF,$DE,$23,$11,$40,$DB,$14
                      db $60,$6E,$87,$DB,$04,$60,$B0,$30
                      db $C6,$00

MusicB2S08P01:        db $DA,$01,$DE,$23,$12,$40,$DB,$12
                      db $0C,$6E,$C7,$60,$8D,$DB,$02,$60
                      db $B1,$24,$C6

MusicB2S08P02:        db $DA,$01,$DE,$23,$13,$40,$DB,$10
                      db $18,$6E,$C7,$60,$93,$DB,$00,$60
                      db $B7,$18,$C6

MusicB2S08P03:        db $DA,$01,$DE,$23,$12,$40,$DB,$0E
                      db $24,$6E,$C7,$60,$99,$6C,$C6

MusicB2S08P04:        db $DA,$01,$DE,$23,$13,$40,$DB,$0C
                      db $30,$6E,$C7,$60,$9F,$60,$C6

MusicB2S08P05:        db $DA,$01,$DE,$23,$12,$40,$DB,$0A
                      db $30,$6E,$C7,$0C,$C7,$60,$A4,$54
                      db $C6

MusicB2S08P06:        db $DA,$01,$DE,$23,$14,$40,$DB,$08
                      db $48,$6E,$C7,$60,$A5,$48,$C6

MusicB2S08P07:        db $DA,$01,$DE,$23,$12,$40,$DB,$06
                      db $48,$6E,$C7,$0C,$C7,$60,$AB,$3C
                      db $C6

MusicB2S08P08:        db $E7,$64,$E8,$60,$C8,$DA,$01,$E2
...
MusicB2S08P09:        db $E7,$64,$E8,$60,$C8,$DA,$01,$DB
...
MusicB2S08P0E:        db $E7,$64,$E8,$48,$C8,$DA,$01,$DB
                      db $0F,$06,$6F,$B5,$06,$6B,$B5,$B5
                      db $B5,$B5,$B5,$B5,$B5,$06,$6D,$B5
...
MusicB2S08P11:        db $04,$C7,$DA,$01,$E7,$C8,$DB,$0A
...
MusicB2S08P10:        db $DA,$01,$E7,$C8,$DB,$0A,$DE,$28
                      db $28,$20,$48,$6E,$C7,$18,$AC,$B2
                      db $C7,$C7,$AC,$B2,$C7,$C7,$AC,$B2
                      db $B3,$B1,$B2,$C6,$48,$C7,$60,$C7

MusicB2S08P14:        db $DA,$01,$E2,$19,$DB,$0F,$E7,$78
...
MusicB2S08P15:        db $DA,$01,$DB,$14,$E7,$78,$E8,$30
...
MusicB2S08P16:        db $DA,$01,$E7,$C8,$DB,$0A,$DE,$1E
                      db $28,$20,$30,$6F,$8C,$8C,$92,$92
                      db $91,$91,$93,$93

MusicB2S08P18:        db $DA,$01,$E7,$C8,$DB,$0A,$DE,$1E
                      db $27,$20,$18,$6F,$8C,$8C,$8C,$8C
                      db $92,$92,$92,$92,$91,$91,$91,$91
                      db $93,$93,$93,$93

MusicB2S08P1B:        db $DA,$01,$E7,$C8,$DB,$0A,$DE,$1E
...
MusicB2S08P17:        db $DA,$04,$E7,$C8,$DB,$05,$DE,$1E
...
MusicB2S08P19:        db $DA,$01,$E7,$DC,$DB,$0A,$DE,$1E
                      db $28,$20,$18,$7D,$B3,$C6,$B0,$AB
                      db $18,$AA,$48,$B0,$18,$C7,$AB,$B0
                      db $B7,$30,$B3,$B2

MusicB2S08P1A:        db $DA,$01,$E7,$DC,$DB,$0A,$DE,$18
                      db $29,$20,$18,$7C,$AB,$C6,$A7,$A4
                      db $18,$A4,$48,$AA,$18,$C7,$A4,$AB
                      db $B0,$60,$A9

MusicB2S08P1C:        db $E7,$78,$E8,$30,$C8,$08,$A4,$A4
...
MusicB2S08P1D:        db $E7,$78,$E8,$30,$C8,$04,$C6,$08
...
MusicB2S08P20:        db $DA,$01,$E7,$C8,$DB,$0A,$DE,$1E
...
MusicB2S08P24:        db $E8,$30,$C8,$04,$C6,$08,$9E,$A7
                      db $A7,$A7,$B0,$B0,$E8,$30,$78,$B0
...
MusicB2S08P27:        db $DA,$01,$E7,$C8,$DB,$0A,$DE,$1E
...
MusicB2S05P0C:        db $12,$C7

MusicB2S05P0D:        db $DA,$04,$DB,$0A,$E7,$C8,$60,$C7
                      db $18,$7C,$C7,$60,$9D,$DD,$00,$60
                      db $C1,$C6,$48,$C6

MusicB2S05P0A:        db $DA,$01,$DB,$05,$E7,$C8,$0C,$6D
                      db $AB,$C7,$C7,$AB,$C7,$AB,$AB,$AB
                      db $AB,$C7,$C7,$AE,$C6,$AC,$AE,$AC
                      db $AB,$C7,$C7,$AB,$C7,$AB,$AB,$AB
                      db $AB,$C7,$C7,$AE,$C6,$C6,$C7,$C7

MusicB2S05P0B:        db $DA,$01,$DB,$0A,$E7,$C8,$0C,$6D
                      db $A6,$C7,$C7,$A6,$C7,$A6,$A6,$A6
                      db $A6,$C7,$C7,$A9,$C6,$A7,$A9,$A7
                      db $A6,$C7,$C7,$A6,$C7,$A6,$A6,$A6
                      db $A6,$C7,$C7,$A9,$C6,$C6,$C7,$C7

MusicB2S05P08:        db $DA,$0A,$DB,$0A,$E7,$C8,$E9,$C2
                      db $35,$04,$0C,$6F,$D6,$D7,$D7,$D6
                      db $D7,$D7,$D6,$D7,$00

MusicB2S05P1E:        db $E9,$C2,$35,$03,$0C,$D6,$D7,$D7
                      db $06,$D6,$D6,$0C,$D6,$D6,$D6,$D6

MusicB2S05P09:        db $DA,$04,$E7,$C8,$DB,$0A,$DE,$23
                      db $14,$40,$24,$6D,$8C,$93,$18,$98
                      db $24,$8D,$94,$18,$99

MusicB2S05P1F:        db $24,$8C,$93,$18,$98,$24,$8D,$94
...
MusicB2S0CP03:        db $DA,$05,$DB,$0F,$01,$C7,$08,$49
...
MusicB2S0CP04:        db $DA,$06,$DB,$05,$DE,$23,$14,$20
...
MusicB2S0CP00:        db $DA,$04,$E2,$38,$DB,$0A,$DE,$23
...
MusicB2S0CP05:        db $DA,$06,$DB,$0F,$DE,$23,$14,$20
...
MusicB2S0CP02:        db $DA,$04,$DB,$0A,$18,$4B,$91,$C7
                      db $91,$C7,$8F,$C7,$8F,$C7,$8E,$C7
                      db $8E,$C7,$8D,$C7,$8D,$C7,$8C,$C7
                      db $C7,$C7,$C7,$C7,$8E,$90,$91,$C7
                      db $8C,$C7,$91,$C7,$91,$C7,$00

MusicB2S0AP00:        db $F0,$DA,$0D,$E2,$30,$DB,$0D,$30
                      db $6D,$9F,$C6,$C6

MusicB2S0AP01:        db $DA,$0D,$DB,$0C,$04,$C7,$30,$6C
                      db $A6,$C6,$C6

MusicB2S0AP02:        db $DA,$0D,$DB,$0B,$08,$C7,$30,$6C
                      db $A9,$C6,$C6

MusicB2S0AP03:        db $DA,$0D,$DB,$0A,$0B,$C7,$30,$6C
                      db $AE,$C6,$C6

MusicB2S0AP04:        db $DA,$0D,$DB,$09,$0E,$C7,$30,$6C
                      db $B2,$C6,$C6

MusicB2S0AP05:        db $DA,$0D,$DB,$08,$11,$C7,$30,$6C
                      db $B5,$30,$6D,$B5,$C6

MusicB2S0AP06:        db $DA,$0D,$DB,$07,$14,$C7,$30,$6D
                      db $B9,$18,$6D,$C6,$B0,$00

MusicB2S0AP07:        db $DB,$0D,$60,$6D,$98,$C6,$C6

MusicB2S0AP08:        db $DB,$0C,$04,$C7,$60,$6C,$9F,$C6
                      db $C6

MusicB2S0AP09:        db $DB,$0B,$08,$C7,$60,$6C,$A2,$C6
                      db $C6

MusicB2S0AP0A:        db $DB,$0A,$30,$6C,$AE,$AB,$C6,$C6

MusicB2S0AP0B:        db $DB,$09,$03,$C7,$30,$6C,$B1,$AE
                      db $C6,$C6

MusicB2S0AP0C:        db $DB,$08,$06,$C7,$30,$6C,$B4,$B1
                      db $C6,$C6

MusicB2S0AP0D:        db $DB,$07,$09,$C7,$30,$6D,$B9,$B4
                      db $00

MusicB2S0AP0E:        db $DB,$0D,$60,$6D,$9D,$C6,$C6,$00

MusicB2S0AP0F:        db $DB,$0C,$04,$C7,$60,$6C,$A4,$C6
                      db $C6

MusicB2S0AP10:        db $DB,$0B,$08,$C7,$48,$6C,$A8,$30
                      db $C6,$C3,$60,$C6,$C6

MusicB2S0AP11:        db $DB,$0A,$01,$C7,$48,$6C,$AD,$B9
                      db $C6,$C6

MusicB2S0AP12:        db $DB,$09,$03,$C7,$48,$6C,$B0,$18
                      db $C6,$60,$BE,$C6

MusicB2S0AP13:        db $DB,$08,$05,$C7,$60,$6C,$B4,$C6
                      db $C6

MusicB2S0AP14:        db $DB,$07,$07,$C7,$60,$6D,$B7,$C6
                      db $C6,$00

MusicB2S09P00:        db $F0,$DA,$03,$E2,$30,$DB,$0A,$04
                      db $6F,$B4,$B2,$B4,$24,$C7,$E2,$34
                      db $DA,$09,$0C,$6E,$C4,$C5,$C4,$C5
                      db $C1,$BC,$BD,$BE,$B8,$B9,$B5,$B0
                      db $B1,$B2,$AC,$AD,$30,$A9,$9D,$00

MusicB2S09P01:        db $DA,$09,$DB,$0A,$30,$4E,$C7,$18
                      db $C7,$AD,$C7,$AB,$C7,$A9,$C7,$A8
                      db $18,$A4,$C7,$98,$C7

MusicB2S09P02:        db $DA,$09,$DB,$0A,$30,$6E,$C7,$18
                      db $9D,$18,$4E,$A9,$18,$6E,$9B,$18
                      db $4E,$A7,$18,$6E,$9A,$18,$4E,$A6
                      db $18,$6E,$98,$18,$4E,$A4,$18,$6E
                      db $91,$C7,$30,$91

MusicB2S01P00:        db $F0,$DA,$09,$E2,$40,$DB,$0A,$DE
                      db $00,$00,$00,$0C,$6E,$B4,$0C,$6C
                      db $B2,$AE,$24,$6E,$B4,$0C,$6C,$B2
                      db $AE,$18,$AD,$18,$6E,$B9,$B9,$C6
                      db $00

MusicB2S01P01:        db $DA,$09,$DB,$14,$24,$6D,$96,$96
                      db $18,$C6,$60,$95

MusicB2S01P02:        db $DA,$09,$DB,$0A,$24,$6D,$9E,$9E
                      db $18,$C6,$18,$9F,$B1,$B1,$C6

MusicB2S01P03:        db $DA,$09,$DB,$00,$24,$6E,$AE,$AE
                      db $18,$C6,$18,$A5,$06,$B3,$12,$B4
                      db $06,$B3,$12,$B4,$18,$C6

MusicB2S01P13:        db $DE,$00,$00,$00,$30,$6E,$B9,$24
                      db $6D,$B5,$0C,$B0,$B2,$18,$B5,$30
                      db $B5,$0C,$B2,$18,$B0,$B5,$B5,$BC
                      db $24,$B9,$30,$B7,$0C,$B0,$00

MusicB2S01P14:        db $18,$6C,$91,$18,$4C,$A4,$18,$6C
...
MusicB2S01P15:        db $18,$4C,$C7,$A1,$C7,$A1,$C7,$A2
                      db $C7,$A3,$C7,$A1,$C7,$A1,$C7,$A2
                      db $C7,$A2

MusicB2S01P16:        db $18,$4C,$C7,$A9,$C7,$A9,$C7,$A9
                      db $C7,$A9,$C7,$A9,$C7,$A9,$C7,$A9
                      db $C7,$A8

MusicB2S01P08:        db $DA,$0C,$0C,$6F,$B0,$C6,$B5,$C6
...
MusicB2S01P17:        db $30,$6E,$B9,$24,$6D,$B5,$0C,$B0
                      db $B2,$18,$B5,$30,$B5,$0C,$B2,$18
                      db $B0,$B5,$0C,$BA,$B9,$B7,$30,$B5
                      db $C7,$0C,$C7,$00

MusicB2S01P18:        db $18,$6C,$91,$18,$4C,$A4,$18,$6C
                      db $95,$18,$4C,$A4,$18,$6C,$96,$18
                      db $4C,$A6,$18,$6C,$97,$18,$4C,$A6
...
MusicB2S01P19:        db $18,$4C,$C7,$A1,$C7,$A1,$C7,$A2
                      db $C7,$A3,$C7,$A2,$C7,$A4,$C7,$A1
                      db $C7,$A1

MusicB2S01P1A:        db $18,$4C,$C7,$A9,$C7,$A9,$C7,$A9
                      db $C7,$A9,$C7,$A9,$C7,$AB,$C7,$A9
                      db $C7,$A9

MusicB2S01P1B:        db $24,$6D,$B9,$24,$6C,$B5,$18,$B0
                      db $24,$6D,$B9,$3C,$6C,$B5,$0C,$6D
                      db $B8,$0C,$6C,$B5,$18,$B0,$24,$6D
                      db $B8,$6C,$6C,$B7,$00

MusicB2S01P1C:        db $18,$6B,$96,$18,$4B,$A6,$18,$6B
...
MusicB2S01P1D:        db $18,$4B,$C7,$A2,$C7,$A2,$C7,$A1
                      db $C7,$A1,$C7,$A0,$C7,$A0,$C7,$A2
                      db $C7,$A2

MusicB2S01P1E:        db $18,$4B,$C7,$A9,$C7,$A9,$C7,$A9
                      db $C7,$A9,$C7,$A9,$C7,$A9,$C7,$A9
                      db $C7,$A8

MusicB2S01P1F:        db $DA,$0C,$0C,$6D,$B0,$C6,$B5,$C6
                      db $B0,$C6,$B5,$B5,$B0,$C6,$B5,$C6
                      db $B0,$C6,$B5,$B5,$B0,$C6,$B5,$C6
                      db $B0,$C6,$B5,$B5,$B0,$C6,$B5,$C6
                      db $B0,$C6,$B5,$B5

MusicB2S01P20:        db $24,$6D,$B9,$24,$6C,$B5,$18,$B0
                      db $24,$6D,$B9,$3C,$6C,$B5,$0C,$6D
                      db $B8,$0C,$6C,$B5,$18,$B0,$60,$BC
                      db $30,$C7,$00

MusicB2S01P21:        db $30,$6E,$B9,$24,$6D,$B5,$0C,$B0
...
MusicB2S01P22:        db $18,$6C,$91,$18,$4C,$A4,$18,$6C
...
MusicB2S01P23:        db $18,$4C,$C7,$A1,$C7,$A1,$C7,$A2
...
MusicB2S01P24:        db $18,$4C,$C7,$A9,$C7,$A9,$C7,$AB
...
MusicB2S01P04:        db $DB,$0A,$0C,$5C,$C6,$A6,$B2,$AD
...
MusicB2S01P05:        db $DB,$14,$18,$6C,$8E,$18,$4C,$A6
...
MusicB2S01P06:        db $DB,$0A,$0C,$5C,$C7,$C7,$AA,$C6
                      db $C6,$24,$7E,$AA,$24,$5C,$AA,$54
                      db $7E,$AA,$24,$5C,$AE,$24,$7E,$AE
                      db $24,$5C,$AE,$3C,$7E,$AE

MusicB2S01P07:        db $DB,$00,$18,$4C,$C7,$9E,$C7,$9E
                      db $C7,$9E,$C7,$9E,$C7,$A2,$C7,$A2
                      db $C7,$A2,$C7,$A2

MusicB2S01P09:        db $0C,$5C,$C6,$A4,$B0,$AB,$AE,$18
...
MusicB2S01P0A:        db $18,$6C,$8C,$18,$4C,$A4,$18,$6C
...
MusicB2S01P0B:        db $0C,$5C,$C7,$C7,$A8,$C6,$C6,$24
                      db $7E,$A8,$24,$5C,$A8,$54,$7E,$A8
                      db $24,$5C,$A9,$24,$7E,$A9,$18,$7B
                      db $A1,$18,$7D,$A1,$18,$7E,$A0,$18
                      db $7E,$9F

MusicB2S01P0C:        db $18,$4C,$C7,$9C,$C7,$9C,$C7,$9C
                      db $C7,$9C,$C7,$9D,$C7,$9D,$A7,$A7
                      db $18,$6E,$A6,$A5

MusicB2S01P0D:        db $DA,$0C,$0C,$6F,$B0,$C6,$B5,$C6
                      db $B0,$C6,$B5,$B5,$B0,$C6,$B5,$C6
                      db $B0,$C6,$B5,$B5,$B0,$C6,$B5,$C6
                      db $B0,$C6,$B5,$B5,$B5,$B0,$B5,$B0
                      db $B5,$B0,$B5,$B0

MusicB2S01P0E:        db $0C,$5C,$C6,$A8,$B4,$A8,$AB,$18
...
MusicB2S01P0F:        db $18,$6C,$8C,$18,$4C,$A4,$18,$6C
                      db $93,$18,$4C,$A4,$18,$6C,$8C,$18
                      db $4C,$A4,$18,$6C,$93,$18,$4C,$A4
                      db $18,$6C,$91,$18,$4C,$A4,$18,$6C
...
MusicB2S06P09:        db $DA,$08,$DB,$05,$24,$5E,$A1,$9D
                      db $18,$98,$24,$A1,$30,$9D,$0C,$C7
                      db $A0,$9D,$18,$98,$24,$A0,$60,$9F
                      db $0C,$C7

MusicB2S06P08:        db $DA,$08,$DB,$0F,$06,$6B,$C7,$24
                      db $A1,$9D,$18,$98,$24,$A1,$30,$9D
                      db $0C,$C7,$A0,$9D,$18,$98,$24,$A0
                      db $60,$9F,$0C,$C7

MusicB2S06P07:        db $DA,$03,$DB,$00,$18,$4E,$8A,$8E
...
MusicB2S07P00:        db $F0,$DA,$01,$E2,$12,$DB,$0F,$DE
...
MusicB2S07P02:        db $DA,$02,$DB,$0A,$DE,$00,$00,$00
                      db $06,$67,$BB,$BD,$B9,$BC,$BB,$BD
                      db $B9,$BC,$BB,$BD,$B9,$BC,$BB,$BD
                      db $B9,$BC,$BB,$BD,$B9,$BC,$BB,$BD
                      db $B9,$BC,$BB,$BD,$B9,$BC,$BB,$BD
...
MusicB2S07P01:        db $DA,$01,$DB,$05,$DE,$00,$00,$00
...
MusicB2S07P04:        db $DA,$0B,$DB,$00,$DE,$00,$00,$00
                      db $E7,$A0,$E8,$60,$FF,$60,$7F,$A9
                      db $DD,$30,$60,$A7,$E8,$60,$B0,$DC
                      db $60,$0A,$60,$C6

MusicB2S07P03:        db $DA,$0B,$DB,$00,$DE,$00,$00,$00
                      db $E7,$A0,$E8,$60,$FF,$60,$7F,$A3
                      db $DD,$30,$60,$A1,$E8,$60,$B0,$DC
                      db $60,$0A,$60,$C6

MusicB2S07P05:        db $DA,$01,$DB,$0F,$E0,$80,$E1,$60
...
MusicB2S07P07:        db $DA,$02,$DB,$0A,$06,$67,$BD,$BF
                      db $BB,$BE,$BD,$BF,$BB,$BE,$BD,$BF
                      db $BB,$BE,$BD,$BF,$BB,$BE,$BD,$BF
                      db $BB,$BE,$BD,$BF,$BB,$BE,$BD,$BF
                      db $BB,$BE,$BD,$BF,$BB,$BE

MusicB2S07P06:        db $DA,$01,$DB,$05,$06,$67,$B7,$B9
                      db $B6,$B8,$B7,$B9,$B6,$B8,$B7,$B9
                      db $B6,$B8,$B7,$B9,$B6,$B8,$B7,$B9
                      db $B6,$B8,$B7,$B9,$B6,$B8,$B7,$B9
                      db $B6,$B8,$B7,$B9,$B6,$B8

MusicB2S07P09:        db $DA,$0B,$DB,$0A,$DE,$00,$00,$00
                      db $E7,$A0,$E8,$60,$FF,$60,$7F,$AB
                      db $DD,$30,$60,$A9,$E8,$60,$B0,$DC
                      db $60,$14,$60,$C6

MusicB2S07P08:        db $DA,$0B,$DB,$0A,$DE,$00,$00,$00
                      db $E7,$A0,$E8,$60,$FF,$60,$7F,$A5
                      db $DD,$30,$60,$A3,$E8,$60,$B0,$DC
                      db $60,$14,$60,$C6

MusicB2S07P0A:        db $DA,$01,$DB,$0F,$E0,$80,$E1,$60
...
MusicB2S07P0C:        db $DA,$02,$DB,$0A,$06,$67,$BF,$C1
                      db $BD,$C0,$BF,$C1,$BD,$C0,$BF,$C1
                      db $BD,$C0,$BF,$C1,$BD,$C0,$BF,$C1
                      db $BD,$C0,$BF,$C1,$BD,$C0,$BF,$C1
                      db $BD,$C0,$BF,$C1,$BD,$C0

MusicB2S07P0B:        db $DA,$01,$DB,$05,$06,$67,$B9,$BB
                      db $B8,$BA,$B9,$BB,$B8,$BA,$B9,$BB
                      db $B8,$BA,$B9,$BB,$B8,$BA,$B9,$BB
                      db $B8,$BA,$B9,$BB,$B8,$BA,$B9,$BB
                      db $B8,$BA,$B9,$BB,$B8,$BA

MusicB2S07P0E:        db $DA,$0B,$DB,$14,$DE,$00,$00,$00
                      db $E7,$A0,$E8,$60,$FF,$60,$7F,$AD
                      db $DD,$30,$60,$AB,$E8,$60,$B0,$DC
                      db $60,$0A,$60,$C6

MusicB2S07P0D:        db $DA,$0B,$DB,$14,$DE,$00,$00,$00
                      db $E7,$A0,$E8,$60,$FF,$60,$7F,$A7
                      db $DD,$30,$60,$A5,$E8,$60,$B0,$DC
                      db $60,$0A,$60,$C6

MusicB2S07P0F:        db $DA,$01,$DB,$0F,$E0,$80,$E1,$60
...
MusicB2S07P11:        db $DA,$02,$DB,$0A,$06,$67,$C1,$C3
                      db $BF,$C2,$C1,$C3,$BF,$C2,$C1,$C3
                      db $BF,$C2,$C1,$C3,$BF,$C2,$C1,$C3
                      db $BF,$C2,$C1,$C3,$BF,$C2,$C1,$C3
                      db $BF,$C2,$C1,$C3,$BF,$C2

MusicB2S07P10:        db $DA,$01,$DB,$05,$06,$67,$BB,$BD
                      db $BA,$BC,$BB,$BD,$BA,$BC,$BB,$BD
                      db $BA,$BC,$BB,$BD,$BA,$BC,$BB,$BD
                      db $BA,$BC,$BB,$BD,$BA,$BC,$BB,$BD
                      db $BA,$BC,$BB,$BD,$BA,$BC

MusicB2S07P13:        db $DA,$0B,$DB,$0A,$E7,$A0,$E8,$60
                      db $FF,$60,$7F,$AF,$DD,$30,$60,$AD
                      db $E8,$60,$B0,$DC,$60,$00,$60,$C6

MusicB2S07P12:        db $DA,$0B,$DB,$0A,$E7,$A0,$E8,$60
                      db $FF,$60,$7F,$A9,$DD,$30,$60,$A7
                      db $E8,$60,$B0,$DC,$60,$00,$60,$C6

MusicB2S07P14:        db $DA,$01,$E0,$FF,$DB,$0F,$DE,$00
...
MusicB2S07P16:        db $DA,$02,$DB,$0A,$DE,$00,$00,$00
...
MusicB2S07P19:        db $DA,$01,$DB,$05,$DE,$00,$00,$00
...
MusicB2S07P18:        db $DA,$0B,$E7,$FF,$DB,$05,$DE,$14
                      db $1E,$70,$30,$7F,$A6,$18,$A3,$9E
                      db $9F,$48,$A3,$18,$C6,$9E,$A3,$AA
                      db $30,$A6,$A5

MusicB2S07P15:        db $DA,$0B,$E7,$FF,$DB,$0A,$DE,$14
                      db $1E,$70,$12,$7B,$C7,$30,$A6,$18
                      db $A3,$9E,$9F,$48,$A3,$18,$C6,$9E
                      db $A3,$AA,$30,$A6,$A5

MusicB2S07P17:        db $DA,$04,$E7,$FF,$DB,$0F,$DE,$00
                      db $00,$00,$30,$7E,$8E,$18,$8B,$86
                      db $87,$48,$8B,$18,$C6,$86,$8B,$92
                      db $30,$8E,$8D

MusicB2S07P1A:        db $E0,$FF,$06,$67,$BF,$C1,$BD,$C0
...
MusicB2S07P1E:        db $DA,$01,$DB,$05,$06,$67,$B9,$BB
                      db $B8,$BA,$B9,$BB,$B8,$BA,$B9,$BB
                      db $B8,$BA,$B9,$BB,$B8,$BA,$B9,$BB
                      db $B8,$BA,$B9,$BB,$B8,$BA,$B9,$BB
                      db $B8,$BA,$B9,$BB,$B8,$BA,$B9,$BB
...
MusicB2S07P1D:        db $DA,$0B,$E7,$FF,$DB,$05,$DE,$14
                      db $1E,$70,$30,$7F,$A4,$18,$A1,$9C
                      db $9D,$48,$A1,$18,$C6,$9C,$A1,$A8
                      db $30,$A4,$A3

MusicB2S07P1B:        db $DA,$0B,$E7,$FF,$DB,$0A,$DE,$14
                      db $1E,$70,$12,$7B,$C7,$30,$A4,$18
                      db $A1,$9C,$9D,$48,$A1,$18,$C6,$9C
                      db $A1,$A8,$30,$A4,$A3

MusicB2S07P1C:        db $DA,$04,$E7,$FF,$DB,$0F,$DE,$00
                      db $00,$00,$30,$7E,$8C,$18,$89,$84
                      db $85,$48,$89,$18,$C6,$84,$89,$90
                      db $30,$8C,$8B

MusicB2S07P1F:        db $E0,$FF,$06,$67,$BD,$BF,$BB,$BE
...
MusicB2S07P23:        db $DA,$01,$DB,$05,$06,$67,$B7,$B9
                      db $B6,$B8,$B7,$B9,$B6,$B8,$B7,$B9
                      db $B6,$B8,$B7,$B9,$B6,$B8,$B7,$B9
                      db $B6,$B8,$B7,$B9,$B6,$B8,$B7,$B9
                      db $B6,$B8,$B7,$B9,$B6,$B8,$B7,$B9
...
MusicB2S02P0D:        db $DA,$05,$DB,$0F,$DE,$00,$00,$00
...
MusicB2S02P09:        db $DA,$05,$DB,$05,$DE,$00,$00,$00
...
MusicB2S02P0A:        db $DA,$04,$DB,$0A,$18,$4C,$91,$C7
                      db $8E,$C7,$93,$C7,$8C,$C7,$91,$C7
                      db $8E,$C7,$93,$92,$C6,$C6

MusicB2S02P0B:        db $60,$01,$C7,$C7,$C7,$C7

MusicB2S02P0E:        db $DA,$05,$DB,$0A,$DE,$00,$00,$00
...
MusicB2S02P0F:        db $DA,$05,$DB,$05,$02,$C7,$08,$48
                      db $B9,$C6,$C6,$B9,$C7,$B0,$B9,$C6
...
MusicB2S02P12:        db $DA,$05,$DB,$0F,$01,$49,$C7,$08
...
MusicB2S02P11:        db $DA,$07,$DB,$0A,$30,$5C,$AD,$24
                      db $A9,$0C,$A4,$A6,$18,$A9,$30,$A9
                      db $0C,$A6,$18,$A4,$A9,$A9,$B0,$24
                      db $AD,$30,$AB,$0C,$A4

MusicB2S02P0C:        db $DA,$0C,$DB,$0A,$E7,$FF,$0C,$6F
...
MusicB2S02P10:        db $DA,$04,$18,$4B,$91,$C7,$95,$C7
                      db $96,$C7,$97,$C7,$95,$C7,$94,$C7
                      db $93,$8C,$8E,$90

MusicB2S02P13:        db $08,$5B,$B0,$C6,$C6,$08,$5C,$B0
                      db $C7,$08,$5B,$B9,$B0,$C6,$C6,$08
                      db $5C,$B0,$C7,$08,$5B,$B9,$B2,$C6
                      db $C6,$08,$5C,$B2,$C7,$08,$5B,$BA
                      db $B2,$C6,$C6,$08,$5C,$B2,$C7,$08
...
MusicB2S02P14:        db $02,$C7,$08,$48,$B9,$C6,$C6,$B9
                      db $C7,$B0,$B9,$C6,$C6,$B9,$C7,$B0
...
MusicB2S02P17:        db $01,$C7,$08,$49,$B5,$C6,$C6,$B5
                      db $C7,$B5,$B5,$C6,$C6,$B5,$C7,$B5
                      db $B5,$C6,$C6,$B5,$C7,$B5,$B5,$C6
...
MusicB2S02P16:        db $30,$5C,$AD,$24,$A9,$0C,$A4,$A6
                      db $18,$A9,$30,$A9,$0C,$A6,$18,$A4
                      db $A9,$0C,$AE,$AD,$AB,$30,$A9,$C7
                      db $C7

MusicB2S02P15:        db $18,$4B,$91,$C7,$95,$C7,$96,$C7
                      db $97,$C7,$98,$8C,$90,$93,$91,$8C
                      db $91,$C7

MusicB2S02P18:        db $08,$5B,$B2,$C6,$C6,$08,$5C,$B2
...
MusicB2S02P19:        db $02,$C7,$08,$48,$BA,$C6,$C6,$BA
...
MusicB2S02P1D:        db $01,$49,$C7,$08,$B5,$C6,$C6,$B5
                      db $C7,$B5,$B5,$C6,$C6,$B5,$C7,$B5
...
MusicB2S02P1B:        db $24,$5C,$AD,$A9,$18,$A4,$24,$AD
                      db $30,$A9,$0C,$C7,$AC,$A9,$18,$A4
                      db $24,$AC,$60,$AB,$0C,$C7

MusicB2S02P1A:        db $DA,$08,$DB,$0A,$18,$4B,$96,$97
                      db $98,$9A,$98,$95,$91,$93,$94,$97
                      db $9A,$9D,$9F,$9D,$9C,$98

MusicB2S02P1C:        db $DA,$0C,$DB,$0A,$E7,$FF,$06,$6F
...
MusicB2S02P1E:        db $08,$5B,$B2,$C6,$C6,$08,$5C,$B2
                      db $C7,$08,$5B,$BA,$B2,$C6,$C6,$08
...
MusicB2S02P1F:        db $02,$C7,$08,$48,$BA,$C6,$C6,$BA
                      db $C7,$B2,$BA,$C6,$C6,$BA,$C7,$B2
                      db $B9,$C6,$C6,$B9,$C7,$B0,$B9,$C7
                      db $B0,$B9,$C7,$B0,$B8,$C6,$C6,$B8
                      db $C7,$AF,$B8,$C6,$C6,$B8,$C7,$AF
...
MusicB2S02P22:        db $01,$C7,$08,$49,$B5,$C6,$C6,$B5
                      db $C7,$B5,$B5,$C6,$C6,$B5,$C7,$B5
                      db $B5,$C6,$C6,$B5,$C7,$B5,$B5,$C7
                      db $B5,$B5,$C7,$B5,$B2,$C6,$C6,$B2
                      db $C7,$B2,$B2,$C6,$C6,$B2,$C7,$B2
...
MusicB2S02P21:        db $24,$5C,$AD,$A9,$18,$A4,$24,$AD
                      db $30,$A9,$0C,$C7,$AC,$A9,$18,$A4
                      db $60,$B0,$C6

MusicB2S02P20:        db $18,$4B,$96,$95,$96,$9A,$9D,$9C
                      db $98,$95,$97,$9A,$9D,$97,$96,$9A
                      db $98,$9C

MusicB2S02P28:        db $DA,$05,$DB,$0A,$08,$49,$A6,$C6
...
MusicB2S02P24:        db $DA,$05,$DB,$05,$02,$C7,$08,$48
                      db $B9,$C6,$C6,$B9,$C7,$B0,$B9,$C6
                      db $C6,$B9,$C7,$B0,$B9,$C6,$C6,$B9
                      db $C7,$B0,$B9,$C6,$C6,$B9,$C7,$B0
                      db $B9,$C6,$C6,$B9,$C7,$B0,$B9,$C6
...
MusicB2S02P27:        db $DA,$05,$DB,$0F,$01,$C7,$08,$49
                      db $B5,$C6,$C6,$B5,$C7,$B5,$B5,$C6
                      db $C6,$B5,$C7,$B5,$B5,$C6,$C6,$B5
                      db $C7,$B5,$B5,$C6,$C6,$B5,$C7,$B5
                      db $B5,$C6,$C6,$B5,$C7,$B5,$B5,$C6
...
MusicB2S02P26:        db $DA,$07,$DB,$0A,$30,$5C,$AD,$24
                      db $A9,$0C,$A4,$A6,$18,$A9,$30,$A9
...
MusicB2S02P25:        db $DA,$04,$DB,$0A,$18,$4B,$91,$C7
                      db $91,$C7,$8F,$C7,$8F,$C7,$8E,$C7
                      db $8E,$C7,$8D,$C7,$8D,$C7,$8C,$C7
                      db $C7,$C7,$C7,$C7,$8E,$90,$91,$C7
                      db $8C,$C7,$91,$C7,$91,$C7

MusicB2S03P00:        db $F0,$DA,$01,$E2,$32,$DB,$0A,$DE
                      db $23,$12,$40,$48,$7E,$BE,$30,$BA
                      db $18,$B5,$24,$B4,$0C,$B4,$06,$B5
                      db $B6,$48,$B7,$00

MusicB2S03P03:        db $DA,$01,$DB,$8A,$06,$7B,$C7,$48
                      db $BE,$30,$BA,$18,$B5,$24,$B4,$0C
                      db $B4,$06,$B5,$B6,$3C,$B7,$0C,$C7

MusicB2S03P02:        db $DA,$01,$DB,$0A,$DE,$23,$12,$40
                      db $48,$6E,$9F,$30,$9F,$18,$9F,$24
                      db $8C,$0C,$8C,$06,$8E,$8F,$48,$90
                      db $00

MusicB2S03P04:        db $DA,$01,$DB,$8A,$DE,$23,$12,$40
                      db $06,$6B,$C7,$48,$9F,$30,$9F,$18
                      db $9F,$24,$8C,$0C,$8C,$06,$8E,$8F
                      db $48,$90,$00

MusicB2S03P01:        db $DA,$01,$DB,$0A,$48,$6E,$B5,$30
                      db $B2,$18,$AE,$24,$AB,$0C,$AB,$06
                      db $AD,$AD,$48,$AE

MusicB2S03P05:        db $DA,$01,$DB,$A0,$06,$6E,$C7,$48
                      db $B5,$30,$B2,$18,$AE,$24,$AB,$0C
                      db $AB,$06,$AD,$AD,$48,$AE

MusicB2S03P08:        db $DA,$01,$DB,$0A,$DE,$23,$12,$40
                      db $48,$3E,$91,$8E,$93,$8C,$91,$8E
                      db $93,$18,$8C,$8E,$90,$00

MusicB2S03P06:        db $DA,$03,$DB,$0A,$DE,$23,$12,$40
...
MusicB2S03P0E:        db $DA,$01,$DB,$0A,$DE,$23,$12,$40
                      db $12,$7B,$C7,$48,$B9,$30,$B5,$18
                      db $B0,$30,$B2,$18,$B5,$48,$B5,$30
                      db $B0,$18,$B5,$30,$B5,$18,$BC,$48
                      db $B9,$B7

MusicB2S03P0B:        db $48,$6E,$B9,$30,$B5,$18,$B0,$30
                      db $B2,$18,$B5,$48,$B5,$30,$B0,$18
                      db $B5,$30,$B5,$18,$BC,$48,$B9,$B7
                      db $00

MusicB2S03P10:        db $DA,$01,$DB,$0F,$DE,$23,$12,$40
                      db $48,$7C,$A4,$A5,$A6,$A5,$A4,$A3
                      db $A2,$A8

MusicB2S03P18:        db $DA,$02,$DB,$0A,$48,$6C,$B9,$30
                      db $B5,$18,$B0,$30,$B2,$18,$B5,$48
                      db $B5,$30,$B0,$18,$B5,$30,$B5,$18
                      db $BC,$48,$B9,$B7

MusicB2S03P0D:        db $DA,$01,$DB,$0A,$DE,$23,$12,$40
                      db $48,$3E,$91,$95,$96,$97,$95,$94
                      db $93,$18,$8C,$8E,$90

MusicB2S03P0C:        db $DA,$01,$DB,$0A,$18,$4D,$C7,$A4
                      db $A4,$C7,$A4,$A4,$C7,$A6,$A6,$C7
                      db $A6,$A6,$C7,$A8,$A8,$C7,$A7,$A7
                      db $C7,$A6,$A6,$C7,$A8,$A8

MusicB2S03P0F:        db $DA,$01,$DB,$0A,$18,$4D,$C7,$A1
                      db $A1,$C7,$A1,$A1,$C7,$A2,$A2,$C7
                      db $A3,$A3,$C7,$A4,$A4,$C7,$A4,$A4
                      db $C7,$A2,$A2,$C7,$A4,$A4

MusicB2S03P14:        db $12,$7B,$C7

MusicB2S03P11:        db $48,$B9,$30,$B5,$18,$B0,$30,$B2
                      db $18,$B5,$48,$B5,$30,$B0,$18,$B5
                      db $BA,$B9,$B7,$48,$B5,$C7,$00

MusicB2S03P17:        db $DA,$01,$48,$7B,$A4,$A5,$A6,$A5
                      db $A4,$A2,$A1,$C6,$00

MusicB2S03P1A:        db $DA,$01,$48,$7B,$A4,$A5,$A6,$A5
                      db $A4,$A8,$A9,$C6,$00

MusicB2S03P19:        db $DA,$02,$DB,$0A,$48,$6C,$B9,$30
                      db $B5,$18,$B0,$30,$B2,$18,$B5,$48
                      db $B5,$30,$B0,$18,$B5,$BA,$B9,$B7
                      db $48,$B5,$C7,$00

MusicB2S03P13:        db $DA,$01,$DB,$0A,$48,$3E,$91,$95
                      db $96,$97,$93,$98,$18,$91,$98,$95
                      db $48,$91,$00

MusicB2S03P15:        db $DA,$0C,$DB,$0A,$18,$6D,$C7,$0C
                      db $B0,$B0,$18,$B0,$C7,$AD,$B2,$C7
                      db $0C,$B0,$B0,$18,$B0,$C7,$AD,$B2
                      db $C7,$0C,$B0,$B0,$18,$B0,$C7,$AD
                      db $B2,$AD,$B0,$B0,$AD,$C7,$C7

MusicB2S03P12:        db $DA,$01,$DB,$0A,$18,$4D,$C7,$A4
                      db $A4,$C7,$A4,$A4,$C7,$A6,$A6,$C7
                      db $A6,$A6,$C7,$A6,$A6,$C7,$A4,$A4
                      db $C7,$A4,$A4,$C7,$A4,$A4,$00

MusicB2S03P16:        db $DA,$01,$DB,$0A,$18,$4D,$C7,$A1
                      db $A1,$C7,$A1,$A1,$C7,$A2,$A2,$C7
                      db $A3,$A3,$C7,$A2,$A2,$C7,$A2,$A2
                      db $C7,$A1,$A1,$C7,$A1,$A1,$00

MusicB2S03P1E:        db $12,$7B,$C7

MusicB2S03P1B:        db $DA,$01,$48,$B9,$30,$B5,$18,$B0
                      db $48,$B9,$B5,$00

MusicB2S03P21:        db $DA,$00,$60,$67,$B0,$0C,$B1,$B2
                      db $B5,$B9,$48,$BC,$B9,$00

MusicB2S03P1D:        db $DA,$01,$48,$3E,$96,$96,$95,$95
                      db $00

MusicB2S03P1C:        db $DA,$01,$18,$4D,$C7,$A9,$A9,$C7
                      db $A9,$A9,$C7,$A9,$A9,$C7,$A9,$A9
                      db $00

MusicB2S03P20:        db $DA,$01,$DB,$0A,$18,$4D,$C7,$A6
                      db $A6,$C7,$A6,$A6,$C7,$A4,$A4,$C7
                      db $A4,$A4,$C7,$00

MusicB2S03P1F:        db $DA,$0C,$DB,$0A,$18,$6D,$C7,$B2
                      db $B2,$C7,$B2,$AD,$C7,$B2,$B2,$C7
                      db $AD,$B2,$C7,$B2,$B2,$C7,$B2,$AD
                      db $C7,$B2,$B2,$C7,$AD,$B2

MusicB2S03P25:        db $12,$C6

MusicB2S03P22:        db $48,$B8,$30,$B5,$18,$B8,$48,$B7
                      db $C7,$00

MusicB2S03P27:        db $60,$AF,$0C,$B0,$B2,$B5,$B8,$48
                      db $BA,$B7,$00

MusicB2S03P24:        db $48,$94,$94,$93,$18,$8C,$8E,$90
                      db $00

MusicB2S03P23:        db $18,$C7,$A9,$A9,$C7,$A9,$A9,$C7
                      db $A9,$A9,$C7,$A8,$A8,$00

MusicB2S03P26:        db $18,$C7,$A3,$A3,$C7,$A3,$A3,$C7
                      db $A2,$A2,$C7,$A4,$A4,$C7,$00

MusicB2S03P29:        db $12,$C6

MusicB2S03P28:        db $48,$B8,$30,$B5,$18,$B0,$48,$BC
                      db $C6,$00

MusicB2S03P2A:        db $60,$AF,$0C,$B0,$B1,$B2,$B5,$48
                      db $B9,$B7,$00


                      base off

MusicBank2_End:       dw $0000,SPCEngine
