...
CODE_028008:          PHX
                      ...
                      STA.W SPCIO3                              ; /
                      LDX.B #$0B
CODE_028019:          LDA.W SpriteStatus,X
                      BEQ CODE_028042
                      DEX
                      BPL CODE_028019
...
CODE_028042:          LDA.B #$08                                ; \ Sprite status = Normal
...
ExplodeBombRt:        JSR ExplodeBombSubRt                      ;BOMB
                      RTL

ExplodeBombSubRt:     STZ.W SpriteTweakerA,X                    ; Make sprite unstompable
                    ...
                    + LDY.B #$04
                      STY.B _F
CODE_0280C4:          LDA.W SpriteMisc1540,X
                      LSR A
                      PHA
                      AND.B #$03
                      STA.B _2
...
ExplodeLoopStart:     CPY.W CurSpriteProcess                    ; | Don't attempt to kill self
                      BEQ CODE_02814C                           ; |
                      PHY                                       ; |
...
CODE_028398:          LDA.B EffFrame
                      AND.B #$03
                      BNE CODE_0283C4
                      STZ.B _0
CODE_0283A0:          LDX.B _0
                      LDA.L DATA_0283C8,X
                      TAY
                      JSL GetRand
                      AND.B #$01
...
CODE_0283CE:          LDA.W SpriteMisc1534+9
                      SEC
                      SBC.B #$1E
                      STA.B _C
...
CODE_0283F8:          LDA.W BossPillarYPos,X
                      LSR A
                      LSR A
                      LSR A
                      LSR A
...
CODE_02842A:          CPX.B #$01
                      BNE +
                      STZ.B SpriteLock
                      STZ.W PlayerIsFrozen
                    + LDA.B #$B0
CODE_028435:          STA.W BossPillarYPos,X
                      RTS

CODE_028439:          LDA.L DATA_0283CC,X
                      TAY
                      STZ.B _0
CODE_028440:          LDA.B #$F0
                      STA.W OAMTileYPos,Y
...
IsOffScreenBnk2:      LDA.W SpriteOffscreenX,X
                      ORA.W SpriteOffscreenVert,X
                      RTS

CODE_0284A6:          STA.B _3
                      LDA.B #$02
                      STA.B _1
                    - JSL CODE_0284D8
                      LDA.B _2
...
CODE_0284BC:          LDA.B #$12
                      BRA +

CODE_0284C0:          LDA.B #$00
                    + STA.B _0
                      STZ.B _2
                      LDA.B SpriteNumber,X
                      CMP.B #$41
                      ...
                      CMP.B #$42
                      BNE CODE_0284D8
CODE_0284D0:          LDA.B SpriteYSpeed,X
                      BPL Return0284E7
                      LDA.B #$0A
                      BRA CODE_0284A6

CODE_0284D8:          JSR IsOffScreenBnk2
                      BNE Return0284E7
                      LDY.B #$0B
CODE_0284DF:          LDA.W MinExtSpriteNumber,Y
                      BEQ CODE_0284E8
                      DEY
                      BPL CODE_0284DF
Return0284E7:         RTL

CODE_0284E8:          LDA.B SpriteYPosLow,X
                      CLC
                      ADC.B #$00
                      AND.B #$F0
                      CLC
...
CODE_028528:          JSR IsOffScreenBnk2
                      LDA.W SpriteOffscreenVert,X
                      BNE Return0284E7
                      LDA.B #$04
                      STA.B _0
                      LDY.B #$07                                ; \ Find a free extended sprite slot
CODE_028536:          LDA.W ExtSpriteNumber,Y                   ; |
                      BEQ CODE_02853F                           ; |
                      DEY                                       ; |
                      BPL CODE_028536                           ; |
                      RTL                                       ; / Return if no free slots

CODE_02853F:          LDA.B #$07                                ; \ Extended sprite = Lava splash
...
CODE_02858F:          LDY.B #$1F                                ; \ If Big Mario:
                      LDX.B #$00                                ; | Y = #$1F
                      LDA.B Powerup                             ; | X = #$00
                      BNE +                                     ; | Small Mario:
                      LDY.B #$0F                                ; | Y = #$0F
                    ...
                    + STX.B _1
                      ...
                      STA.B _2
CODE_0285BA:          LDY.B #$0B
CODE_0285BC:          LDA.W MinExtSpriteNumber,Y
                      BEQ CODE_0285C5
                      DEY
                      BPL CODE_0285BC
                      RTL

CODE_0285C5:          LDA.B #$05
                      STA.W MinExtSpriteNumber,Y
                      LDA.B #$00
...
CODE_0285DF:          JSR IsOffScreenBnk2
                      BNE Return0285EE
                      LDY.B #$0B
CODE_0285E6:          LDA.W MinExtSpriteNumber,Y
                      BEQ CODE_0285EF
                      DEY
                      BPL CODE_0285E6
Return0285EE:         RTL

CODE_0285EF:          JSL GetRand
                      LDA.B #$04
                      STA.W MinExtSpriteNumber,Y
                      LDA.B #$00
                      STA.W MinExtSpriteYSpeed,Y
...
CODE_02862F:          JSL FindFreeSprSlot                       ; \ Return if no free slots
                      BMI +                                     ; /
                      TYX
...
ShatterBlock:         PHX
                      ...
                      LDY.B #$03
                      LDX.B #$0B
CODE_02866A:          LDA.W MinExtSpriteNumber,X
                      BEQ CODE_02867F
CODE_02866F:          DEX
                      BPL CODE_02866A
...
YoshiStompRoutine:    LDA.W SpriteStompCounter
                      BNE +
                      PHB
                      PHK
                      PLB
...
CODE_0286EF:          LDA.W QuakeSpriteNumber,Y
                      BEQ CODE_0286F8
                      DEY
                      BPL CODE_0286EF
                      INY
CODE_0286F8:          LDA.B TouchBlockXPos
                      STA.W QuakeSpriteXPosLow,Y
                      LDA.B TouchBlockXPos+1
...
CODE_028780:          LDA.B #$02                                ; \ Replace block with "nothing" tile
...
FindTurningBlkSlot:   LDA.W BounceSpriteNumber,Y                ; |
                      BEQ CODE_028807                           ; |
                      DEY                                       ; |
...
CODE_028818:          LDA.B _4                                  ; \ Play on/off sound if appropriate
                      CMP.B #$05                                ; |
                      BNE +                                     ; |
                      LDX.B #!SFX_SWITCH                        ; |
                      STX.W SPCIO0                              ; /
                    + TAX
                      LDA.W BlockBounce,X
                      STA.W BounceSpriteYXPPCCCT,Y
CODE_02882A:          LDA.B _4                                  ; \ Set block bounce sprite type
                      INC A                                     ; |
...
CODE_028907:          LDA.W SpriteStatus,X                      ; |
                    ...
                    + LDA.W SpriteToOverwrite
                      ...
                      ADC.B #$0A
                      TAX
CODE_028922:          STX.W TileGenerateTrackA
                      LDY.B _5
...
CODE_028972:          LDA.B TouchBlockXPos
                      STA.B SpriteXPosLow,X
                      LDA.B TouchBlockXPos+1
                      STA.W SpriteYPosHigh,X
                      LDA.B TouchBlockYPos
...
CODE_0289D3:          CMP.B #$04
                      ...
                      BNE CODE_028A11
                      LDY.B #$0B
CODE_0289E1:          LDA.W SpriteStatus,Y
                      CMP.B #$08
                      BCC CODE_0289F3
                      LDA.W SpriteNumber,Y
                      CMP.B #$2D
                      BNE CODE_0289F3
CODE_0289EF:          LDY.B #$01
                      BRA CODE_0289FB
...
CODE_0289F3:          DEY
                      ...
                      LDY.W YoshiIsLoose
                      BNE CODE_0289EF
CODE_0289FB:          LDA.W DATA_0288A1,Y
                      STA.W SpriteMisc151C,X
CODE_028A01:          BRA CODE_028A0D

CODE_028A03:          INC.B SpriteTableC2,X
                      INC.B SpriteTableC2,X
                      RTL

ADDR_028A08:          LDA.B #$FF
                      STA.W SpriteMisc1540,X
CODE_028A0D:          LDA.B #$D0
                      BRA +

CODE_028A11:          LDA.B #$3E
                      STA.W SpriteMisc1540,X
                      LDA.B #$D0
...
CODE_028A2A:          LDA.B SpriteXPosLow,X
                      LSR A
                      LSR A
                      LSR A
                      LSR A
...
CODE_028A44:          PHX
                      LDX.B #$03
CODE_028A47:          LDA.W SmokeSpriteNumber,X
                      BEQ CODE_028A50
                      DEX
                      BPL CODE_028A47
                      INX
CODE_028A50:          LDA.B #$01
...
CODE_028A66:          LDX.B #$03
CODE_028A68:          LDA.W CoinSpriteExists,X
                      BEQ CODE_028A7D
                      DEX
                      BPL CODE_028A68
...
CODE_028AC3:          DEC.W GivePlayerLives
                      BEQ +
                      LDA.B #$23
                    ...
                    + LDA.B #!SFX_1UP                           ; \ Play sound effect
                      STA.W SPCIO3                              ; /
                      INC.W PlayerLives
CODE_028AD5:          LDA.W InvinsibilityTimer                  ; \ Branch if Mario doesn't have star
                      BEQ CODE_028AEB                           ; /
                      CMP.B #$08
                      BCC CODE_028AEB
                      LSR A
...
CODE_028AEB:          LDA.W PlayerSparkleTimer
                      BEQ +
                      DEC.W PlayerSparkleTimer
                      AND.B #$01
CODE_028AF5:          ORA.B PlayerXPosScrRel+1
...
CODE_028B67:          LDX.B #$0B
CODE_028B69:          LDA.W MinExtSpriteNumber,X
                      BEQ +
...
ADDR_028BC2:          LDA.W MinExtSpriteNumber,Y                ; |
                      BEQ ADDR_028BCB                           ; |
                      DEY                                       ; |
                      BPL ADDR_028BC2                           ; |
                      RTS                                       ; /
...
ADDR_028C0F:          LDA.W MinExtSpriteTimer,X
                      BNE ADDR_028C61
...
ADDR_028C20:          SEC
                    ...
                    + STA.W MinExtSpriteXSpeed,X
                      ...
                      BNE Return028C60
                      LDY.B #$0B
ADDR_028C32:          LDA.W MinExtSpriteNumber,Y
                      BEQ ADDR_028C3B
                      DEY
                      BPL ADDR_028C32
                      RTS
...
ADDR_028C61:          DEC.W MinExtSpriteTimer,X
                      BNE +
ADDR_028C66:          STZ.W MinExtSpriteNumber,X
                      RTS
...
CODE_028CC4:          LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE CODE_028CFF                           ; /
                      LDA.W MinExtSpriteXPosLow,X
                      CLC
                      ADC.B #$04
                    ...
                    + DEC.W MinExtSpriteTimer,X
                      BEQ CODE_028D62
CODE_028CFF:          LDY.W BrokenBlock,X
                      LDA.W MinExtSpriteXPosLow,X
                      SEC
                      SBC.B Layer1XPos
                      STA.B _0
...
CODE_028D4F:          LDA.W MinExtSpriteXPosLow,X
                      CMP.B Layer1XPos
                      LDA.W MinExtSpriteXPosHigh,X
                      SBC.B Layer1XPos+1
                      BNE CODE_028D62
                      ...
                      CMP.B #$20
                      BNE +
CODE_028D62:          STZ.W MinExtSpriteNumber,X
                      RTS
                    ...
                    + LDA.W MinExtSpriteTimer,X
                      ...
                      INC A
                    + STA.B _0
CODE_028D8B:          LDY.W BrokenBlock,X
                      LDA.W MinExtSpriteXPosLow,X
                      CLC
                      ADC.B _0
                      SEC
...
CODE_028DDB:          LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE CODE_028E20                           ; /
                      LDA.W MinExtSpriteTimer,X
                      BEQ +
                      DEC.W MinExtSpriteTimer,X
...
CODE_028E20:          LDY.W BrokenBlock,X
                      LDA.W MinExtSpriteXPosLow,X
                      SEC
                      SBC.B Layer1XPos
                      CMP.B #$08
...
CODE_028E76:          STZ.W MinExtSpriteNumber,X
                      RTS


                      db $03,$43,$83,$C3

CODE_028E7E:          DEC.W MinExtSpriteTimer,X
                      LDA.W MinExtSpriteTimer,X
                      AND.B #$3F
                      BEQ CODE_028ED7
                      JSR CODE_02B5BC
...
CODE_028ED2:          LDA.W MinExtSpriteTimer,X
                      BNE +
CODE_028ED7:          JMP CODE_028F87
...
CODE_028F2F:          LDA.W MinExtSpriteXPosLow,X
                      CMP.B Layer1XPos
                      LDA.W MinExtSpriteXPosHigh,X
                      SBC.B Layer1XPos+1
                      BNE CODE_028F87
...
CODE_028F87:          STZ.W MinExtSpriteNumber,X
                      RTS

CODE_028F8B:          LDA.B SpriteLock                          ; \ Branch if sprites locked
                      BNE CODE_028FCA                           ; /
                      LDA.B TrueFrame
                      AND.B #$03
                      BEQ CODE_028FAB
...
CODE_028FAB:          LDY.B #$00
                    ...
                    + CLC
                      ...
                      BNE CODE_028FCA
                      INC.W MinExtSpriteYSpeed,X
CODE_028FCA:          LDA.W MinExtSpriteYPosLow,X
                      SEC
                      SBC.B Layer1YPos
                      STA.B _0
                      LDA.W MinExtSpriteYPosHigh,X
                      ...
                      BPL CODE_028F87
                      BMI Return02902C
CODE_028FDD:          LDY.W BrokenBlock,X
                      LDA.W MinExtSpriteXPosLow,X
                      SEC
                      SBC.B Layer1XPos
                      STA.B _1
...
CODE_02902D:          LDA.W MulticoinTimer
                      CMP.B #$02
                      BCC +
                      LDA.B SpriteLock
                      BNE +
...
CODE_02904D:          LDA.W BounceSpriteNumber,X
                      BEQ Return02904C
                      LDY.B SpriteLock
                      BNE +
...
TurnBlockSpr:         LDA.B SpriteLock                          ; \ Return if sprites locked
                      BNE Return0290CD                          ; /
...
CODE_0290A8:          JSR CODE_02B526
                      ...
                      JSR BounceSprGfx
CODE_0290BB:          LDA.W TurnBlockSpinTimer,X
                      BEQ +
...
BounceBlockSpr:       JSR BounceSprGfx
                      LDA.B SpriteLock
                      BNE Return0290CD
...
TileFromBounceSpr0:   LDA.W BounceSpriteTile,X                  ; \ If doesn't turn into multiple coin block,
                      CMP.B #$0A                                ; |
                      BEQ CODE_0291AA                           ; |
                      CMP.B #$0B                                ; |
                      BNE +                                     ; / Block to generate = Bounce sprite block to turn into
CODE_0291AA:          LDY.W MulticoinTimer
                      CPY.B #$01
                      BNE +
...
TileFromBounceSpr1:   STA.B Map16TileGenerate                   ; Set block to generate
...
CODE_0292CA:          LDA.W BounceSpriteYPosLow,X
                      SEC
                      SBC.B #$03
                      AND.B #$F0
                      STA.B _0
...
ADDR_029358:          LDA.W CoinSpriteExists,Y
                      BEQ ADDR_029361
                      DEY
                      BPL ADDR_029358
                      INY
...
CODE_029394:          STZ.W QuakeSpriteNumber,X
                    - RTS

CODE_029398:          LDA.W QuakeSpriteNumber,X
                      BEQ -
                      ...
                      STZ.B _E
CODE_0293AE:          LDX.B #$0B
CODE_0293B0:          STX.W CurSpriteProcess
                      LDA.W SpriteStatus,X
                      CMP.B #$0B
                      BEQ CODE_0293F7
                      CMP.B #$08
...
CODE_0293EB:          JSR CODE_029663
                    + JSL CheckForContact
                      BCC CODE_0293F7
                      JSR CODE_029404
CODE_0293F7:          LDY.W MinorSpriteProcIndex
                      DEX
                      BMI +
                      JMP CODE_0293B0
...
CODE_029427:          CMP.B #$2D
                      ...
                      LDA.B SpriteTableC2,X
                      BEQ CODE_029448
CODE_029443:          LDA.B #$FF
                      STA.W SpriteMisc1540,X
CODE_029448:          STZ.W SpriteMisc1558,X
                      LDA.B _E
                      CMP.B #$35
                      BEQ +
                      JSL CODE_01AB6F
...
KillSprLoopStart:     LDA.W SpriteStatus,X                      ; \ Skip current sprite if status < 8
                      CMP.B #$08                                ; |
                      BCC +                                     ; /
...
CODE_0294F5:          LDA.W CapeInteracts
                      BEQ Return02950A
                      STA.B _E
                      LDA.B TrueFrame
                      LSR A
...
CODE_0295AE:          LDA.W CapeInteractionYPos
                      CLC
                      ADC.W DATA_02953C,Y
                      AND.B #$F0
                      STA.B _0
...
CODE_029631:          LDX.B #$07
CODE_029633:          STX.W CurSpriteProcess
...
CODE_029696:          LDA.W CapeInteractionXPos
                      SEC
                      SBC.B #$02
                      STA.B _0
                      LDA.W CapeInteractionXPos+1
...
CODE_0296C0:          LDA.W SmokeSpriteNumber,X
                      BEQ Return0296D7
                      AND.B #$7F
                      JSL ExecutePtr
...
CODE_0296DF:          STZ.W SmokeSpriteNumber,X
                      RTS

CODE_0296E3:          LDA.W SmokeSpriteTimer,X
                      BEQ CODE_0296DF
                      LDA.W SmokeSpriteNumber,X
                      BMI CODE_0296F1
                      LDA.B SpriteLock
                      BNE +
CODE_0296F1:          DEC.W SmokeSpriteTimer,X
...
CODE_02974A:          LDY.W DATA_0296B8,X
                      LDA.W SmokeSpriteXPos,X
                      SEC
                      SBC.B Layer1XPos
                      CMP.B #$F4
...
CODE_029793:          STZ.W SmokeSpriteNumber,X
                      RTS

CODE_029797:          LDA.W SmokeSpriteTimer,X
                      BEQ CODE_029793
                      LDY.B SpriteLock
                      BNE +
...
CODE_0298BE:          STZ.W SmokeSpriteNumber,X
                      RTS
...
CODE_0298CA:          LDA.W SmokeSpriteTimer,X
                      BEQ CODE_0298BE
                      LDY.B SpriteLock
                      BNE Return029921
                      DEC.W SmokeSpriteTimer,X
                      ...
                      BNE Return029921
                      LDY.B #$0B
CODE_0298DC:          LDA.W MinExtSpriteNumber,Y
                      BEQ CODE_0298F1
                      DEY
                      BPL CODE_0298DC
                      DEC.W MinExtSpriteSlotIdx
...
CODE_029927:          LDA.W SmokeSpriteTimer,X
                      BNE CODE_029941
                      BIT.W IRQNMICommand
                      BVC +
...
CODE_029941:          LDY.B SpriteLock
                    ...
                    + LDA.B SpriteNumber+7
                      ...
                      AND.B #$40
                      BNE CODE_02999F
CODE_029967:          LDY.W DATA_0296BC,X
                      BRA +

CODE_02996C:          LDY.W DATA_0296B8,X
                    + LDA.W SmokeSpriteXPos,X
                      SEC
                      SBC.B Layer1XPos
                      STA.W OAMTileXPos,Y
...
CODE_02999F:          LDY.W DATA_0296BC,X
                      LDA.W SmokeSpriteXPos,X
                      SEC
                      SBC.B Layer1XPos
                      STA.W OAMTileXPos+$100,Y
...
CODE_0299D2:          LDX.B #$03
CODE_0299D4:          STX.W CurSpriteProcess
...
CODE_029AA8:          JSL CODE_02AD34                           ; Find next usable location in score sprite table
                      LDA.B #$01
...
CODE_029ADA:          LDY.B #$03                                ; for (c=3;c>=0;c--)
CODE_029ADC:          LDA.W SmokeSpriteNumber,Y                 ; {
                      BEQ CODE_029AE5                           ;  check if there is empty space in smoke/dust sprite table
                      DEY
                      BPL CODE_029ADC                           ; }
                      RTS                                       ;  if no empty space, return

CODE_029AE5:          LDA.B #$05                                ; if there's an empty space, make it 5 (glitter sprite)
...
CODE_029B16:          LDA.W ExtSpriteNumber,X
                      BEQ Return029B15
                      LDY.B SpriteLock
                      BNE +
...
CODE_029BDA:          STZ.W ExtSpriteNumber,X                   ; Clear extended sprite
                      RTS
...
CODE_029BE4:          LDA.B #$05                                ; \ Set ground shake timer
                      STA.W ScreenShakeTimer                    ; /
                      LDA.B #!SFX_KAPOW                         ; \ Play sound effect
                      STA.W SPCIO3                              ; /
                      STZ.B _0
                      JSR CODE_029BF5
                      INC.B _0
CODE_029BF5:          LDY.B #$07                                ; \ Find a free extended sprite slot
CODE_029BF7:          LDA.W ExtSpriteNumber,Y                   ; |
                      BEQ CODE_029C00                           ; |
                      DEY                                       ; |
                      BPL CODE_029BF7                           ; |
                      RTS                                       ; / Return if no free slots

CODE_029C00:          LDA.B #$0F                                ; \ Extended sprite = Yoshi stomp smoke
                      STA.W ExtSpriteNumber,Y                   ; /
                      LDA.B PlayerYPosNext
                      CLC
                      ADC.B #$28
...
CODE_029C7F:          STZ.W ExtSpriteNumber,X                   ; Clear extended sprite
                      RTS

SpinJumpStars:        LDA.W ExtSpriteMisc176F,X
                      BEQ CODE_029C7F
                      JSR CODE_02A1A4
                      LDY.W DATA_02A153,X
                      LDA.B #$34
...
ADDR_029CE3:          LDA.W ExtSpriteMisc1765,X
                      BNE +
                      JSR CODE_02A56E
                      BCC +
                      LDA.B #$D0
                    ...
                    + JSR CODE_02A3F6
CODE_029CF8:          LDA.W ExtSpriteYPosLow,X
                      SEC
                      SBC.B Layer1YPos
                      CMP.B #$F0
                      BCS CODE_029D5A
                      ...
                      STA.W OAMTileNo,Y
                      LDA.B #$0B
CODE_029D36:          ORA.B SpriteProperties
                      STA.W OAMTileAttr,Y
                      TYA
                      LSR A
                      LSR A
...
CODE_029D5A:          STZ.W ExtSpriteNumber,X                   ; Clear extended sprite
Return029D5D:         RTS
...
UnusedExtendedSpr:    JSR CODE_02A3F6
...
CODE_029E39:          STZ.W ExtSpriteNumber,X
                      RTS
...
LavaSplash:           LDA.B SpriteLock
                      ...
                      CMP.B #$30
                      BPL +
CODE_029E9D:          LDY.W DATA_02A153,X
                      LDA.W ExtSpriteXPosLow,X
                      SEC
                      SBC.B Layer1XPos
                      STA.B _0
...
WaterBubble:          LDA.B SpriteLock
                    ...
                    + TXA
                      ...
                      CMP.B #$06
                      BCC CODE_029F2A
CODE_029F27:          JMP CODE_02A211

CODE_029F2A:          LDA.W ExtSpriteYPosLow,X
                      CMP.B Layer1YPos
                      LDA.W ExtSpriteYPosHigh,X
                      SBC.B Layer1YPos+1
                      BNE CODE_029F27
...
YoshiFireball:        LDA.B SpriteLock
                      BNE +
                      JSR CODE_02B554
                      JSR CODE_02B560
                      JSR ProcessFireball
...
MarioFireball:        LDA.B SpriteLock
                      BNE CODE_02A02C
                      LDA.W ExtSpriteYPosLow,X
                      CMP.B Layer1YPos
                      LDA.W ExtSpriteYPosHigh,X
...
CODE_02A010:          STZ.W ExtSpriteXPosSpx,X
                    + LDY.B #$00
                      LDA.W ExtSpriteXSpeed,X
                      BPL +
                      DEY
                    + CLC
                      ...
                      JSR CODE_02B560
CODE_02A02C:          LDA.B SpriteNumber+7
                      CMP.B #$A9
                      BEQ CODE_02A03B
                      LDA.W IRQNMICommand
                      BPL CODE_02A03B
                      AND.B #$40
                      BNE +
CODE_02A03B:          LDY.W DATA_029FA3,X
                      JSR CODE_02A1A7
                      RTS

CODE_02A042:          JSR CODE_02A02C
CODE_02A045:          LDA.B #!SFX_BONK                          ; \ Play sound effect
                      STA.W SPCIO0                              ; /
                      LDA.B #$0F
                      JMP CODE_02A4E0
...
ProcessFireball:      TXA                                       ; \ Return every other frame
                      ...
                      LDX.B #$09                                ; Loop over sprites:
FireRtLoopStart:      STX.W CurSpriteProcess
...
TurnSpriteToCoin:     LDA.B #!SFX_KICK                          ; \ Turn sprite into coin:
                      ...
                      EOR.B #$01
                      STA.W SpriteMisc157C,X                    ; /
FireRtNextSprite:     LDY.W TileGenerateTrackA
                      DEX
                      BMI +
                      JMP FireRtLoopStart
...
ReznorFireball:       LDA.B SpriteLock
                      BNE CODE_02A178
                      JSR CODE_02B554
                      JSR CODE_02B560
                      JSR CODE_02A3F6
CODE_02A178:          LDA.W IRQNMICommand
                      BPL CODE_02A1A4
                      JSR CODE_02A1A4
                      LDY.W DATA_02A153,X
                      LDA.B EffFrame
...
CODE_02A1A4:          LDY.W DATA_02A153,X
CODE_02A1A7:          LDA.W ExtSpriteXSpeed,X
                      AND.B #$80
                      EOR.B #$80
                      LSR A
                      STA.B _0
...
CODE_02A211:          LDA.B #$00                                ; \ Clear extended sprite
...
Baseball:             LDA.B SpriteLock
                      ...
                      INC.W ExtSpriteMisc1765,X
                    + JSR CODE_02A3F6
CODE_02A26A:          LDA.W ExtSpriteNumber,X
                      CMP.B #$0D
                      BNE CODE_02A2C3
                      LDA.W ExtSpriteXPosLow,X
                      SEC
                      ...
                      BPL CODE_02A2BF
                      BMI Return02A2BE
CODE_02A287:          LDY.W DATA_02A153,X
                      LDA.B _0
                      STA.W OAMTileXPos,Y
                      LDA.W ExtSpriteYPosLow,X
                      SEC
...
CODE_02A2BF:          STZ.W ExtSpriteNumber,X                   ; Clear extended sprite
                      RTS

CODE_02A2C3:          JSR CODE_02A317
                      LDA.W OAMTileNo,Y
                      CMP.B #$26
                      LDA.B #$80
                      BCS +
...
Hammer:               LDA.B SpriteLock
                    ...
                    + JSR CODE_02A3F6
                      INC.W ExtSpriteMisc1765,X
CODE_02A30C:          LDA.W ExtSpriteNumber,X
                      CMP.B #$0B
                      BNE CODE_02A317
                      JSR CODE_02A178
                      RTS

CODE_02A317:          JSR CODE_02A1A4
                      LDY.W DATA_02A153,X
                      LDA.W ExtSpriteMisc1765,X
                      LSR A
                      LSR A
...
SmokePuff:            LDA.W ExtSpriteMisc176F,X
                      BEQ -
                      LDA.W ReznorOAMIndex
                      BNE CODE_02A362
                      LDA.W IRQNMICommand
                      ...
                      AND.B #$40
                      BNE ADDR_02A3B1
CODE_02A362:          LDY.W DATA_02A153,X
                      CPX.B #$08
                      BCC +
                      LDY.W DATA_029FA3,X
                    + LDA.W ExtSpriteXPosLow,X
...
CODE_02A3AE:          JML CODE_02A211                           ;!
                   else                                         ;<================ U, SS, E0, & E1 ==============
CODE_02A3AE:          JMP CODE_02A211                           ;!
                   endif                                        ;/===============================================
...
CODE_02A3F6:          LDA.W PlayerBehindNet
                      ...
                      STZ.W ExtSpriteNumber,X                   ; Clear extended sprite
                      LDY.B #$03
ADDR_02A41E:          LDA.W SmokeSpriteNumber,Y
                      BEQ ADDR_02A427
                      DEY
                      BPL ADDR_02A41E
                      INY
...
CODE_02A469:          LDA.W InvinsibilityTimer                  ; \ Branch if Mario has star
                      BNE CODE_02A4B5                           ; /
...
CODE_02A4B5:          LDA.W ExtSpriteNumber,X
                      CMP.B #$04
                      BEQ CODE_02A4DE
                      LDA.W ExtSpriteXPosLow,X
                      SEC
...
CODE_02A4DE:          LDA.B #$07
CODE_02A4E0:          STA.W ExtSpriteMisc176F,X
                      LDA.B #$01
                      STA.W ExtSpriteNumber,X
                      RTS
...
CODE_02A519:          LDY.W ExtSpriteNumber,X
                      LDA.W ExtSpriteXPosLow,X
                      CLC
...
CODE_02A547:          LDA.W ExtSpriteXPosLow,Y
                      SEC
                      SBC.B #$02
                      STA.B _0
...
CODE_02A679:          LDA.W ExtSpriteYPosLow,X
                      CLC
                      ADC.B #$08
                      STA.B TouchBlockYPos
                      AND.B #$F0
...
CODE_02A72B:          LDA.B TouchBlockYPos
                      AND.B #$0F
                      CMP.B #$06
                      BCS CODE_02A729
                      SEC
...
CODE_02A735:          LDA.B TouchBlockYPos
                      AND.B #$0F
                      CMP.B #$06
                      BCS CODE_02A729
                      LDA.W ExtSpriteYPosLow,X
...
LoadSprFromLevel:     LDA.B TrueFrame                           ; \ Return every other frame
                      AND.B #$01                                ; |
                      BNE Return02A84B                          ; /
CODE_02A802:          LDY.B Layer1ScrollDir
...
CODE_02A817:          LDA.B Layer1XPos                          ; \ Horizontal level:
...
LoadSpriteLoopStrt:   LDA.B [SpriteDataPtr],Y                   ; Byte format: YYYYEEsy
...
CODE_02A84C:          BNE Return02A84B                          ; Return if sprite screen > adjusted screen boundary
                      LDA.B [SpriteDataPtr],Y                   ; Byte format: XXXXSSSS
...
CODE_02A88C:          CMP.B #$DE                                ; \ Branch if sprite number != 5 Eeries
                      BNE CODE_02A89C                           ; /
                      PHY
                      PHX
                      DEY
                      ...
                      PLX
                      PLY
CODE_02A89A:          BRA LoadNextSprite

CODE_02A89C:          CMP.B #$E0                                ; \ Branch if sprite number != 3 Platforms on Chain
                      BNE CODE_02A8AC                           ; /
                      PHY
                      PHX
                      DEY
...
CODE_02A8AC:          CMP.B #$CB                                ; \ Branch if sprite number < #$CB
                      BCC CODE_02A8D4                           ; /
...
CODE_02A8C0:          CMP.B #$E1                                ; \ Branch if sprite number < #$E1
                      BCC CODE_02A8D0                           ; /
                      PHX
                      PHY
                      DEY
...
CODE_02A8D0:          LDA.B #$09
                      BRA CODE_02A8DF

CODE_02A8D4:          CMP.B #$C9                                ; \ Branch if sprite number < #$C9
                      BCC LoadNormalSprite                      ; /
                      JSR LoadShooter
                      BRA CODE_02A89A

LoadNormalSprite:     LDA.B #$01                                ; \ $04 = #$01
CODE_02A8DF:          STA.B _4                                  ; / Eventually goes into sprite status
                      DEY                                       ; Previous byte
                      STY.B _3
                    ...
                    + LDA.B _5
                      ...
                      AND.B #$10
                      BEQ CODE_02A916
CODE_02A90F:          LDX.W SpriteSlotMax2,Y
                      LDA.B #$FF
                      STA.B _6
CODE_02A916:          STX.B _F
CODE_02A918:          LDA.W SpriteStatus,X
                      BEQ CODE_02A93C
                      DEX
                      CPX.B _6
                      BNE CODE_02A918
                      ...
                      BNE CODE_02A936
                      LDX.B _F
ADDR_02A92A:          LDA.W SpriteTweakerD,X
                      AND.B #$02
                      BEQ CODE_02A93C
                      DEX
                      CPX.B _6
                      BNE ADDR_02A92A
CODE_02A936:          LDX.B _2
                      STZ.W SpriteLoadStatus,X                  ; Allow sprite to be reloaded by level loading routine
                      RTS

CODE_02A93C:          LDY.B _3
                      LDA.B ScreenMode                          ; \ Branch if horizontal level
                      LSR A                                     ; |
                      BCC CODE_02A95B                           ; /
...
CODE_02A95B:          LDA.B [SpriteDataPtr],Y                   ; Byte format: YYYYEEsy
...
CODE_02A996:          STA.B SpriteNumber,X
                      PLY
...
CODE_02A9C9:          JSL InitSpriteTables                      ; Reset sprite tables
...
FindFreeSprSlot:      STZ.B _E                                  ; Number of slots tp leave free = 0
                    + PHB
                      PHK
                      PLB
                      JSR FindFreeSlotRt
...
FindFreeSlotRt:       LDY.W SpriteMemorySetting                 ; \ Subroutine: Return the first free sprite slot in Y (#$FF if not found)
                      ...
                      SBC.B _E                                  ; |
                      TAY                                       ; |
CODE_02A9FE:          LDA.W SpriteStatus,Y                      ; | If free slot...
...
CODE_02AA33:          LDX.B #$0E                                ; \ Unreachable
...
CODE_02AA8D:          STZ.W BooCloudTimer
                      LDX.B #$13
                    - LDA.B #$07
                      STA.W ClusterSpriteNumber,X
                      LDA.W DATA_02AA0B,X
...
CODE_02AB11:          LDY.W BooRingIndex
                      CPY.B #$02
                      BCS Return02AB77
                      LDY.B #$01
                      CMP.B #$E2
                    ...
                    + STY.B _F
                      ...
                      STA.B _E
                      LDX.B #$13
CODE_02AB28:          LDA.W ClusterSpriteNumber,X
                      BNE CODE_02AB71
                      LDA.B #$04
                      STA.W ClusterSpriteNumber,X
                      LDA.W BooRingIndex
...
CODE_02AB71:          DEX
                      BPL CODE_02AB28
CODE_02AB74:          INC.W BooRingIndex
Return02AB77:         RTS

LoadShooter:          STX.B _2
                      DEY
                      STY.B _3
                      STA.B _4
                      LDX.B #$07
CODE_02AB81:          LDA.W ShooterNumber,X
                      BEQ CODE_02AB9E
                      DEX
                      BPL CODE_02AB81
...
CODE_02ABC7:          LDA.B [SpriteDataPtr],Y
                      PHA
                      AND.B #$F0
                      STA.W ShooterYPosLow,X
                      PLA
...
CODE_02ABF2:          LDX.B #$3F
                    - STZ.W SpriteLoadStatus,X                  ; Allow sprite to be reloaded by level loading routine
                      ...
                      STA.B _0
                      LDX.B #$0B
CODE_02AC00:          LDA.B #$FF                                ; \ Set to permanently erase sprite
...
CODE_02ACA1:          LDA.B Layer1ScrollDir
                      PHA
                      LDA.B #$01
                      STA.B Layer1ScrollDir
                      LDA.B Layer1XPos
...
CODE_02ACEF:          PHY                                       ;  - note coordinates are level coords, not screen
                      ...
                      PHA                                       ; save that value
                      LDA.W SpriteXPosHigh,X                    ; Get y-pos high byte for sprite jumped on
                      SBC.B #$00
...
CODE_02AD34:          LDY.B #$05                                ; (here css is used to index through the table of score sprites in table at $16E1
CODE_02AD36:          LDA.W ScoreSpriteNumber,Y                 ; for (css=5;css>=0;css--){
...
ScoreSprGfx:          BIT.W IRQNMICommand
                      BVC CODE_02ADB8
                      LDA.W IRQNMICommand
                      CMP.B #$C1
                      BEQ Return02ADC8
                      ...
                      STA.W OAMTileYPos+4
                      STA.W OAMTileYPos+8
CODE_02ADB8:          LDX.B #$05
CODE_02ADBA:          STX.W CurSpriteProcess
...
DATA_02ADD9:          db $01,$02,$03,$05,$05,$0A,$0F,$14
                      db $19

DATA_02ADE2:          db $04,$06
...
CODE_02AE03:          LDA.W DATA_02ADE2-$16,Y                   ; Hey, this label might be wrong!
                      CLC
...
CODE_02AE12:          LDA.W PlayerTurnLvl
                      ASL A
                      ADC.W PlayerTurnLvl
                      TAX
                      LDA.W PlayerScore,X
                    ...
                    + LDX.W CurSpriteProcess                    ; X = Sprite index
CODE_02AE38:          LDA.W ScoreSpriteTimer,X
                      LSR A
                      LSR A
                      LSR A
                      LSR A
...
CODE_02AE5B:          LDA.W ScoreSpriteLayer,X
                      ASL A
                      ASL A
                      TAY
                      REP #$20                                  ; A->16
...
Load3Platforms:       LDY.B _3
                      ...
                      LDA.B #$02
                      STA.B _4
CODE_02AF45:          JSL FindFreeSprSlot                       ; \ Return if no free slots
                      BMI Return02AF86                          ; /
                      TYX
                      LDA.B #$01                                ; \ Sprite status = Initialization
                      STA.W SpriteStatus,X                      ; /
...
Load5Eeries:          LDY.B _3
                      ...
                      LDA.B #$04
                      STA.B _4
CODE_02AFAF:          JSL FindFreeSprSlot                       ; \ Return if no free slots
                      BMI Return02AFFD                          ; /
                      TYX
                      LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,X                      ; /
...
CallGenerator:        LDA.W CurrentGenerator
                      BEQ +
                      LDY.B SpriteLock
                      BNE +
                      DEC A
...
TurnOffGen2:          INC.W SpriteWillAppear
                      STZ.W SpriteRespawnTimer                  ; Don't respawn any sprites
                      RTS

TurnOffGenerators:    STZ.W CurrentGenerator
                      RTS

GenerateFire:         LDA.B EffFrame
                      AND.B #$7F
                      BNE +
...
GenerateBullet:       LDA.B EffFrame
                      ...
                      ADC.W DATA_02B1B8,Y
                      STA.B SpriteXPosLow,X
CODE_02B0BD:          LDA.B Layer1XPos+1
CODE_02B0BF:          ADC.W DATA_02B1BA,Y
                      STA.W SpriteYPosHigh,X
                      TYA
                      STA.B SpriteTableC2,X
                    + RTS
...
GenMultiBullets:      LDA.B EffFrame
                      LSR A
                      BCS Return02B0F9
...
CODE_02B115:          JSL FindFreeSlotLowPri
                      BMI +
                      LDA.B #$1C                                ; \ Sprite = Bullet Bill
...
GenerateDolphin:      LDA.B EffFrame
                      AND.B #$1F
                      BNE Return02B2CF
                      LDY.W CurrentGenerator
                      LDX.W DATA_02B263,Y
                      LDA.W DATA_02B265,Y
                      STA.B _0
CODE_02B27D:          LDA.W SpriteStatus,X
                      BEQ CODE_02B288
                      DEX
                      CPX.B _0
                      BNE CODE_02B27D
...
CODE_02B288:          LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,X                      ; /
                      LDA.B #$41
                      STA.B SpriteNumber,X
                      JSL InitSpriteTables
...
CODE_02B387:          LDA.B SpriteLock
                      BNE Return02B3AA
                      LDX.B #$07
CODE_02B38D:          STX.W CurSpriteProcess
...
LaunchTorpedo:        LDA.W ShooterTimer,X
                      BNE Return02B42C
                      LDA.B #$50
                      STA.W ShooterTimer,X
                      ...
                      PLX                                       ; X = shooter index
                      LDY.B #$07                                ; \ Find a free extended sprite slot
CODE_02B424:          LDA.W ExtSpriteNumber,Y                   ; |
                      BEQ CODE_02B42D                           ; |
                      DEY                                       ; |
                      BPL CODE_02B424                           ; |
Return02B42C:         RTS                                       ; / Return if no free slots

CODE_02B42D:          LDA.B #$08                                ; \ Extended sprite = Torpedo Ted arm
                      STA.W ExtSpriteNumber,Y                   ; /
                      LDA.W ShooterXPosLow,X
                      CLC
                      ADC.B #$08
...
ShootBullet:          LDA.W ShooterTimer,X                      ; \ Return if it's not time to generate
                      BNE +                                     ; /
...
FindFreeSmokeSlot:    LDA.W SmokeSpriteNumber,Y                 ; |
                      BEQ SetShooterSmoke                       ; |
                      DEY                                       ; |
...
CODE_02B526:          LDA.W BounceSpriteYSpeed,X
                      ASL A
                      ASL A
                      ASL A
                      ASL A
...
CODE_02B560:          LDA.W ExtSpriteYSpeed,X
                      ASL A
                      ASL A
                      ASL A
                      ASL A
...
CODE_02B58E:          LDA.W CoinSpriteYSpeed,X
                      ASL A
                      ASL A
                      ASL A
                      ASL A
...
CODE_02B5C8:          LDA.W MinExtSpriteYSpeed,X
                      ASL A
                      ASL A
                      ASL A
                      ASL A
...
PokeyMainRt:          LDA.W SpriteMisc1534,X
                      BNE CODE_02B681
...
CODE_02B681:          JSL GenericSprGfxRt2
...
CODE_02B6A7:          LDA.B SpriteTableC2,X                     ; \ Erase sprite if no segments remain
                      BNE +                                     ; |
                    - STZ.W SpriteStatus,X                      ; |
                      RTS
                    ...
                    + JSR CODE_02B7AC
                      LDY.B #$00
CODE_02B709:          LDA.B SpriteTableC2,X
                      AND.W DATA_02B653,Y
                      BNE +
                      LDA.B SpriteTableC2,X
                      PHA
...
CODE_02B781:          LDA.B _1
                    ...
                    + STA.W OAMTileNo+$100,Y
                      ...
                      LDA.B #$04
                      LDY.B #$02
CODE_02B7A7:          JSL FinishOAMWrite
                      RTS

CODE_02B7AC:          LDY.B #$09
CODE_02B7AE:          TYA
                      EOR.B TrueFrame
                      LSR A
                      BCS CODE_02B7D2
...
CODE_02B7D6:          LDA.W SpriteMisc1558,X
                      BNE -
...
CODE_02B82E:          JSL FindFreeSprSlot                       ; \ Return if no free slots
                      BMI +                                     ; /
                      LDA.B #$02                                ; \ Sprite status = Killed
                      STA.W SpriteStatus,Y                      ; /
                      LDA.B #$70
...
CODE_02B88A:          LDA.B SpriteProperties                    ; \ Save $64
                      PHA                                       ; /
...
CODE_02B952:          LDY.B #$03
CODE_02B954:          LDA.W SmokeSpriteNumber,Y
                      BEQ CODE_02B969
                      DEY
                      BPL CODE_02B954
...
CODE_02B969:          LDA.B SpriteXPosLow,X
                      STA.B _0
                      LDA.W SpriteYPosHigh,X
                      STA.B _1
                      PHX
...
CODE_02B9BD:          LDA.B #$02
                      STA.W SilverCoinsCollected
                      LDY.B #$09
CODE_02B9C4:          LDA.W SpriteStatus,Y
                      CMP.B #$08
                      BCC +
...
CODE_02BA48:          LDA.B _1
                    ...
                    + ADC.B _D
                      STA.B _6
CODE_02BA92:          LDX.W CurSpriteProcess                    ; X = Sprite index
                      LDA.B #$7E
                      STA.B _7
                      LDA.B [_5]
                      STA.W Map16TileNumber
                      ...
                      LDY.B #$0B
CODE_02BAB7:          LDA.W SpriteStatus,Y                      ; \ Find a free sprite slot and branch
                      BEQ CODE_02BAC0                           ; |
                      DEY                                       ; |
                      BPL CODE_02BAB7                           ; /
Return02BABF:         RTL                                       ; Return if no slots found

CODE_02BAC0:          LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,Y                      ; /
...
DolphinMain:          JSR CODE_02BC14
                      ...
                      CMP.B #$3F
                      BCS CODE_02BBB7
CODE_02BBB5:          INC.B SpriteYSpeed,X
CODE_02BBB7:          TXA
                      EOR.B TrueFrame
                      LSR A
                      BCC +
                    ...
                    + LDA.W SpriteMisc151C,X
                      ...
                      BNE CODE_02BBFB
                      INC.B SpriteTableC2,X
CODE_02BBF7:          LDA.B #$C0
                      STA.B SpriteYSpeed,X
CODE_02BBFB:          JSL InvisBlkMainRt
Return02BBFF:         RTL

CODE_02BC00:          LDA.B EffFrame
                      AND.B #$04
                      LSR A
                      LSR A
                      STA.W SpriteMisc157C,X
...
CODE_02BC14:          LDA.B SpriteNumber,X
                      CMP.B #$43
                      BNE +
                      JMP CODE_02BC00
...
WallFollowersMain:    JSL SprSprInteract
                      JSL GetRand
                      AND.B #$FF
                      ORA.B SpriteLock
                      BNE +
...
CODE_02BD23:          CMP.B #$A5
                      BCC CODE_02BD2C
                      JSR CODE_02BE4E
                      BRA CODE_02BD2F

CODE_02BD2C:          JSR CODE_02BF5C
CODE_02BD2F:          LDA.W SpriteStatus,X
                      CMP.B #$08
                      BEQ +
...
CODE_02BD68:          LDA.W SpriteMisc1540,X
                      BNE Return02BD74
                      LDA.B #$80
                      STA.W SpriteMisc1540,X
                      INC.B SpriteTableC2,X
...
CODE_02BD75:          LDA.B SpriteNumber,X                      ; \ Branch if Wall-detect Urchin
                      CMP.B #$3B                                ; |
                      BEQ CODE_02BD80                           ; /
                      LDA.W SpriteMisc1540,X
                      BEQ CODE_02BD91
CODE_02BD80:          JSR UpdateXPosNoGrvty
                      JSR UpdateYPosNoGrvty
                      JSL CODE_019138
                      LDA.W SpriteBlockedDirs,X
                      AND.B #$0F
                      BEQ +
CODE_02BD91:          LDA.B SpriteXSpeed,X
                      EOR.B #$FF
                      INC A
                      STA.B SpriteXSpeed,X
                      LDA.B SpriteYSpeed,X
...
CODE_02BDA7:          LDA.B SpriteYPosLow,X
                      SEC
                      SBC.B Layer1YPos
                      CMP.B #$E0
                      BCC CODE_02BDB3
                      STZ.W SpriteStatus,X
CODE_02BDB3:          LDA.W SpriteMisc1540,X
                      BNE CODE_02BDE7
                      LDY.B SpriteTableC2,X
                      LDA.W DATA_02BCA7,Y
                      STA.B SpriteYSpeed,X
...
CODE_02BDE7:          LDA.B #$20
                    ...
                    + CMP.B #$08
                      ...
                      LDA.B #$04
                      STA.B SpriteTableC2,X
CODE_02BE0E:          LDY.B SpriteTableC2,X
                      LDA.W SpriteBlockedDirs,X
                      AND.W DATA_02BCAF,Y
                      BEQ CODE_02BE2F
                      LDA.B #$08
...
CODE_02BE27:          CMP.B #$03
                      BNE CODE_02BE2F
                      LDA.B #$07
CODE_02BE2D:          STA.B SpriteTableC2,X
CODE_02BE2F:          LDY.B SpriteTableC2,X
                      LDA.W DATA_02BC97,Y
                      STA.B SpriteYSpeed,X
                      LDA.W DATA_02BC8F,Y
                      STA.B SpriteXSpeed,X
...
CODE_02BE4E:          LDA.B SpriteNumber,X
                      CMP.B #$A5
                      BNE CODE_02BEB5
                      JSL GenericSprGfxRt2
                      LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
...
CODE_02BF5C:          LDA.W SpriteMisc163E,X
                      BNE +
...
RipVanFishMain:       JSL GenericSprGfxRt2
                      LDA.B SpriteLock
                      BNE -
                      JSR SubOffscreen0Bnk2
                      JSL SprSpr_MarioSprRts
...
CODE_02C042:          DEC.B SpriteXSpeed,X
CODE_02C044:          LDA.W SpriteBlockedDirs,X                 ; \ Branch if not on ground
                      AND.B #$04                                ; |
                      BEQ +                                     ; /
                      STZ.B SpriteYSpeed,X                      ; Sprite Y Speed = 0
                      LDA.B SpriteYPosLow,X
                    ...
                    + JSL CODE_02C0D9
                      ...
                      CMP.B #$60
                      BCS CODE_02C07B
CODE_02C072:          INC.B SpriteTableC2,X
                      LDA.B #$FF
                      STA.W SpriteMisc151C,X
                      BRA CODE_02C08A

CODE_02C07B:          LDY.B #$02
                      LDA.W SpriteMisc1570,X
                      AND.B #$30
                      BNE +
                      INY
...
CODE_02C08A:          LDA.B TrueFrame
                      AND.B #$01
                      BNE CODE_02C095
                      DEC.W SpriteMisc151C,X
                      BEQ CODE_02C0CA
CODE_02C095:          LDA.B TrueFrame
                      AND.B #$07
                      BNE CODE_02C0BB
                      JSR CODE_02D4FA
                      LDA.B SpriteXSpeed,X
...
CODE_02C0CA:          STZ.B SpriteTableC2,X
                      JMP CODE_02C02E
...
CODE_02C0D9:          LDA.B #$06
                    + TAY
                      ...
                      STA.W SpriteMisc1528,X
                      LDY.B #$0B
CODE_02C0F2:          LDA.W MinExtSpriteNumber,Y
                      BEQ CODE_02C107
                      DEY
                      BPL CODE_02C0F2
                      DEC.W MinExtSpriteSlotIdx
...
CODE_02C13A:          LDA.W SpriteMisc1558,X
                      BEQ CODE_02C156
                      CMP.B #$01
                      BNE +
                      LDA.B #$30
...
CODE_02C156:          LDA.W SpriteMisc1540,X
                      BNE CODE_02C181
                      INC.W SpriteMisc1534,X
                    ...
                    + JSR CODE_02C19A
CODE_02C181:          LDY.W SpriteMisc1570,X
                      LDA.W DATA_02C136,Y
                      STA.W SpriteMisc1602,X
                      LDY.W SpriteMisc157C,X
                      LDA.W DATA_02C1F3,Y
...
CODE_02C19A:          JSL FindFreeSprSlot                       ; \ Return if no free slots
                      BMI +                                     ; /
                      LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,Y                      ; /
                      LDA.B #$48
...
CODE_02C22C:          LDA.W SpriteStatus,X
                      CMP.B #$08
                      BNE -
                    ...
                    + LDA.W SpriteBlockedDirs,X                 ; \ Branch if not touching object
                      ...
                      CMP.B #$1E
                      BNE CODE_02C2E4
CODE_02C2A6:          LDA.W SpriteBlockedDirs,X                 ; \ Branch if not on ground
                      AND.B #$04                                ; |
                      BEQ CODE_02C2F7                           ; /
                      LDA.B TouchBlockXPos+1
                      PHA
...
CODE_02C2E4:          LDA.W SpriteBlockedDirs,X                 ; \ Branch if not on ground
                      AND.B #$04                                ; |
                      BEQ CODE_02C2F7                           ; /
                      LDA.B #$C0
                      STA.B SpriteYSpeed,X
...
CODE_02C2F4:          JSR UpdateXPosNoGrvty
CODE_02C2F7:          LDA.W SpriteBlockedDirs,X                 ; \ Branch if not on ground
                      AND.B #$04                                ; |
                      BEQ +                                     ; /
                      JSR CODE_02C579
                    + JSR UpdateYPosNoGrvty
...
CODE_02C3CB:          LDA.W SpriteMisc1534,X
                      BNE CODE_02C43A
                      JSR CODE_02D50C
                      LDA.B _E
                      BPL +
...
CODE_02C43A:          LDA.W SpriteMisc1540,X
                      BEQ CODE_02C45C
                      PHA
                      CMP.B #$20
                      BCC +
...
CODE_02C45C:          STZ.W SpriteMisc1534,X
                      RTS
...
CODE_02C466:          LDA.W SpriteMisc1558,X
                      ORA.W SpriteOffscreenVert,X
                      BNE Return02C439
                      LDY.B #$07                                ; \ Find a free extended sprite slot
CODE_02C470:          LDA.W ExtSpriteNumber,Y                   ; |
                      BEQ CODE_02C479                           ; |
                      DEY                                       ; |
                      BPL CODE_02C470                           ; |
                      RTS                                       ; / Return if no free slots

CODE_02C479:          LDA.B #$0D                                ; \ Extended sprite = Baseball
                      STA.W ExtSpriteNumber,Y                   ; /
                      LDA.B SpriteXPosLow,X
                      STA.B _0
                      LDA.W SpriteYPosHigh,X
...
CODE_02C4BD:          STZ.W SpriteMisc1602,X
                      TXA
                      ASL A
                      ASL A
                      ASL A
...
CODE_02C4E3:          JSR CODE_02C556
                      ...
                      STA.W SpriteMisc1FE2,X
                    + LDA.B #$07
CODE_02C504:          STA.W SpriteMisc1602,X
                      LDA.W SpriteBlockedDirs,X                 ; \ Branch if not on ground
                      AND.B #$04                                ; |
                      BEQ +                                     ; /
                      ...
                      STA.B SpriteYSpeed,X
                      INC.W SpriteMisc160E,X
CODE_02C536:          LDA.B #!SFX_SPRING                        ; \ Play sound effect
                      STA.W SPCIO3                              ; /
                    + RTS

CODE_02C53C:          LDA.B #$06
                      STA.W SpriteMisc1602,X
                      LDA.W SpriteBlockedDirs,X                 ; \ Branch if not on ground
                      AND.B #$04                                ; |
                      BEQ +                                     ; /
...
CODE_02C564:          LDA.B #$03
                      ...
                      LDA.B #$05
                      STA.B SpriteTableC2,X
CODE_02C579:          STZ.B SpriteXSpeed,X                      ; Sprite X Speed = 0
                      STZ.B SpriteYSpeed,X                      ; Sprite Y Speed = 0
                    + RTS
...
CODE_02C5BC:          JSL FindFreeSprSlot
                      BMI CODE_02C5FC
                      LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,Y                      ; /
                      LDA.B #$91
                      ...
                      LDA.B #$50
                      STA.W SpriteMisc1540,Y
CODE_02C5FC:          LDA.B #$09
                      STA.W SpriteMisc1602,X
                      RTS

CODE_02C602:          JSR CODE_02D4FA
                      TYA
                      STA.W SpriteMisc157C,X
                      LDA.B _F
                      CLC
...
CODE_02C691:          LDY.W SpriteMisc1594,X
                      LDA.W DATA_02C62E,Y
                      STA.W SpriteMisc151C,X
                      RTS
...
CODE_02C6A7:          LDA.W SpriteBlockedDirs,X                 ; \ Branch if not on ground
                      AND.B #$04                                ; |
                      BEQ +                                     ; /
                      LDA.W SpriteMisc163E,X
                      CMP.B #$01
                    ...
                    + INY
                      INY
CODE_02C70E:          LDA.W DATA_02C69F,Y
                      STA.B SpriteXSpeed,X
CODE_02C713:          LDA.B TrueFrame
                      LDY.W SpriteMisc187B,X
                      BNE +
                      LSR A
                    + LSR A
...
CODE_02C74A:          LDY.W SpriteMisc1570,X
                      LDA.W SpriteMisc1540,X
                      BNE CODE_02C760
                      INC.W SpriteMisc1570,X
                      INY
                      ...
                      LDA.W DATA_02C743,Y
                      STA.W SpriteMisc1540,X
CODE_02C760:          LDA.W DATA_02C73D,Y
                      STA.W SpriteMisc1602,X
                      LDA.B #$02
                      CPY.B #$05
                      BNE +
...
CODE_02C777:          LDA.B SpriteNumber,X
                      CMP.B #$94
                      BEQ CODE_02C794
                      CMP.B #$46
                      BNE +
...
CODE_02C79D:          LDA.W SpriteMisc1564,X
                      BNE Return02C80F
                      JSL MarioSprInteract
                      BCC Return02C80F
                      ...
                      LDA.B #$D0
                      STA.B SpriteYSpeed,X
CODE_02C7B1:          STZ.B SpriteXSpeed,X                      ; Sprite X Speed = 0
                      LDA.B #$02                                ; \ Sprite status = Killed
                      STA.W SpriteStatus,X                      ; /
...
CODE_02C7F6:          LDA.B #!SFX_ENEMYHURT                     ; \ Play sound effect
                      STA.W SPCIO3                              ; /
                      LDA.B #$03
                      STA.B SpriteTableC2,X
                      LDA.B #$03
...
CODE_02C81A:          JSR GetDrawInfo2
                      JSR CODE_02C88C
                      JSR CODE_02CA27
                      JSR CODE_02CA9D
                      JSR CODE_02CBA1
                      LDY.B #$FF
CODE_02C82B:          LDA.B #$04
                      JMP CODE_02B7A7
...
CODE_02CB2D:          ORA.B SpriteProperties
                      STA.W OAMTileAttr+$100,Y
                      STA.W OAMTileAttr+$104,Y
                      TYA
                      LSR A
                      LSR A
                      TAX
CODE_02CB39:          STZ.W OAMTileSize+$40,X
...
CODE_02CBA1:          LDA.B SpriteNumber,X
                      CMP.B #$46
                      BNE Return02CBFB
                      LDA.W SpriteMisc1602,X
                      CMP.B #$05
...
CODE_02CBB2:          CMP.B #$0E
                      BCC Return02CBFB
                      SEC
                      SBC.B #$0E
CODE_02CBB9:          STA.B _2
                      LDA.W SpriteOAMIndex,X
                      CLC
                      ADC.B #$0C
                      TAY
...
WingedCageMain:       LDA.B SpriteLock                          ; \ If sprites not locked,
...
CODE_02CD59:          LDA.W SpriteMisc1540,X
                      CMP.B #$5E
                      BNE +
...
PeaBouncerMain:       JSR SubOffscreen0Bnk2
                      JSR CODE_02CEE0
                      LDA.B SpriteLock
                      BNE Return02CDFE
                      LDA.W SpriteMisc1534,X
...
CODE_02CE0F:          LDA.W SpriteMisc1540,X
                      BEQ CODE_02CE20
                      DEC A
                      BNE +
                      INC.W SpriteMisc1528,X
...
CODE_02CE20:          LDA.B SpriteTableC2,X
                      BMI CODE_02CE29
...
CODE_02CE3A:          INC.W SpriteMisc1570,X
                      LDA.W SpriteMisc1570,X
                      AND.B #$03
                      BNE CODE_02CE49
                      DEC.W SpriteMisc151C,X
                      BEQ CODE_02CE86
CODE_02CE49:          LDA.W SpriteMisc151C,X
                      EOR.B #$FF
                      INC A
                      STA.B _0
                      LDA.W SpriteMisc157C,X
...
CODE_02CE70:          LDA.B SpriteTableC2,X
                      SEC
                      SBC.B #$04
                      STA.B SpriteTableC2,X
                      BPL Return02CE7D
...
CODE_02CE86:          STZ.B SpriteTableC2,X
                      STZ.W SpriteMisc1528,X
                      RTL
...
CODE_02CF52:          LDA.B PlayerAnimation
                      CMP.B #$01
                      BCS -
...
CODE_02D04D:          LDA.B TrueFrame
                    ...
                    + LDA.B _0
                      BPL Return02D090
OffScrEraseSprBnk2:   LDA.W SpriteStatus,X                      ; \ If sprite status < 8, permanently erase sprite
                      CMP.B #$08                                ; |
                      BCC +                                     ; /
...
VerticalLevelBnk2:    LDA.W SpriteTweakerD,X                    ; \ If "process offscreen" flag is set, return
                      AND.B #$04                                ; |
                      BNE Return02D090                          ; /
...
IsSprOffScreenBnk2:   LDA.W SpriteOffscreenX,X
                      ORA.W SpriteOffscreenVert,X
                      RTS
...
CODE_02D0D4:          LDA.W SpriteMisc1564,X
                      BNE +
...
CODE_02D149:          LDA.B SpriteYPosLow,X                     ; \ $18B2 = Sprite Y position + #$08
                      CLC                                       ; |
                      ADC.B #$08                                ; |
                      STA.W YoshiYPos                           ; /
...
SetTreeTile:          LDA.W YoshiXPos                           ; \ Set X position of block
                      STA.B TouchBlockXPos                      ; |
                      LDA.W YoshiXPos+1                         ; |
                      STA.B TouchBlockXPos+1                    ; /
...
CODE_02D214:          LDA.B byetudlrHold
                      AND.B #$03
                      BNE CODE_02D228
CODE_02D21A:          LDA.B SpriteXSpeed,X
                      BEQ CODE_02D226
                      BPL +
                      INC.B SpriteXSpeed,X
                      INC.B SpriteXSpeed,X
                    + DEC.B SpriteXSpeed,X
CODE_02D226:          BRA CODE_02D247
...
CODE_02D238:          LDA.B SpriteXSpeed,X
                      CMP.W DATA_02D211,Y
                      BEQ CODE_02D247
                      BMI CODE_02D21A
CODE_02D241:          CLC
...
UpdateYPosNoGrvty:    LDA.B SpriteYSpeed,X                      ; \ $14EC or $14F8 += 16 * speed
                      ASL A                                     ; |
                      ASL A                                     ; |
                      ASL A                                     ; |
                      ASL A                                     ; |
...
GetDrawInfo2:         STZ.W SpriteOffscreenVert,X
                    ...
                    + LDA.W SpriteYPosHigh,X
                      ...
                      BEQ CODE_02D3B2
                      INY
CODE_02D3B2:          LDA.B SpriteYPosLow,X
                      CLC
                      ADC.W DATA_02D374,Y
                      PHP
                      CMP.B Layer1YPos
...
Layer3SmashMain:      JSL CODE_00FF61
                      LDA.B SpriteLock
                      BNE Return02D444
                      JSR CODE_02D49C
                      LDY.B #$00
...
CODE_02D419:          LDA.W SpriteWillAppear
                      BEQ +
                    ...
                    + LDA.W SpriteMisc1540,X
                      ...
                      STZ.W SpriteXPosHigh,X
                      STZ.B SpriteYSpeed,X                      ; Sprite Y Speed = 0
Return02D444:         RTL

CODE_02D445:          LDA.W SpriteMisc1540,X
                      BEQ +
...
CODE_02D455:          JSR UpdateYPosNoGrvty
                      LDA.B SpriteYSpeed,X
                      BMI CODE_02D460
...
CODE_02D481:          LDA.W SpriteMisc1540,X
                      BNE +
                      INC.B SpriteTableC2,X
                    + RTL

CODE_02D489:          LDA.B #con($E0,$E0,$E0,$D8,$D8)
                      STA.B SpriteYSpeed,X
                      JSR UpdateYPosNoGrvty
                      LDA.B SpriteYPosLow,X
                      BNE +
...
CODE_02D625:          JSR CODE_02D62A
                    + PLB
                      RTL

CODE_02D62A:          JSR SubOffscreen3Bnk2
                      LDA.B SpriteLock
                      BNE CODE_02D653
                      LDA.B SpriteXPosLow,X
                      LDY.B #$02
                    ...
                    + CLC
                      ...
                      AND.B #$01
                      STA.W SpriteMisc151C,X
CODE_02D653:          LDA.W SpriteMisc151C,X
                      STA.B _1
                      LDA.W SpriteMisc1602,X
                      STA.B _0
                      REP #$30                                  ; AXY->16
...
CODE_02D73D:          LDA.W SpriteMisc160E,X
                      BEQ +
                      STZ.W SpriteMisc160E,X
                      PHX
                      JSL CODE_00E2BD
...
CODE_02D750:          JSL MarioSprInteract
                      JSR CODE_02D813
                    + PLA
                      STA.W SpriteXPosHigh,X
                      PLA
...
CODE_02D8BB:          LDA.W SpriteOAMIndex,X
                      CLC
                      ADC.B #$14
                      STA.W SpriteOAMIndex,X
                      JSL GenericSprGfxRt2
...
CODE_02D978:          LDY.B SpriteTableC2,X
...
CODE_02DA5A:          STZ.W SpriteMisc157C,X
                      LDA.W SpriteStatus,X
                      CMP.B #$02
                      BNE +
                      JMP HammerBroGfx
...
CODE_02DABA:          LDA.W ExtSpriteNumber,Y                   ; |
                      BEQ GenerateHammer                        ; |
                      DEY                                       ; |
                      BPL CODE_02DABA                           ; |
                      RTS                                       ; / Return if no free slots
...
HammerBroGfx:         JSR GetDrawInfo2
                      LDA.W SpriteMisc157C,X
                      STA.B _2
                      PHX
                      LDX.B #$03
CODE_02DB08:          LDA.B _0
                      CLC
...
CODE_02DB5C:          JSR FlyingPlatformGfx                     ; Draw sprite
                      LDA.B #$FF                                ; \ $1594 = #$FF
                      STA.W SpriteMisc1594,X                    ; /
                      LDY.B #$09                                ; \ Check sprite slots 0-9 for Hammer Brother
CODE_02DB66:          LDA.W SpriteStatus,Y                      ; |
                      CMP.B #$08                                ; |
                      BNE CODE_02DB74                           ; |
                      LDA.W SpriteNumber,Y                      ; |
                      CMP.B #$9B                                ; |
...
PutHammerBroOnPlat:   TYA                                       ; \ $1594 = index of Hammer Bro
                    ...
                    + LDA.W SpriteMisc151C,X
                      ...
                      BNE CODE_02DBD7
                      INC.W SpriteMisc151C,X
CODE_02DBD7:          JSR UpdateYPosNoGrvty
                      JSR UpdateXPosNoGrvty
                      STA.W SpriteMisc1528,X
                      JSL InvisBlkMainRt
                      LDA.W SpriteMisc1558,X
...
FlyingPlatformGfx:    JSR GetDrawInfo2
                      LDA.B SpriteTableC2,X
                      STA.B _7
                      LDA.W SpriteMisc1558,X
                      LSR A
...
CODE_02DCEA:          LDA.B #$01
                      STA.W SpriteMisc1602,X
                      LDA.W SpriteMisc1540,X
                      BNE +
                      STZ.W SpriteMisc1602,X
                      LDA.B #$03
CODE_02DCF9:          STA.W SpriteMisc1540,X
                      INC.B SpriteTableC2,X
                    + RTS

CODE_02DCFF:          LDA.W SpriteMisc1540,X
                      BNE Return02DD0B
...
CODE_02DD0E:          LDA.W SpriteMisc1558,X
                      BNE CODE_02DD45
                      LDY.W SpriteMisc157C,X
                      LDA.W DATA_02DD0C,Y
                      STA.B SpriteXSpeed,X
...
CODE_02DD3D:          LDA.B #$03
CODE_02DD3F:          JSR CODE_02DCF9
                      STZ.B SpriteTableC2,X
Return02DD44:         RTS

CODE_02DD45:          LDA.B #$01
                      STA.W SpriteMisc1602,X
                      RTS

CODE_02DD4B:          LDA.B #$03
                      LDY.W SpriteMisc1540,X
                      BEQ CODE_02DD81
                      CPY.B #$2E
                      BNE CODE_02DD6F
...
CODE_02DD81:          LDA.W SpriteMisc157C,X
                      EOR.B #$01
                      STA.W SpriteMisc157C,X
                      LDA.B #$40
                      JSR CODE_02DD3F
...
GenSumoLightning:     JSL FindFreeSprSlot                       ; \ Return if no free slots
                      BMI +                                     ; /
...
CODE_02DEB0:          LDA.W SpriteMisc1540,X
                      BNE CODE_02DEFC
                      LDA.B #$30
                      STA.B SpriteYSpeed,X
                      JSR UpdateYPosNoGrvty
...
CODE_02DF2C:          LDA.B SpriteXPosLow,X
                      STA.B _0
                      LDA.W SpriteYPosHigh,X
                      STA.B _1
                      LDY.B #$09
CODE_02DF37:          LDA.W ClusterSpriteNumber,Y
                      BEQ CODE_02DF4C
                      DEY
                      BPL CODE_02DF37
...
CODE_02DF93:          JSR VolcanoLotusGfx
                      LDA.B SpriteLock
                      BNE Return02DFC8
...
CODE_02DFC9:          LDA.W SpriteMisc1540,X
                      BNE +
                      LDA.B #$40
CODE_02DFD0:          STA.W SpriteMisc1540,X
                      INC.B SpriteTableC2,X
                      RTS
...
CODE_02DFDF:          LDA.W SpriteMisc1540,X
                      BNE CODE_02DFE8
                      LDA.B #$40
                      BRA CODE_02DFD0
...
CODE_02DFEF:          LDA.W SpriteMisc1540,X
                      BNE +
                      LDA.B #$80
                      JSR CODE_02DFD0
                      STZ.B SpriteTableC2,X
...
CODE_02E079:          LDA.W SpriteOffscreenX,X
                      ORA.W SpriteOffscreenVert,X
                      BNE Return02E0C4
                      LDA.B #$03
                      STA.B _0
CODE_02E085:          LDY.B #$07                                ; \ Find a free extended sprite slot
CODE_02E087:          LDA.W ExtSpriteNumber,Y                   ; |
                      BEQ CODE_02E090                           ; |
                      DEY                                       ; |
                      BPL CODE_02E087                           ; |
                      RTS                                       ; / Return if no free slots

CODE_02E090:          LDA.B #$0C                                ; \ Extended sprite = Volcano Lotus fire
                      STA.W ExtSpriteNumber,Y                   ; /
                      LDA.B SpriteXPosLow,X
                      CLC
                      ADC.B #$04
...
CODE_02E0CD:          JSL LoadSpriteTables
                      LDA.B SpriteProperties
                      PHA
                      LDA.B #$10
                      STA.B SpriteProperties
...
CODE_02E13C:          STZ.B SpriteYSpeed,X                      ; Sprite Y Speed = 0
                      LDA.W SpriteMisc1540,X
                      BNE +
                      JSR CODE_02D4FA
                      LDA.B _F
...
CODE_02E159:          LDA.B SpriteYSpeed,X
                      BMI CODE_02E161
                      CMP.B #$40
                      BCS +
CODE_02E161:          CLC
...
CODE_02E177:          INC.W SpriteMisc151C,X
                      LDA.W SpriteMisc1540,X
                      BNE CODE_02E1A4
CODE_02E17F:          INC.W SpriteMisc1570,X
                      LDA.B EffFrame
                      AND.B #$03
                      BNE +
                      LDA.B SpriteYSpeed,X
...
CODE_02E1A4:          LDY.B SpriteNumber,X
                      CPY.B #$50
                      BNE CODE_02E1F7
                      STZ.W SpriteMisc1570,X
                      CMP.B #$40
                      ...
                      JSR CODE_02E1C0
                      LDA.B #$F0
CODE_02E1C0:          STA.B _0
                      LDY.B #$07                                ; \ Find a free extended sprite slot
CODE_02E1C4:          LDA.W ExtSpriteNumber,Y                   ; |
                      BEQ CODE_02E1CD                           ; |
                      DEY                                       ; |
                      BPL CODE_02E1C4                           ; |
                      RTS                                       ; / Return if no free slots

CODE_02E1CD:          LDA.B #$0B                                ; \ Extended sprite = Piranha fireball
                      STA.W ExtSpriteNumber,Y                   ; /
                      LDA.B SpriteXPosLow,X
                      CLC
                      ADC.B #$04
...
CODE_02E21D:          LDA.B SpriteProperties
                      PHA
                      LDA.W SpriteMisc1540,X
                      CMP.B #$30
                      BCC +
...
CODE_02E245:          JSL GenericSprGfxRt2
                      LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
                      LDA.B #$2E
                      STA.W OAMTileNo+$100,Y
                      LDA.W OAMTileAttr+$100,Y
                    ...
                    + PLA
                      ...
                      BNE CODE_02E288
CODE_02E271:          STZ.W DirectCoinTimer
                      STZ.W SpriteStatus,X
                      LDA.W BluePSwitchTimer
...
CODE_02E288:          LDY.B SpriteTableC2,X
                      LDA.W DATA_02E1F9,Y
                      STA.B SpriteXSpeed,X
                      LDA.W DATA_02E1FD,Y
                      STA.B SpriteYSpeed,X
...
CODE_02E2F3:          LDA.W SprMap16TouchHorizHigh
                      BNE CODE_02E2FF
                      LDA.W SprMap16TouchHorizLow
                      CMP.B #$25
                      BEQ +
CODE_02E2FF:          JSR CODE_02E271
                    + RTS
...
CODE_02E41F:          JSL GenericSprGfxRt2
                      LDA.B SpriteLock
                      BNE Return02E462
                      BRA +
...
CODE_02E463:          LDA.B SpriteTableC2,X
                      STA.B SpriteNumber,X
                      JSL InitSpriteTables
                      LDA.B #$D0
                      STA.B SpriteYSpeed,X
...
ScalePlatformMain:    LDA.W SpriteOAMIndex,X
                      PHA
                      PHB
                      PHK
                      PLB
...
CODE_02E4A5:          JSR SubOffscreen2Bnk2
                      STZ.W TileGenerateTrackA
                      LDA.B SpriteXPosLow,X
                      PHA
                      LDA.W SpriteYPosHigh,X
...
CODE_02E524:          LDA.B SpriteYPosLow,X
                      AND.B #$0F
                      BNE CODE_02E54E
                      LDA.B SpriteYSpeed,X
                      BEQ CODE_02E54E
                    ...
                    + LDA.W MushrmScaleTiles,Y
                      ...
                      STA.B TouchBlockYPos+1                    ; /
                      JSL GenerateTile                          ; Generate the tile
CODE_02E54E:          JSR MushroomScaleGfx
                      STZ.W SpriteMisc1528,X
                      JSL InvisBlkMainRt
                      RTS

CODE_02E559:          LDY.B SpriteLock
                      BNE Return02E57D
                      PHA
                      JSR UpdateYPosNoGrvty
                      PLA
...
MushroomScaleGfx:     JSR GetDrawInfo2
                      LDA.B _0
                      SEC
                      SBC.B #$08
                      STA.W OAMTileXPos+$100,Y
...
CODE_02E5BC:          JSR SubOffscreen0Bnk2
                      LDA.B SpriteLock
                      BNE CODE_02E5D7
                      INC.W SpriteMisc1570,X
                      LDY.B #$10
...
CODE_02E5D7:          JSR CODE_02E637
                      ...
                      BNE +
CODE_02E5E8:          JSL MarioSprInteract
...
CODE_02E5F7:          LDY.B #$0B
CODE_02E5F9:          CPY.W CurSpriteProcess
                      BEQ CODE_02E633
                      TYA
                      EOR.B TrueFrame
                      AND.B #$03
...
CODE_02E727:          JSL GenericSprGfxRt2
                      LDA.B SpriteLock
                      BNE +
                      JSR SubOffscreen0Bnk2
                      JSL SprSpr_MarioSprRts
...
CODE_02E74E:          LDY.W SpriteMisc157C,X
                      LDA.W DATA_02E74C,Y
                      STA.B SpriteXSpeed,X
                      JSR UpdateXPosNoGrvty
                      LDA.W SpriteMisc1540,X
...
CODE_02E77C:          INC.B SpriteTableC2,X
                      LDA.B #$80
                      STA.W SpriteMisc1540,X
                      LDA.B #$A0
                      STA.B SpriteYSpeed,X
...
CODE_02E788:          LDA.W SpriteMisc1540,X
                      BEQ CODE_02E7A4
                      CMP.B #$70
                      BCS Return02E7A3
                      STZ.B SpriteXSpeed,X                      ; Sprite X Speed = 0
...
CODE_02E7A4:          LDA.B SpriteYPosLow,X
                      AND.B #$F0
                      STA.B SpriteYPosLow,X
                      INC.B SpriteTableC2,X
                      STZ.W SpriteMisc1570,X
...
CODE_02E7BD:          LDA.B SpriteProperties
                      PHA
                      LDA.W SpriteMisc1540,X
                      BEQ +
                      LDA.B #$10
                    ...
                    + STA.B SpriteYSpeed,X
                      ...
                      LDA.B #$F8
                    + STA.B SpriteXSpeed,X
CODE_02E828:          JSL SprSpr_MarioSprRts
Return02E82C:         RTS
...
CODE_02E845:          LDA.W SpriteMisc1534,X
                      BMI +
                      LDA.B SpriteYPosLow,X
                      PHA
                      SEC
...
CODE_02E8A2:          LDA.W DATA_02E835,Y
                      STA.B SpriteYSpeed,X
                      BEQ +
                      LDA.B SpriteYPosLow,X
                      AND.B #$0F
                      ...
                      JSR GrowingPipeGfx
                    + JSR UpdateYPosNoGrvty
CODE_02E8B5:          JSL InvisBlkMainRt
                      RTS
...
CODE_02E93D:          LDA.W SpriteStatus,X
                      CMP.B #$02
                      BNE +
                      LDA.B #$02
                      STA.W SpriteMisc1602,X
...
CODE_02E96D:          LDA.W SpriteMisc1540,X
                      BNE +
                      JSR CODE_02D4FA
                      LDA.B _F
                      CLC
                      ...
                      BCC +
                      LDA.B #$90
CODE_02E980:          STA.W SpriteMisc1540,X
                      INC.B SpriteTableC2,X
                    + RTS

CODE_02E986:          LDA.W SpriteMisc1540,X
                      BNE CODE_02E996
                      JSR CODE_02D4FA
                      TYA
                      STA.W SpriteMisc157C,X
...
CODE_02E996:          CMP.B #$7C
                      BCC +
CODE_02E99A:          LDA.B #$F8
CODE_02E99C:          STA.B SpriteYSpeed,X
                      JSR UpdateYPosNoGrvty
                      RTS
...
CODE_02E9B4:          LDA.W SpriteMisc1540,X
                      BNE CODE_02E99A
                      LDA.B #$80
                      BRA CODE_02E980

CODE_02E9BD:          LDA.W SpriteMisc1540,X
                      BNE CODE_02E9C6
                      LDA.B #$20
                      BRA CODE_02E980

CODE_02E9C6:          CMP.B #$40
                      BNE +
                      JSL CODE_01EA19
                      RTS
...
CODE_02E9D5:          LDA.W SpriteMisc1540,X
                      BNE +
                      LDA.B #$50
                      JSR CODE_02E980
                      STZ.B SpriteTableC2,X
...
CODE_02EA25:          LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
...
ADDR_02EACE:          STZ.W SpriteMisc163E,X
                      RTS
...
CODE_02EAF2:          JSL FindFreeSprSlot                       ; \ Return if no free slots
                      BMI +                                     ; /
                      LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,Y                      ; /
                      LDA.B #$77
...
CODE_02EB31:          JSR CODE_02ECDE
                      LDA.W SpriteStatus,X
                      CMP.B #$02
                      BNE CODE_02EB49
                      LDY.B #$04
CODE_02EB3D:          LDA.B EffFrame
                      AND.B #$04
                      BEQ +
                      INY
                    + TYA
...
CODE_02EB7D:          LDA.B SpriteTableC2,X
                      JSL ExecutePtr
...
CODE_02EB8D:          LDA.B TrueFrame
                      ...
                      STA.B SpriteXSpeed,X
                    + INC.B _0
CODE_02EBAB:          INC.W SpriteMisc151C,X
                      LDA.W SpriteMisc151C,X
                      CMP.B #$30
                      BEQ CODE_02EBCA
CODE_02EBB5:          LDY.B #$00
                      LDA.B TrueFrame
                      AND.B #$04
                      BEQ +
                      INY
...
CODE_02EBCA:          INC.B SpriteTableC2,X
                      LDA.B #$D0
                      STA.B SpriteYSpeed,X
                      RTS

CODE_02EBD1:          LDA.B SpriteYSpeed,X
                      CLC
                      ADC.B #$02
                      STA.B SpriteYSpeed,X
                      CMP.B #$14
...
CODE_02EBE7:          LDY.W SpriteMisc157C,X
                      LDA.W DATA_02EB89,Y
                      STA.B SpriteXSpeed,X
                      LDA.B SpriteYSpeed,X
                      BEQ CODE_02EBF8
...
CODE_02ED3B:          LDA.B SpriteNumber,X
                      CMP.B #$72
                      LDA.B #$08
                      BCC +
                      LSR A
...
CODE_02ED4D:          LDA.W DATA_02EC96,X
                      ORA.B _5
                    + ORA.B SpriteProperties
                      BCS +
                      PHA
...
CODE_02ED8A:          STZ.W SkullRaftSpeed
                      INC.B SpriteTableC2,X
                      LDA.B #$02
                      STA.B _0
CODE_02ED93:          JSL FindFreeSprSlot                       ; \ Branch if no free slots
                      BMI +                                     ; /
                      LDA.B #$08                                ; \ Sprite status = Normal
                      STA.W SpriteStatus,Y                      ; /
                      LDA.B #$61
...
CODE_02EDF6:          JSL GenericSprGfxRt2
                      LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
                      LDA.B EffFrame
                      LSR A
                      LSR A
                    ...
                    + LDA.B SpriteLock
                      ...
                      STZ.B _0
                      LDY.B #$09
CODE_02EE21:          LDA.W SpriteStatus,Y
                      BEQ +
                      LDA.W SpriteNumber,Y
                      CMP.B #$61
                      BNE +
...
ADDR_02EEB5:          LDA.B SpriteTableC2,X
                      BNE +
                      INC.B SpriteTableC2,X
                    ...
                    + LDA.B SpriteYSpeed,X
                      ...
                      ADC.W DATA_02EEB1,Y
                      STA.B SpriteYSpeed,X
ADDR_02EF12:          JSR UpdateYPosNoGrvty
                      LDA.B #$08
                      STA.B SpriteXSpeed,X
                      JSR UpdateXPosNoGrvty
ADDR_02EF1C:          LDA.W SpriteOAMIndex,X
                      PHA
                      CLC
                      ADC.B #$04
                      STA.W SpriteOAMIndex,X
...
ADDR_02EF67:          LDA.W GameCloudCoinCount
                      CMP.B #$0A
                      BCC ADDR_02EFAA
                      LDY.B #$0B
ADDR_02EF70:          LDA.W SpriteStatus,Y
                      BEQ ADDR_02EF7B
                      DEY
                      CPY.B #$09
                      BNE ADDR_02EF70
...
ADDR_02EFAA:          LDA.W SpriteMisc1570,X
                      CMP.B #$0B
                      BCS Return02EFBB
                      LDY.B #$07                                ; \ Find a free extended sprite slot
ADDR_02EFB3:          LDA.W ExtSpriteNumber,Y                   ; |
                      BEQ ADDR_02EFBC                           ; |
                      DEY                                       ; |
                      BPL ADDR_02EFB3                           ; |
...
CODE_02F061:          JSR UpdateXPosNoGrvty
                      JSR UpdateYPosNoGrvty
                      JSR SubOffscreen0Bnk2
                      INC.W SpriteMisc1570,X
                      LDA.W SpriteMisc151C,X
...
CODE_02F0AE:          LDA.W SpriteMisc15AC,X
                      BNE +
                      LDA.W SpriteMisc157C,X
                      EOR.B #$01
                      STA.W SpriteMisc157C,X
...
CODE_02F1C7:          PHX
                    ...
                    + STA.W OAMTileAttr+$100,Y
                      ...
                      STA.B _0
                      LDY.W SpriteOAMIndex,X                    ; Y = Index into sprite OAM
CODE_02F22B:          LDA.W OAMTileXPos+$104,Y
                      SEC
                      SBC.B PlayerXPosScrRel
                      ADC.B #$0C
                      CMP.B #$18
...
CODE_02F296:          JSL HurtMario
                      RTS

CODE_02F29B:          BRA CODE_02F2C7
...
CODE_02F2D7:          LDY.B #$07                                ; \ Find a free extended sprite slot
CODE_02F2D9:          LDA.W ExtSpriteNumber,Y                   ; |
                      BEQ CODE_02F2E2                           ; |
                      DEY                                       ; |
                      BPL CODE_02F2D9                           ; |
                      RTS                                       ; / Return if no free slots

CODE_02F2E2:          LDA.B #$0E                                ; \ Extended sprite = Wiggler flower
                      STA.W ExtSpriteNumber,Y                   ; /
                      LDA.B #$01
                      STA.W ExtSpriteMisc1765,Y
                      LDA.B SpriteXPosLow,X
...
CODE_02F317:          LDA.W SpriteMisc15AC,X
                      BEQ +
                      LDA.B #$04
                      STA.W SpriteMisc1602,X
                    + JSR CODE_02F3EA
...
CODE_02F342:          LDY.W SpriteMisc157C,X
                      LDA.W DATA_02F340,Y
                      STA.B SpriteXSpeed,X
                      STZ.W SpriteMisc1602,X
                      LDA.B SpriteYSpeed,X
...
CODE_02F381:          LDA.W SpriteMisc154C,X
                      BNE +
                      JSR CODE_02F3C1
                      LDA.B #$10
                      STA.W SpriteMisc154C,X
...
CODE_02F38F:          STZ.B SpriteYSpeed,X                      ; Sprite Y Speed = 0
                      STZ.B SpriteXSpeed,X                      ; Sprite X Speed = 0
                      STZ.W SpriteMisc1602,X
                      LDA.W SpriteMisc1540,X
                      BEQ CODE_02F3A3
...
CODE_02F3A3:          LDA.W SpriteMisc1570,X
                      BEQ +
                      DEC.W SpriteMisc1570,X
                      JSL GetRand
                      AND.B #$1F
                    ...
                    + STZ.B SpriteTableC2,X
                      ...
                      AND.B #$01
                      BNE +
CODE_02F3C1:          LDA.W SpriteMisc157C,X
                      EOR.B #$01
                      STA.W SpriteMisc157C,X
                      LDA.B #$0A
                      STA.W SpriteMisc15AC,X
...
CODE_02F434:          INC.W SpriteMisc1570,X
                      LDY.B #$04
                      LDA.W SpriteMisc1570,X
                      AND.B #$40
                      BEQ +
...
CODE_02F4EB:          LDA.W SpriteOAMIndex,X
                      CLC
                      ADC.B #$08
                      TAY
                      LDA.B #$B8
...
CODE_02F54A:          LDA.W SpriteStatus,Y
                      BEQ CODE_02F553
                      DEY
                      BPL CODE_02F54A
                      RTS
...
CODE_02F5D0:          LDA.B Layer1XPos
                      CMP.B #$46
                      BCS Return02F618
                      LDX.B #$09
                      LDY.B #$A0
CODE_02F5DA:          STZ.B _2
                      LDA.W DATA_02F59E,X
                      SEC
                      SBC.B Layer1XPos
                      STA.B _0
...
CODE_02F66E:          LDA.W NoYoshiIntroTimer
                      BEQ +
...
CODE_02F698:          LDA.B #$30
CODE_02F69A:          STA.B _0
                      JSR CODE_02F6B8
                      RTS
...
CODE_02F759:          LDA.W NoYoshiIntroTimer
                      BEQ +
                      DEC.W NoYoshiIntroTimer
                    + CMP.B #$76
                      BNE +
...
CODE_02F810:          LDX.B #$13
CODE_02F812:          STX.W CurSpriteProcess
...
CODE_02F83D:          LDA.W BooCloudTimer
                      STA.W TileGenerateTrackA
                      TXY
                      BNE +
                      DEC.W BooCloudTimer
...
CODE_02F91C:          LDA.W ClusterSpriteMisc0F4A,X
                      BEQ CODE_02F93C
                      LDY.B SpriteLock
                      BNE +
...
CODE_02F93C:          STZ.W ClusterSpriteNumber,X
                      RTS
...
ADDR_02F9A6:          STZ.W ClusterSpriteNumber,X
                      RTS
...
CODE_02F9AE:          TXA
                      ...
                      LDA.W InvinsibilityTimer                  ; \ Branch if Mario has star
                      BNE ADDR_02F9A6                           ; /
CODE_02F9F5:          LDA.W PlayerRidingYoshi
                      BNE +
                      JSL HurtMario
Return02F9FE:         RTS
...
CODE_02FA98:          LDY.W ClusterSpriteMisc0F86,X
...
CODE_02FBC7:          CPX.B #$00
                    ...
                    + TAX
                      ...
                      LDA.B _1
                      STA.W ClusterSpriteMisc1E66,X
CODE_02FC3E:          LDX.W CurSpriteProcess                    ; X = Sprite index
CODE_02FC41:          LDA.B SpriteLock
                      BNE +
                    ...
                    + LDA.W ClusterSpriteYPosLow,X
                      ...
                      STZ.W ClusterSpriteMisc0F86,X
                      STZ.W ClusterSpriteMisc1E66,X
CODE_02FC8D:          LDA.W ClusterSpriteXPosLow,X
                      STA.B _0
                      LDA.W ClusterSpriteXPosHigh,X
                      STA.B _1
                      REP #$20                                  ; A->16
...
CODE_02FCD9:          LDY.W DATA_02FF50,X
                      LDA.B #$F0
                      STA.W OAMTileYPos+$100,Y
                      RTS

CODE_02FCE2:          LDA.B SpriteLock
                      BNE CODE_02FD46
                      LDA.W ClusterSpriteNumber,X
                      CMP.B #$08
                      BEQ CODE_02FD46
                    ...
                    + TYA
                      ...
                      STA.W ClusterSpriteYPosHigh,X
CODE_02FD46:          LDA.B #$0E
CODE_02FD48:          STA.B _2
                      LDY.W DATA_02FF50,X
                      LDA.W ClusterSpriteXPosLow,X
                      SEC
                      SBC.B Layer1XPos
...
CODE_02FE48:          LDY.W DATA_02FF64,X
                      LDA.W ClusterSpriteXPosLow,X
                      SEC
                      SBC.B Layer1XPos
                      STA.W OAMTileXPos,Y
...
DATA_02FECB:          db $01,$FF
                    ...
                    + LDA.B _0
                      BPL Return02FF1D
ADDR_02FF0E:          LDY.W ClusterSpriteMisc0F86,X
                      CPY.B #$FF
                      BEQ +
                      LDA.B #$00                                ; \ Allow sprite to be reloaded by level loading routine
                      STA.W SpriteLoadStatus,Y                  ; /
...
ADDR_02FF1E:          LDA.B TrueFrame                           ; \ Unreachable, called from above routine
                      LSR A
                      BCS Return02FF1D
                      AND.B #$01
                      STA.B _1
...
CODE_02FFA3:          LDA.W ClusterSpriteMisc1E52,X
                      ASL A
                      ASL A
                      ASL A
                      ASL A
...
CODE_02FFD1:          LDA.W SpriteBlockedDirs,X
                      BMI ADDR_02FFDD
                      LDA.B #$00
                      LDY.W SpriteSlope,X
                      BEQ +
