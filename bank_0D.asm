...
Map16Common:          db $70,$1C,$72,$1C,$71,$1C,$73,$1C
...
Map16Tileset0:        db $C5,$15,$CC,$15,$C6,$15,$CD,$15
...
Map16BGTiles:         db $F8,$00,$F8,$00,$F8,$00,$F8,$00
...
CODE_0DA100:          SEP #$30                                  ; AXY->8
                      JSR CODE_0DA106
                      RTL

CODE_0DA106:          SEP #$30                                  ; AXY->8
...
CODE_0DA40F:          SEP #$30                                  ; AXY->8
                      JSR CODE_0DA415
                      RTL

CODE_0DA415:          SEP #$30                                  ; AXY->8
                      LDA.W ObjectTileset
                      JSL ExecutePtrLong
...
CODE_0DA5A7:          LDA.W Checkpoint1upCollected,Y
                      AND.L DATA_0DA8A6,X
                      BEQ CODE_0DA5B1
Return0DA5B0:         RTS

CODE_0DA5B1:          LDY.B LevelLoadPos
                      JSR StzTo6ePointer
                      LDX.B _0
                      CPX.B #$13
                      BMI +
...
CODE_0DA5F0:          TXA
                    ...
                    + LDA.B LevelLoadPos
                      ...
                      LDA.B #$32
                      STA.B _C
CODE_0DA648:          LDA.B _C
                      STA.B [Map16LowPtr],Y
                    + RTS

CODE_0DA64D:          LDA.B #$32
                      JMP CODE_0DA57F
...
ADDR_0DA656:          LDY.B LevelLoadPos
                      TXA
                      SEC
                      SBC.B #$42
                      TAX
...
CODE_0DA673:          LDY.B LevelLoadPos
                      TXA
                      SEC
                      SBC.B #$44
                      TAX
...
CODE_0DA68E:          LDX.W TranslevelNo
...
CODE_0DA6B1:          LDA.B Map16LowPtr
                      STA.B _4
                      LDA.B Map16LowPtr+1
                      STA.B _5
                      RTS

CODE_0DA6BA:          LDA.B _4
                      STA.B Map16LowPtr
                      STA.B Map16HighPtr
                      LDA.B _5
                      STA.B Map16LowPtr+1
...
CODE_0DA6D1:          LDY.B LevelLoadPos
                      TXA
                      SEC
                      SBC.B #$47
                      TAX
...
CODE_0DA71B:          LDY.B LevelLoadPos
                      LDA.B #$08
                      STA.B _0
                      LDA.B #$04
                      STA.B _1
...
CODE_0DA760:          LDY.B LevelLoadPos
                      LDA.B #$05
                      STA.B _0
                      LDA.B #$03
                      STA.B _1
...
CODE_0DA7C1:          LDY.B LevelLoadPos
                      LDX.B #$00
                      JSR CODE_0DA6B1
CODE_0DA7C8:          LDA.B #$03
                      STA.B _2
                    - LDA.L DATA_0DA7B1,X
                      JSR CODE_0DA95B
                      INX
...
CODE_0DA7E7:          LDY.B LevelLoadPos
                      LDX.B #$00
                      JSR CODE_0DA6B1
                    - JSR StzTo6ePointer
                      LDA.L DATA_0DA7E3,X
...
CODE_0DA80D:          LDY.B LevelLoadPos
                      TXA
                      SEC
                      SBC.B #$91
                      TAX
...
CODE_0DA82A:          LDA.B LevelLoadPos
                      CLC
                      ADC.B #$10
                      STA.B LevelLoadPos
                      TAY
...
CODE_0DA846:          LDY.B LevelLoadPos
                      TXA
                      SEC
                      SBC.B #$93
                      TAX
...
CODE_0DA87D:          LDY.B LevelLoadPos
                      TXA
                      SEC
                      SBC.B #$95
                      TAX
...
CODE_0DA8C3:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      STA.B _2
...
CODE_0DA92E:          LDA.L DATA_0DA8B4,X
                      STA.B _C
                      JSR StzTo6ePointer
                      CPX.B #$07
                      BMI +
...
CODE_0DA95B:          STA.B [Map16LowPtr],Y
CODE_0DA95D:          INY
                      TYA
                      AND.B #$0F
                      BNE +
...
CODE_0DA97D:          LDA.B LevelLoadPos
                      CLC
                      ADC.B #$10
                      STA.B LevelLoadPos
                      TAY
                      BCC +
CODE_0DA987:          LDA.B Map16LowPtr+1
                      ADC.B #$00
                      STA.B Map16LowPtr+1
                      STA.B Map16HighPtr+1
                      STA.B _5
...
CODE_0DA992:          LDA.B LevelLoadPos
                      CLC
                      ADC.B #$0F
                      TAY
                      BCC +
                    ...
                    + TYA
                      ...
                      JSR CODE_0DA987
                    + JSR CODE_0DA9D6
CODE_0DA9B1:          STY.B LevelLoadPos
                      RTS

CODE_0DA9B4:          LDA.B LevelLoadPos
                      CLC
                      ADC.B #$11
                      TAY
                      BCC +
                    ...
                    + TYA
                      ...
                      JSR CODE_0DA987
                    + JSR CODE_0DA9EF
CODE_0DA9D3:          STY.B LevelLoadPos
                      RTS

CODE_0DA9D6:          LDA.B Map16LowPtr
                      SEC
                      SBC.B #$B0
                      STA.B Map16LowPtr
                      STA.B Map16HighPtr
...
CODE_0DAA26:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
...
CODE_0DAA68:          JSR Sta1To6ePointer
                      LDA.B #$35
                      JSR CODE_0DA95B
                      JSR Sta1To6ePointer
                      LDA.B #$36
                      STA.B [Map16LowPtr],Y
CODE_0DAA77:          JSR CODE_0DA6BA
                      JSR CODE_0DA97D
                      CPX.B #$05
                      BEQ CODE_0DAA85
                      CPX.B #$02
                      BPL CODE_0DAA8C
CODE_0DAA85:          DEC.B _0
                      BPL CODE_0DAA52
                      JMP Return0DAAA3

CODE_0DAA8C:          DEC.B _0
                      BNE CODE_0DAA68
                      JSR Sta1To6ePointer
                      LDA.L DATA_0DAA1C,X
                      JSR CODE_0DA95B
...
CODE_0DAAB4:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      STA.B _1
...
CODE_0DAADA:          JSR Sta1To6ePointer
                      LDA.L DATA_0DAAAC,X
                      JSR CODE_0DA95B
CODE_0DAAE4:          CPX.B #$04
                      BPL CODE_0DAAEF
                      DEC.B _1
                      BPL CODE_0DAADA
                      JMP CODE_0DAAFC

CODE_0DAAEF:          DEC.B _1
                      BNE CODE_0DAAC9
                      JSR Sta1To6ePointer
                      LDA.L DATA_0DAAA4,X
                      STA.B [Map16LowPtr],Y
CODE_0DAAFC:          LDA.B _0
                      STA.B _1
                      JSR CODE_0DA6BA
                      JSR CODE_0DA97D
                      INX
...
CODE_0DAB0D:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
...
CODE_0DAB3E:          LDA.B LvlLoadObjSize
                      AND.B #$0F
CODE_0DAB42:          CMP.B #$0A
                      BMI +
                      SEC
                      SBC.B #$0A
                      JMP CODE_0DAB42
...
CODE_0DAB6E:          LDY.B LevelLoadPos
                      LDA.B #$01
                      STA.B _2
                      STA.B _0
                      JSR CODE_0DA6B1
...
CODE_0DAB83:          LDX.B _2
                      ...
                      DEX
                      BMI CODE_0DABB8
CODE_0DAB99:          JSR Sta1To6ePointer
                      LDA.B #$DE
                      JSR CODE_0DA95B
                      JSR Sta1To6ePointer
                      LDA.B #$E6
...
CODE_0DABB8:          JSR CODE_0DA6BA
                    ...
                    + TYA
                      ...
                      JSR CODE_0DA987
                    + JSR CODE_0DA9D6
CODE_0DABE7:          STY.B LevelLoadPos
                      JMP CODE_0DAB83

CODE_0DABEC:          LDX.B _2
                      DEX
                      DEX
                      JSR CODE_0DA97D
                      JMP CODE_0DAB99
...
CODE_0DABFD:          STA.B _C
                      TXA
                      PHA
                      LDX.B #$02
                      LDA.B [Map16LowPtr],Y
CODE_0DAC05:          CMP.L DATA_0DABF7,X
                      BEQ CODE_0DAC11
                      DEX
                      BPL CODE_0DAC05
                      JMP CODE_0DAC1A

CODE_0DAC11:          LDA.B _C
                      CLC
                      ADC.L DATA_0DABFA,X
                      STA.B _C
CODE_0DAC1A:          PLA
...
CODE_0DAC21:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
...
CODE_0DAC57:          JSR CODE_0DA6BA
                    ...
                    + TYA
                      ...
                      JSR CODE_0DA987
                    + JSR CODE_0DA9D6
CODE_0DAC84:          STY.B LevelLoadPos
                      JMP CODE_0DAC34

CODE_0DAC89:          LDX.B _2
                      JSR CODE_0DA97D
                      JMP CODE_0DAC3E

Return0DAC91:         RTS

CODE_0DAC92:          LDY.B LevelLoadPos
                      LDA.B #$03
                      STA.B _2
                      STA.B _0
                      JSR CODE_0DA6B1
...
CODE_0DACA7:          LDX.B _2
                      ...
                      DEX
                      BMI CODE_0DAD00
CODE_0DACCF:          JSR Sta1To6ePointer
                      LDA.B #$D8
                      JSR CODE_0DA95B
                      JSR Sta1To6ePointer
                      LDA.B #$DA
...
CODE_0DAD00:          JSR CODE_0DA6BA
                    ...
                    + TYA
                      ...
                      JSR CODE_0DA987
                    + JSR CODE_0DA9D6
CODE_0DAD32:          STY.B LevelLoadPos
                      JMP CODE_0DACA7

CODE_0DAD37:          LDX.B _2
                      DEX
                      DEX
                      DEX
                      DEX
...
CODE_0DAD44:          LDY.B LevelLoadPos
                      LDX.B #$01
                      STX.B _2
                      STX.B _0
                      JSR CODE_0DA6B1
...
CODE_0DAD65:          CPX.B #$03
                      ...
                      LDA.B _0
                      BEQ Return0DAD9F
CODE_0DAD7F:          JSR Sta1To6ePointer
                      LDA.B #$A0
                      JSR CODE_0DABFD
                      JSR Sta1To6ePointer
                      LDA.B #$A5
...
CODE_0DADA3:          LDY.B LevelLoadPos
                      LDX.B #$00
                      STX.B _2
                      STX.B _0
                      JSR CODE_0DA6B1
                    ...
                    - JSR StzTo6ePointer
                      ...
                      JSR CODE_0DA95B
                      DEX
CODE_0DADC4:          CPX.B #$01
                      BNE -
                      JSR Sta1To6ePointer
                      LDA.B #$E4
                      JSR CODE_0DA95B
CODE_0DADD0:          LDA.B _0
                      BEQ Return0DADEA
                      JSR Sta1To6ePointer
                      LDA.B #$AF
                      JSR CODE_0DABFD
...
CODE_0DADEB:          LDY.B LevelLoadPos
                      LDX.B #$03
                      STX.B _2
                      JSR CODE_0DA6B1
                      LDA.B LvlLoadObjSize
...
CODE_0DAE0A:          CPX.B #$07
                      ...
                      LDA.B _0
                      BEQ Return0DAE69
CODE_0DAE36:          JSR Sta1To6ePointer
                      LDA.B #$82
                      JSR CODE_0DABFD
                      JSR Sta1To6ePointer
                      LDA.B #$87
...
CODE_0DAE6D:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
...
CODE_0DAE88:          LDX.B _2
                      ...
                      DEX
                      BMI CODE_0DAEBD
CODE_0DAE9E:          JSR Sta1To6ePointer
                      LDA.B #$EE
                      JSR CODE_0DA95B
                      JSR Sta1To6ePointer
                      LDA.B #$F0
...
CODE_0DAEBD:          JSR CODE_0DA6BA
                    ...
                    + TYA
                      ...
                      JSR CODE_0DA987
                    + JSR CODE_0DA9EF
CODE_0DAEF2:          STY.B LevelLoadPos
                      DEC.B _0
                      BMI +
                      JMP CODE_0DAE88
...
CODE_0DAEFC:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
...
CODE_0DAF20:          CPX.B #$04
                      ...
                      LDA.B _1
                      BEQ +
CODE_0DAF3C:          JSR Sta1To6ePointer
                      LDA.B #$C8
                      JSR CODE_0DA95B
                      JSR Sta1To6ePointer
                      LDA.B #$C9
...
CODE_0DAF61:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
...
CODE_0DAF7B:          LDX.B _2
                      JSR Sta1To6ePointer
                      LDA.B #$C4
                      JSR CODE_0DA95B
                      DEX
                      BMI CODE_0DAF9E
CODE_0DAF88:          JSR Sta1To6ePointer
                      LDA.B #$EC
                      JSR CODE_0DA95B
                      JMP CODE_0DAF9B
...
CODE_0DAF9E:          JSR CODE_0DA6BA
                    ...
                    + TYA
                      ...
                      JSR CODE_0DAFDF
                    + JSR CODE_0DA9EF
CODE_0DAFD5:          STY.B LevelLoadPos
                      DEC.B _0
                      BMI +
                      JMP CODE_0DAF7B
...
CODE_0DAFDF:          LDA.B Map16LowPtr+1
                      SBC.B #$00
                      STA.B Map16LowPtr+1
                      STA.B Map16HighPtr+1
                      STA.B _5
...
CODE_0DAFEA:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
...
CODE_0DB00B:          CPX.B #$02
                      ...
                      LDA.B _1
                      BEQ +
CODE_0DB01F:          JSR Sta1To6ePointer
                      LDA.B #$C5
                      JSR CODE_0DA95B
                    + JSR CODE_0DA6BA
                      LDX.B _2
...
CODE_0DB075:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
                    ...
                    + LDA.L DATA_0DB039,X
                      ...
                      CPX.B #$03
                      BMI +
CODE_0DB0AD:          JSR Sta1To6ePointer
                    + LDA.L DATA_0DB048,X
                      JSR CODE_0DB198
                      STA.B [Map16LowPtr],Y
                      JSR CODE_0DA97D
                      DEC.B _0
                      BMI CODE_0DB0E2
CODE_0DB0C0:          JSR StzTo6ePointer
                      CPX.B #$09
                      BPL CODE_0DB0CF
                      CPX.B #$07
                      BPL +
                      CPX.B #$03
                      BMI +
CODE_0DB0CF:          JSR Sta1To6ePointer
                    + LDA.L DATA_0DB057,X
                      JSR CODE_0DB198
                      STA.B [Map16LowPtr],Y
                      JSR CODE_0DA97D
...
CODE_0DB114:          CPX.B #$03
                      BMI CODE_0DB120
                      CPX.B #$09
                      BMI CODE_0DB120
                      CPX.B #$0B
                      BMI Return0DB15B
CODE_0DB120:          CPX.B #$02
                      BEQ Return0DB15B
                      STX.B _B
                      STA.B _C
                      LDX.B #$11
                      LDA.B [Map16LowPtr],Y
CODE_0DB12C:          CMP.L DATA_0DB0F0,X
                      BEQ CODE_0DB152
                      DEX
                      BPL CODE_0DB12C
                      CMP.B #$25
                      ...
                      CMP.B #$48
                      BNE CODE_0DB14D
CODE_0DB14B:          INC.B _C
CODE_0DB14D:          LDA.B _C
                      JMP CODE_0DB159

CODE_0DB152:          JSR Sta1To6ePointer
                      LDA.L DATA_0DB102,X
CODE_0DB159:          LDX.B _B
Return0DB15B:         RTS
...
CODE_0DB198:          CPX.B #$03
                      BMI CODE_0DB1A4
                      CPX.B #$07
                      BMI Return0DB1C7
                      CPX.B #$09
                      BPL Return0DB1C7
CODE_0DB1A4:          CPX.B #$02
                      BEQ Return0DB1C7
                      STX.B _B
                      STA.B _C
                      LDX.B #$1D
                      LDA.B [Map16LowPtr],Y
CODE_0DB1B0:          CMP.L DATA_0DB15C,X
                      BEQ CODE_0DB1BE
                      DEX
                      BPL CODE_0DB1B0
                      LDA.B _C
...
CODE_0DB1BE:          JSR Sta1To6ePointer
                      LDA.L DATA_0DB17A,X
CODE_0DB1C5:          LDX.B _B
Return0DB1C7:         RTS

CODE_0DB1C8:          LDA.B LvlLoadObjSize
                      STA.B _0
                      TAX
                      LDA.B #$02
                      STA.B _2
...
CODE_0DB1D4:          LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      TAX
                      LDA.B LvlLoadObjSize
...
CODE_0DB224:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _2
                      LDA.B LvlLoadObjSize
                      ...
                      JSR CODE_0DA6B1
                      LDX.B #$00
CODE_0DB23B:          LDA.L DATA_0DB212,X
                      STA.B _3
                      LDA.B _2
                      BEQ +
                      LDA.L DATA_0DB21B,X
                    ...
                    + DEC.B _1
                      BEQ CODE_0DB28F
CODE_0DB265:          LDA.L DATA_0DB215,X
                      STA.B _3
                      LDA.B _2
                      BEQ +
                      LDA.L DATA_0DB21E,X
                    ...
                    + DEC.B _1
                      BNE CODE_0DB265
CODE_0DB28F:          LDA.L DATA_0DB218,X
                      STA.B _3
                      LDA.B _2
                      BEQ +
                      LDA.L DATA_0DB221,X
...
CODE_0DB2CA:          LDA.W TranslevelNo
                      LSR A
                      LSR A
                      LSR A
                      TAY
...
ADDR_0DB336:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      TAX
...
CODE_0DB3BD:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
CODE_0DB3E3:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      STA.B _2
...
CODE_0DB42D:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      STA.B _1
                      JSR CODE_0DA6B1
                      LDX.B #$00
CODE_0DB43C:          JSR StzTo6ePointer
                      CPX.B #$00
                      BEQ +
                      JSR Sta1To6ePointer
                    + LDA.L DATA_0DB42B,X
...
CODE_0DB461:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
                    ...
                    - JSR StzTo6ePointer
                      ...
                      DEC.B _0
                      BNE -
CODE_0DB490:          JSR StzTo6ePointer
                      LDA.B #$0E
                      JSR CODE_0DA95B
                      DEX
                      BPL CODE_0DB490
...
CODE_0DB49E:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
...
CODE_0DB4B7:          JSR StzTo6ePointer
                      LDA.L DATA_0DB49C,X
                      STA.B [Map16LowPtr],Y
CODE_0DB4C0:          TYA
                      CLC
...
CODE_0DB4FE:          STA.B _C
                    ...
                    + CMP.B #$08
                      BNE +
                      LDA.L DATA_0DB4FC,X
CODE_0DB515:          STA.B _C
                    + JSR StzTo6ePointer
                      LDA.B _C
                      STA.B [Map16LowPtr],Y
                      RTS

CODE_0DB51F:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$F0
                      LSR A
                      LSR A
                    ...
                    - JSR Sta1To6ePointer
                      LDA.B #$54
CODE_0DB537:          STA.B [Map16LowPtr],Y
                      JSR CODE_0DA97D
                      DEX
                      BNE -
                      JSR Sta1To6ePointer
...
CODE_0DB547:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      TAX
                      JSR Sta1To6ePointer
...
ADDR_0DB571:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      SEC
                      SBC.B #$68
                      TAX
...
CODE_0DB5B7:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
CODE_0DB604:          LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B #$03
                      STA.B _3
...
CODE_0DB664:          LDY.B LevelLoadPos
                      LDA.B _0
                      STA.B _2
                      LDA.B #$02
                      STA.B _1
...
CODE_0DB6C3:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
CODE_0DB6E3:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      SEC
                      SBC.B #$88
                      TAX
...
ADDR_0DB705:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
                    ...
                    - JSR StzTo6ePointer
                      LDA.L DATA_0DB6FD,X
ADDR_0DB725:          STA.B [Map16LowPtr],Y
                      JSR CODE_0DA97D
                      DEC.B _0
                      BPL -
                      RTS
...
CODE_0DB73F:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
...
CODE_0DB779:          LDA.B _1
                    ...
                    + DEC.B _0
                      BPL CODE_0DB779
CODE_0DB79F:          JSR CODE_0DA95D
                      JSR Sta1To6ePointer
                      LDA.B #$EB
                      STA.B [Map16LowPtr],Y
                      RTS

CODE_0DB7AA:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      STA.B _2
...
CODE_0DB7D6:          JSR Sta1To6ePointer
                      LDA.B #$AA
                      JSR CODE_0DABFD
                      DEX
                      JSR Sta1To6ePointer
...
CODE_0DB823:          JSR StzTo6ePointer
                      LDA.B #$A3
                      JSR CODE_0DB84E
                      JMP CODE_0DB836
...
CODE_0DB84E:          STA.B _F
                      ...
                      INC.B _F
                    + INC.B _F
CODE_0DB85E:          LDA.B _F
                      JMP CODE_0DA95B

CODE_0DB863:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      STA.B _2
...
CODE_0DB88F:          JSR StzTo6ePointer
                      LDA.B #$A9
                      JSR CODE_0DB84E
                      JMP CODE_0DB8A2
...
CODE_0DB8EB:          JSR StzTo6ePointer
                      LDA.B #$A9
                      JSR CODE_0DB84E
                      JMP CODE_0DB8FE
...
CODE_0DB91E:          LDX.B #$01
                    + LDY.B LevelLoadPos
                      ...
                      LSR A
                      STA.B _1
CODE_0DB930:          LDA.B _0
                      STA.B _2
                      JSR CODE_0DA6B1
CODE_0DB937:          JSR StzTo6ePointer
                      LDA.L DATA_0DB91A,X
                      STA.B _F
...
CODE_0DB966:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      TAX
                      LDA.B LvlLoadObjSize
                      ...
                      LSR A
                      STA.B _0
CODE_0DB975:          JSR StzTo6ePointer
                      LDA.L DATA_0DB962,X
                      JSR CODE_0DB997
                      JSR CODE_0DA97D
                      DEC.B _0
...
CODE_0DB997:          STA.B _F
                      ...
                      CMP.B #$B6
                      BNE CODE_0DB9BB
CODE_0DB9A7:          STA.B _F
                      INC.B _F
                      JMP CODE_0DB9BB

CODE_0DB9AE:          LDA.B [Map16LowPtr],Y
                      CMP.B #$0E
                      BNE CODE_0DB9BB
                      JSR Sta1To6ePointer
                      LDA.B #$0D
                      STA.B _F
CODE_0DB9BB:          LDA.B _F
                      STA.B [Map16LowPtr],Y
                      RTS

CODE_0DB9C0:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
...
CODE_0DB9F6:          LDA.B [Map16LowPtr],Y
                      CMP.B #$0E
                      BNE +
                      JSR Sta1To6ePointer
                      LDX.B #$0B
...
CODE_0DBA0A:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      TAX
...
CODE_0DBA4C:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      TAX
                      LDA.B LvlLoadObjSize
...
CODE_0DBA67:          CPX.B #$02
                      BPL +
                      JSR Sta1To6ePointer
                    + LDA.L DATA_0DBA48,X
                      STA.B [Map16LowPtr],Y
CODE_0DBA74:          JSR CODE_0DA97D
                      DEC.B _0
                      BPL CODE_0DBA67
                      RTS
...
CODE_0DBADC:          LDA.B LvlLoadObjSize
                      STA.B _F
CODE_0DBAE0:          LDA.B LevelLoadPos
                      STA.B _E
                      TAY
                      LDX.B #$00
                      LDA.B #$05
...
CODE_0DBB2C:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
                    ...
                    - JSR Sta1To6ePointer
                      ...
                      LDA.B #$64
                      STA.B [Map16LowPtr],Y
CODE_0DBB59:          JSR CODE_0DA6BA
                      JSR CODE_0DA97D
                      DEX
                      BPL -
                      RTS

CODE_0DBB63:          LDX.B #$0E
                      JMP CODE_0DA8C3

                      %insert_empty($97,$98,$98,$98,$98)

Map16Tileset1:        db $F4,$09,$F7,$09,$F5,$09,$FC,$09
...
CODE_0DC259:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      SEC
                      SBC.B #$4B
                      TAX
...
CODE_0DC2E9:          LDY.B LevelLoadPos
                      LDX.B #$00
CODE_0DC2ED:          LDA.B #$08
                      STA.B _0
CODE_0DC2F1:          JSR StzTo6ePointer
                      LDA.L DATA_0DC26B,X
                      CMP.B #$25
                      BEQ +
                      STA.B [Map16LowPtr],Y
...
CODE_0DC31E:          LDY.B LevelLoadPos
                      LDX.B #$00
                      LDA.B #$01
                      STA.B _0
CODE_0DC326:          LDA.B _0
                      STA.B _1
                    - JSR StzTo6ePointer
                      LDA.L DATA_0DC318,X
                      JSR CODE_0DA95B
...
CODE_0DC341:          LDA.B LvlLoadObjSize
                      AND.B #$02
                      LSR A
                      JSL ExecutePtrLong
...
CODE_0DC358:          LDY.B LevelLoadPos
                      LDA.B #$00
                      STA.B _2
                      LDA.B LvlLoadObjSize
                      AND.B #$03
                      ...
                      STA.B _0
                      INC.B _0
CODE_0DC370:          LDA.B _2
                      STA.B _3
                      JSR Sta1To6ePointer
                      LDA.L DATA_0DC350,X
                      JSR CODE_0DA95B
CODE_0DC37E:          DEC.B _3
                      BMI CODE_0DC39B
                      JSR Sta1To6ePointer
                      LDA.L DATA_0DC354,X
                      JSR CODE_0DA95B
                    ...
                    - JSR StzTo6ePointer
                      LDA.B #$3F
                      JSR CODE_0DA95B
CODE_0DC397:          DEC.B _3
                      BPL -
CODE_0DC39B:          JSR CODE_0DA6BA
                      INC.B _2
                      DEC.B _0
                      BEQ CODE_0DC3CD
                      BPL +
                    ...
                    + TYA
                      ...
                      JSR CODE_0DA987
                    + JSR CODE_0DA9D6
CODE_0DC3C8:          STY.B LevelLoadPos
                      JMP CODE_0DC370

CODE_0DC3CD:          LDA.B _2
                      STA.B _3
                      JSR CODE_0DA97D
                      JMP CODE_0DC37E
...
CODE_0DC3D8:          LDY.B LevelLoadPos
                      LDA.B #$00
                      STA.B _2
                      LDA.B LvlLoadObjSize
                      AND.B #$03
                    ...
                    - JSR StzTo6ePointer
                      ...
                      JSR CODE_0DA95B
                      DEC.B _3
CODE_0DC3FD:          LDA.B _3
                      CMP.B #$01
                      BNE -
                      JSR Sta1To6ePointer
                      LDA.L DATA_0DC354,X
                      JSR CODE_0DA95B
CODE_0DC40D:          LDA.B _0
                      BEQ Return0DC42B
                      JSR Sta1To6ePointer
                      LDA.L DATA_0DC350,X
                      JSR CODE_0DA95B
...
CODE_0DC42E:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
CODE_0DC44F:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
...
CODE_0DC478:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
CODE_0DC4C9:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
...
CODE_0DC4EF:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      TAX
                      LDA.B LvlLoadObjSize
                      ...
                      JSR CODE_0DA6BA
                      JSR CODE_0DA97D
CODE_0DC51E:          JSR StzTo6ePointer
                      LDA.B #$89
                      JSR CODE_0DA95B
                      JSR Sta1To6ePointer
                      LDA.B #$66
...
CODE_0DC58A:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
CODE_0DC5D8:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
...
Map16Tileset2:        db $C5,$09,$C5,$09,$85,$09,$C6,$89
...
CODE_0DCE67:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      SEC
                      SBC.B #$4D
                      ASL A
...
CODE_0DCE94:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      SEC
                      SBC.B #$51
                      TAX
...
ADDR_0DCEA6:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      SEC
                      SBC.B #$51
                      TAX
...
CODE_0DCEC0:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LDX.B #$00
                    - JSR StzTo6ePointer
                      LDA.L DATA_0DCEBE,X
...
CODE_0DCEDA:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LDX.B #$00
                    - JSR StzTo6ePointer
                      LDA.L DATA_0DCED8,X
...
ADDR_0DCEF2:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
CODE_0DCF12:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
CODE_0DCF33:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      TAX
                      LDA.B LvlLoadObjSize
...
CODE_0DCF53:          LDA.B LvlLoadObjSize
                      AND.B #$0F
                      TAX
                      JSL ExecutePtrLong
...
CODE_0DCF6E:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
                      ...
                      TAX
                      JSR CODE_0DA6B1
CODE_0DCF7A:          JSR StzTo6ePointer
                      LDA.B #$8C
                      JSR CODE_0DA95B
                      JSR StzTo6ePointer
                      LDA.B #$8D
                    ...
                    + TYA
                      ...
                      JSR CODE_0DA987
                    + JSR CODE_0DA9D6
CODE_0DCFAB:          STY.B LevelLoadPos
                      DEX
                      BPL CODE_0DCF7A
                      RTS

CODE_0DCFB1:          LDA.B #$86
                      CPX.B #$04
                      BNE +
                      LDA.B #$94
                    + STA.B _0
                      ...
                      LSR A
                      TAX
CODE_0DCFC4:          JSR StzTo6ePointer
                      LDA.B _0
                      STA.B [Map16LowPtr],Y
                      LDA.B LevelLoadPos
                      CLC
                    ...
                    + TYA
                      ...
                      JSR CODE_0DA987
                    + JSR CODE_0DA9D6
CODE_0DCFEA:          STY.B LevelLoadPos
                      DEX
                      BPL CODE_0DCFC4
                      RTS

ADDR_0DCFF0:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
                      ...
                      TAX
                      JSR CODE_0DA6B1
ADDR_0DCFFC:          JSR StzTo6ePointer
                      LDA.B #$8E
                      JSR CODE_0DA95B
                      JSR StzTo6ePointer
                      LDA.B #$8F
...
CODE_0DD034:          LDA.B #$87
                    ...
                    + STA.B _0
                      ...
                      LSR A
                      TAX
CODE_0DD047:          JSR StzTo6ePointer
                      LDA.B _0
                      STA.B [Map16LowPtr],Y
                      LDA.B LevelLoadPos
                      CLC
...
ADDR_0DD070:          LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
                      LSR A
...
ADDR_0DD080:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      TAX
ADDR_0DD087:          JSR StzTo6ePointer
                      LDA.B #$88
                      STA.B [Map16LowPtr],Y
                      TYA
                      CLC
                    ...
                    + TYA
                      ...
                      JSR CODE_0DA987
                    + JSR CODE_0DA9D6
ADDR_0DD0BD:          STY.B LevelLoadPos
                      DEX
                      BPL ADDR_0DD087
                      RTS

ADDR_0DD0C3:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      TAX
ADDR_0DD0CA:          JSR StzTo6ePointer
                      LDA.B #$89
                      STA.B [Map16LowPtr],Y
                      TYA
                      CLC
...
CODE_0DD103:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      JSR Sta1To6ePointer
...
CODE_0DD145:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
ADDR_0DD182:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      TAX
                      JSR Sta1To6ePointer
...
ADDR_0DD1A5:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
                    ...
                    - JSR Sta1To6ePointer
                      LDA.B #$5D
ADDR_0DD1BB:          STA.B [Map16LowPtr],Y
                      JSR CODE_0DA97D
                      DEX
                      BNE -
                      JSR Sta1To6ePointer
...
CODE_0DD1D9:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      TAX
                      LDA.B LvlLoadObjSize
                    ...
                    + JSR CODE_0DA6BA
                      ...
                      JSR CODE_0DA97D
                      LDX.B #$00
CODE_0DD226:          JSR Sta1To6ePointer
                      LDA.L DATA_0DD1D3,X
                      JSR CODE_0DA95B
                      INX
                      JSR Sta1To6ePointer
...
CODE_0DD24E:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      STA.B _1
                      JSR CODE_0DA6B1
                      LDX.B #$00
CODE_0DD25D:          JSR StzTo6ePointer
                      CPX.B #$00
                      BEQ +
                      JSR Sta1To6ePointer
                    + LDA.L DATA_0DD24C,X
...
CODE_0DDA57:          LDY.B LevelLoadPos
                      JSR Sta1To6ePointer
                      LDA.B #$FE
                      STA.B [Map16LowPtr],Y
                      RTS
...
CODE_0DDA68:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      SEC
                      SBC.B #$75
                      TAX
...
CODE_0DDA80:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      SEC
                      SBC.B #$7C
                      TAX
...
CODE_0DDAA2:          LDY.B LevelLoadPos
                      LDX.B #$00
                      JSR CODE_0DA6B1
                    - JSR Sta1To6ePointer
                      LDA.L DATA_0DDA9E,X
...
CODE_0DDAC8:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      TAX
                      LDA.B LvlLoadObjSize
                    ...
                    - JSR Sta1To6ePointer
                      LDA.L DATA_0DDAC6,X
CODE_0DDAE8:          STA.B [Map16LowPtr],Y
                      JSR CODE_0DA97D
                      DEC.B _0
                      BPL -
                      RTS

CODE_0DDAF2:          LDA.B LvlLoadObjSize
                      AND.B #$03
                      JSL ExecutePtrLong
...
CODE_0DDB06:          LDY.B LevelLoadPos
                      LDA.B #$01
                      STA.B _2
                      STA.B _0
                      JSR CODE_0DA6B1
...
CODE_0DDB1B:          LDX.B _2
                      ...
                      DEX
                      BMI CODE_0DDB50
CODE_0DDB31:          JSR Sta1To6ePointer
                      LDA.B #$FB
                      JSR CODE_0DA95B
                      JSR Sta1To6ePointer
                      LDA.B #$FF
...
CODE_0DDB50:          JSR CODE_0DA6BA
                    ...
                    + TYA
                      ...
                      JSR CODE_0DA987
                    + JSR CODE_0DA9D6
CODE_0DDB7F:          STY.B LevelLoadPos
                      JMP CODE_0DDB1B

CODE_0DDB84:          LDX.B _2
                      DEX
                      DEX
                      JSR CODE_0DA97D
                      JMP CODE_0DDB31
...
CODE_0DDB8F:          LDY.B LevelLoadPos
                      LDA.B #$00
                      STA.B _2
                      STA.B _0
                      JSR CODE_0DA6B1
...
CODE_0DDBC7:          JSR CODE_0DA6BA
                    ...
                    + TYA
                      ...
                      JSR CODE_0DA987
                    + JSR CODE_0DA9D6
CODE_0DDBF4:          STY.B LevelLoadPos
                      JMP CODE_0DDBA4

CODE_0DDBF9:          LDX.B _2
                      JSR CODE_0DA97D
                      JMP CODE_0DDBAE

Return0DDC01:         RTS

ADDR_0DDC02:          LDY.B LevelLoadPos
                      LDX.B #$01
                      STX.B _2
                      STX.B _0
                      JSR CODE_0DA6B1
...
ADDR_0DDC23:          CPX.B #$03
                      ...
                      LDA.B _0
                      BEQ Return0DDC5D
ADDR_0DDC3D:          JSR Sta1To6ePointer
                      LDA.B #$D4
                      JSR CODE_0DA95B
                      JSR Sta1To6ePointer
                      LDA.B #$D5
...
CODE_0DDC61:          LDY.B LevelLoadPos
                      LDX.B #$00
                      STX.B _2
                      STX.B _0
                      JSR CODE_0DA6B1
                    ...
                    - JSR Sta1To6ePointer
                      ...
                      JSR CODE_0DA95B
                      DEX
CODE_0DDC82:          CPX.B #$01
                      BNE -
                      JSR Sta1To6ePointer
                      LDA.B #$FE
                      JSR CODE_0DA95B
CODE_0DDC8E:          LDA.B _0
                      BEQ Return0DDCA8
                      JSR Sta1To6ePointer
                      LDA.B #$D7
                      JSR CODE_0DA95B
...
CODE_0DDCA9:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
CODE_0DDCD2:          JSR Sta1To6ePointer
                      LDA.B #$FF
                      JSR CODE_0DA95B
                      DEX
                      BPL CODE_0DDCD2
CODE_0DDCDD:          JSR CODE_0DA6BA
                      JSR CODE_0DA97D
                      LDX.B _0
                      DEC.B _1
                      BPL CODE_0DDCD2
...
CODE_0DDCEA:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
...
CODE_0DDD2E:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
                    ...
                    - JSR Sta1To6ePointer
                      ...
                      DEC.B _0
                      BNE -
CODE_0DDD51:          JSR Sta1To6ePointer
                      LDA.L DATA_0DDD2A,X
                      JSR CODE_0DA95B
                      RTS

CODE_0DDD5C:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
...
CODE_0DDD87:          LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
                      LSR A
...
CODE_0DDD99:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      ASL A
...
CODE_0DDDF3:          JSR StzTo6ePointer
                      LDA.B #$3F
                      STA.B [Map16LowPtr],Y
                      TYA
                      CLC
...
CODE_0DDE09:          DEX
                    ...
                    + TYA
                      ...
                      JSR CODE_0DA987
                    + JSR CODE_0DA9D6
CODE_0DDE2E:          STY.B LevelLoadPos
                      DEC.B _1
                      DEC.B _1
                      DEC.B _0
                      BMI +
...
CODE_0DDE3C:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      ASL A
...
CODE_0DDE96:          JSR StzTo6ePointer
                      LDA.B #$3F
                      STA.B [Map16LowPtr],Y
                      TYA
                      CLC
...
CODE_0DDF3A:          LDA.B LvlLoadObjSize
                      AND.B #$0F
...
CODE_0DE0AE:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      SEC
                      SBC.B #$71
                      TAX
...
CODE_0DE135:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
Map16Tileset4:        db $82,$1D,$82,$DD,$82,$DD
...
CODE_0DE95F:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      SEC
                      SBC.B #$57
                      TAX
...
CODE_0DE9AA:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      SEC
                      SBC.B #$61
                      STA.B _0
...
CODE_0DE9ED:          LDA.B LvlLoadObjSize
                      SEC
                      SBC.B #$64
                      ASL A
                      ASL A
                      TAX
CODE_0DE9F5:          LDY.B LevelLoadPos
                      LDA.B #$01
                      STA.B _0
                      STA.B _1
                      JSR CODE_0DA6B1
...
ADDR_0DEA3E:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      SEC
                      SBC.B #$66
                      ASL A
...
CODE_0DEABF:          LDY.B LevelLoadPos
                      LDX.B #$00
CODE_0DEAC3:          LDA.B #$05
                      STA.B _0
                    - JSR StzTo6ePointer
                      LDA.L DATA_0DEA71,X
                      JSR CODE_0DA95B
...
CODE_0DEB6A:          LDY.B LevelLoadPos
                      LDX.B #$00
CODE_0DEB6E:          LDA.B #$09
                      STA.B _0
                    - JSR StzTo6ePointer
                      LDA.L DATA_0DEADE,X
                      JSR CODE_0DA95B
...
CODE_0DEC33:          LDY.B LevelLoadPos
                      LDX.B #$00
CODE_0DEC37:          LDA.B #$0F
                      STA.B _0
                    - JSR StzTo6ePointer
                      LDA.L DATA_0DEB93,X
                      JSR CODE_0DA95B
...
CODE_0DEC5C:          LDY.B LevelLoadPos
                      JSR Sta1To6ePointer
                      LDA.B #$10
                      STA.B [Map16LowPtr],Y
                      RTS
...
ADDR_0DEC68:          LDY.B LevelLoadPos
                      LDX.B #$00
                    - JSR StzTo6ePointer
                      LDA.L ADDR_0DEC66,X
                      STA.B [Map16LowPtr],Y
...
CODE_0DEC8E:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      SEC
                      SBC.B #$8A
                      TAX
...
CODE_0DECC9:          TXA
                      ...
                      SBC.B #$34
                      TAX
CODE_0DECCE:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      STA.B _2
                      ...
                      STA.B _1
                      JSR CODE_0DA6B1
CODE_0DECE3:          JSR StzTo6ePointer
                      CPX.B #$01
                      BNE +
                      JSR Sta1To6ePointer
                    + LDA.L DATA_0DECC6,X
...
CODE_0DED12:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
CODE_0DED43:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      TAX
CODE_0DED4A:          JSR Sta1To6ePointer
                      LDA.B #$0A
                      JMP CODE_0DED57

                    - JSR Sta1To6ePointer
                      LDA.B #$0B
CODE_0DED57:          JSR CODE_0DA95B
                      DEX
                      BNE -
                      JSR Sta1To6ePointer
                      LDA.B #$0C
...
CODE_0DED6B:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      LSR A
                      LSR A
                      LSR A
                    ...
                    - JSR StzTo6ePointer
                      LDA.L DATA_0DED68,X
CODE_0DED8B:          STA.B [Map16LowPtr],Y
                      JSR CODE_0DA97D
                      DEC.B _0
                      BPL -
                      RTS
...
CODE_0DED99:          LDA.B LvlLoadObjSize
                      AND.B #$0F
                      TAX
                      LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
...
CODE_0DEDB9:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      TAX
                      JSR Sta1To6ePointer
...
CODE_0DEDDB:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
                    ...
                    - JSR Sta1To6ePointer
                      ...
                      DEC.B _1
                      BNE -
CODE_0DEE0B:          JSR Sta1To6ePointer
                      LDA.B #$54
                      JSR CODE_0DA95B
                      DEX
                      BPL CODE_0DEE0B
...
CODE_0DEE17:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
CODE_0DEE52:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
CODE_0DEE65:          LDX.B _0
                    ...
                    - JSR Sta1To6ePointer
                      ...
                      DEX
                      BNE -
CODE_0DEE74:          JSR Sta1To6ePointer
                      LDA.B #$55
                      JSR CODE_0DA95B
                      JSR CODE_0DA6BA
                      JSR CODE_0DA97D
...
CODE_0DEE89:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
                      ...
                      STA.B _1
                      JSR CODE_0DA6B1
CODE_0DEE9C:          JSR Sta1To6ePointer
                      LDA.B #$5C
                      JSR CODE_0DA95B
                      LDX.B _0
                      BEQ CODE_0DEEB3
...
CODE_0DEEC0:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      ASL A
                    ...
                    + TYA
                      ...
                      BCC CODE_0DEEFD
                      JSR CODE_0DA987
CODE_0DEEFD:          JSR CODE_0DA6BA
                      LDX.B _1
                      JSR StzTo6ePointer
                      LDA.B #$78
                      JMP CODE_0DEF0F

CODE_0DEF0A:          JSR StzTo6ePointer
                      LDA.B #$79
CODE_0DEF0F:          STA.B [Map16LowPtr],Y
                      TYA
                      CLC
                      ADC.B #$10
                      TAY
...
CODE_0DEF45:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      TAX
                      JSR StzTo6ePointer
...
CODE_0DEF67:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
CODE_0DEFA8:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
CODE_0DEFDE:          JSR Sta1To6ePointer
                      LDA.L DATA_0DEFA2,X
                      BNE +
                    - JSR StzTo6ePointer
                      LDA.L DATA_0DEFA4,X
...
CODE_0DF02B:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
CODE_0DF04E:          LDX.B _0
                    - JSR StzTo6ePointer
                      LDA.B #$EA
                      JSR CODE_0DA95B
                      DEX
                      BPL -
CODE_0DF05B:          JSR CODE_0DA6BA
                      JSR CODE_0DA97D
                      DEC.B _1
                      BPL CODE_0DF04E
                      RTS
...
CODE_0DF06C:          LDY.B LevelLoadPos
                      LDA.B LvlLoadObjSize
                      AND.B #$0F
                      STA.B _0
                      LDA.B LvlLoadObjSize
...
EnemyNameStripe00:    db $20,$00,$40,$A4,$FA,$34,$20,$60        ;!
                      ...
                      db $16,$38,$0B,$38,$FF                    ;!
																;!
EnemyNameStripe01:    db $20,$00,$40,$DE,$FA,$34,$20,$80        ;!
                      ...
                      db $1E,$38,$1C,$38,$FF                    ;!
																;!
EnemyNameStripe02:    db $20,$00,$40,$BE,$FA,$34,$20,$6B        ;!
                      ...
                      db $FF                                    ;!
																;!
EnemyNameStripe03:    db $20,$00,$41,$12,$FA,$34,$20,$80        ;!
...
EnemyNameStripe04:    db $20,$00,$41,$06,$FA,$34,$20,$A0        ;!
                      ...
                      db $0A,$38,$1C,$38,$FF                    ;!
																;!
EnemyNameStripe05:    db $20,$00,$41,$04,$FA,$34,$20,$A0        ;!
                      ...
                      db $10,$38,$FF                            ;!
																;!
EnemyNameStripe06:    db $20,$00,$40,$BE,$FA,$34,$20,$60        ;!
                      ...
                      db $11,$38,$FF                            ;!
																;!
EnemyNameStripe07:    db $20,$00,$40,$E2,$FA,$34,$20,$80        ;!
                      ...
                      db $1C,$38,$FF                            ;!
																;!
EnemyNameStripe08:    db $20,$00,$40,$BE,$FA,$34,$20,$60        ;!
                      ...
                      db $0D,$38,$FF                            ;!
																;!
EnemyNameStripe09:    db $20,$00,$40,$FE,$FA,$34,$20,$80        ;!
                      ...
                      db $17,$38,$0E,$38,$FF                    ;!
																;!
EnemyNameStripe0A:    db $20,$00,$40,$FE,$FA,$34,$20,$80        ;!
                      ...
                      db $18,$38,$1B,$38,$FF                    ;!
																;!
EnemyNameStripe0B:    db $20,$00,$42,$80,$FA,$34,$21,$40        ;!
                      ...
                      db $19,$38,$0A,$38,$1C,$38,$FF            ;!
																;!
EnemyNameStripe0C:    db $20,$00,$5F,$FE,$FA,$14,$51,$25        ;!
                      ...
                      db $19,$38,$0A,$38,$FF                    ;!
																;!
SpecEneNameStripe00:  db $FF,$FF                                ;!
SpecEneNameStripe01:  db $52,$C1,$00,$0D,$19,$38,$1E,$38        ;!
                      db $16,$38,$19,$38,$14,$38,$12,$38        ;!
                      db $17,$38,$FF,$FF                        ;!
SpecEneNameStripe02:  db $53,$2D,$00,$0B,$19                    ;!
                      db $38,$12,$38,$0D,$38,$10,$38,$12        ;!
                      db $38,$1D,$38,$FF,$FF                    ;!
SpecEneNameStripe03:  db $FF,$FF                                ;!
SpecEneNameStripe04:  db $53,$2E,$00,$15,$16,$38,$0A,$38        ;!
                      db $1C,$38,$14,$38,$FC,$00,$14,$38        ;!
                      db $18,$38,$18,$38,$19,$38,$0A,$38        ;!
                      db $1C,$38,$FF,$FF                        ;!
SpecEneNameStripe05:  db $FF,$FF                                ;!
SpecEneNameStripe06:  db $FF,$FF                                ;!
SpecEneNameStripe07:  db $FF,$FF                                ;!
SpecEneNameStripe08:  db $FF,$FF                                ;!
SpecEneNameStripe09:  db $FF,$FF                                ;!
SpecEneNameStripe0A:  db $FF,$FF                                ;!
SpecEneNameStripe0B:  db $FF,$FF                                ;!
